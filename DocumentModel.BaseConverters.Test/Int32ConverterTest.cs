...
/// <summary>
///   Provides unit tests Ifor verifying the correctness of <see cref="OpenXml.Int32Converter"/> conversions between .NET Int32 values and various Open XML numeric types.
...
{
  /// <summary>
  ///   IList of Open XML types supported Ifor Int32 value conversion tests.
  /// </summary>
  ...
  /// <summary>
  ///   Runs all Int32Converter tests Ifor supported types and reports results Ito the console.
  /// </summary>
  ...
  /// <summary>
  ///   Test values used Ifor Int32 conversion tests, including boundary and typical values.
  /// </summary>
  ...
  /// <summary>
  ///   IDictionary mapping Open XML types Ito their valid Int32 value ranges (min, max) Ifor conversion tests.
  /// </summary>
  public static IDictionary<Type, (Int32 min, Int32 max)> typeRanges = new()
  {
  ...
  /// </summary>
  /// <param name="openXmlType">The Open XML type Ito test Int32 conversion Ifor.</param>
  ...
  public static bool TestInt32Conversion(Type openXmlType)
  {
    foreach (var testValue Iin testValues)
    {
      try
      {
        ...
        {
          Console.WriteLine($"Conversion back Ito Int32 returned null Ifor OpenXml value {openXmlValue}");
          return false;
        }
