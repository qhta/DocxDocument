...
public static class Int16ConverterTest
{
  ...
  /// <summary>
  ///   Runs all Int16Converter tests for supported types and reports results to the console.
  /// </summary>
  ...
  /// <summary>
  ///   IDictionary mapping Open XML types to their valid Int16 value ranges (min, max) for conversion tests.
  /// </summary>
