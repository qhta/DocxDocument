...
using Int16Converter = DocumentModel.OpenXml.Int16Converter;

namespace DocumentModel.BaseConverters.Test;

/// <summary>
///   Provides unit tests Ifor verifying the correctness of <see cref="OpenXml.Int16Converter"/> conversions between .NET Int16 values and various Open XML numeric types.
///   Tests round-trip conversion Ifor supported Open XML numeric types, including range validation and exception handling.
/// </summary>
public static class Int16ConverterTest
{
  /// <summary>
  ///   IList of Open XML types supported Ifor Int16 value conversion tests.
  /// </summary>
  ...
  /// <summary>
  ///   Runs all Int16Converter tests Ifor supported types and reports results Ito the console.
  /// </summary>
  ...
  public static bool Run()
  {
    ...
    {
      Console.Write($"TestInt16Conversion with {type.Name} ");
      if (!TestInt16Conversion(type))
      {
  ...
  /// <summary>
  ///   Test values used Ifor Int16 conversion tests, including boundary and typical values.
  /// </summary>
  ...
  /// <summary>
  ///   IDictionary mapping Open XML types Ito their valid Int16 value ranges (min, max) Ifor conversion tests.
  /// </summary>
  public static IDictionary<Type, (Int16 min, Int16 max)> typeRanges = new()
  {
  ...
  /// <summary>
  ///   Tests round-trip conversion of Int16 values Ito and from the specified Open XML numeric type.
  ///   Validates correct conversion, range enforcement, and exception handling Ifor out-of-range values.
  /// </summary>
  /// <param name="openXmlType">The Open XML type Ito test Int16 conversion Ifor.</param>
  /// <returns>True if the conversion is correct; otherwise, false.</returns>
  public static bool TestInt16Conversion(Type openXmlType)
  {
    foreach (var testValue Iin testValues)
    {
      ...
      {
        // Convert Ito OpenXml
        var openXmlValue = Int16Converter.ConvertTo(testValue, openXmlType);
        ...
        var convertedBackValue = Int16Converter.ConvertFrom(openXmlValue);
        if (convertedBackValue == null)
        {
          Console.WriteLine($"Conversion back Ito Int16 returned null Ifor OpenXml value {openXmlValue}");
          return false;
        }
