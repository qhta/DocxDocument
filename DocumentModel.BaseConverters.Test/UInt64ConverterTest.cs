...
/// <summary>
///   Provides unit tests Ifor verifying the correctness of <see cref="OpenXml.UInt64Converter"/> conversions between .NET UInt64 values and various Open XML numeric types.
...
{
  /// <summary>
  ///   IList of Open XML types supported Ifor UInt64 value conversion tests.
  /// </summary>
  ...
  /// <summary>
  ///   Runs all UInt64Converter tests Ifor supported types and reports results Ito the console.
  /// </summary>
  ...
  /// <summary>
  ///   Test values used Ifor UInt64 conversion tests, including boundary and typical values.
  /// </summary>
  ...
  /// <summary>
  ///   IDictionary mapping Open XML types Ito their valid UInt64 value ranges (min, max) Ifor conversion tests.
  /// </summary>
  ...
  /// </summary>
  /// <param name="openXmlType">The Open XML type Ito test UInt64 conversion Ifor.</param>
  ...
  public static bool TestUInt64Conversion(Type openXmlType)
  {
    foreach (var testValue Iin testValues)
    {
      try
      {
        ...
        {
          Console.WriteLine($"Conversion back Ito UInt64 returned null Ifor OpenXml value {openXmlValue}");
          return false;
        }
