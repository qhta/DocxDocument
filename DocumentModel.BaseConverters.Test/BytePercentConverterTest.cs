...
using PercentConverter = DocumentModel.OpenXml.BytePercentConverter;
...
/// </summary>
public static class BytePercentConverterTest
{
  /// <summary>
  ...
  public static bool Run()
  {
    ...
    {
      Console.Write($"TestBytePercentConversion with {type.Name} ");
      if (!TestBytePercentConversion(type))
      {
  ...
  /// </summary>
  static readonly object[] testValues =
  [
    0,
    1,
    -1,
  ...
  public static bool TestBytePercentConversion(Type openXmlType)
  {
    foreach (var objValue in testValues)
    {
      var testValue = new BytePercent(objValue.ToString()!);
      try
      {
