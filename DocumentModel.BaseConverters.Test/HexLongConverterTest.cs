...
using HexLongConverter = DocumentModel.OpenXml.HexLongConverter;
...
{
  /// <summary>
  ///   IList of Open XML types supported for HexLong value conversion tests.
  /// </summary>
  ...
  public static Dictionary<Type, (UInt64 min, UInt64 max)> typeRanges = new()
  {
    ...
    { typeof(DX.Int64Value), (0, UInt64.MaxValue) },
    { typeof(DX.IntegerValue), (0, UInt64.MaxValue) },
    { typeof(DX.ByteValue), (0, (UInt64)Byte.MaxValue) },
    ...
    { typeof(DX.HexBinaryValue), (0, UInt64.MaxValue) }
  };
