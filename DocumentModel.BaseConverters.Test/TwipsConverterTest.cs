...
{
  /// <summary>
  ///   List of Open XML types supported for Twips value conversion tests.
  /// </summary>
  ...
  /// <summary>
  ///   Dictionary mapping Open XML types to their valid Twips value ranges (min, max) for conversion tests.
  /// </summary>
