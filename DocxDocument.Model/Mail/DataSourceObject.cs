...
public class DataSourceObject: DocxBasedElement<WD.DataSourceObject>, IDataSourceObject
{
  public DataSourceObject() : base(new WD.DataSourceObject())
  {
  }

  public DataSourceObject(WD.DataSourceObject element) : base(element)
  {
  }
  ...
  {
    get => DocxElement.ReadUnsignedDecimalNumberType<WD.ColumnDelimiter>();
    set => DocxElement.WriteUnsignedDecimalNumberType<WD.ColumnDelimiter>(value);
  }
