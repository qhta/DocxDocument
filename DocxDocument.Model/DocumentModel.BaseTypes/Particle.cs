namespace DocumentModel
{
  internal abstract class Particle<T>
  {
    ...
    /// </summary>
    internal bool UnboundedMaxOccurs => this.MaxOccurs == 0;

    /// <summary>
    /// Gets a value indicating whether maxOccurs is unbounded or maxOccurs &gt; 1
    /// </summary>
    internal bool CanOccursMoreThanOne => this.UnboundedMaxOccurs || this.MaxOccurs > 1;
    ...
    internal bool MaxOccursGreaterThan(int count) => this.UnboundedMaxOccurs || this.MaxOccurs > count;
