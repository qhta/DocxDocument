...
public class StyleDocDefaultsParagraphPropertiesTest: AbstractTestClass
{
  ...
  static bool TestStoreInDocument()
  {
    ...
    Console.WriteLine("✓ Store sample doc defaults Paragraph properties test passed\n");
    return true;
  }
  ...
  static bool TestUpdateInDocument()
  {
    ...
    Console.WriteLine("Updated document doc defaults Paragraph properties:\n" + xmlString);
    ...
    Console.WriteLine("✓ Updated document doc defaults Paragraph properties test passed\n");
    return true;
  }
  ...
  static bool TestValidateOpenXml()
  {
    Console.WriteLine("--- Validate sample doc defaults Paragraph properties stored in new document against OpenXml schema ---");
    {
      ...
      Console.WriteLine("✓ Validate sample doc defaults Paragraph properties test passed\n");
      return true;
    }
  }
