namespace DocumentModel.InOpenXml.Test
{
  ...
  public class BaseTablePropertiesTest: _AbstractTestClass
  {
    ...
    private bool TestXmlSerialization()
    {
      ...
      if (!TestHelper.CompareTestData(typeof(BaseTableProperties), (object)testData, (object)deserialized, "testData", "deserialized", out var message))
      {
    ...
    private BaseTableProperties CreateSampleProperties(bool isUpdated = false)
    {
    ...
    private BaseTableProperties CreateBaseTableProperties(bool isUpdated = false)
    {
