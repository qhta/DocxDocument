namespace DocumentModel.InOpenXml.Test
{
  ...
  public class BaseTableCellPropertiesTest: _AbstractTestClass
  {
    ...
    private bool TestXmlSerialization()
    {
      ...
      if (!TestHelper.CompareTestData(typeof(BaseTableCellProperties), (object)testData, (object)deserialized, "testData", "deserialized", out var message))
      {
    ...
    private BaseTableCellProperties CreateSampleProperties(bool isUpdated = false)
    {
    ...
    private BaseTableCellProperties CreateBaseTableCellProperties(bool isUpdated = false)
    {
      return new BaseTableCellProperties
      {
        ...
        TableCellMargin = new TableCellMargin
        {
          ...
          LeftMargin = new TableMeasure { Value = 50, Type = TableMeasureType.Relative },
