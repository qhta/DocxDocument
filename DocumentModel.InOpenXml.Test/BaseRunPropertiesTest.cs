namespace DocumentModel.InOpenXml.Test
{
  ...
  public class BaseRunPropertiesTest: _AbstractTestClass
  {
    ...
    private BaseRunProperties CreateSampleProperties(bool isUpdated = false)
    {
    ...
    internal static BaseRunProperties CreateSampleRunProperties(bool isUpdated = false)
    {
      return new BaseRunProperties
      {
        ...
        Color = isUpdated ? new DMW.Color("00AA00") : new DMW.Color { Value = "000000", ThemeColor = ThemeColors.Text1 },
