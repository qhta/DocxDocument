namespace DocumentModel.InOpenXml.Test
{
  ...
  public class BaseSectionPropertiesTest : _AbstractTestClass
  {
    ...
    private bool TestXmlSerialization()
    {
      ...
      if (!TestHelper.CompareTestData(typeof(BaseSectionProperties), (object)testData, (object)deserialized, "testData", "deserialized", out var message))
      {
    ...
    private BaseSectionProperties CreateSampleProperties(bool isUpdated = false)
    {
    ...
    private BaseSectionProperties CreateBaseSectionProperties(bool isUpdated = false)
    {
