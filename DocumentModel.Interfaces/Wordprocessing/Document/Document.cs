...
public partial interface Document : InteropObject
{
  ...
  ///// <summary>
  ///// Returns the metadata stored in a document, such as author name, subject, and company.
  ///// Used in document management and content management systems. Read-only.
  ///// </summary>
