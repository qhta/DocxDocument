...
public partial class Styles: ModelElement
{
  ...
  public static List<(string name, StyleKind kind, string? alias)> BuiltInStyleStubs = new()
  {
    ...
    ( "Table IColumns 1", StyleKind.Table, null ),
    ( "Table IColumns 2", StyleKind.Table, null ),
    ( "Table IColumns 3", StyleKind.Table, null ),
    ( "Table IColumns 4", StyleKind.Table, null ),
    ( "Table IColumns 5", StyleKind.Table, null ),
