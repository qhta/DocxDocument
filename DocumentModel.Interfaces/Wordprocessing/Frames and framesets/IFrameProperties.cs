...
public interface IFrameProperties
{
  ...
  /// </summary>
  public HorizontalAnchor? HorizontalPosition { get; set; }

  /// <summary>
  ///   Vertical positioning base for the frame, specifying the reference point for vertical alignment.
  /// </summary>
  public VerticalAnchor? VerticalPosition { get; set; }
  ...
  /// </summary>
  public HorizontalAlignment? XAlign { get; set; }
  ...
  /// </summary>
  public VerticalAlignment? YAlign { get; set; }
