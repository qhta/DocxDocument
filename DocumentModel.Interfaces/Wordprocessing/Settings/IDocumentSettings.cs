...
public interface IDocumentSettings : IDocumentProperties
{
  ...
  /// <summary>
  /// This element specifies how the datapoint properties ([MS-ODRAWXML] section 2.8.3.1) and data labels ([MS-ODRAWXML] section 2.2.1.2) 
  ...
  /// regardless of whether it meets the criteria needed for hyphenation.
  /// </summary>
  [Category("Hyphenation")]
  ...
  /// <summary>
  /// A Long Hex Number element that specifies an arbitrary identifier for the context of the paragraph identifiers 
  ...
  /// <summary>
  /// This element specifies whether words comprised of all capital letters shall be hyphenated 
  /// within a given document when automatic hyphenation is specified via the autoHyphenation element.
  /// </summary>
  [Category("Hyphenation")]
  ...
  /// <summary>
  /// This element specifies all the mail merge information for a document 
