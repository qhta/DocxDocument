namespace DocumentModel.Wordprocessing;
  ...
  /// This interface provides properties for the command name, command index, and argument, enabling configuration and management of keyboard shortcuts for fixed commands.
  /// </summary>
