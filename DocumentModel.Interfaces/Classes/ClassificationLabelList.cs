...
public interface ClassificationLabelList
{
  ...
  /// displaying in Office applications, document properties, and visual markings (headers, footers,
  /// watermarks). Each label typically represents a sensitivity or compliance level such as:
  /// <list type="bullet">
  /// <item><description><b>Public:</b> Can be freely shared externally</description></item>
  /// <item><description><b>Internal:</b> For internal organizational use only</description></item>
  /// <item><description><b>Confidential:</b> Sensitive information with restricted access</description></item>
  /// <item><description><b>Highly Confidential:</b> Very sensitive, highly restricted</description></item>
  /// <item><description><b>Restricted/Secret:</b> Highest security, need-to-know access</description></item>
  /// </list>
  /// </para>
  /// <para>
  /// Labels can be organized hierarchically:
  /// <list type="bullet">
  /// <item><description><b>Parent labels:</b> Top-level categories (e.g., "Confidential")</description></item>
  /// <item><description><b>Sub-labels:</b> More granular classifications (e.g., "Confidential - Finance")</description></item>
  /// <item><description><b>Scoped labels:</b> Available only to specific departments or groups</description></item>
  /// </list>
  /// This hierarchy allows organizations to maintain simple top-level categories while providing
  /// detailed sub-classifications for specific use cases.
  /// </para>
  /// <para>
  /// Each classification label typically includes:
  /// <list type="bullet">
  /// <item><description><b>Identifier:</b> Unique ID for the label (often a GUID)</description></item>
  /// <item><description><b>Display name:</b> User-friendly label text shown in UI</description></item>
  /// <item><description><b>Description:</b> Explanation of when and how to use this label</description></item>
  /// <item><description><b>Color/Icon:</b> Visual indicator for quick recognition</description></item>
  /// <item><description><b>Protection settings:</b> Encryption, usage rights, access restrictions</description></item>
  /// <item><description><b>Marking settings:</b> Header, footer, watermark configurations</description></item>
  /// <item><description><b>Tooltip/Help text:</b> Guidance for users selecting labels</description></item>
  /// </list>
  /// </para>
  /// <para>
  /// Labels in the collection are applied through various mechanisms:
  /// <list type="bullet">
  /// <item><description><b>Manual selection:</b> Users choose labels from Office UI (typically Info pane or ribbon)</description></item>
  /// <item><description><b>Recommended labels:</b> Machine learning suggests appropriate labels based on content</description></item>
  /// <item><description><b>Automatic labeling:</b> Policies automatically apply labels based on content patterns</description></item>
  /// <item><description><b>Default labels:</b> Templates or locations have default classifications</description></item>
  /// <item><description><b>Mandatory labeling:</b> Users required to select a label before saving</description></item>
  /// </list>
  /// </para>
  /// <para>
  /// Label behavior and enforcement:
  /// <list type="bullet">
  /// <item><description><b>Downgrade prevention:</b> Require justification or admin approval to lower classification</description></item>
  /// <item><description><b>Upgrade encouragement:</b> Prompt users to increase classification when sensitive content is detected</description></item>
  /// <item><description><b>Label locking:</b> Prevent label changes after initial application</description></item>
  /// <item><description><b>Inheritance:</b> Child documents or excerpts inherit parent document labels</description></item>
  /// <item><description><b>Conflict resolution:</b> Define which label takes precedence when merging documents</description></item>
  /// </list>
  /// </para>
  /// <para>
  /// Integration with protection features:
  /// <list type="bullet">
  /// <item><description><b>Encryption:</b> Labels can automatically apply Rights Management encryption</description></item>
  /// <item><description><b>Access control:</b> Define who can view, edit, print, or copy based on label</description></item>
  /// <item><description><b>Expiration:</b> Set document expiration dates tied to classification</description></item>
  /// <item><description><b>External sharing:</b> Control whether documents can be shared outside organization</description></item>
  /// <item><description><b>Device restrictions:</b> Prevent download to personal devices based on label</description></item>
  /// </list>
  /// </para>
  /// <para>
  /// Visual marking integration:
  /// <list type="bullet">
  /// <item><description>Labels can trigger automatic headers, footers, or watermarks</description></item>
  /// <item><description>Markings display the classification level prominently (e.g., "CONFIDENTIAL" watermark)</description></item>
  /// <item><description>Color-coding provides quick visual identification of document sensitivity</description></item>
  /// <item><description>Icons or badges can appear in file explorers or document lists</description></item>
  /// </list>
  /// </para>
  /// <para>
  /// The label collection should be synchronized with:
  /// <list type="bullet">
  /// <item><description>Microsoft Purview Information Protection policies</description></item>
  /// <item><description>Azure Information Protection label definitions</description></item>
  /// <item><description>Organizational classification taxonomies and policies</description></item>
  /// <item><description>Industry-specific compliance frameworks</description></item>
  /// <item><description>Legal and regulatory requirements</description></item>
  /// </list>
  /// </para>
  /// </remarks>
