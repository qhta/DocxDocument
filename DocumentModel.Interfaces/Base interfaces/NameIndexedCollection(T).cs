...
/// changes.
/// </summary>
/// <remarks>This interface combines name-based indexing with standard collection functionality and change
...
/// <typeparam name="T">The type of elements in the collection. Must implement <see cref="NamedObject"/> and <see cref="CollectionItem"/>.</typeparam>
public interface NameIndexedElementCollection<T>: ElementCollection<T>
  where T: NamedObject, CollectionItem
{
}