...
/// <summary>
/// <see cref="ITwips"/> data type to/from string converter. 
...
internal class TwipsTypeConverter : TypeConverter, IRealTypeConverter
{
  ...
  /// <summary>
  /// Implements conversion from string data type to <see cref="ITwips"/> data type.
  /// </summary>
  public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
  {
    if (value is string str)
      return new ITwips(str);
