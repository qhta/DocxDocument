...
public partial interface IApplication : IModelObject
{
  /// <summary>
  /// Returns or sets the name of the specified object.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.name?view=word-pia"/>
  public string Name { get; }

  /// <summary>
  /// Returns a Documents collection that represents all the open documents.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.documents?view=word-pia"/>
  public IDocuments Documents { get; }

  /// <summary>
  /// Returns a Windows collection that represents all document windows.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.windows?view=word-pia"/>
  public IWindows Windows { get; }

  /// <summary>
  /// Returns a Document object that represents the active document.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.activedocument?view=word-pia"/>
  public IDocument ActiveDocument { get; }

  /// <summary>
  /// Returns a Window object that represents the active window.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.activewindow?view=word-pia"/>
  public IWindow ActiveWindow { get; }

  ///// <summary>
  ///// Returns the Selection object that represents a selected range or the insertion point.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.selection?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.wordbasic?view=word-pia"/>
  //public object WordBasic { get; }

  ///// <summary>
  ///// Returns a RecentFiles collection that represents the most recently accessed files.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.recentfiles?view=word-pia"/>
  //public RecentFiles RecentFiles { get; }

  /// <summary>
  /// Returns a Template object that represents the Normal template.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.normaltemplate?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.system?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.autocorrect?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.languages?view=word-pia"/>
  //public DXW.Languages Languages { get; }

  ///// <summary>
  ///// Returns a Assistant object that represents the Microsoft Office Assistant.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.assistant?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.browser?view=word-pia"/>
  //public Browser Browser { get; }

  ///// <summary>
  ///// Returns a FileConverters collection that represents all the file converters available to Microsoft Word.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.fileconverters?view=word-pia"/>
  //public FileConverters FileConverters { get; }

  ///// <summary>
  ///// Returns a MailingLabel object that represents a mailing label.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.mailinglabel?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.dialogs?view=word-pia"/>
  //public Dialogs Dialogs { get; }

  ///// <summary>
  ///// Returns a CaptionLabels collection that represents all the available caption labels.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.captionlabels?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.autocaptions?view=word-pia"/>
  //public DXW.AutoCaptions AutoCaptions { get; }

  ///// <summary>
  ///// Returns a AddIns collection that represents all available add-ins, regardless of whether they're currently loaded.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.addins?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.visible?view=word-pia"/>
  public bool Visible { get; set; }

  /// <summary>
  /// Returns the Microsoft Word version number.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.version?view=word-pia"/>
  public string Version { get; }

  /// <summary>
  /// Determines if screen updating is turned on. Returns True if screen updating is turned on, and False if not.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.screenupdating?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.printpreview?view=word-pia"/>
  public bool PrintPreview { get; set; }

  /// <summary>
  /// Returns a Tasks collection that represents all the applications that are running.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.tasks?view=word-pia"/>
  public ITasks Tasks { get; }

  /// <summary>
  /// Determines if the status bar is displayed.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displaystatusbar?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.specialmode?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.usablewidth?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.usableheight?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.mathcoprocessoravailable?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.mouseavailable?view=word-pia"/>
  public bool MouseAvailable { get; }

  /// <summary>
  /// Returns the version and build number of the Word application.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.build?view=word-pia"/>
  public string Build { get; }

  /// <summary>
  /// Determines if the CAPS LOCK key is turned on. Returns True if the CAPS LOCK key is turned on, and False if it is not.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.capslock?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.numlock?view=word-pia"/>
  public bool NumLock { get; }

  /// <summary>
  /// Returns or sets the user's name, which is used on envelopes and for the Author document property.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.username?view=word-pia"/>
  public string UserName { get; set; }

  /// <summary>
  /// Returns or sets the user's initials, which Microsoft Word uses to construct comment marks.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.userinitials?view=word-pia"/>
  public string UserInitials { get; set; }

  /// <summary>
  /// Returns or sets the user's mailing address.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.useraddress?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.macrocontainer?view=word-pia"/>
  public object MacroContainer { get; }

  /// <summary>
  /// Determines if the names of recently used files are displayed on the File menu.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displayrecentfiles?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.commandbars?view=word-pia"/>
  //public Core.CommandBars CommandBars { get; }

  /// <summary>
  /// Returns a VBE object that represents the Visual Basic Editor.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.vbe?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.defaultsaveformat?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.listgalleries?view=word-pia"/>
  //public ListGalleries ListGalleries { get; }

  /// <summary>
  /// Returns or sets the name of the active printer.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.activeprinter?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.templates?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.customizationcontext?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.keybindings?view=word-pia"/>
  //public KeyBindings KeyBindings { get; }

  /// <summary>
  /// Returns or sets the caption text for the specified document or application window.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.caption?view=word-pia"/>
  public string Caption { get; set; }

  /// <summary>
  /// Returns the disk or Web path to the specified object.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.path?view=word-pia"/>
  public string Path { get; }

  /// <summary>
  /// Determines if Word displays a scroll bar in at least one document window.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displayscrollbars?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.startuppath?view=word-pia"/>
  public string StartupPath { get; set; }

  /// <summary>
  /// Returns the number of files queued up to be saved in the background.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.backgroundsavingstatus?view=word-pia"/>
  public int BackgroundSavingStatus { get; }

  /// <summary>
  /// Returns the number of print jobs in the background printing queue.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.backgroundprintingstatus?view=word-pia"/>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.left?view=word-pia"/>
  public int Left { get; set; }

  /// <summary>
  /// Returns or sets the vertical position of the active document, in points.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.top?view=word-pia"/>
  public int Top { get; set; }

  /// <summary>
  /// Returns or sets the width of the specified object, in points.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.width?view=word-pia"/>
  public int Width { get; set; }

  /// <summary>
  /// Returns or sets the height of the active document window.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.height?view=word-pia"/>
  public int Height { get; set; }

  ///// <summary>
  ///// Returns or sets the state of the specified document window or task window.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.windowstate?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displayautocompletetips?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.options?view=word-pia"/>
  //public Options Options { get; }

  ///// <summary>
  ///// Returns or sets the way certain alerts and messages are handled while a macro is running.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displayalerts?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.customdictionaries?view=word-pia"/>
  //public Dictionaries CustomDictionaries { get; }

  ///// <summary>
  ///// Returns the character used to separate folder names.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.pathseparator?view=word-pia"/>
  //public string PathSeparator { get; }

  ///// <summary>
  ///// Displays the specified text in the status bar.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.statusbar?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.mapiavailable?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displayscreentips?view=word-pia"/>
  //public bool DisplayScreenTips { get; set; }

  ///// <summary>
  ///// Returns or sets the way that Word handles CTRL+BREAK user interruptions.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.enablecancelkey?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.usercontrol?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.filesearch?view=word-pia"/>
  //public Core.FileSearch FileSearch { get; }

  ///// <summary>
  ///// Returns the mail system (or systems) installed on the host machine.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.mailsystem?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.defaulttableseparator?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.showvisualbasiceditor?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.browseextrafiletypes?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.hangulhanjadictionaries?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.mailmessage?view=word-pia"/>
  //public MailMessage MailMessage { get; }

  ///// <summary>
  ///// Determines if the insertion point is in an e-mail header field.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.focusinmailheader?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.emailoptions?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.language?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.comaddins?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.checklanguage?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.languagesettings?view=word-pia"/>
  //public Core.LanguageSettings LanguageSettings { get; }

  ///// <summary>
  ///// Reserved for internal use.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.dummy1?view=word-pia"/>
  //public bool Dummy1 { get; }

  ///// <summary>
  ///// Returns a AnswerWizard object that contains the files used by the online Help search engine.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.answerwizard?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.featureinstall?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.automationsecurity?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.emailtemplate?view=word-pia"/>
  //public string EmailTemplate { get; set; }

  ///// <summary>
  ///// This object, member, or enumeration is deprecated and is not intended to be used in your code.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.showwindowsintaskbar?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.newdocument?view=word-pia"/>
  //public Core.NewFile NewDocument { get; }

  ///// <summary>
  ///// Determines if the Task Pane will be displayed when starting Microsoft Word.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.showstartupdialog?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.autocorrectemail?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.taskpanes?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.defaultlegalblackline?view=word-pia"/>
  //public bool DefaultLegalBlackline { get; set; }

  ///// <summary>
  ///// Returns a SmartTagRecognizers collection for an application.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.smarttagrecognizers?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.smarttagtypes?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.xmlnamespaces?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.arbitraryxmlsupportavailable?view=word-pia"/>
  //public bool ArbitraryXMLSupportAvailable { get; }

  ///// <summary>
  ///// Reserved for internal use.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.buildfull?view=word-pia"/>
  //public string BuildFull { get; }

  ///// <summary>
  ///// Reserved for internal use.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.buildfeaturecrew?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.bibliography?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.showstylepreviews?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.restrictlinkedstyles?view=word-pia"/>
  //public bool RestrictLinkedStyles { get; set; }

  ///// <summary>
  ///// Returns the auto correct entries for equations. Read-only.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.omathautocorrect?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.displaydocumentinformationpanel?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.assistance?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.openattachmentsinfullscreen?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.activeencryptionsession?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.dontresetinsertionpointproperties?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.smartartlayouts?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.smartartquickstyles?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.smartartcolors?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.undorecord?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.pickerdialog?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.protectedviewwindows?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.activeprotectedviewwindow?view=word-pia"/>
  //public ProtectedViewWindow ActiveProtectedViewWindow { get; }

  ///// <summary>
  ///// Gets whether the application window is a protected view window.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.issandboxed?view=word-pia"/>
  //public bool IsSandboxed { get; }

  ///// <summary>
  ///// Gets or sets how Word will validate files before opening them.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.filevalidation?view=word-pia"/>
  ...
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.chartdatapointtrack?view=word-pia"/>
  //public bool ChartDataPointTrack { get; set; }

  ///// <summary>
  ///// This object, member, or enumeration is deprecated and is not intended to be used in your code.
  ///// </summary>
  ///// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word._application.showanimation?view=word-pia"/>
