...
public partial interface ICustomTaskPaneEvents: IModelObject
{
  /// <summary>
  ...
  public void VisibleStateChange(ICustomTaskPane CustomTaskPaneInst);
  /// <summary>
  ...
  public void DockPositionStateChange(ICustomTaskPane CustomTaskPaneInst);
}
