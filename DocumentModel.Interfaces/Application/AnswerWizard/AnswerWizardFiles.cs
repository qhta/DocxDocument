...
public partial interface IAnswerWizardFiles: IModelObject
{
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.answerwizardfiles.item?view=office-pia"/>
  public string this[int Index] { get; }
  /// <summary>
  /// Gets the `Count` property.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.answerwizardfiles.count?view=office-pia"/>
