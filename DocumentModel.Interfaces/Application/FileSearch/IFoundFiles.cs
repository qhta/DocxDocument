...
public partial interface IFoundFiles: IEnumerable
{
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.ifoundfiles.item?view=office-pia"/>
  public string this[int Index] { get; }
  /// <summary>
  /// Gets the number of found files.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.ifoundfiles.count?view=office-pia"/>
