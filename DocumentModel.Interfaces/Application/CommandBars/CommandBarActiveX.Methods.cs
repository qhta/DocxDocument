...
/// </remarks>
public partial interface ICommandBarActiveX
{
  /// <summary>
  /// Initializes the current instance using the specified object.
  /// </summary>
  /// <param name="obj">The object that provides initialization data for the current instance.</param>
  /// <returns>An object representing the result of the initialization. The specific type and meaning of the return value depend
  /// on the implementation.</returns>
  public object InitWith(Object obj);
