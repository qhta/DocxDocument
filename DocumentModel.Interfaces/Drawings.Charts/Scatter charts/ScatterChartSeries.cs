...
/// <summary>
///   Represents a series in a scatter chart, including index, order, text, shape properties, marker, data points, labels, trendlines, error bars, X and Y values, smoothing, and extensions.
/// </summary>
public interface ScatterChartSeries : CollectionItem
{
  /// <summary>
