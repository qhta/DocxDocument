...
/// <summary>
///   Represents a series in a bubble chart, including index, order, text, shape properties, picture options, inversion, data points, labels, trendlines, error bars, values, bubble size, 3D bubbles, and extensions.
/// </summary>
public interface BubbleChartSeries3
{
  /// <summary>
