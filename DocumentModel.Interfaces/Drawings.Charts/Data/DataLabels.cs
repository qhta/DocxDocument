...
///   This interface allows configuration of label formatting, display options, and additional label features.
/// </summary>
public interface DataLabels: ElementCollection<DataLabel>
{
  /// <summary>
