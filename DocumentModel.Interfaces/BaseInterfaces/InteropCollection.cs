...
public interface InteropCollection<ItemType> : ICollection<ItemType>
{
  /// <summary>
  ...
  /// <returns>The default item at the specified index or key.</returns>
  public ItemType _Default(object Index);
}
