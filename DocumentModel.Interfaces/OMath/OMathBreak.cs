...
public partial interface IOMathBreak : IModelObject
{
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word.omathbreak.range?view=word-pia"/>
  public IRange Range { get; }

  /// <summary>
  /// Returns or sets the alignment position at the line break.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word.omathbreak.alignat?view=word-pia"/>
