...
public partial interface IOMathAutoCorrectEntry : IModelObject
{
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word.omathautocorrectentry.index?view=word-pia"/>
  public int Index { get; }

  /// <summary>
  /// Returns or sets the text that is replaced.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word.omathautocorrectentry.name?view=word-pia"/>
  public string Name { get; set; }

  /// <summary>
  /// Returns or sets the replacement text for the entry.
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word.omathautocorrectentry.value?view=word-pia"/>
