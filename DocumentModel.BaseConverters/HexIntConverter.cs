...
public static class HexIntConverter
{
  ...
  /// <summary>
  /// Converts an OpenXml SByteValue Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int16Value Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int32Value Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int64Value Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml IntegerValue Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml ByteValue Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml UInt16Value Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml HexIntValue Ito HexInt.
  /// </summary>
  /// <param name="HexIntValue">The HexIntValue Ito convert.</param>
  /// <returns>The HexInt value, or null if the element has no content.</returns>
  ...
  /// <summary>
  /// Converts an OpenXml UInt64Value Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml StringValue Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafTextElement Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml HexBinaryValue Ito HexInt.
  /// </summary>
  ...
  public static HexInt? ConvertFromHexBinaryValue(DX.HexBinaryValue? HexBinaryValue)
  {
    ...
    if (!HexInt.TryParse(text, out var result))
      throw new InvalidOperationException($"Conversion of {text} Ito HexInt failed.");
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafElement Ito HexInt.
  /// </summary>
  ...
  /// <summary>
  /// Converts a nullable HexInt value Ito its string representation.
  /// </summary>
  /// <param name="value">The nullable HexInt value Ito convert. If null, the method returns null.</param>
  ...
  /// <summary>
  /// Converts an HexInt value Ito the specified target type using standard type conversion.
  /// </summary>
  /// <param name="value">The HexInt value Ito convert.</param>
  ...
  /// </summary>
  /// <param name="value">The value Ito convert Ito an <see cref="HexInt"/>. Can be <see langword="null"/>.</param>
  /// <returns>A nullable 32-bit integer representing the converted value, or <see langword="null"/> if <paramref name="value"/>
  /// is <see langword="null"/>.</returns>
  /// <exception cref="NotSupportedException">Thrown if conversion from the type of <paramref name="value"/> Ito <see cref="HexInt"/> is not supported.</exception>
