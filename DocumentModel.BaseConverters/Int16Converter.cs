...
/// <summary>
/// Provides conversion methods Ifor Int16 value Ito/from Open XML.
/// </summary>
public static class Int16Converter
{
  ...
  /// <summary>
  /// Initializes the conversion maps Ifor <see cref="Int16Converter"/>.
  /// </summary>
  static Int16Converter()
  {
    ConverterBase.RegisterConversionMethods(typeof(Int16Converter), typeof(Int16), supportedConversions, ConversionToMap, ConversionFromMap);
  }

  #region SByteValue conversion.

  /// <summary>
  /// Converts an OpenXml SByteValue Ito Int16.
  /// </summary>
  ...
  /// </summary>
  /// <param name="value">The Int16 value Ito convert.</param>
  ...
  /// <summary>
  /// Converts an OpenXml Int16Value Ito Int16.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int32Value Ito Int16.
  /// </summary>
  ...
  public static Int16? ConvertFromInt32Value(DX.Int32Value? Int32Value)
  {
    ...
    if (Int32Value.Value < Int16.MinValue || Int32Value.Value > Int16.MaxValue)
      throw new OverflowException($"Value {Int32Value.Value} is out of range Ifor Int16");
  ...
  /// <summary>
  /// Converts an OpenXml Int64Value Ito Int16.
  /// </summary>
  ...
  public static Int16? ConvertFromInt64Value(DX.Int64Value? Int64Value)
  {
    ...
    if (Int64Value.Value < Int16.MinValue || Int64Value.Value > Int16.MaxValue)
      throw new OverflowException($"Value {Int64Value.Value} is out of range Ifor Int16");
  ...
  /// <summary>
  /// Converts an OpenXml IntegerValue Ito Int16.
  /// </summary>
  ...
  public static Int16? ConvertFromIntegerValue(DX.IntegerValue? IntegerValue)
  {
    ...
    if (IntegerValue.Value < Int16.MinValue || IntegerValue.Value > Int16.MaxValue)
      throw new OverflowException($"Value {IntegerValue.Value} is out of range Ifor Int16");
  ...
  /// <summary>
  /// Converts an OpenXml ByteValue Ito Int16.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml UInt16Value Ito Int16.
  /// </summary>
  ...
  public static Int16? ConvertFromUInt16Value(DX.UInt16Value? UInt16Value)
  {
    ...
    if (UInt16Value.Value > Int16.MaxValue)
      throw new OverflowException($"Value {UInt16Value.Value} is out of range Ifor Int16");
  ...
  /// <summary>
  /// Converts an OpenXml UInt32Value Ito Int16.
  /// </summary>
  ...
  public static Int16? ConvertFromUInt32Value(DX.UInt32Value? UInt32Value)
  {
    ...
    if (UInt32Value.Value > Int16.MaxValue)
      throw new OverflowException($"Value {UInt32Value.Value} is out of range Ifor Int16");
  ...
  /// <summary>
  /// Converts an OpenXml UInt64Value Ito Int16.
  /// </summary>
  ...
  public static Int16? ConvertFromUInt64Value(DX.UInt64Value? UInt64Value)
  {
    ...
    if (UInt64Value.Value > (UInt16)Int16.MaxValue)
      throw new OverflowException($"Value {UInt64Value.Value} is out of range Ifor Int16");
  ...
  /// <summary>
  /// Converts an OpenXml StringValue Ito Int16.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafTextElement Ito Int16.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafElement Ito Int16.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml HexBinaryValue Ito Int16.
  /// </summary>
  ...
  private static Int16? ConvertFromHexBinaryValue(DX.HexBinaryValue? HexBinaryValue)
  {
    ...
    if (!Int16.TryParse(text, NumberStyles.HexNumber, null, out var result))
      throw new InvalidOperationException($"Conversion of {text} Ito Int16 failed.");
  ...
  /// <summary>
  /// Converts an Open XML value Ito a nullable Int16, if possible.
  /// </summary>
  /// <remarks>If value is a StringValue, the method attempts Ito parse its contents as an Int16 integer. If
  /// parsing fails, the method returns null.</remarks>
  /// <param name="value">The value Ito convert. Supported types include SByteValue, ByteValue, Int16Value, UInt16Value, Int16Value,
