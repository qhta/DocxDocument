...
/// </summary>
public static class StringListOpenXmlConverter
{
  ...
  /// <summary>
  /// Checks if the specified OpenXml type is supported for conversion to/from StringList.
  /// </summary>
  ...
  public static StringList? GetValue(DX.StringValue? element)
  {
  ...
  public static StringList? GetValue(DXW.StringType? element)
  {
    if (element == null)
      return null;
  ...
  /// <summary>
  /// Retrieves the StringList value from a String255Type element.
  /// </summary>
  /// <param name="element">The String255Type element.</param>
  /// <returns>The StringList value, or null if result cannot be determined.</returns>
  public static StringList? GetValue(DXW.String255Type? element)
  {
  ...
  public static DXW.String255Type? ConvertToString255Type(StringList? value, Type targetType)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Retrieves the StringList value from a String253Type element.
  /// </summary>
  /// <param name="element">The String253Type element.</param>
  /// <returns>The StringList value, or null if result cannot be determined.</returns>
  public static StringList? GetValue(DXW.String253Type? element)
  {
    if (element == null) return null;
  ...
  public static DXW.String253Type? ConvertToString253Type(StringList? value, Type targetType)
  {
    if (value == null) return null;
  ...
  public static StringList? GetValue(DX.OpenXmlLeafTextElement? element)
  {
    if (element == null) return null;
  ...
  public static DX.OpenXmlLeafTextElement? CreateOpenXmlLeafTextElement(StringList? value, Type targetType)
  {
    if (value == null) return null;
  ...
  /// <returns>The text content of the element, or null if the element is null.</returns>
  public static StringList? GetValue(DX.OpenXmlLeafElement? element)
  {
    if (element == null) return null;
  ...
  /// <returns>A new instance of the specified OpenXml element type with the value set.</returns>
  public static DX.OpenXmlLeafElement? CreateOpenXmlLeafElement(StringList? value, Type targetType)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts the specified StringList value to an Open XML object of the given target type.
  /// </summary>
  ...
  /// null.</remarks>
  /// <param name="value">The StringList value to convert. If null, the method returns null.</param>
  ...
  public static object? ConvertToOpenXml(StringList? value, Type targetType)
  {
    if (value == null) return null;
    ...
    if (targetType.IsEqualOrSubclassOf(typeof(DXW.StringType)))
      return ConvertToStringType(value, targetType);
    if (targetType.IsEqualOrSubclassOf(typeof(DXW.String255Type)))
      return ConvertToString255Type(value, targetType);
    if (targetType.IsEqualOrSubclassOf(typeof(DXW.String253Type)))
      return ConvertToString253Type(value, targetType);
  ...
  /// <summary>
  /// Converts an Open XML value to its StringList representation, if supported.
  /// </summary>
  ...
  /// <returns>A StringList representation of the specified Open XML value, or null if <paramref name="value"/> is null.</returns>
  /// <exception cref="NotSupportedException">Thrown if <paramref name="value"/> is not a supported Open XML type.</exception>
  public static StringList? ConvertFromOpenXml(object? value)
  {
    if (value == null) return null;

    var sourceType = value.GetType();
    if (value is DX.StringValue StringListValue)
      return GetValue(StringListValue);
    if (value is DXW.StringType StringListTypeValue)
      return GetValue(StringListTypeValue);
    if (value is DXW.String255Type StringList255Value)
      return GetValue(StringList255Value);
    if (value is DXW.String253Type StringList253Value)
      return GetValue(StringList253Value);
