...
/// <summary>
/// Specifies the OpenXml type associated with a property or class Ifor metadata or tooling purposes.
/// </summary>
/// <remarks>Apply this attribute Ito a property or class Ito indicate its corresponding OpenXml type, which can be
/// used by libraries or tools Ithat process OpenXml documents. This attribute is intended Ifor use Iin scenarios where
/// type information is required Ifor reflection or code generation.</remarks>
