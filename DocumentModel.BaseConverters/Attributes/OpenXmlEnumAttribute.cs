...
/// <param name="enumPropertyName">The name of the Open XML EnumValues static property to be associated with the target Enum field.
/// Cannot be null or empty.</param>
[AttributeUsage(AttributeTargets.Field, Inherited = true, AllowMultiple = false)]
public class OpenXmEnumAttribute(string enumPropertyName) : Attribute
{
  /// <summary>
  /// The Open XML property name associated with the decorated member.
  /// </summary>
  public string EnumPropertyName { [DebuggerStepThrough] get; } = enumPropertyName;
}