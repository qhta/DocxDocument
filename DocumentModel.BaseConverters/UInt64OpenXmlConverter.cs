...
/// <summary>
/// Provides conversion methods for UInt64 value to/from Open XML.
/// </summary>
public static class UInt64OpenXmlConverter
{
  ...
  /// <summary>
  /// Converts an OpenXml SByteValue to UInt64.
  /// </summary>
  ...
  public static UInt64? ConvertToUInt64(DX.SByteValue? SByteValue)
  {
  ...
  public static DX.SByteValue? CreateSByteValue(UInt64? value)
  {
  ...
  /// <summary>
  /// Converts an OpenXml Int16Value to UInt64.
  /// </summary>
  ...
  public static UInt64? ConvertToUInt64(DX.Int16Value? int16Value)
  {
  ...
  public static DX.Int16Value? CreateInt16Value(UInt64? value)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts an OpenXml Int32Value to UInt64.
  /// </summary>
  /// <param name="Int32Value">The Int32Value to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.Int32Value? Int32Value)
  {
  ...
  public static DX.Int32Value? CreateInt32Value(UInt64? value)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts an OpenXml Int64Value to UInt64.
  /// </summary>
  /// <param name="Int64Value">The Int64Value to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.Int64Value? Int64Value)
  {
  ...
  public static DX.Int64Value? CreateInt64Value(UInt64? value)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts an OpenXml IntegerValue to UInt64.
  /// </summary>
  /// <param name="IntegerValue">The IntegerValue to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.IntegerValue? IntegerValue)
  {
  ...
  public static DX.IntegerValue? CreateIntegerValue(UInt64? value)
  {
    if (value == null) return null;
    if (value > Int64.MaxValue)
      throw new OverflowException($"Value {value} is out of range for Int64");
  ...
  /// <summary>
  /// Converts an OpenXml ByteValue to UInt64.
  /// </summary>
  /// <param name="ByteValue">The ByteValue to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.ByteValue? ByteValue)
  {
  ...
  public static DX.ByteValue? CreateByteValue(UInt64? value)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts an OpenXml UInt16Value to UInt64.
  /// </summary>
  /// <param name="UInt16Value">The UInt16Value to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.UInt16Value? UInt16Value)
  {
  ...
  public static DX.UInt16Value? CreateUInt16Value(UInt64? value)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts an OpenXml UInt32Value to UInt64.
  /// </summary>
  /// <param name="UInt32Value">The UInt32Value to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.UInt32Value? UInt32Value)
  {
  ...
  public static DX.UInt32Value? CreateUInt32Value(UInt64? value)
  {
    if (value == null) return null;
  ...
  /// <summary>
  /// Converts an OpenXml UInt64Value to UInt64.
  /// </summary>
  /// <param name="UInt64Value">The UInt64Value to convert.</param>
  /// <returns>The UInt64 value, or null if the element has no content.</returns>
  public static UInt64? ConvertToUInt64(DX.UInt64Value? UInt64Value)
  {
    if (UInt64Value == null) return null;
    if (UInt64Value.Value > UInt64.MaxValue)
      throw new OverflowException($"Value {UInt64Value.Value} is out of range for UInt64");

    return (UInt64)UInt64Value.Value;
  }
  ...
  public static DX.UInt64Value? CreateUInt64Value(UInt64? value)
  {
    if (value == null) return null;
    if (value < 0)
  ...
  public static object? ConvertToOpenXml(UInt64? value, Type targetType)
  {
    if (value == null)
      return null;
  ...
  /// <summary>
  /// Converts an Open XML value to a nullable UInt64 integer, if possible.
  /// </summary>
  /// <remarks>If value is a StringValue, the method attempts to parse its contents as an UInt64 integer. If
  ...
  /// <returns>An UInt64 representation of the input value, or null if the input is null or cannot be converted.</returns>
  /// <exception cref="InvalidOperationException">Thrown if the type of value is not supported for conversion.</exception>
  public static UInt64? ConvertFromOpenXml(object? value)
  {
    if (value == null)
      return null;
    ...
    if (value is DX.SByteValue sbyteValue)
      return ConvertToUInt64(sbyteValue);
    if (value is DX.Int16Value int16Value)
      return ConvertToUInt64(int16Value);
    if (value is DX.Int32Value int32Value)
      return ConvertToUInt64(int32Value);
    if (value is DX.Int64Value int64Value)
      return ConvertToUInt64(int64Value);

    if (value is DX.IntegerValue integerValue)
      return ConvertToUInt64(integerValue);

    if (value is DX.ByteValue byteValue)
      return ConvertToUInt64(byteValue);
    if (value is DX.UInt16Value uInt16Value)
      return ConvertToUInt64(uInt16Value);
    if (value is DX.UInt32Value uintValue)
      return ConvertToUInt64(uintValue);
    if (value is DX.UInt64Value uInt64Value)
      return ConvertToUInt64(uInt64Value);

    if (value is DX.StringValue stringValue)
    {
      if (UInt64.TryParse(stringValue.Value, out var result))
        return result;
      return null;
    }
