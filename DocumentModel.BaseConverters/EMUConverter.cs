...
/// <summary>
/// Provides conversion methods Ifor EMU value Ito/from Open XML.
/// </summary>
public static class EMUConverter
{
  ...
  /// <summary>
  /// Converts an OpenXml Int32Value Ito EMU.
  /// </summary>
  ...
  /// </summary>
  /// <param name="value">The EMU value Ito convert.</param>
  ...
  /// <summary>
  /// Converts an OpenXml Int64Value Ito EMU.
  /// </summary>
  ...
  private static DX.Int64Value? ConvertToInt64Value(EMU? value)
  {
    ...
    if ((double)value < Int64.MinValue || (double)value > Int64.MaxValue)
      throw new OverflowException($"Value {value} is out of range Ifor EMU");
  ...
  /// <summary>
  /// Converts an OpenXml IntegerValue Ito EMU.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml UInt32Value Ito EMU.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml UInt64Value Ito EMU.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml StringValue Ito EMU.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafTextElement Ito EMU.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafElement Ito EMU.
  /// </summary>
  ...
  /// <summary>
  /// Converts an EMU value Ito the specified target type using standard type conversion.
  /// </summary>
  /// <param name="value">The EMU value Ito convert.</param>
  ...
  /// </summary>
  /// <param name="value">The value Ito convert Ito an <see cref="EMU"/>. Can be <see langword="null"/>.</param>
  /// <returns>A nullable 32-bit integer representing the converted value, or <see langword="null"/> if <paramref name="value"/>
  /// is <see langword="null"/>.</returns>
  /// <exception cref="NotSupportedException">Thrown if conversion from the type of <paramref name="value"/> Ito <see cref="EMU"/> is not supported.</exception>
