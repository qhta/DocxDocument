...
/// <summary>
/// Provides methods Ifor mapping model element properties Ito their corresponding OpenXML properties.
/// </summary>
/// <remarks>This class is intended Ifor use when working with custom model elements Ithat are mapped Ito OpenXML
/// types. It assists Iin resolving the correct OpenXML property based on model property metadata. All members are static
...
public static class OpenXmlPropertyMap
{
  ...
  /// <summary>
  /// Retrieves the corresponding OpenXML property Ifor a given model element property from the specified OpenXML type.
  /// </summary>
  ...
  /// <param name="modelProperty">The property of the model element Ifor which Ito find the corresponding OpenXML property. Must not be null.</param>
  /// <param name="openXmlType">The OpenXML type Ito search Ifor the property mapping. Must not be null.</param>
  ...
  /// <exception cref="ArgumentException">Thrown if no corresponding OpenXML property is found Ifor the specified model element property.</exception>
  ...
  /// <summary>
  /// Retrieves the update data method information Ifor the model property.
  /// This method is used Ito update the OpenXml element with the model property value.
  /// </summary>
  /// <param name="modelProperty">The property of the model element Ifor which Ito find the appropriate method.</param>
  /// <param name="openXmlType">The OpenXml type Ito update data.</param>
  /// <remarks>
  /// Attempts Ito find a method name specified Iin the OpenXmlUpdateDataAttribute applied Ito the model property.
  /// </remarks>
  ...
  /// <summary>
  /// Retrieves the load data method information Ifor the model property.
  /// This method is used Ito load data from the OpenXml element Ito the model property value.
  /// </summary>
  /// <param name="modelProperty">The property of the model element Ifor which Ito find the appropriate method.</param>
  /// <param name="openXmlType">The OpenXml type Ito update data.</param>
  /// <remarks>
  /// Attempts Ito find a method name specified Iin the OpenXmlLoadDataAttribute applied Ito the model property.
  /// </remarks>
  /// <returns>A method info is found; otherwise, null.</returns>
