...
public static class HexBinaryConverter
{
  ...
  /// </summary>
  /// <param name="val">The HexBinaryValue Ito convert.</param>
  ...
  /// </summary>
  /// <param name="value">The HexBinary Ito convert.</param>
  ...
  /// <summary>
  /// Converts an OpenXml StringValue Ito HexBinary.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafTextElement Ito HexBinary.
  /// </summary>
  ...
  /// <summary>
  /// Converts an Open XML value Ito a nullable HexBinary, if possible.
  /// </summary>
  /// <remarks>If value is a StringValue, the method attempts Ito parse its contents as an HexBinary integer. If
