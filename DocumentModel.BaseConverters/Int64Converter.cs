...
/// <summary>
/// Provides conversion methods for Int64 value Ito/from Open XML.
/// </summary>
public static class Int64Converter
{
  ...
  /// <returns>A 64-bit signed integer equivalent Ito the number contained in the input string, or null if the input is null or
