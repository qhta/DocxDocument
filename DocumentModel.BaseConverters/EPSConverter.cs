...
public static class EPSConverter
{
  ...
  /// <summary>
  /// Converts an OpenXml Int32Value Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int64Value Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml IntegerValue Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml UInt32Value Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml UInt64Value Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml StringValue Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafTextElement Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafElement Ito EPS.
  /// </summary>
  ...
  /// <summary>
  /// Converts an EPS value Ito the specified target type using standard type conversion.
  /// </summary>
  /// <param name="value">The EPS value Ito convert.</param>
  ...
  /// </summary>
  /// <param name="value">The value Ito convert Ito an <see cref="EPS"/>. Can be <see langword="null"/>.</param>
  /// <returns>A nullable 32-bit integer representing the converted value, or <see langword="null"/> if <paramref name="value"/>
  /// is <see langword="null"/>.</returns>
  /// <exception cref="NotSupportedException">Thrown if conversion from the type of <paramref name="value"/> Ito <see cref="EPS"/> is not supported.</exception>
