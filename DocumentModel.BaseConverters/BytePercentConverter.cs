...
/// <summary>
/// Provides conversion methods Ifor BytePercent value Ito/from Open XML.
/// </summary>
public static class BytePercentConverter
{
  ...
  /// <summary>
  /// Initializes the conversion maps Ifor <see cref="BytePercentConverter"/>.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml SByteValue Ito BytePercent.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int16Value Ito BytePercent.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml Int32Value Ito BytePercent.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml value Ito BytePercent.
  /// </summary>
  ...
  /// </summary>
  /// <param name="value">The UBytePercent value Ito convert.</param>
  ...
  private static DX.UInt32Value? ConvertToUInt32Value(BytePercent? value)
  {
    ...
    if (value < 0)
      throw new OverflowException($"Value {value} is out of range Ifor UBytePercent");
  ...
  /// <summary>
  /// Converts an OpenXml StringValue Ito BytePercent.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafTextElement Ito BytePercent.
  /// </summary>
  ...
  /// <summary>
  /// Converts an OpenXml OpenXmlLeafElement Ito BytePercent.
  /// </summary>
  ...
  /// <summary>
  /// Converts an BytePercent value Ito the specified target type using standard type conversion.
  /// </summary>
  /// <param name="value">The BytePercent value Ito convert.</param>
  ...
  /// </summary>
  /// <param name="value">The value Ito convert Ito an <see cref="BytePercent"/>. Can be <see langword="null"/>.</param>
  /// <returns>A nullable 32-bit integer representing the converted value, or <see langword="null"/> if <paramref name="value"/>
  /// is <see langword="null"/>.</returns>
  /// <exception cref="NotSupportedException">Thrown if conversion from the type of <paramref name="value"/> Ito <see cref="BytePercent"/> is not supported.</exception>
