...
public interface IDefaultPivotTableLayoutOptions
{
  [DispId(148)]
  ...
  [DispId(2879)]
  XlPivotFieldRepeatLabels RepeatAllLabels
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    get;
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
