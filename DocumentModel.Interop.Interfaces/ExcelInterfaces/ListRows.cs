...
public interface ListRows: IEnumerable
{
  ...
  [DispId(2085)]
  [return: MarshalAs(UnmanagedType.Interface)]
  ListRow Add([Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Position);

  [IndexerName("_Default")]
  [DispId(0)]
  ListRow this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
  ...
  ([Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Position,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object AlwaysInsert);
}