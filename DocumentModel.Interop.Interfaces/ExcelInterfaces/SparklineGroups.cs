...
public interface SparklineGroups: IEnumerable
{
  ...
  [DispId(181)]
  [return: MarshalAs(UnmanagedType.Interface)]
  SparklineGroup Add([In] XlSparkType Type, [In] [MarshalAs(UnmanagedType.BStr)] string SourceData);
  ...
  [DispId(0)]
  SparklineGroup this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(0)]
  ...
  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [DispId(46)]
  void Group([In] [MarshalAs(UnmanagedType.Interface)] Range Location);
