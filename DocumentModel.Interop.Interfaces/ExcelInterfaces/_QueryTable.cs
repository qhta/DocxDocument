...
public interface _QueryTable
{
  ...
  [DispId(1875)]
  bool WebPreFormattedTextToColumns
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(1875)]
  ...
  [DispId(1877)]
  bool WebDisableDateRecognition
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(1877)]
  ...
  [DispId(1878)]
  bool WebConsecutiveDelimitersAsOne
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(1878)]
