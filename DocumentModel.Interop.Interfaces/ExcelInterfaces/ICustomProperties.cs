...
public interface ICustomProperties: IEnumerable
{
  ...
  [return: MarshalAs(UnmanagedType.Interface)]
  CustomProperty Add
    ([In] [MarshalAs(UnmanagedType.BStr)] string Name, [In] [MarshalAs(UnmanagedType.Struct)] object Value);
  ...
  [DispId(0)]
  CustomProperty this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
