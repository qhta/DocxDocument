...
public interface IQueries: IEnumerable
{
  [DispId(148)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  WorkbookQuery Item([In] [MarshalAs(UnmanagedType.Struct)] object NameOrIndex);

  [IndexerName("_Default")]
  [DispId(0)]
  WorkbookQuery this[[In] [MarshalAs(UnmanagedType.Struct)] object NameOrIndex]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
