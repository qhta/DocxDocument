...
public interface Hyperlinks: IEnumerable
{
  ...
  [return: MarshalAs(UnmanagedType.IDispatch)]
  object Add
  ([In] [MarshalAs(UnmanagedType.IDispatch)] object Anchor, [In] [MarshalAs(UnmanagedType.BStr)] string Address,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object SubAddress,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object ScreenTip,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object TextToDisplay);
