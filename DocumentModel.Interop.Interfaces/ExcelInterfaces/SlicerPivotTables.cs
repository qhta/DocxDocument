...
public interface SlicerPivotTables: IEnumerable
{
  ...
  [DispId(0)]
  PivotTable this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(0)]
  ...
  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [DispId(2990)]
  void AddPivotTable([In] [MarshalAs(UnmanagedType.Interface)] PivotTable PivotTable);

  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [DispId(2991)]
  void RemovePivotTable([In] [MarshalAs(UnmanagedType.Struct)] object PivotTable);
}