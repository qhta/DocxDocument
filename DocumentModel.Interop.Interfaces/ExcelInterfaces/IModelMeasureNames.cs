...
public interface IModelMeasureNames: IEnumerable
{
  [DispId(148)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  ModelMeasureName Item([In] [MarshalAs(UnmanagedType.Struct)] object Index);

  [IndexerName("_Default")]
  [DispId(0)]
  ModelMeasureName this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
