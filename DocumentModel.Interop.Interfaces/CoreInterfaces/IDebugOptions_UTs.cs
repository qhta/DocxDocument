...
/// <summary>
  ...
  public IDebugOptions_UTs GetUnitTestsInCollection(string bstrCollectionName);
  /// <summary>
  ...
  public IDebugOptions_UT GetUnitTest(string bstrCollectionName, string bstrUnitTestName);
  /// <summary>
