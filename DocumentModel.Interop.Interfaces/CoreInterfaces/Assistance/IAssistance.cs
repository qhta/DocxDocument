...
/// <summary>
/// Microsoft Word assistance refers to built-in tools and AI features designed to help you write, edit, and navigate the application.
/// It includes the Microsoft Editor (for grammar and style), Copilot (generative AI for writing/summarizing),
/// and a Searchable Help Center (for troubleshooting).
/// </summary>
