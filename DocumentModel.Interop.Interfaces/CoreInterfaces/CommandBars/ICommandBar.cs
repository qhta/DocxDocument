...
/// <summary>
/// In Microsoft Word, a CommandBar is a legacy programming object and interface component that represents a toolbar,
/// menu bar, or shortcut (context) menu. While replaced by the modern Ribbon interface in standard Word windows,
/// CommandBars remain active for built-in right-click menus and within Visual Basic for Applications (VBA) macros
/// </summary>
