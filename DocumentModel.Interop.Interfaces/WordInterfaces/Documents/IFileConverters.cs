...
public interface IFileConverters : IInteropObject, IInteropCollection<IFileConverter>
{
  /// <summary>
  /// Controls whether text enclosed in chevron characters (Â« Â») is converted to merge fields.
  /// </summary>
