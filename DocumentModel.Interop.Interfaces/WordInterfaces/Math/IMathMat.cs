...
public interface IMathMat : IInteropObject
{
  /// <summary>
  ...
  public MathSpacingRule ColGapRule { get; set; }
...
/// <summary>
  ...
  public IMath Cell(int row, int col);
