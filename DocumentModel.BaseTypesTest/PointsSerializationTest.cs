...
public static class PointsSerializationTests
{
  ...
  {
    Console.WriteLine("--- Testing Points Basic Operations ---");

    try
    {
      // Test string to Points conversion (plain number)
      Points points1 = "72";
      Console.WriteLine($"✓ String to Points: {points1} = {(Int64)points1} points");

      // Test integer to Points conversion
      Points points2 = 72;
      Console.WriteLine($"✓ Int to Points: {points2}");
      ...
      Console.WriteLine($"✓ Points to string: {str}");
      ...
      // Test hash code
      Console.WriteLine($"✓ Hash code: {points1.GetHashCode()}");

      // Test comparison
      Points points3 = 144; // 2 inches
      Console.WriteLine($"✓ CompareTo (72 vs 144): {points1.CompareTo(points3)} (expected < 0)");
  ...
  {
    Console.WriteLine("--- Testing Points Unit Conversions ---");
  ...
  {
    Console.WriteLine("--- Testing Points XML Serialization ---");
    ...
    try
    {
      ...
      bool isValid =
        ...
        testData.ParagraphSpacing.CompareTo(deserializedData.ParagraphSpacing) == 0 &&
        testData.Indent.CompareTo(deserializedData.Indent) == 0 &&
        testData.BodyFontSize.CompareTo(deserializedData.BodyFontSize) == 0 &&
        testData.HeadingFontSize.CompareTo(deserializedData.HeadingFontSize) == 0 &&
  ...
  {
    Console.WriteLine("--- Testing Points JSON Serialization ---");
    ...
    try
    {
      ...
      Console.WriteLine($"  ParagraphSpacing: {deserializedData.ParagraphSpacing}");
      Console.WriteLine($"  Indent: {deserializedData.Indent}");
      Console.WriteLine($"  BodyFontSize: {deserializedData.BodyFontSize}");
      Console.WriteLine($"  HeadingFontSize: {deserializedData.HeadingFontSize}");
      Console.WriteLine($"  ZeroValue: {deserializedData.ZeroValue}");
      Console.WriteLine($"  SmallValue: {deserializedData.SmallValue}");
      Console.WriteLine($"  LargeValue: {deserializedData.LargeValue}");
      Console.WriteLine();
  ...
  {
    Console.WriteLine("--- Testing Points Edge Cases ---");
  ...
  {
    Console.WriteLine("--- Testing Points Performance ---");
