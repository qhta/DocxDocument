...
public static class VStreamDataSerializationTests
{
  ...
  {
    Console.WriteLine("--- Testing VStreamData Construction ---");

    try
    {
      // Test constructor with version GUID and data
      ...
      Console.WriteLine($"✓ Created stream data: Version={streamInfo.Version}, Size={streamInfo.Data.Length}");
      ...
      Console.WriteLine($"✓ Created with Guid.Empty: Version={emptyGuidStream.Version}");
      ...
      Console.WriteLine($"✓ Created with empty data: Size={emptyDataStream.Data.Length}");
      ...
      Console.WriteLine($"✓ Created with null data (converted to empty): Size={nullDataStream.Data.Length}");
      ...
      Console.WriteLine($"✓ Created OLE stream: Version={oleStream.Version}");
      ...
      Console.WriteLine($"✓ Created large stream: Size={largeStream.Data.Length} bytes");
  ...
  {
    Console.WriteLine("--- Testing VStreamData Properties ---");
    ...
    try
    {
      ...
      Console.WriteLine("✓ Version property works correctly");
      ...
      Console.WriteLine("✓ Data property never returns null (empty array instead)");
      ...
      Console.WriteLine("✓ Document content preserved correctly");
  ...
  {
    Console.WriteLine("--- Testing VStreamData Equality ---");
  ...
  {
    Console.WriteLine("--- Testing VStreamData Version GUIDs ---");

    try
    {
      // Test with Excel CLSID
      ...
      Console.WriteLine($"✓ Excel CLSID: {excelStream.Version}");
      ...
      Console.WriteLine($"✓ Word CLSID: {wordStream.Version}");
      ...
      Console.WriteLine($"✓ PowerPoint CLSID: {pptStream.Version}");
      ...
      Console.WriteLine($"✓ Custom format: {customStream.Version}");
      ...
      Console.WriteLine($"✓ Unversioned stream: {unversionedStream.Version}");
      ...
      Console.WriteLine($"✓ GUID format is standard (with hyphens)");
    ...
    {
      Console.WriteLine($"✗ Version GUID test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing VStreamData XML Serialization ---");
    ...
    try
    {
      ...
      bool isValid =
        ...
        testData.ExcelStream.Equals(deserializedData.ExcelStream) &&
        testData.WordStream.Equals(deserializedData.WordStream) &&
        testData.BinaryStream.Equals(deserializedData.BinaryStream) &&
        testData.EmptyStream.Equals(deserializedData.EmptyStream) &&
        testData.LargeStream.Equals(deserializedData.LargeStream);
  ...
  {
    Console.WriteLine("--- Testing VStreamData JSON Serialization ---");
  ...
  {
    Console.WriteLine("--- Testing VStreamData Edge Cases ---");
    ...
    try
    {
      ...
      Console.WriteLine($"✓ All zeros: Size={zeroData.Data.Length}");
      ...
      Console.WriteLine($"✓ Large document: Size={largeDocData.Data.Length / 1024}KB");
      ...
      Console.WriteLine("✓ OLE signature preserved");
      ...
      Console.WriteLine("✓ XML content with special characters preserved");
      ...
      Console.WriteLine($"✓ Pattern data: Size={patternData.Data.Length}");
  ...
  {
    Console.WriteLine("--- Testing VStreamData Performance ---");
