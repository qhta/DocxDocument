...
public static class EighthPointsSerializationTests
{
  ...
  {
    Console.WriteLine("--- Testing EighthPoints Basic Operations ---");

    try
    {
      // Test string to EighthPoints conversion (plain number)
      EighthPoints ep1 = "576";
      Console.WriteLine($"✓ String to EighthPoints: {ep1} = {(Int64)ep1} eighth-points");

      // Test integer to EighthPoints conversion
      EighthPoints ep2 = 576;
      Console.WriteLine($"✓ Int to EighthPoints: {ep2}");
      ...
      Console.WriteLine($"✓ EighthPoints to string: {str}");
      ...
      // Test hash code
      Console.WriteLine($"✓ Hash code: {ep1.GetHashCode()}");

      // Test comparison
      EighthPoints ep3 = 1152; // 2 inches
      Console.WriteLine($"✓ CompareTo (576 vs 1152): {ep1.CompareTo(ep3)} (expected < 0)");
  ...
  {
    Console.WriteLine("--- Testing EighthPoints Unit Conversions ---");
  ...
  {
    Console.WriteLine("--- Testing EighthPoints XML Serialization ---");
    ...
    try
    {
      ...
      Console.WriteLine($"  MicroKerning: {deserializedData.MicroKerning} ({deserializedData.MicroKerning.ToPoints():F3}pt)");
      Console.WriteLine($"  LetterSpacing: {deserializedData.LetterSpacing} ({deserializedData.LetterSpacing.ToPoints():F3}pt)");
      ...
      bool isValid =
        ...
        testData.MicroKerning.CompareTo(deserializedData.MicroKerning) == 0 &&
  ...
  {
    Console.WriteLine("--- Testing EighthPoints JSON Serialization ---");
  ...
  {
    Console.WriteLine("--- Testing EighthPoints Edge Cases ---");
  ...
  {
    Console.WriteLine("--- Testing EighthPoints Performance ---");
