...
public static class VariantSerializationTests
{
  ...
  {
    Console.WriteLine("--- Testing Variant Construction ---");
    ...
    try
    {
      ...
      Console.WriteLine($"✓ Empty variant: Type={empty.VariantType}, Value={empty.Value ?? "null"}");

      // Test automatic type recognition
      Console.WriteLine("\nTesting automatic type recognition:");
      Variant intVariant = new Variant(42);
      Console.WriteLine($"✓ Int value: Type={intVariant.VariantType}, Value={intVariant.Value}");

      Variant strVariant = new Variant("Hello");
      Console.WriteLine($"✓ String value: Type={strVariant.VariantType}, Value={strVariant.Value}");

      Variant boolVariant = new Variant(true);
      Console.WriteLine($"✓ Boolean value: Type={boolVariant.VariantType}, Value={boolVariant.Value}");
      ...
      Console.WriteLine($"✓ Decimal variant: Type={decimalVariant.VariantType}, Value={decimalVariant.Value}");

      Variant dateVariant = new Variant(VariantType.Date, DateOnly.FromDateTime(DateTime.Now));
      Console.WriteLine($"✓ Date variant: Type={dateVariant.VariantType}, Value={dateVariant.Value}");

      // Test null and empty
      Console.WriteLine("\nTesting null and empty values:");
      Variant nullVariant = new Variant(VariantType.Null);
      Console.WriteLine($"✓ Null variant: Type={nullVariant.VariantType}, Value type={nullVariant.Value?.GetType().Name ?? "null"}");

      Variant emptyVariant = new Variant(VariantType.Empty);
      Console.WriteLine($"✓ Empty variant: Type={emptyVariant.VariantType}, Value={emptyVariant.Value ?? "null"}");
    ...
    {
      Console.WriteLine($"✗ Construction test FAILED: {ex.Message}");
  ...
  {
    Console.WriteLine("--- Testing Variant Numeric Types ---");
    ...
    {
      Console.WriteLine($"✗ Numeric type test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing Variant String Types ---");
    ...
    {
      Console.WriteLine($"✗ String type test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing Variant DateTime Types ---");
    ...
    {
      Console.WriteLine($"✗ DateTime type test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing Variant Special Types ---");
    ...
    {
      Console.WriteLine($"✗ Special type test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing Variant Binary Types ---");
    ...
    {
      Console.WriteLine($"✗ Binary type test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing Variant Type Conversions ---");
  ...
  {
    Console.WriteLine("--- Testing Variant Equality ---");
    ...
    {
      Console.WriteLine($"✗ Equality test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing Variant XML Serialization ---");

    try
    {
      // Create test object with various variant types
      ...
      Console.WriteLine($"  IntValue: {deserializedData.IntValue.Value}");
      Console.WriteLine($"  StringValue: {deserializedData.StringValue.Value}");
      Console.WriteLine($"  DoubleValue: {deserializedData.DoubleValue.Value}");
      Console.WriteLine($"  BooleanValue: {deserializedData.BooleanValue.Value}");
      Console.WriteLine($"  DateValue: {deserializedData.DateValue.Value}");
      Console.WriteLine($"  DateTimeValue: {deserializedData.DateTimeValue.Value}");
      Console.WriteLine($"  GuidValue: {deserializedData.GuidValue.Value}");
      Console.WriteLine($"  BlobValue: {((byte[])deserializedData.BlobValue.Value!).Length} bytes");
      Console.WriteLine();
      ...
      bool isValid =
        ...
        testData.IntValue.Equals(deserializedData.IntValue) &&
        testData.StringValue.Equals(deserializedData.StringValue) &&
        testData.DoubleValue.Equals(deserializedData.DoubleValue) &&
        testData.BooleanValue.Equals(deserializedData.BooleanValue) &&
        testData.DateValue.Equals(deserializedData.DateValue) &&
        testData.GuidValue.Equals(deserializedData.GuidValue) &&
        testData.BlobValue.Equals(deserializedData.BlobValue) &&
        testData.NullValue.VariantType == deserializedData.NullValue.VariantType &&
        testData.EmptyValue.VariantType == deserializedData.EmptyValue.VariantType;
  ...
  {
    Console.WriteLine("--- Testing Variant JSON Serialization ---");
  ...
  {
    Console.WriteLine("--- Testing Variant Edge Cases ---");
  ...
  {
    Console.WriteLine("--- Testing Variant Performance ---");
