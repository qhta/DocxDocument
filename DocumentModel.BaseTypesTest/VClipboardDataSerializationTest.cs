...
public static class VClipboardDataSerializationTests
{
  ...
  {
    Console.WriteLine("--- Testing VClipboardData Construction ---");

    try
    {
      // Test constructor with text data
      ...
      Console.WriteLine($"✓ Created text clipboard data: Format={textData.Format}, Size={textData.Size}");
      ...
      Console.WriteLine($"✓ Created binary clipboard data: Format={binaryClipData.Format}, Size={binaryClipData.Size}");
      ...
      Console.WriteLine($"✓ Created empty clipboard data: Format={emptyClipData.Format}, Size={emptyClipData.Size}");
      ...
      Console.WriteLine($"✓ Created large clipboard data: Format={largeClipData.Format}, Size={largeClipData.Size}");
  ...
  {
    Console.WriteLine("--- Testing VClipboardData Properties ---");
    ...
    try
    {
      ...
      Console.WriteLine("✓ Format property works correctly");
      ...
      Console.WriteLine("✓ Size property matches data length");
      ...
      Console.WriteLine("✓ Data property preserves original bytes");
      ...
      Console.WriteLine("✓ Unicode text preserved correctly");
    ...
    {
      Console.WriteLine($"✗ Property test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing VClipboardData Equality ---");
    ...
    try
    {
      ...
      Console.WriteLine("✓ Equal instances have same hash code");
  ...
  {
    Console.WriteLine("--- Testing VClipboardData Clipboard Formats ---");
    ...
    try
    {
      ...
      Console.WriteLine($"✓ CF_TEXT: Format={textClip.Format}, Size={textClip.Size}");
      ...
      Console.WriteLine($"✓ CF_BITMAP: Format={bitmapClip.Format}, Size={bitmapClip.Size}");
      ...
      Console.WriteLine($"✓ CF_METAFILEPICT: Format={metaClip.Format}, Size={metaClip.Size}");

      // Test CF_DIB (8)
      Console.WriteLine("\nTesting CF_DIB format (8):");
      byte[] dibBytes = new byte[256];
      VClipboardData dibClip = new VClipboardData(8, dibBytes);
      Console.WriteLine($"✓ CF_DIB: Format={dibClip.Format}, Size={dibClip.Size}");
      ...
      Console.WriteLine($"✓ CF_UNICODETEXT: Format={unicodeClip.Format}, Size={unicodeClip.Size}");
      ...
      Console.WriteLine($"✓ CF_ENHMETAFILE: Format={emfClip.Format}, Size={emfClip.Size}");
      ...
      Console.WriteLine($"✓ CF_HDROP: Format={hdropClip.Format}, Size={hdropClip.Size}");
      ...
      Console.WriteLine($"✓ Custom format: Format={customClip.Format}, Size={customClip.Size}");
    ...
    {
      Console.WriteLine($"✗ Clipboard format test FAILED: {ex.Message}");
      Console.WriteLine($"  Stack trace: {ex.StackTrace}");
      Console.WriteLine();
      return false;
    }
  ...
  {
    Console.WriteLine("--- Testing VClipboardData XML Serialization ---");
    ...
    try
    {
      ...
      bool isValid =
        ...
        testData.TextClipboard.Equals(deserializedData.TextClipboard) &&
        testData.BitmapClipboard.Equals(deserializedData.BitmapClipboard) &&
        testData.BinaryClipboard.Equals(deserializedData.BinaryClipboard) &&
        testData.EmptyClipboard.Equals(deserializedData.EmptyClipboard) &&
        testData.LargeClipboard.Equals(deserializedData.LargeClipboard);
  ...
  {
    Console.WriteLine("--- Testing VClipboardData JSON Serialization ---");
  ...
  {
    Console.WriteLine("--- Testing VClipboardData Edge Cases ---");
    ...
    try
    {
      ...
      Console.WriteLine($"✓ Large format: Format={largeFormatData.Format}");
      ...
      Console.WriteLine($"✓ Pattern data: Size={patternData.Size}");
      ...
      Console.WriteLine("✓ Hash codes generated for edge cases");
      ...
      Console.WriteLine("✓ Special characters preserved");
  ...
  {
    Console.WriteLine("--- Testing VClipboardData Performance ---");
