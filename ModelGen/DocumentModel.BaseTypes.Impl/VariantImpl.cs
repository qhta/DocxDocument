...
public class VariantImpl : ModelElementImpl
{
  ...
  public VariantImpl(DocumentFormat.OpenXml.OpenXmlElement element)
  {
  ...
  public static Variant VTToVariant(DocumentFormat.OpenXml.OpenXmlElement openXmlElement)
  {
  ...
  public static DocumentFormat.OpenXml.OpenXmlElement ObjectToVT(object? value)
  {
    if (value is Variant variant)
      return VariantToVT(variant);
    throw new NotImplementedException();
  }

  public static DocumentFormat.OpenXml.OpenXmlElement VariantToVT(Variant value)
  {
    switch (value.VariantType)
    {
      ...
      case VariantType.Variant:
        ...
        {
          variantVariant.AddChild(VariantToVT(variantValue));
        };
        return variantVariant;
      case VariantType.Vector:
        if (value is VectorVariant varVector)
        {
          var vtVector = new VTVectorImpl { Value = varVector }.OpenXmlElement;
          if (vtVector != null)
            return vtVector;
        }
      ...
      case VariantType.Array:
        ...
        {
          var vtArray = new VTArrayImpl { Value = varArray }.OpenXmlElement;
          if (vtArray != null)
            return vtArray;
        }
