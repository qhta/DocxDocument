...
public interface IPresentationOf // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Axis
  /// </summary>
  public List<AxisValues>? Axis { get ; set; }
  
  /// <summary>
  /// Data Point Type
  /// </summary>
  public List<ElementValues>? PointType { get ; set; }
