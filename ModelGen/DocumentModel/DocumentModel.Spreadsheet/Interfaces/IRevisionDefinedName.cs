...
public interface IRevisionDefinedName // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Revision Id
  /// </summary>
  ...
  /// Old Function
  /// </summary>
  public bool? OldFunction { get ; set; }
  ...
  /// </summary>
  public byte? OldFunctionGroupId { get ; set; }
  ...
  /// Old Short Cut Key
  /// </summary>
  public byte? OldShortcutKey { get ; set; }
  ...
  /// </summary>
  public string? OldCustomMenu { get ; set; }
  ...
  /// Old Status Bar
  /// </summary>
  public string? OldStatusBar { get ; set; }
  ...
  /// Formula.
  /// </summary>
  public DocumentModel.Spreadsheet.IFormula? Formula { get ; set; }
  
  /// <summary>
  /// Old Formula.
  /// </summary>
  public IOldFormula? OldFormula { get ; set; }
