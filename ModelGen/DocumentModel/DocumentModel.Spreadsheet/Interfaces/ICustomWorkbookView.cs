...
public interface ICustomWorkbookView // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Custom View Name
  /// </summary>
  ...
  /// Merge Interval
  /// </summary>
  public uint? MergeInterval { get ; set; }
  ...
  /// </summary>
  public bool? IncludeHiddenRowColumn { get ; set; }
  ...
  /// </summary>
  public uint? ActiveSheetId { get ; set; }
  ...
  /// Show Comments
  /// </summary>
  public CommentsValues? ShowComments { get ; set; }
  
  /// <summary>
  /// Show Objects
  /// </summary>
  public ObjectDisplayValues? ShowObjects { get ; set; }
