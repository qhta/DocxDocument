...
/// </summary>
public interface IMetadataType // : DocumentFormat.OpenXml.TypedOpenXmlLeafElement
{
  /// <summary>
  /// Metadata Type Name
  /// </summary>
  ...
  /// </summary>
  public uint? MinSupportedVersion { get ; set; }
  
  /// <summary>
  /// Metadata Ghost Row
  /// </summary>
  public bool? GhostRow { get ; set; }
  
  /// <summary>
  /// Metadata Ghost Column
  /// </summary>
  public bool? GhostColumn { get ; set; }
  ...
  /// </summary>
  public bool? PasteFormulas { get ; set; }
  
  /// <summary>
  /// Metadata Paste Special Values
  /// </summary>
  public bool? PasteValues { get ; set; }
  
  /// <summary>
  /// Metadata Paste Formats
  /// </summary>
  public bool? PasteFormats { get ; set; }
  
  /// <summary>
  /// Metadata Paste Comments
  /// </summary>
  public bool? PasteComments { get ; set; }
  
  /// <summary>
  /// Metadata Paste Data Validation
  /// </summary>
  public bool? PasteDataValidation { get ; set; }
  
  /// <summary>
  /// Metadata Paste Borders
  /// </summary>
  public bool? PasteBorders { get ; set; }
  
  /// <summary>
  /// Metadata Paste Column Widths
  /// </summary>
  public bool? PasteColWidths { get ; set; }
  
  /// <summary>
  /// Metadata Paste Number Formats
  /// </summary>
  public bool? PasteNumberFormats { get ; set; }
  ...
  /// Metadata Split All
  /// </summary>
  public bool? SplitAll { get ; set; }
  
  /// <summary>
  /// Metadata Insert Delete
  /// </summary>
  public bool? RowColumnShift { get ; set; }
