...
/// </summary>
public interface PivotTableDefinition // : DocumentModel.BaseTypes.ModelElement
{
  /// <summary>
  ...
  /// PivotEdits.
  /// </summary>
  public PivotEdits? PivotEdits { get ; set; }
  ...
  /// ConditionalFormats.
  /// </summary>
  public ConditionalFormats? ConditionalFormats { get ; set; }
