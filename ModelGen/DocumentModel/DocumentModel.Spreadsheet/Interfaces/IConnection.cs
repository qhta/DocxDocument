...
public interface IConnection // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  ...
  /// reconnectionMethod
  /// </summary>
  public uint? ReconnectionMethod { get ; set; }
  ...
  /// credentials
  /// </summary>
  public CredentialsMethodValues? Credentials { get ; set; }
  ...
  /// DatabaseProperties.
  /// </summary>
  public IDatabaseProperties? DatabaseProperties { get ; set; }
  
  /// <summary>
  /// OlapProperties.
  /// </summary>
  public IOlapProperties? OlapProperties { get ; set; }
  
  /// <summary>
  /// WebQueryProperties.
  /// </summary>
  public IWebQueryProperties? WebQueryProperties { get ; set; }
  
  /// <summary>
  /// TextProperties.
  /// </summary>
  public DocumentModel.Spreadsheet.ITextProperties? TextProperties { get ; set; }
  ...
  /// </summary>
  public IConnectionExtensionList? ConnectionExtensionList { get ; set; }
