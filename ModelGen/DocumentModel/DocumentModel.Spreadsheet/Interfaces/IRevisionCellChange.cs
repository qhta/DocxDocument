...
public interface IRevisionCellChange // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Revision Id
  /// </summary>
  ...
  /// Old Formatting
  /// </summary>
  public bool? OldFormatting { get ; set; }
  
  /// <summary>
  /// Row Column Formatting Change
  /// </summary>
  public bool? RowColumnFormattingAffected { get ; set; }
  
  /// <summary>
  /// Style Revision
  /// </summary>
  public bool? StyleRevision { get ; set; }
  ...
  /// Old Quote Prefix
  /// </summary>
  public bool? OldQuotePrefix { get ; set; }
  
  /// <summary>
  /// Phonetic Text
  /// </summary>
  public bool? HasPhoneticText { get ; set; }
  
  /// <summary>
  /// Old Phonetic Text
  /// </summary>
  public bool? OldPhoneticText { get ; set; }
  
  /// <summary>
  /// End of List  Formula Update
  /// </summary>
  public bool? EndOfListFormulaUpdate { get ; set; }
  
  /// <summary>
  /// Old Cell Data.
  /// </summary>
  public IOldCell? OldCell { get ; set; }
  
  /// <summary>
  /// New Cell Data.
  /// </summary>
  public INewCell? NewCell { get ; set; }
  
  /// <summary>
  /// Old Formatting Information.
  /// </summary>
  public IOldDifferentialFormat? OldDifferentialFormat { get ; set; }
  
  /// <summary>
  /// New Formatting Information.
  /// </summary>
  public INewDifferentialFormat? NewDifferentialFormat { get ; set; }
