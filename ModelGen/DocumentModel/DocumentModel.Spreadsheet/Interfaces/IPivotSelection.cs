...
public interface IPivotSelection // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Pane
  /// </summary>
  ...
  /// Axis
  /// </summary>
  public PivotTableAxisValues? Axis { get ; set; }
  ...
  /// Active Column
  /// </summary>
  public uint? ActiveColumn { get ; set; }
  
  /// <summary>
  /// Previous Row
  /// </summary>
  public uint? PreviousRow { get ; set; }
  
  /// <summary>
  /// Previous Column Selection
  /// </summary>
  public uint? PreviousColumn { get ; set; }
