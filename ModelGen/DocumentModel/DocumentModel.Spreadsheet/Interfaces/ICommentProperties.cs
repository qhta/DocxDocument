...
public interface ICommentProperties // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  ...
  /// textHAlign
  /// </summary>
  public DocumentModel.Spreadsheet.TextHorizontalAlignmentValues? TextHAlign { get ; set; }
  
  /// <summary>
  /// textVAlign
  /// </summary>
  public DocumentModel.Spreadsheet.TextVerticalAlignmentValues? TextVAlign { get ; set; }
