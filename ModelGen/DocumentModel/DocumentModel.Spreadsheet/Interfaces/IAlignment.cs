...
public interface IAlignment // : DocumentFormat.OpenXml.TypedOpenXmlLeafElement
{
  ...
  /// </summary>
  public DocumentModel.Spreadsheet.HorizontalAlignmentValues? Horizontal { get ; set; }
  
  /// <summary>
  /// Vertical Alignment
  /// </summary>
  public DocumentModel.Spreadsheet.VerticalAlignmentValues? Vertical { get ; set; }
