...
/// </summary>
public interface QueryTableRefresh // : DocumentModel.BaseTypes.ModelElement
{
  /// <summary>
  ...
  /// Query table fields.
  /// </summary>
  public QueryTableFields? QueryTableFields { get ; set; }
  
  /// <summary>
  /// Deleted Fields.
  /// </summary>
  public QueryTableDeletedFields? QueryTableDeletedFields { get ; set; }
