...
public interface ITableColumn // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Table Field Id
  /// </summary>
  ...
  /// Totals Row Function
  /// </summary>
  public TotalsRowFunctionValues? TotalsRowFunction { get ; set; }
  ...
  /// </summary>
  public uint? HeaderRowDifferentialFormattingId { get ; set; }
  
  /// <summary>
  /// Data and Insert Row Format Id
  /// </summary>
  public uint? DataFormatId { get ; set; }
  
  /// <summary>
  /// Totals Row Format Id
  /// </summary>
  public uint? TotalsRowDifferentialFormattingId { get ; set; }
  ...
  /// </summary>
  public ICalculatedColumnFormula? CalculatedColumnFormula { get ; set; }
  
  /// <summary>
  /// Totals Row Formula.
  /// </summary>
  public ITotalsRowFormula? TotalsRowFormula { get ; set; }
