...
public interface IExternalBook // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  ...
  /// </summary>
  public IExternalBookAlternateUrls? ExternalBookAlternateUrls { get ; set; }
  
  /// <summary>
  /// Sheet names of supporting book.
  /// </summary>
  public ISheetNames? SheetNames { get ; set; }
  
  /// <summary>
  /// Defined names associated with supporting book..
  /// </summary>
  public IExternalDefinedNames? ExternalDefinedNames { get ; set; }
  
  /// <summary>
  /// Cached worksheet data associated with supporting book.
  /// </summary>
  public ISheetDataSet? SheetDataSet { get ; set; }
