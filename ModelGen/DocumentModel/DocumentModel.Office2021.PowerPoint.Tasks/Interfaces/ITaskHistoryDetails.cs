...
public interface ITaskHistoryDetails // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  ...
  /// TaskHistory.
  /// </summary>
  public DocumentModel.Office2021.PowerPoint.Tasks.ITaskHistory? TaskHistory { get ; set; }
