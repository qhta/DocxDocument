...
/// </summary>
public partial interface WorksheetPart
{
  ...
  /// </summary>
  public DocumentModel.Packaging.DrawingsPart? DrawingsPart { get; }
  ...
  /// </summary>
  public DocumentModel.Packaging.SingleCellTablePart? SingleCellTablePart { get; }
  ...
  /// </summary>
  public DocumentModel.Packaging.WorksheetCommentsPart? WorksheetCommentsPart { get; }
  
  /// <summary>
  /// Gets the WorksheetSortMapPart of the WorksheetPart
  /// </summary>
  public DocumentModel.Packaging.WorksheetSortMapPart? WorksheetSortMapPart { get; }
