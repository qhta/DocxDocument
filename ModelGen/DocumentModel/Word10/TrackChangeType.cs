...
/// </summary>
public partial class TrackChangeType: ModelElement<DXO10W.TrackChangeType>
{
  public TrackChangeType(): base(){ }
  
  public TrackChangeType(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public TrackChangeType(DXO10W.TrackChangeType openXmlElement): base(openXmlElement) { }
