...
public interface IInterpretation // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// id
  /// </summary>
  ...
  /// offset-to-start
  /// </summary>
  public int? OffsetToStart { get ; set; }
  ...
  /// medium
  /// </summary>
  public List<MediumValues>? Medium { get ; set; }
  ...
  /// uninterpreted
  /// </summary>
  public bool? Uninterpreted { get ; set; }
