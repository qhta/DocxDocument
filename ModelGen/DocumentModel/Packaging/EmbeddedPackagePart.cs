...
/// </summary>
public partial class EmbeddedPackagePart: ModelElement<DXPack.EmbeddedPackagePart>
{
  public EmbeddedPackagePart(): base(){ }
  
  public EmbeddedPackagePart(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
