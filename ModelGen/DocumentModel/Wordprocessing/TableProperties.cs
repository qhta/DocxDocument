...
public partial class TableProperties: ModelElement<DXW.TableProperties>
{
  ...
  public DMW.TablePropertiesChange? TablePropertiesChange
  {
    get
    {
      var element = _Element?.GetFirstChild<DXW.TablePropertiesChange>();
      if (element != null)
        return TablePropertiesChangeConverter.CreateModelElement(element);
      return null;
    }
    set
    {
      var itemElement = _ExistingElement.GetFirstChild<DXW.TablePropertiesChange>();
      if (itemElement != null)
        itemElement.Remove();
      if (value != null)
      {
        itemElement = TablePropertiesChangeConverter.CreateOpenXmlElement<DXW.TablePropertiesChange>(value);
        if (itemElement != null)
          _ExistingElement.AddChild(itemElement);
      }
    }
