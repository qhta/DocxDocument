...
/// </summary>
public partial class StyleRunProperties: ModelElement<DXW.StyleRunProperties>
{
  public StyleRunProperties(): base(){ }
  
  public StyleRunProperties(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public StyleRunProperties(DXW.StyleRunProperties openXmlElement): base(openXmlElement) { }
