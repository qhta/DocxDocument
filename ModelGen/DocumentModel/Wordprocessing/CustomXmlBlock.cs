...
/// </summary>
public partial class CustomXmlBlock: ModelElement<DXW.CustomXmlBlock>
{
  public CustomXmlBlock(): base(){ }
  
  public CustomXmlBlock(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public CustomXmlBlock(DXW.CustomXmlBlock openXmlElement): base(openXmlElement) { }
