...
/// </summary>
public partial class FrameName: ModelElement<DXW.FrameName>
{
  public FrameName(): base(){ }
  
  public FrameName(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public FrameName(DXW.FrameName openXmlElement): base(openXmlElement) { }
