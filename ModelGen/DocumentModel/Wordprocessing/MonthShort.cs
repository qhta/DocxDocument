...
/// </summary>
public partial class MonthShort: ModelElement<DXW.MonthShort>
{
  public MonthShort(): base(){ }
  
  public MonthShort(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public MonthShort(DXW.MonthShort openXmlElement): base(openXmlElement) { }
