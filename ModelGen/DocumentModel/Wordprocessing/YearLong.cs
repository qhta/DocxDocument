...
/// </summary>
public partial class YearLong: ModelElement<DXW.YearLong>
{
  public YearLong(): base(){ }
  
  public YearLong(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public YearLong(DXW.YearLong openXmlElement): base(openXmlElement) { }
