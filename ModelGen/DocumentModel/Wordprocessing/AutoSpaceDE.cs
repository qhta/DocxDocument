...
/// </summary>
public partial class AutoSpaceDE: ModelElement<DXW.AutoSpaceDE>
{
  public AutoSpaceDE(): base(){ }
  
  public AutoSpaceDE(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public AutoSpaceDE(DXW.AutoSpaceDE openXmlElement): base(openXmlElement) { }
