...
/// </summary>
public partial class MonthLong: ModelElement<DXW.MonthLong>
{
  public MonthLong(): base(){ }
  
  public MonthLong(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public MonthLong(DXW.MonthLong openXmlElement): base(openXmlElement) { }
