...
/// </summary>
public partial class InsideVerticalBorder: ModelElement<DXW.InsideVerticalBorder>
{
  public InsideVerticalBorder(): base(){ }
  
  public InsideVerticalBorder(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public InsideVerticalBorder(DXW.InsideVerticalBorder openXmlElement): base(openXmlElement) { }
