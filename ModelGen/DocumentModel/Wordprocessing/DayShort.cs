...
/// </summary>
public partial class DayShort: ModelElement<DXW.DayShort>
{
  public DayShort(): base(){ }
  
  public DayShort(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public DayShort(DXW.DayShort openXmlElement): base(openXmlElement) { }
