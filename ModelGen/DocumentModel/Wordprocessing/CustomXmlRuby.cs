...
/// </summary>
public partial class CustomXmlRuby: ModelElement<DXW.CustomXmlRuby>
{
  public CustomXmlRuby(): base(){ }
  
  public CustomXmlRuby(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public CustomXmlRuby(DXW.CustomXmlRuby openXmlElement): base(openXmlElement) { }
