...
/// </summary>
public partial class PreviousTableRowProperties: ModelElement<DXW.PreviousTableRowProperties>
{
  public PreviousTableRowProperties(): base(){ }
  
  public PreviousTableRowProperties(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public PreviousTableRowProperties(DXW.PreviousTableRowProperties openXmlElement): base(openXmlElement) { }
