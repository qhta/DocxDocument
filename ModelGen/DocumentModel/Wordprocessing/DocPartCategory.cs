...
/// </summary>
public partial class DocPartCategory: ModelElement<DXW.DocPartCategory>
{
  public DocPartCategory(): base(){ }
  
  public DocPartCategory(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public DocPartCategory(DXW.DocPartCategory openXmlElement): base(openXmlElement) { }
