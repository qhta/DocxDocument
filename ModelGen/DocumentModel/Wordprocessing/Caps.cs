...
/// </summary>
public partial class Caps: ModelElement<DXW.Caps>
{
  public Caps(): base(){ }
  
  public Caps(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Caps(DXW.Caps openXmlElement): base(openXmlElement) { }
