...
/// </summary>
public partial class AutoRedefine: ModelElement<DXW.AutoRedefine>
{
  public AutoRedefine(): base(){ }
  
  public AutoRedefine(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public AutoRedefine(DXW.AutoRedefine openXmlElement): base(openXmlElement) { }
