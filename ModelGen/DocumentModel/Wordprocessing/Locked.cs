...
/// </summary>
public partial class Locked: ModelElement<DXW.Locked>
{
  public Locked(): base(){ }
  
  public Locked(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Locked(DXW.Locked openXmlElement): base(openXmlElement) { }
