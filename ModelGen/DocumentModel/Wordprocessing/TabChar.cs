...
/// </summary>
public partial class TabChar: ModelElement<DXW.TabChar>
{
  public TabChar(): base(){ }
  
  public TabChar(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public TabChar(DXW.TabChar openXmlElement): base(openXmlElement) { }
