...
/// </summary>
public partial class BlipExtensionList: ModelElement<DXD.BlipExtensionList>
{
  public BlipExtensionList(): base(){ }
  
  public BlipExtensionList(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public BlipExtensionList(DXD.BlipExtensionList openXmlElement): base(openXmlElement) { }
