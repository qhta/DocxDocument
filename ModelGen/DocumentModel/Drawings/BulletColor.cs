...
///   Color Specified.
/// </summary>
public partial class BulletColor: ModelElement<DXD.BulletColor>
{
  public BulletColor(): base(){ }
  
  public BulletColor(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public BulletColor(DXD.BulletColor openXmlElement): base(openXmlElement) { }
