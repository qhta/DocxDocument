...
/// </summary>
public partial class AdjustValueList: ModelElement<DXD.AdjustValueList>
{
  public AdjustValueList(): base(){ }
  
  public AdjustValueList(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public AdjustValueList(DXD.AdjustValueList openXmlElement): base(openXmlElement) { }
