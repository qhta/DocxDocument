...
/// </summary>
public partial class Complement: ModelElement<DXD.Complement>
{
  public Complement(): base(){ }
  
  public Complement(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Complement(DXD.Complement openXmlElement): base(openXmlElement) { }
