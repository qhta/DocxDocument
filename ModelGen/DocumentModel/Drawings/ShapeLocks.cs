...
/// </summary>
public partial class ShapeLocks: ModelElement<DXD.ShapeLocks>
{
  public ShapeLocks(): base(){ }
  
  public ShapeLocks(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public ShapeLocks(DXD.ShapeLocks openXmlElement): base(openXmlElement) { }
  ...
  public Boolean? NoTextEdit
  {
    get
    {
      return _Element?.NoTextEdit?.Value;
    }
    set
    {
      if (value != null)
        _ExistingElement.NoTextEdit = new DX.BooleanValue { Value = (Boolean)value };
      else
        _ExistingElement.NoTextEdit = null;
    }
  }
