...
/// </summary>
public partial class ColorFrom: ModelElement<DXD.ColorFrom>
{
  public ColorFrom(): base(){ }
  
  public ColorFrom(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public ColorFrom(DXD.ColorFrom openXmlElement): base(openXmlElement) { }
