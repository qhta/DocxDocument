...
/// </summary>
public partial class ConnectorLockingExtensionList: ModelElement<DXD.ConnectorLockingExtensionList>
{
  public ConnectorLockingExtensionList(): base(){ }
  
  public ConnectorLockingExtensionList(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public ConnectorLockingExtensionList(DXD.ConnectorLockingExtensionList openXmlElement): base(openXmlElement) { }
