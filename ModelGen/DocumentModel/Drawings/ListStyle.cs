...
/// </summary>
public partial class ListStyle: ModelElement<DXD.ListStyle>
{
  public ListStyle(): base(){ }
  
  public ListStyle(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public ListStyle(DXD.ListStyle openXmlElement): base(openXmlElement) { }
