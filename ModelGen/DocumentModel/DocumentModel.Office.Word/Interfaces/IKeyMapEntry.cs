...
public interface IKeyMapEntry // : DocumentModel.ITypedOpenXmlCompositeElement
{
  ...
  /// </summary>
  public DocumentModel.Office.Word.IFixedCommandKeyboardCustomization? FixedCommandKeyboardCustomization { get ; set; }
  
  /// <summary>
  /// MacroKeyboardCustomization.
  /// </summary>
  public DocumentModel.Office.Word.IMacroWllType? MacroKeyboardCustomization { get ; set; }
  
  /// <summary>
  /// AllocatedCommandKeyboardCustomization.
  /// </summary>
  public DocumentModel.Office.Word.IAcceleratorKeymapType? AllocatedCommandKeyboardCustomization { get ; set; }
  
  /// <summary>
  /// WllMacroKeyboardCustomization.
  /// </summary>
  public DocumentModel.Office.Word.IMacroWllType? WllMacroKeyboardCustomization { get ; set; }
