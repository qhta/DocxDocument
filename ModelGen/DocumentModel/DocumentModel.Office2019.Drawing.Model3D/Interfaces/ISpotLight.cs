...
public interface ISpotLight // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  ...
  /// </summary>
  public IIntensityPositiveRatio? IntensityPositiveRatio { get ; set; }
