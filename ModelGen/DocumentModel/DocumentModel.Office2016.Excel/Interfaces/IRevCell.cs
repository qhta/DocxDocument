...
public interface IRevCell // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// t, this property is only available in Office 2016 and later.
  /// </summary>
  public CellValues? T { get ; set; }
  ...
  /// FFormula.
  /// </summary>
  public IFFormula? FFormula { get ; set; }
  
  /// <summary>
  /// Xstring.
  /// </summary>
  public DocumentModel.Office2016.Excel.IXstring? Xstring { get ; set; }
  
  /// <summary>
  /// RstType.
  /// </summary>
  public DocumentModel.Office2016.Excel.IRstType? RstType { get ; set; }
