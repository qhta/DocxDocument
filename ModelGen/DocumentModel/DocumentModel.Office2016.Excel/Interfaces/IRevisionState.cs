...
public interface IRevisionState // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// RowColVisualOps.
  /// </summary>
  public IRowColVisualOps? RowColVisualOps { get ; set; }
  
  /// <summary>
  /// HideUnhideSheet.
  /// </summary>
  public IHideUnhideSheet? HideUnhideSheet { get ; set; }
  
  /// <summary>
  /// ShowGridlinesHeadings.
  /// </summary>
  public IShowGridlinesHeadings? ShowGridlinesHeadings { get ; set; }
  
  /// <summary>
  /// FreezePanes.
  /// </summary>
  public IFreezePanes? FreezePanes { get ; set; }
  
  /// <summary>
  /// Outlines.
  /// </summary>
  public IOutlines? Outlines { get ; set; }
