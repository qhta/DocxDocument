...
public interface IBidirectionalEmbedding // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// val
  /// </summary>
  public DocumentModel.Wordprocessing.DirectionValues? Val { get ; set; }
