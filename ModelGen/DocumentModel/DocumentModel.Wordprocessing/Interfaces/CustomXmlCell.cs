...
/// </summary>
public interface CustomXmlCell // : DocumentModel.Wordprocessing.CustomXmlElement
{
  public CustomXmlProperties? CustomXmlProperties { get ; set; }
  
  public Collection<TableCell>? TableCells { get ; set; }
  
  public Collection<CustomXmlCell>? CustomXmlCells { get ; set; }
  
  public Collection<SdtCell>? SdtCells { get ; set; }
