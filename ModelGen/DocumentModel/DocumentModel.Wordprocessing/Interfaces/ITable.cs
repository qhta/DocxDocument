...
public interface ITable // : DocumentModel.ITypedOpenXmlCompositeElement
{
  ...
  public DocumentModel.Wordprocessing.ITableProperties? TableProperties { get ; set; }
  
  public DocumentModel.Wordprocessing.ITableGrid? TableGrid { get ; set; }
  
  public System.Collections.ObjectModel.Collection<DocumentModel.Wordprocessing.ITableRow>? TableRows { get ; set; }
  
  public DocumentModel.Wordprocessing.ICustomXmlRow? CustomXmlRow { get ; set; }
  
  public DocumentModel.Wordprocessing.ISdtRow? SdtRow { get ; set; }
