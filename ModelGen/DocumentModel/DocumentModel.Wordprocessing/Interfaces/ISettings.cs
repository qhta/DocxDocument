...
public interface ISettings // : DocumentModel.ITypedOpenXmlPartRootElement
{
  ...
  public Collection<IActiveWritingStyle>? ActiveWritingStyles { get ; set; }
  
  public IProofState? ProofState { get ; set; }
  
  public Boolean? FormsDesign { get ; set; }
  
  public IRelationshipType? AttachedTemplate { get ; set; }
  
  public Boolean? LinkStyles { get ; set; }
  
  public IStylePaneFormatFilter? StylePaneFormatFilter { get ; set; }
  ...
  public INoLineBreaksAfterKinsoku? NoLineBreaksAfterKinsoku { get ; set; }
  
  public INoLineBreaksBeforeKinsoku? NoLineBreaksBeforeKinsoku { get ; set; }
  ...
  public IFootnoteDocumentWideProperties? FootnoteDocumentWideProperties { get ; set; }
  
  public IEndnoteDocumentWideProperties? EndnoteDocumentWideProperties { get ; set; }
  
  public ICompatibility? Compatibility { get ; set; }
  ...
  public ILanguageType? ThemeFontLanguages { get ; set; }
  ...
  public IShapeDefaults? ShapeDefaults { get ; set; }
