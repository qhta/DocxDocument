...
public interface IParagraph // : DocumentModel.ITypedOpenXmlCompositeElement
{
  ...
  /// </summary>
  public DocumentModel.IHexBinaryValue? RsidParagraphMarkRevision { get ; set; }
  
  /// <summary>
  /// Revision Identifier for Paragraph
  /// </summary>
  public DocumentModel.IHexBinaryValue? RsidParagraphAddition { get ; set; }
  
  /// <summary>
  /// Revision Identifier for Paragraph Deletion
  /// </summary>
  public DocumentModel.IHexBinaryValue? RsidParagraphDeletion { get ; set; }
  
  /// <summary>
  /// Revision Identifier for Paragraph Properties
  /// </summary>
  public DocumentModel.IHexBinaryValue? RsidParagraphProperties { get ; set; }
  
  /// <summary>
  /// Default Revision Identifier for Runs
  /// </summary>
  public DocumentModel.IHexBinaryValue? RsidRunAdditionDefault { get ; set; }
  ...
  /// </summary>
  public System.Boolean? NoSpellError { get ; set; }
  
  /// <summary>
  /// Paragraph Properties.
  /// </summary>
  public DocumentModel.Wordprocessing.IParagraphProperties? ParagraphProperties { get ; set; }
  
  public DocumentModel.Wordprocessing.ICustomXmlRun? CustomXmlRun { get ; set; }
  
  public System.Collections.ObjectModel.Collection<DocumentModel.Wordprocessing.ISimpleField>? SimpleFields { get ; set; }
  
  public DocumentModel.Wordprocessing.IHyperlink? Hyperlink { get ; set; }
  ...
  public DocumentModel.Wordprocessing.IRelationshipType? SubDocumentReference { get ; set; }
