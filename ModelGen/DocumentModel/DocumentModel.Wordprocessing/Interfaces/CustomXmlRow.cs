...
/// </summary>
public interface CustomXmlRow // : DocumentModel.Wordprocessing.CustomXmlElement
{
  public CustomXmlProperties? CustomXmlProperties { get ; set; }
  
  public Collection<TableRow>? TableRows { get ; set; }
  
  public Collection<CustomXmlRow>? CustomXmlRows { get ; set; }
  
  public Collection<SdtRow>? SdtRows { get ; set; }
