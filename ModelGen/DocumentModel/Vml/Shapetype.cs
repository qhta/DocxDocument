...
///   Shape Template.
/// </summary>
public partial class Shapetype: ModelElement<DXV.Shapetype>
{
  public Shapetype(): base(){ }
  
  public Shapetype(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Shapetype(DXV.Shapetype openXmlElement): base(openXmlElement) { }
  ...
  public String? Adjustment
  {
    get
    {
      return StringValueConverter.GetValue(_Element?.Adjustment);
    }
    set
    {
      _ExistingElement.Adjustment = StringValueConverter.CreateStringValue(value);
    }
  }
  ...
  public String? EdgePath
  {
    get
    {
      return StringValueConverter.GetValue(_Element?.EdgePath);
    }
    set
    {
      _ExistingElement.EdgePath = StringValueConverter.CreateStringValue(value);
    }
  }
  ...
  public String? Master
  {
    get
    {
      return StringValueConverter.GetValue(_Element?.Master);
    }
    set
    {
      _ExistingElement.Master = StringValueConverter.CreateStringValue(value);
    }
  }
  
  [DataMember]
  public DMVML.Complex? Complex
  {
    get
    {
      var element = _Element?.GetFirstChild<DXVO.Complex>();
      if (element != null)
        return ComplexConverter.CreateModelElement(element);
      return null;
    }
    set
    {
      var itemElement = _ExistingElement.GetFirstChild<DXVO.Complex>();
      if (itemElement != null)
        itemElement.Remove();
      if (value != null)
      {
        itemElement = ComplexConverter.CreateOpenXmlElement<DXVO.Complex>(value);
        if (itemElement != null)
