...
public partial class Shape: ModelElement<DXV.Shape>
{
  ...
  public DM.Base64Binary? EncodedPackage
  {
    get
    {
      if (_Element?.EncodedPackage?.Value != null)
        return Convert.FromBase64String(_ExistingElement.EncodedPackage.Value);
      return null;
    }
    set
    {
      if (value != null)
        _ExistingElement.EncodedPackage = Convert.ToBase64String(value);
      else
        _ExistingElement.EncodedPackage = null;
    }
  }
  ...
  public String? EquationXml
  {
    get
    {
      return StringValueConverter.GetValue(_Element?.EquationXml);
    }
    set
    {
      _ExistingElement.EquationXml = StringValueConverter.CreateStringValue(value);
    }
  }
