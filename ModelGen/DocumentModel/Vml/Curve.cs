...
///   Bezier Curve.
/// </summary>
public partial class Curve: ModelElement<DXV.Curve>
{
  public Curve(): base(){ }
  
  public Curve(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Curve(DXV.Curve openXmlElement): base(openXmlElement) { }
  ...
  public String? Control1
  {
    get
    {
      return StringValueConverter.GetValue(_Element?.Control1);
    }
    set
    {
      _ExistingElement.Control1 = StringValueConverter.CreateStringValue(value);
    }
  }
  ...
  public String? Control2
  {
    get
    {
      return StringValueConverter.GetValue(_Element?.Control2);
    }
    set
    {
      _ExistingElement.Control2 = StringValueConverter.CreateStringValue(value);
    }
  }
