...
public partial class Stroke
{
  ...
  /// </summary>
  [SchemaAttr("filltype")]
  public DocumentModel.Vml.StrokeFillTypeValues? FillType { get; set; }
  ...
  ///   LeftStroke.
  /// </summary>
  public DocumentModel.Vml.Office.StrokeChildType? LeftStroke { get; set; }
  
  
  /// <summary>
  ///   TopStroke.
  /// </summary>
  public DocumentModel.Vml.Office.StrokeChildType? TopStroke { get; set; }
  
  
  /// <summary>
  ///   RightStroke.
  /// </summary>
  public DocumentModel.Vml.Office.StrokeChildType? RightStroke { get; set; }
  
  
  /// <summary>
  ///   BottomStroke.
  /// </summary>
  public DocumentModel.Vml.Office.StrokeChildType? BottomStroke { get; set; }
  
  
  /// <summary>
  ///   ColumnStroke.
  /// </summary>
  public DocumentModel.Vml.Office.StrokeChildType? ColumnStroke { get; set; }
