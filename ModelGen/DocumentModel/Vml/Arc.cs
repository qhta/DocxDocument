...
///   Arc Segment.
/// </summary>
public partial class Arc: ModelElement<DXV.Arc>
{
  public Arc(): base(){ }
  
  public Arc(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Arc(DXV.Arc openXmlElement): base(openXmlElement) { }
