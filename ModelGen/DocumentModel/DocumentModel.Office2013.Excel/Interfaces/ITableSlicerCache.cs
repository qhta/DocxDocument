...
public interface ITableSlicerCache // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  ...
  /// </summary>
  public TabularSlicerCacheSortOrderValues? SortOrder { get ; set; }
  ...
  /// </summary>
  public SlicerCacheCrossFilterValues? CrossFilter { get ; set; }
