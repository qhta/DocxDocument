...
public interface ICategoryFilterException // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// UniqueIdChartUniqueID.
  /// </summary>
  public IUniqueIdChartUniqueID? UniqueIdChartUniqueID { get ; set; }
  
  /// <summary>
  /// ShapeProperties.
  /// </summary>
  public DocumentModel.Office2016.Drawing.Charts.IShapeProperties? ShapeProperties { get ; set; }
  
  /// <summary>
  /// UnsignedIntegerType.
  /// </summary>
  public DocumentModel.Office2016.Drawing.Charts.IUnsignedIntegerType? UnsignedIntegerType { get ; set; }
  
  /// <summary>
  /// InvertIfNegativeBoolean.
  /// </summary>
  public DocumentModel.Office2016.Drawing.Charts.IInvertIfNegativeBoolean? InvertIfNegativeBoolean { get ; set; }
  
  /// <summary>
  /// Bubble3DBoolean.
  /// </summary>
  public IBubble3DBoolean? Bubble3DBoolean { get ; set; }
  
  /// <summary>
  /// Marker.
  /// </summary>
  public DocumentModel.Office2016.Drawing.Charts.IMarker? Marker { get ; set; }
  
  /// <summary>
  /// DLbl.
  /// </summary>
  public IDLbl? DLbl { get ; set; }
