...
public interface IWebImageSupportingRichData // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// AddressWebImageSupportingRichDataRelationship.
  /// </summary>
  public IAddressWebImageSupportingRichDataRelationship? AddressWebImageSupportingRichDataRelationship { get ; set; }
  
  /// <summary>
  /// MoreImagesAddressWebImageSupportingRichDataRelationship.
  /// </summary>
  public IMoreImagesAddressWebImageSupportingRichDataRelationship? MoreImagesAddressWebImageSupportingRichDataRelationship { get ; set; }
  
  /// <summary>
  /// BlipWebImageSupportingRichDataRelationship.
  /// </summary>
  public IBlipWebImageSupportingRichDataRelationship? BlipWebImageSupportingRichDataRelationship { get ; set; }
