...
public interface DataLabels
{
  ...
  public Collection<DocumentModel.Drawings16.Charts.DataLabel>? Items { get ; set; }
  
  public Collection<DocumentModel.Drawings16.Charts.DataLabelHidden>? DataLabelHiddens { get ; set; }
