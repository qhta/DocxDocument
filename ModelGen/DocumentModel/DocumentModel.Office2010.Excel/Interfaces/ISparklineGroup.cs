...
public interface ISparklineGroup // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  ...
  /// </summary>
  public SparklineTypeValues? Type { get ; set; }
  ...
  /// </summary>
  public DocumentModel.Office2010.Excel.DisplayBlanksAsValues? DisplayEmptyCellsAs { get ; set; }
  ...
  /// </summary>
  public SparklineAxisMinMaxValues? MinAxisType { get ; set; }
  
  /// <summary>
  /// maxAxisType, this property is only available in Office 2010 and later.
  /// </summary>
  public SparklineAxisMinMaxValues? MaxAxisType { get ; set; }
