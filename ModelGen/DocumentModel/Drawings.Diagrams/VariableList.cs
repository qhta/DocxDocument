...
///   Variable List.
/// </summary>
public partial class VariableList: ModelElement<DXDDD.VariableList>
{
  public VariableList(): base(){ }
  
  public VariableList(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public VariableList(DXDDD.VariableList openXmlElement): base(openXmlElement) { }
