...
/// Multiple Path Line.
/// </summary>
public interface PolyLine // : DocumentModel.BaseTypes.ModelElement
{
  /// <summary>
  /// Unique Identifier
  /// </summary>
  ...
  public Collection<DocumentModel.Spreadsheet.Vml.ClientData>? ClientDatas { get ; set; }
  
  public Collection<DocumentModel.Presentation.Vml.TextData>? TextDatas { get ; set; }
  
  public Collection<Ink>? Inks { get ; set; }
