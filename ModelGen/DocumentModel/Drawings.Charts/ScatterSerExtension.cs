...
/// </summary>
public partial class ScatterSerExtension: ModelElement<DXDC.ScatterSerExtension>
{
  public ScatterSerExtension(): base(){ }
  
  public ScatterSerExtension(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public ScatterSerExtension(DXDC.ScatterSerExtension openXmlElement): base(openXmlElement) { }
