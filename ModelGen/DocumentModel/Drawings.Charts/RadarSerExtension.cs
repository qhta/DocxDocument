...
/// </summary>
public partial class RadarSerExtension: ModelElement<DXDC.RadarSerExtension>
{
  public RadarSerExtension(): base(){ }
  
  public RadarSerExtension(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public RadarSerExtension(DXDC.RadarSerExtension openXmlElement): base(openXmlElement) { }
