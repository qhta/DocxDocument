...
/// </summary>
public partial class Menu: ModelElement<DXOCUI.Menu>
{
  public Menu(): base(){ }
  
  public Menu(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public Menu(DXOCUI.Menu openXmlElement): base(openXmlElement) { }
