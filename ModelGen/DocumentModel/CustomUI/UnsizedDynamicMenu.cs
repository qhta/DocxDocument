...
/// </summary>
public partial class UnsizedDynamicMenu: ModelElement<DXOCUI.UnsizedDynamicMenu>
{
  public UnsizedDynamicMenu(): base(){ }
  
  public UnsizedDynamicMenu(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public UnsizedDynamicMenu(DXOCUI.UnsizedDynamicMenu openXmlElement): base(openXmlElement) { }
