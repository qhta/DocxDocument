...
/// </summary>
public partial class UnsizedControlClone: ModelElement<DXOCUI.UnsizedControlClone>
{
  public UnsizedControlClone(): base(){ }
  
  public UnsizedControlClone(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public UnsizedControlClone(DXOCUI.UnsizedControlClone openXmlElement): base(openXmlElement) { }
