...
/// </summary>
public partial class MenuWithTitle: ModelElement<DXOCUI.MenuWithTitle>
{
  public MenuWithTitle(): base(){ }
  
  public MenuWithTitle(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public MenuWithTitle(DXOCUI.MenuWithTitle openXmlElement): base(openXmlElement) { }
