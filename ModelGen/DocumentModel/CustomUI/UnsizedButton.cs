...
/// </summary>
public partial class UnsizedButton: ModelElement<DXOCUI.UnsizedButton>
{
  public UnsizedButton(): base(){ }
  
  public UnsizedButton(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public UnsizedButton(DXOCUI.UnsizedButton openXmlElement): base(openXmlElement) { }
