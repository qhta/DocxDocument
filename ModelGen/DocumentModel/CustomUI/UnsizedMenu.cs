...
/// </summary>
public partial class UnsizedMenu: ModelElement<DXOCUI.UnsizedMenu>
{
  public UnsizedMenu(): base(){ }
  
  public UnsizedMenu(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public UnsizedMenu(DXOCUI.UnsizedMenu openXmlElement): base(openXmlElement) { }
