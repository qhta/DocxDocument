...
/// </summary>
public partial class VisibleButton: ModelElement<DXOCUI.VisibleButton>
{
  public VisibleButton(): base(){ }
  
  public VisibleButton(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public VisibleButton(DXOCUI.VisibleButton openXmlElement): base(openXmlElement) { }
