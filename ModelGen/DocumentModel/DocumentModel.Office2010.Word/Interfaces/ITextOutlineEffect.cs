...
public interface ITextOutlineEffect // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  ...
  /// </summary>
  public DocumentModel.Office2010.Word.LineCapValues? CapType { get ; set; }
  
  /// <summary>
  /// cmpd, this property is only available in Office 2010 and later.
  /// </summary>
  public DocumentModel.Office2010.Word.CompoundLineValues? Compound { get ; set; }
  
  /// <summary>
  /// algn, this property is only available in Office 2010 and later.
  /// </summary>
  public DocumentModel.Office2010.Word.PenAlignmentValues? Alignment { get ; set; }
