...
public interface ITaskHistoryEvent // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  ...
  /// </summary>
  public DocumentModel.Office.PowerPoint.Y2021.M06.Main.IAtrbtnTaskAssignUnassignUser? AtrbtnTaskAssignUnassignUser { get ; set; }
  
  /// <summary>
  /// TaskAnchor.
  /// </summary>
  public DocumentModel.Office.PowerPoint.Y2021.M06.Main.ITaskAnchor? TaskAnchor { get ; set; }
