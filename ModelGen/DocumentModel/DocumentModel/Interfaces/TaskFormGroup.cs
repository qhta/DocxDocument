...
/// </summary>
public partial interface TaskFormGroup
{
  /// <summary>
  ...
  /// </summary>
  public DocumentModel.TaskSizesKind? AllowedTaskSizes { get; set; }
  
  public Collection<DocumentModel.TaskFormGroupCategory>? TaskFormGroupCategories { get; set; }
