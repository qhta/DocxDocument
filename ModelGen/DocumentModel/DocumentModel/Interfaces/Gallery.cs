...
/// </summary>
public partial interface Gallery
{
  /// <summary>
  /// size, this property is only available in Office 2010 and later.
  /// </summary>
  public DocumentModel.SizeKind? Size { get; set; }
  ...
  /// </summary>
  public DocumentModel.GalleryShowInRibbonKind? ShowInRibbon { get; set; }
  ...
  public Collection<DocumentModel.Item>? Items { get; set; }
  
  public Collection<DocumentModel.ButtonRegular>? ButtonRegulars { get; set; }
