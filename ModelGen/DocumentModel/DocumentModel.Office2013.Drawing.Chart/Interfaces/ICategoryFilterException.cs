...
public interface ICategoryFilterException // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  ...
  /// Explosion.
  /// </summary>
  public DocumentModel.Office2013.Drawing.Chart.IExplosion? Explosion { get ; set; }
  
  /// <summary>
  /// InvertIfNegativeBoolean.
  /// </summary>
  public DocumentModel.Office2013.Drawing.Chart.IInvertIfNegativeBoolean? InvertIfNegativeBoolean { get ; set; }
  
  /// <summary>
  /// Bubble3D.
  /// </summary>
  public DocumentModel.Office2013.Drawing.Chart.IBubble3D? Bubble3D { get ; set; }
