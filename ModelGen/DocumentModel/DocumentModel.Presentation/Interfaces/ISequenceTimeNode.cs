...
public interface ISequenceTimeNode // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Concurrent
  /// </summary>
  ...
  /// Previous Action
  /// </summary>
  public PreviousActionValues? PreviousAction { get ; set; }
  
  /// <summary>
  /// Next Action
  /// </summary>
  public NextActionValues? NextAction { get ; set; }
