...
/// </summary>
public partial class BackstageRegularButton: ModelElement<DXO10CUI.BackstageRegularButton>
{
  public BackstageRegularButton(): base(){ }
  
  public BackstageRegularButton(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public BackstageRegularButton(DXO10CUI.BackstageRegularButton openXmlElement): base(openXmlElement) { }
  ...
  public Boolean? IsDefinitive
  {
    get
    {
      return _Element?.IsDefinitive?.Value;
    }
    set
    {
      if (value != null)
