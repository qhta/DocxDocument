...
public partial class TaskGroupTask: ModelElement<DXO10CUI.TaskGroupTask>
{
  ...
  public TaskGroupTask(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public TaskGroupTask(DXO10CUI.TaskGroupTask openXmlElement): base(openXmlElement) { }
