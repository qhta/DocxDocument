...
public partial class TaskFormGroupTask: ModelElement<DXO10CUI.TaskFormGroupTask>
{
  ...
  public TaskFormGroupTask(DX.OpenXmlElement openXmlElement): base(openXmlElement) { }
  
  public TaskFormGroupTask(DXO10CUI.TaskFormGroupTask openXmlElement): base(openXmlElement) { }
