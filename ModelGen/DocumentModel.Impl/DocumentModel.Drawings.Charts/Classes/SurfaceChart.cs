...
public class SurfaceChartImpl: ModelElementImpl, SurfaceChart
{
  ...
  public DocumentModel.Drawings.Charts.SurfaceChartExtensionList? SurfaceChartExtensionList
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.SurfaceChartExtensionList>();
        if (item != null)
          return new DocumentModel.Drawings.Charts.SurfaceChartExtensionListImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Drawings.Charts.SurfaceChartExtensionListImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
