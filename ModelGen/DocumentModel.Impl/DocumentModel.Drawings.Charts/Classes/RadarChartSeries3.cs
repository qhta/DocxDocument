...
/// </summary>
public class RadarChartSeries3Impl: ModelElementImpl, RadarChartSeries3
{
  ...
  public RadarChartSeries3Impl(DocumentFormat.OpenXml.Office2013.Drawing.Chart.RadarChartSeries openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Drawings.Charts.RadarSerExtensionList? RadarSerExtensionList
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.RadarSerExtensionList>();
        if (item != null)
          return new DocumentModel.Drawings.Charts.RadarSerExtensionListImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Drawings.Charts.RadarSerExtensionListImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
