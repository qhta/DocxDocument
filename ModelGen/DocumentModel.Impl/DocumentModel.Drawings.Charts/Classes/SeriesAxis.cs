...
public partial class SeriesAxisImpl: ModelElementImpl, SeriesAxis
{
  ...
  public DocumentModel.Drawings.Charts.SerAxExtensionList? SerAxExtensionList
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.SerAxExtensionList>();
        if (item != null)
          return new DocumentModel.Drawings.Charts.SerAxExtensionListImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Drawings.Charts.SerAxExtensionListImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
