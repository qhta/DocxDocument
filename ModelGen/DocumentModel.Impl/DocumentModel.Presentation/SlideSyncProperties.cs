...
public class SlideSyncProperties: ISlideSyncProperties
{
  /// <summary>
  /// Server's Slide File ID
  /// </summary>
  public string? ServerSlideId
  {
    get;
    set;
  }
  ...
  /// </summary>
  public DateTime? ServerSlideModifiedTime
  {
    get;
    set;
  }
  ...
  /// </summary>
  public DateTime? ClientInsertedTime
  {
    get;
    set;
  }
