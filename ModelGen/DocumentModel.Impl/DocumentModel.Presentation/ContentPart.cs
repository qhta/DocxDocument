...
public class ContentPart: IContentPart
{
  ...
  /// </summary>
  public BlackWhiteModeValues? BwMode
  {
    get;
    set;
  }
  ...
  /// </summary>
  public DocumentModel.Office2010.PowerPoint.INonVisualContentPartProperties? NonVisualContentPartProperties
  {
    get;
    set;
  }
  ...
  /// Transform2D.
  /// </summary>
  public DocumentModel.Office2010.PowerPoint.ITransform2D? Transform2D
  {
    get;
    set;
  }
  ...
  /// ExtensionListModify.
  /// </summary>
  public IExtensionListModify? ExtensionListModify
  {
    get;
    set;
  }
