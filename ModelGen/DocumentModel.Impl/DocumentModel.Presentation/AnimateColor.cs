...
public class AnimateColor: IAnimateColor
{
  /// <summary>
  /// Color Space
  /// </summary>
  public AnimateColorSpaceValues? ColorSpace
  {
    get;
    set;
  }
  ...
  /// Direction
  /// </summary>
  public AnimateColorDirectionValues? Direction
  {
    get;
    set;
  }
