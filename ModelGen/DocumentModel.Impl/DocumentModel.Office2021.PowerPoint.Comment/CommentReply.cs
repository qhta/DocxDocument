...
public class CommentReply: ICommentReply
{
  ...
  /// TextBodyType.
  /// </summary>
  public DocumentModel.Office2021.PowerPoint.Comment.ITextBodyType? TextBodyType
  {
    get;
    set;
  }
  ...
  /// ExtensionList.
  /// </summary>
  public DocumentModel.Office2021.PowerPoint.Comment.IExtensionList? ExtensionList
  {
    get;
    set;
  }
