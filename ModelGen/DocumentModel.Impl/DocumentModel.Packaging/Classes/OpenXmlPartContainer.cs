...
public class OpenXmlPartContainerImpl: ModelObjectImpl, OpenXmlPartContainer
{
  ...
  /// </summary>
  public DocumentModel.Packaging.ReferenceRelationship? ExternalRelationships
  {
  ...
  /// </summary>
  public DocumentModel.Packaging.HyperlinkRelationship? HyperlinkRelationships
  {
    get => throw new NotImplementedException("Method not implemented");
    set => throw new NotImplementedException("Method not implemented");
  }
  ...
  /// </summary>
  public DocumentModel.Packaging.ReferenceRelationship? DataPartReferenceRelationships
  {
    get => throw new NotImplementedException("Method not implemented");
    set => throw new NotImplementedException("Method not implemented");
  }
  ...
  /// </summary>
  public DocumentModel.Packaging.IdPartPair? Parts
  {
    get => throw new NotImplementedException("Method not implemented");
    set => throw new NotImplementedException("Method not implemented");
  }
