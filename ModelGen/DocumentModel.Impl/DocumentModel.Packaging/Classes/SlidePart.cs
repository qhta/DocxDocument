...
public class SlidePartImpl: DocumentModel.Packaging.OpenXmlPartImpl, SlidePart
{
  ...
  public Collection<DocumentModel.Packaging.PowerPointCommentPart>? commentParts
  {
    ...
    set
    {
      if (value != null && value != _commentParts && OpenXmlElement!=null)
      {
      ...
      if (value is ObservableCollection<DocumentModel.Packaging.PowerPointCommentPart> observableCollection)
        _commentParts = observableCollection;
      else if (value != null)
        _commentParts = new ObservableCollection<DocumentModel.Packaging.PowerPointCommentPart>(value);
      else
       _commentParts = null;
    }
  }
