...
/// </summary>
public partial class NotesSlidePartImpl: DocumentModel.Packaging.OpenXmlPartImpl, NotesSlidePart
{
  [XmlIgnore]
  ...
  /// </summary>
  public DocumentModel.Packaging.NotesMasterPart? NotesMasterPart
  {
    get
    {
      if (OpenXmlElement?.NotesMasterPart != null)
        return new DocumentModel.Packaging.NotesMasterPartImpl(OpenXmlElement.NotesMasterPart);
      return null;
    }
  }
