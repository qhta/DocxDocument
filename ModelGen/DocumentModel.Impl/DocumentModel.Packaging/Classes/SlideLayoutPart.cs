...
/// </summary>
public partial class SlideLayoutPartImpl: DocumentModel.Packaging.OpenXmlPartImpl, SlideLayoutPart
{
  [XmlIgnore]
  ...
  /// </summary>
  public DocumentModel.Packaging.SlideMasterPart? SlideMasterPart
  {
    get
    {
      if (OpenXmlElement?.SlideMasterPart != null)
        return new DocumentModel.Packaging.SlideMasterPartImpl(OpenXmlElement.SlideMasterPart);
      return null;
    }
  }
