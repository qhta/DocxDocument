...
public class StyleDisplayCategoriesImpl: ModelElementImpl, StyleDisplayCategories
{
  ...
  public Collection<DocumentModel.Drawings.Diagrams.StyleDisplayCategory>? Items
  {
    get
    {
      if (_Items != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Drawing.Diagrams.StyleDisplayCategory>()
            .Select(item => new DocumentModel.Drawings.Diagrams.StyleDisplayCategoryImpl(item)).ToList();
          _Items = new ObservableCollection<DocumentModel.Drawings.Diagrams.StyleDisplayCategory>(items);
        }
        else
          _Items = new ObservableCollection<DocumentModel.Drawings.Diagrams.StyleDisplayCategory>();
    ...
    set
    {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings.Diagrams.StyleDisplayCategory> observableCollection)
        _Items = observableCollection;
      else if (value != null)
        _Items = new ObservableCollection<DocumentModel.Drawings.Diagrams.StyleDisplayCategory>(value);
      else
       _Items = null;
    }
  }
