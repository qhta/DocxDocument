...
public class WordprocessingShape: IWordprocessingShape
{
  /// <summary>
  ...
  /// </summary>
  public DocumentModel.Office2010.Word.DrawingShape.INonVisualDrawingProperties? NonVisualDrawingProperties
  {
    get;
    set;
  }
