...
public class ColorTransformCategoriesImpl: ModelElementImpl, ColorTransformCategories
{
  ...
  public Collection<DocumentModel.Drawings.ColorTransformCategory>? Items
  {
    get
    {
      if (_Items != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Drawing.Diagrams.ColorTransformCategory>()
            .Select(item => new DocumentModel.Drawings.ColorTransformCategoryImpl(item)).ToList();
          _Items = new ObservableCollection<DocumentModel.Drawings.ColorTransformCategory>(items);
        }
        else
          _Items = new ObservableCollection<DocumentModel.Drawings.ColorTransformCategory>();
    ...
    set
    {
      if (value != null && value != _Items && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings.ColorTransformCategoryImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings.ColorTransformCategory> observableCollection)
        _Items = observableCollection;
      else if (value != null)
        _Items = new ObservableCollection<DocumentModel.Drawings.ColorTransformCategory>(value);
      else
       _Items = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings.ColorTransformCategory>? _Items;
