...
/// System Color.
/// </summary>
public class SystemColorImpl: ModelElementImpl, SystemColor
{
  ...
  public SystemColorImpl(DocumentFormat.OpenXml.Drawing.SystemColor openXmlElement): base(openXmlElement)
  {
  ...
  /// Value
  /// </summary>
  public DocumentModel.Drawings.SystemColorKind? Val
  {
    get => (DocumentModel.Drawings.SystemColorKind?)OpenXmlElement?.Val?.Value;
    set
    {
  ...
  /// Last Color
  /// </summary>
  public DocumentModel.HexBinary? LastColor
  {
    get
    {
      if (OpenXmlElement?.LastColor?.Value != null)
        return (DocumentModel.HexBinary)OpenXmlElement.LastColor.Value;
      return null;
    }
    set
    {
      ...
      {
        if (value != null)
          OpenXmlElement.LastColor = new DocumentFormat.OpenXml.HexBinaryValue{ Value = value.ToString() };
        else
