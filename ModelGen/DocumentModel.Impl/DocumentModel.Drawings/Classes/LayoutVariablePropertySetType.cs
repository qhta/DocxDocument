...
public class LayoutVariablePropertySetTypeImpl: ModelElementImpl, LayoutVariablePropertySetType
{
  ...
  /// Diagram Direction.
  /// </summary>
  public virtual DocumentModel.Drawings.DirectionKind? Direction
  {
    get => (DocumentModel.Drawings.DirectionKind?)OpenXmlElement?.Direction?.Val?.Value;
    set
    {
      if (OpenXmlElement != null)
      {
  ...
  /// </summary>
  public virtual DocumentModel.Drawings.HierarchyBranchStyleKind? HierarchyBranch
  {
    get => (DocumentModel.Drawings.HierarchyBranchStyleKind?)OpenXmlElement?.HierarchyBranch?.Val?.Value;
    set
    {
      if (OpenXmlElement != null)
      {
  ...
  /// </summary>
  public virtual DocumentModel.Drawings.AnimateOneByOneKind? AnimateOneByOne
  {
    get => (DocumentModel.Drawings.AnimateOneByOneKind?)OpenXmlElement?.AnimateOneByOne?.Val?.Value;
    set
    {
      if (OpenXmlElement != null)
      {
  ...
  /// Level Animation.
  /// </summary>
  public virtual DocumentModel.Drawings.AnimationLevelStringKind? AnimationLevel
  {
    get => (DocumentModel.Drawings.AnimationLevelStringKind?)OpenXmlElement?.AnimationLevel?.Val?.Value;
    set
    {
      if (OpenXmlElement != null)
      {
  ...
  /// Shape Resize Style.
  /// </summary>
  public virtual DocumentModel.Drawings.ResizeHandlesStringKind? ResizeHandles
  {
    get => (DocumentModel.Drawings.ResizeHandlesStringKind?)OpenXmlElement?.ResizeHandles?.Val?.Value;
    set
    {
      if (OpenXmlElement != null)
      {
