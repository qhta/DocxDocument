...
public class ColorsTypeImpl: ModelElementImpl, ColorsType
{
  ...
  /// </summary>
  public DocumentModel.Drawings.ColorApplicationMethodKind? Method
  {
    get => (DocumentModel.Drawings.ColorApplicationMethodKind?)OpenXmlElement?.Method?.Value;
    set
    {
  ...
  /// Hue Direction
  /// </summary>
  public DocumentModel.Drawings.HueDirectionKind? HueDirection
  {
    get => (DocumentModel.Drawings.HueDirectionKind?)OpenXmlElement?.HueDirection?.Value;
    set
    {
      if (OpenXmlElement != null)
