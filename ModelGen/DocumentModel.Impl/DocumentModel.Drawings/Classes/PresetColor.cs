...
public class PresetColorImpl: ModelElementImpl, PresetColor
{
  ...
  public PresetColorImpl(DocumentFormat.OpenXml.Drawing.PresetColor openXmlElement): base(openXmlElement)
  {
  ...
  /// Value
  /// </summary>
  public DocumentModel.Drawings.PresetColorKind? Val
  {
    get => (DocumentModel.Drawings.PresetColorKind?)OpenXmlElement?.Val?.Value;
    set
    {
