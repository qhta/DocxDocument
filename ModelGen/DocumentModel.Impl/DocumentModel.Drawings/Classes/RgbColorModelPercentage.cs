...
public partial class RgbColorModelPercentageImpl: ModelElementImpl, RgbColorModelPercentage
{
  ...
  public RgbColorModelPercentageImpl(DocumentFormat.OpenXml.Drawing.RgbColorModelPercentage openXmlElement): base(openXmlElement)
  {
  ...
  {
    get => (System.Int32?)OpenXmlElement?.RedPortion?.Value;
    set
    {
  ...
  {
    get => (System.Int32?)OpenXmlElement?.GreenPortion?.Value;
    set
    {
      if (OpenXmlElement != null)
  ...
  {
    get => (System.Int32?)OpenXmlElement?.BluePortion?.Value;
    set
    {
      if (OpenXmlElement != null)
