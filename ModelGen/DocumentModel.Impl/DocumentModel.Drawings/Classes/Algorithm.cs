...
public class AlgorithmImpl: ModelElementImpl, Algorithm
{
  ...
  /// Algorithm Type
  /// </summary>
  public DocumentModel.Drawings.AlgorithmKind? Type
  {
    get => (DocumentModel.Drawings.AlgorithmKind?)OpenXmlElement?.Type?.Value;
    set
    {
  ...
  public Collection<DocumentModel.Drawings.Parameter>? Parameters
  {
    get
    {
      if (_Parameters != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Drawing.Diagrams.Parameter>()
            .Select(item => new DocumentModel.Drawings.ParameterImpl(item)).ToList();
          _Parameters = new ObservableCollection<DocumentModel.Drawings.Parameter>(items);
        }
        else
          _Parameters = new ObservableCollection<DocumentModel.Drawings.Parameter>();
    ...
    set
    {
      if (value != null && value != _Parameters && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings.ParameterImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings.Parameter> observableCollection)
        _Parameters = observableCollection;
      else if (value != null)
        _Parameters = new ObservableCollection<DocumentModel.Drawings.Parameter>(value);
      else
       _Parameters = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings.Parameter>? _Parameters;
