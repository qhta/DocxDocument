...
/// </summary>
public partial class HslColorImpl: ModelElementImpl, HslColor
{
  ...
  public HslColorImpl(): base() {}
  
  public HslColorImpl(DocumentFormat.OpenXml.Drawing.HslColor openXmlElement): base(openXmlElement)
  {
  ...
  {
    get => (System.Int32?)OpenXmlElement?.HueValue?.Value;
    set
    {
  ...
  {
    get => (System.Int32?)OpenXmlElement?.SatValue?.Value;
    set
    {
      if (OpenXmlElement != null)
  ...
  {
    get => (System.Int32?)OpenXmlElement?.LumValue?.Value;
    set
    {
      if (OpenXmlElement != null)
