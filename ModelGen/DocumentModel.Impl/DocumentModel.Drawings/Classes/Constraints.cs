...
public class ConstraintsImpl: ModelElementImpl, Constraints
{
  ...
  public Collection<DocumentModel.Drawings.Constraint>? Items
  {
    get
    {
      if (_Items != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Drawing.Diagrams.Constraint>()
            .Select(item => new DocumentModel.Drawings.ConstraintImpl(item)).ToList();
          _Items = new ObservableCollection<DocumentModel.Drawings.Constraint>(items);
        }
        else
          _Items = new ObservableCollection<DocumentModel.Drawings.Constraint>();
    ...
    set
    {
      if (value != null && value != _Items && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings.ConstraintImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings.Constraint> observableCollection)
        _Items = observableCollection;
      else if (value != null)
        _Items = new ObservableCollection<DocumentModel.Drawings.Constraint>(value);
      else
       _Items = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings.Constraint>? _Items;
