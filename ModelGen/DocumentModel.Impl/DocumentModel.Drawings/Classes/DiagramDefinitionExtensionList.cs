...
public class DiagramDefinitionExtensionListImpl: ModelElementImpl, DiagramDefinitionExtensionList
{
  ...
  public Collection<DocumentModel.Drawings.DiagramDefinitionExtension>? DiagramDefinitionExtensions
  {
    get
    {
      if (_DiagramDefinitionExtensions != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Drawing.Diagrams.DiagramDefinitionExtension>()
            .Select(item => new DocumentModel.Drawings.DiagramDefinitionExtensionImpl(item)).ToList();
          _DiagramDefinitionExtensions = new ObservableCollection<DocumentModel.Drawings.DiagramDefinitionExtension>(items);
        }
        else
          _DiagramDefinitionExtensions = new ObservableCollection<DocumentModel.Drawings.DiagramDefinitionExtension>();
    ...
    set
    {
      if (value != null && value != _DiagramDefinitionExtensions && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings.DiagramDefinitionExtensionImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings.DiagramDefinitionExtension> observableCollection)
        _DiagramDefinitionExtensions = observableCollection;
      else if (value != null)
        _DiagramDefinitionExtensions = new ObservableCollection<DocumentModel.Drawings.DiagramDefinitionExtension>(value);
      else
       _DiagramDefinitionExtensions = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings.DiagramDefinitionExtension>? _DiagramDefinitionExtensions;
