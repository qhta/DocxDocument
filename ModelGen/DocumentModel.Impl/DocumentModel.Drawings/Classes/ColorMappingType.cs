...
/// </summary>
public class ColorMappingTypeImpl: ModelElementImpl, ColorMappingType
{
  ...
  public ColorMappingTypeImpl(DocumentFormat.OpenXml.Drawing.ColorMappingType openXmlElement): base(openXmlElement)
  {
