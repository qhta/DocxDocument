...
public partial class SchemeColorImpl: ModelElementImpl, SchemeColor
{
  ...
  {
    get => (DocumentFormat.OpenXml.Drawing.SchemeColor?)_OpenXmlElement;
    set => _OpenXmlElement = value;
  }
  
  public SchemeColorImpl(): base() {}
  
  public SchemeColorImpl(DocumentFormat.OpenXml.Drawing.SchemeColor openXmlElement): base(openXmlElement)
  {
  ...
  /// Value
  /// </summary>
  public DocumentModel.Drawings.SchemeColorKind? Val
  {
    get => (DocumentModel.Drawings.SchemeColorKind?)OpenXmlElement?.Val?.Value;
    set
    {
