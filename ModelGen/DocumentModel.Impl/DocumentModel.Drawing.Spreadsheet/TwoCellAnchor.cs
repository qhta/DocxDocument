...
public class TwoCellAnchor: ITwoCellAnchor
{
  /// <summary>
  /// Positioning and Resizing Behaviors
  /// </summary>
  public DocumentModel.Drawing.Spreadsheet.EditAsValues? EditAs
  {
    get;
    set;
  }
  ...
  /// Ending Anchor Point.
  /// </summary>
  public DocumentModel.Drawing.Spreadsheet.IToMarker? ToMarker
  {
    get;
    set;
  }
