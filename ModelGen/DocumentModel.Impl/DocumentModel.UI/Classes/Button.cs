...
{
  public DocumentFormat.OpenXml.Office.CustomUI.Button? OpenXmlElement
  {
    get => (DocumentFormat.OpenXml.Office.CustomUI.Button?)_OpenXmlElement;
    set => _OpenXmlElement = value;
  }
  
  public ButtonImpl(): base() {}
  
  public ButtonImpl(DocumentFormat.OpenXml.Office.CustomUI.Button openXmlElement): base(openXmlElement)
  {
