...
public partial class UnsizedMenuImpl: ModelElementImpl, UnsizedMenu
{
  ...
  public UnsizedMenuImpl(DocumentFormat.OpenXml.Office.CustomUI.UnsizedMenu openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.UI.UnsizedMenu? ChildUnsizedMenu
  {
    get
    {
      if (OpenXmlElement != null)
