...
public class OvalImpl: ModelElementImpl, Oval
{
  ...
  {
    get => (DocumentFormat.OpenXml.Vml.Oval?)_OpenXmlElement;
    set => _OpenXmlElement = value;
  }
  
  public OvalImpl(): base() {}
  
  public OvalImpl(DocumentFormat.OpenXml.Vml.Oval openXmlElement): base(openXmlElement)
  {
