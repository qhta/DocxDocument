...
public class PolyLineImpl: ModelElementImpl, PolyLine
{
  ...
  public PolyLineImpl(DocumentFormat.OpenXml.Vml.PolyLine openXmlElement): base(openXmlElement)
  {
  ...
  {
    get => (System.String?)OpenXmlElement?.Points?.Value;
    set
    {
      if (OpenXmlElement != null)
        OpenXmlElement.Points = (System.String?)value;
    }
  }
