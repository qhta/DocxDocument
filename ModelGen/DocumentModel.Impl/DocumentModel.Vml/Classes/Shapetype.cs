...
public partial class ShapetypeImpl: ModelElementImpl, Shapetype
{
  ...
  public ShapetypeImpl(DocumentFormat.OpenXml.Vml.Shapetype openXmlElement): base(openXmlElement)
  {
  ...
  {
    get => (System.String?)OpenXmlElement?.Master?.Value;
    set
    {
      if (OpenXmlElement != null)
        OpenXmlElement.Master = (System.String?)value;
    }
  }
  ...
  public DocumentModel.Vml.Complex? Complex
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Vml.Office.Complex>();
        if (item != null)
          return new DocumentModel.Vml.ComplexImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Vml.ComplexImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
