...
public partial class ArcImpl: ModelElementImpl, Arc
{
  ...
  public ArcImpl(DocumentFormat.OpenXml.Vml.Arc openXmlElement): base(openXmlElement)
  {
  ...
  {
    get => (System.String?)OpenXmlElement?.Wrapcoords?.Value;
    set
    {
      if (OpenXmlElement != null)
  ...
  {
    get => (System.Decimal?)OpenXmlElement?.StartAngle?.Value;
    set
    {
      if (OpenXmlElement != null)
  ...
  {
    get => (System.Decimal?)OpenXmlElement?.EndAngle?.Value;
    set
    {
      if (OpenXmlElement != null)
