...
public class LineImpl: ModelElementImpl, Line
{
  ...
  public LineImpl(DocumentFormat.OpenXml.Vml.Line openXmlElement): base(openXmlElement)
  {
  ...
  public String? From
  {
    get => (String?)OpenXmlElement?.From?.Value;
    set
    {
      if (OpenXmlElement != null)
  ...
  public String? To
  {
    get => (String?)OpenXmlElement?.To?.Value;
    set
    {
      if (OpenXmlElement != null)
