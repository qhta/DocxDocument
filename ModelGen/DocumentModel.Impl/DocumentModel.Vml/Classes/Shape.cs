...
public partial class ShapeImpl: ModelElementImpl, Shape
{
  ...
  /// Encoded Package
  /// </summary>
  public DocumentModel.Base64Binary? EncodedPackage
  {
    get
    {
      if (OpenXmlElement?.EncodedPackage?.Value != null)
        return (DocumentModel.Base64Binary)OpenXmlElement.EncodedPackage.Value;
      return null;
    }
    set
    {
      ...
      {
        if (value != null)
          OpenXmlElement.EncodedPackage = new DocumentFormat.OpenXml.Base64BinaryValue{ Value = value.ToString() };
        else
  ...
  public DocumentModel.Vml.Ink? Ink
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Vml.Office.Ink>();
        if (item != null)
          return new DocumentModel.Vml.InkImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Vml.InkImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
