...
public class TaskHistoryEvent: ITaskHistoryEvent
{
  ...
  /// </summary>
  public DocumentModel.Office2021.PowerPoint.Tasks.IAtrbtnTaskAssignUnassignUser? AtrbtnTaskAssignUnassignUser
  {
    get;
    set;
  }
  ...
  /// TaskAnchor.
  /// </summary>
  public DocumentModel.Office2021.PowerPoint.Tasks.ITaskAnchor? TaskAnchor
  {
    get;
    set;
  }
