...
public partial class ParagraphImpl: ModelElementImpl, Paragraph
{
  ...
  /// </summary>
  public DocumentModel.Math.ParagraphProperties? ParagraphProperties
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Math.ParagraphProperties>();
        if (item != null)
          return new DocumentModel.Math.ParagraphPropertiesImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        {
          item = (value as DocumentModel.Math.ParagraphPropertiesImpl)?.OpenXmlElement;
          if (item != null)
