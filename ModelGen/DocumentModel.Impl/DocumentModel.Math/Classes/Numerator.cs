...
/// Numerator.
/// </summary>
public partial class NumeratorImpl: DocumentModel.Math.OfficeMathArgumentTypeImpl, Numerator
{
  [XmlIgnore]
  ...
  public NumeratorImpl(): base() {}
  
  public NumeratorImpl(DocumentFormat.OpenXml.Math.Numerator openXmlElement): base(openXmlElement)
  {
