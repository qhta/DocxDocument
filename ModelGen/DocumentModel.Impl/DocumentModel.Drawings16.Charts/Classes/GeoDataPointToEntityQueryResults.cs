...
public class GeoDataPointToEntityQueryResultsImpl: ModelElementImpl, GeoDataPointToEntityQueryResults
{
  ...
  public Collection<DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResult>? Items
  {
    get
    {
      if (_Items != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.GeoDataPointToEntityQueryResult>()
            .Select(item => new DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResultImpl(item)).ToList();
          _Items = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResult>(items);
        }
        else
          _Items = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResult>();
    ...
    set
    {
      if (value != null && value != _Items && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResultImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResult> observableCollection)
        _Items = observableCollection;
      else if (value != null)
        _Items = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResult>(value);
      else
       _Items = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings16.Charts.GeoDataPointToEntityQueryResult>? _Items;
