...
public class ParentLabelLayoutImpl: ModelElementImpl, ParentLabelLayout
{
  ...
  /// </summary>
  public DocumentModel.Drawings16.Charts.ParentLabelLayoutVal? ParentLabelLayoutVal
  {
    get => (DocumentModel.Drawings16.Charts.ParentLabelLayoutVal?)OpenXmlElement?.ParentLabelLayoutVal?.Value;
    set
    {
