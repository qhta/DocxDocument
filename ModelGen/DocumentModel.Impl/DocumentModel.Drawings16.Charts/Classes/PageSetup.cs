...
public class PageSetupImpl: ModelElementImpl, PageSetup
{
  ...
  /// </summary>
  public DocumentModel.Drawings16.Charts.PageOrientation? Orientation
  {
    get => (DocumentModel.Drawings16.Charts.PageOrientation?)OpenXmlElement?.Orientation?.Value;
    set
    {
      if (OpenXmlElement != null)
