...
public class ExtensionListImpl: ModelElementImpl, ExtensionList
{
  ...
  public Collection<DocumentModel.Drawings16.Charts.Extension2>? Extension2s
  {
    get
    {
      if (_Extension2s != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.Extension2>()
            .Select(item => new DocumentModel.Drawings16.Charts.Extension2Impl(item)).ToList();
          _Extension2s = new ObservableCollection<DocumentModel.Drawings16.Charts.Extension2>(items);
        }
        else
          _Extension2s = new ObservableCollection<DocumentModel.Drawings16.Charts.Extension2>();
    ...
    set
    {
      if (value != null && value != _Extension2s && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings16.Charts.Extension2Impl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings16.Charts.Extension2> observableCollection)
        _Extension2s = observableCollection;
      else if (value != null)
        _Extension2s = new ObservableCollection<DocumentModel.Drawings16.Charts.Extension2>(value);
      else
       _Extension2s = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings16.Charts.Extension2>? _Extension2s;
