...
public class GeographyImpl: ModelElementImpl, Geography
{
  ...
  /// </summary>
  public DocumentModel.Drawings16.Charts.GeoProjectionType? ProjectionType
  {
    get => (DocumentModel.Drawings16.Charts.GeoProjectionType?)OpenXmlElement?.ProjectionType?.Value;
    set
    {
  ...
  /// </summary>
  public DocumentModel.Drawings16.Charts.GeoMappingLevel? ViewedRegionType
  {
    get => (DocumentModel.Drawings16.Charts.GeoMappingLevel?)OpenXmlElement?.ViewedRegionType?.Value;
    set
    {
      if (OpenXmlElement != null)
  ...
  /// GeoCache.
  /// </summary>
  public DocumentModel.Drawings16.Charts.GeoCache? GeoCache
  {
