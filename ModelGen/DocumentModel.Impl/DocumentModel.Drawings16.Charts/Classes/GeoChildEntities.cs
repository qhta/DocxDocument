...
public class GeoChildEntitiesImpl: ModelElementImpl, GeoChildEntities
{
  ...
  public Collection<DocumentModel.Drawings16.Charts.GeoHierarchyEntity>? GeoHierarchyEntities
  {
    get
    {
      if (_GeoHierarchyEntities != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.GeoHierarchyEntity>()
            .Select(item => new DocumentModel.Drawings16.Charts.GeoHierarchyEntityImpl(item)).ToList();
          _GeoHierarchyEntities = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoHierarchyEntity>(items);
        }
        else
          _GeoHierarchyEntities = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoHierarchyEntity>();
    ...
    set
    {
      if (value != null && value != _GeoHierarchyEntities && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings16.Charts.GeoHierarchyEntityImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings16.Charts.GeoHierarchyEntity> observableCollection)
        _GeoHierarchyEntities = observableCollection;
      else if (value != null)
        _GeoHierarchyEntities = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoHierarchyEntity>(value);
      else
       _GeoHierarchyEntities = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings16.Charts.GeoHierarchyEntity>? _GeoHierarchyEntities;
