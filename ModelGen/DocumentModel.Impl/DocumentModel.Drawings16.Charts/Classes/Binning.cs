...
public class BinningImpl: ModelElementImpl, Binning
{
  ...
  /// </summary>
  public DocumentModel.Drawings16.Charts.IntervalClosedSide? IntervalClosed
  {
    get => (DocumentModel.Drawings16.Charts.IntervalClosedSide?)OpenXmlElement?.IntervalClosed?.Value;
    set
    {
