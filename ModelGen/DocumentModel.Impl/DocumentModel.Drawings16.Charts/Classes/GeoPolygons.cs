...
public class GeoPolygonsImpl: ModelElementImpl, GeoPolygons
{
  ...
  public Collection<DocumentModel.Drawings16.Charts.GeoPolygon>? Items
  {
    get
    {
      if (_Items != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.GeoPolygon>()
            .Select(item => new DocumentModel.Drawings16.Charts.GeoPolygonImpl(item)).ToList();
          _Items = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoPolygon>(items);
        }
        else
          _Items = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoPolygon>();
    ...
    set
    {
      if (value != null && value != _Items && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings16.Charts.GeoPolygonImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings16.Charts.GeoPolygon> observableCollection)
        _Items = observableCollection;
      else if (value != null)
        _Items = new ObservableCollection<DocumentModel.Drawings16.Charts.GeoPolygon>(value);
      else
       _Items = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings16.Charts.GeoPolygon>? _Items;
