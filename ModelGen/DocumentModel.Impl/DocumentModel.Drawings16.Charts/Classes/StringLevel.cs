...
public class StringLevelImpl: ModelElementImpl, StringLevel
{
  ...
  public Collection<DocumentModel.Drawings16.Charts.ChartStringValue>? ChartStringValues
  {
    get
    {
      if (_ChartStringValues != null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.ChartStringValue>()
            .Select(item => new DocumentModel.Drawings16.Charts.ChartStringValueImpl(item)).ToList();
          _ChartStringValues = new ObservableCollection<DocumentModel.Drawings16.Charts.ChartStringValue>(items);
        }
        else
          _ChartStringValues = new ObservableCollection<DocumentModel.Drawings16.Charts.ChartStringValue>();
    ...
    set
    {
      if (value != null && value != _ChartStringValues && OpenXmlElement!=null)
      {
        ...
        {
        if (val is DocumentModel.Drawings16.Charts.ChartStringValueImpl valImpl)
        {
      ...
      if (value is ObservableCollection<DocumentModel.Drawings16.Charts.ChartStringValue> observableCollection)
        _ChartStringValues = observableCollection;
      else if (value != null)
        _ChartStringValues = new ObservableCollection<DocumentModel.Drawings16.Charts.ChartStringValue>(value);
      else
       _ChartStringValues = null;
    }
  }
  private ObservableCollection<DocumentModel.Drawings16.Charts.ChartStringValue>? _ChartStringValues;
