...
public class PathShadeProperties: IPathShadeProperties
{
  /// <summary>
  /// path, this property is only available in Office 2010 and later.
  /// </summary>
  public PathShadeTypeValues? Path
  {
    get;
    set;
  }
  ...
  /// FillToRectangle.
  /// </summary>
  public DocumentModel.Office2010.Word.IFillToRectangle? FillToRectangle
  {
    get;
    set;
  }
