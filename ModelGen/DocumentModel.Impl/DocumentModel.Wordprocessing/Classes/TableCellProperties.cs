...
/// </summary>
public partial class TableCellPropertiesImpl: ModelElementImpl, TableCellProperties
{
  [XmlIgnore]
  ...
  public DocumentModel.Wordprocessing.TableCellPropertiesChange? TableCellPropertiesChange
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.TableCellPropertiesChange>();
        if (item != null)
          return new DocumentModel.Wordprocessing.TableCellPropertiesChangeImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.TableCellPropertiesChangeImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
