...
public partial class SdtBlockImpl: DocumentModel.Wordprocessing.SdtElementImpl, SdtBlock
{
  ...
  public DocumentModel.Wordprocessing.SdtContentBlock? SdtContentBlock
  {
    get
    {
      ...
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.SdtContentBlock>();
        if (item != null)
          return new DocumentModel.Wordprocessing.SdtContentBlockImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        {
          item = (value as DocumentModel.Wordprocessing.SdtContentBlockImpl)?.OpenXmlElement;
          if (item != null)
