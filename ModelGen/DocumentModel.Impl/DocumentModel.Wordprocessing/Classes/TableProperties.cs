...
public partial class TablePropertiesImpl: ModelElementImpl, TableProperties
{
  ...
  /// </summary>
  public DocumentModel.Wordprocessing.TablePropertiesChange? TablePropertiesChange
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.TablePropertiesChange>();
        if (item != null)
          return new DocumentModel.Wordprocessing.TablePropertiesChangeImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.TablePropertiesChangeImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
