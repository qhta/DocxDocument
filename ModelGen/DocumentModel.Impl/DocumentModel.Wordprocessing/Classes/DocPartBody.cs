...
/// </summary>
public class DocPartBodyImpl: ModelElementImpl, DocPartBody
{
  ...
  public DocPartBodyImpl(DocumentFormat.OpenXml.Wordprocessing.DocPartBody openXmlElement): base(openXmlElement)
  {
