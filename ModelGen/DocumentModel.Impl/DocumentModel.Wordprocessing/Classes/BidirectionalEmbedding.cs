...
/// </summary>
public class BidirectionalEmbeddingImpl: ModelElementImpl, BidirectionalEmbedding
{
  ...
  public BidirectionalEmbeddingImpl(DocumentFormat.OpenXml.Wordprocessing.BidirectionalEmbedding openXmlElement): base(openXmlElement)
  {
  ...
  /// val
  /// </summary>
  public DocumentModel.Wordprocessing.DirectionKind? Val
  {
    get => (DocumentModel.Wordprocessing.DirectionKind?)OpenXmlElement?.Val?.Value;
    set
    {
  ...
  public DocumentModel.Wordprocessing.BidirectionalEmbedding? ChildBidirectionalEmbedding
  {
    get
    {
      if (OpenXmlElement != null)
