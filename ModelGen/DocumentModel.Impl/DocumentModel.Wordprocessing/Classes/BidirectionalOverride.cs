...
/// </summary>
public class BidirectionalOverrideImpl: ModelElementImpl, BidirectionalOverride
{
  ...
  public BidirectionalOverrideImpl(DocumentFormat.OpenXml.Wordprocessing.BidirectionalOverride openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.BidirectionalOverride? ChildBidirectionalOverride
  {
    get
    {
      if (OpenXmlElement != null)
