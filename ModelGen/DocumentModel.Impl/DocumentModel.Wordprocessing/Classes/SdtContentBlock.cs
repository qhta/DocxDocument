...
/// </summary>
public class SdtContentBlockImpl: ModelElementImpl, SdtContentBlock
{
  ...
  public SdtContentBlockImpl(DocumentFormat.OpenXml.Wordprocessing.SdtContentBlock openXmlElement): base(openXmlElement)
  {
