...
public class CustomXmlRowImpl: DocumentModel.Wordprocessing.CustomXmlElementImpl, CustomXmlRow
{
  ...
  public CustomXmlRowImpl(DocumentFormat.OpenXml.Wordprocessing.CustomXmlRow openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.CustomXmlRow? ChildCustomXmlRow
  {
    get
    {
      if (OpenXmlElement != null)
