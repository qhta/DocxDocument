...
/// </summary>
public class RunConflictDeletionImpl: DocumentModel.Wordprocessing.RunTrackChangeType2Impl, RunConflictDeletion
{
  ...
  public RunConflictDeletionImpl(DocumentFormat.OpenXml.Office2010.Word.RunConflictDeletion openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.RunConflictDeletion? ChildRunConflictDeletion
  {
    get => throw new NotImplementedException("Method not implemented");
    set => throw new NotImplementedException("Method not implemented");
  }
