...
/// </summary>
public class NumberingSymbolRunPropertiesImpl: ModelElement<DocumentFormat.OpenXml.Wordprocessing.NumberingSymbolRunProperties>, NumberingSymbolRunProperties
{
  /// <summary>
  /// RunFonts.
  /// </summary>
