...
public partial class ParagraphPropertiesImpl: ModelElementImpl, ParagraphProperties
{
  ...
  public ParagraphPropertiesImpl(DocumentFormat.OpenXml.Wordprocessing.ParagraphProperties openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.ParagraphMarkRunProperties? ParagraphMarkRunProperties
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.ParagraphMarkRunProperties>();
        if (item != null)
          return new DocumentModel.Wordprocessing.ParagraphMarkRunPropertiesImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.ParagraphMarkRunPropertiesImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
  ...
  public DocumentModel.Wordprocessing.SectionProperties? SectionProperties
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.SectionProperties>();
        if (item != null)
          return new DocumentModel.Wordprocessing.SectionPropertiesImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.SectionPropertiesImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
  ...
  public DocumentModel.Wordprocessing.ParagraphPropertiesChange? ParagraphPropertiesChange
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.ParagraphPropertiesChange>();
        if (item != null)
          return new DocumentModel.Wordprocessing.ParagraphPropertiesChangeImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.ParagraphPropertiesChangeImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
