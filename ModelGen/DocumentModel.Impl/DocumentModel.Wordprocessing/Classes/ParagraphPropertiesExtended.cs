...
/// </summary>
public class ParagraphPropertiesExtendedImpl: ModelElement<DocumentFormat.OpenXml.Wordprocessing.ParagraphPropertiesExtended>, ParagraphPropertiesExtended
{
  /// <summary>
  /// FrameProperties.
  /// </summary>
