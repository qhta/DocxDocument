...
/// </summary>
public class RunConflictInsertionImpl: DocumentModel.Wordprocessing.RunTrackChangeType2Impl, RunConflictInsertion
{
  ...
  public RunConflictInsertionImpl(DocumentFormat.OpenXml.Office2010.Word.RunConflictInsertion openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.RunConflictInsertion? ChildRunConflictInsertion
  {
    get
    {
      if (OpenXmlElement != null)
