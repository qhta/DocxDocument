...
/// </summary>
public class ParagraphPropertiesBaseStyleImpl: ModelElement<DocumentFormat.OpenXml.Wordprocessing.ParagraphPropertiesBaseStyle>, ParagraphPropertiesBaseStyle
{
  /// <summary>
  /// FrameProperties.
  /// </summary>
