...
public partial class SdtRowImpl: DocumentModel.Wordprocessing.SdtElementImpl, SdtRow
{
  ...
  public DocumentModel.Wordprocessing.SdtContentRow? SdtContentRow
  {
    get
    {
      ...
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.SdtContentRow>();
        if (item != null)
          return new DocumentModel.Wordprocessing.SdtContentRowImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        {
          item = (value as DocumentModel.Wordprocessing.SdtContentRowImpl)?.OpenXmlElement;
          if (item != null)
