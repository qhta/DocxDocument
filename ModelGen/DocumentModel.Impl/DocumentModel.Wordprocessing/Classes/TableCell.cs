...
public partial class TableCellImpl: ModelElementImpl, TableCell
{
  ...
  public DocumentModel.Wordprocessing.TableCellProperties? TableCellProperties
  {
    get
    {
      ...
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.TableCellProperties>();
        if (item != null)
          return new DocumentModel.Wordprocessing.TableCellPropertiesImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        {
          item = (value as DocumentModel.Wordprocessing.TableCellPropertiesImpl)?.OpenXmlElement;
          if (item != null)
