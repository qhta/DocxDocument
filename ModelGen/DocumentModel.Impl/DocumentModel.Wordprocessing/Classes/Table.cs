...
/// </summary>
public partial class TableImpl: ModelElementImpl, Table
{
  [XmlIgnore]
  ...
  public DocumentModel.Wordprocessing.TableProperties? TableProperties
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.TableProperties>();
        if (item != null)
          return new DocumentModel.Wordprocessing.TablePropertiesImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.TablePropertiesImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
  ...
  public DocumentModel.Wordprocessing.TableGrid? TableGrid
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.TableGrid>();
        if (item != null)
          return new DocumentModel.Wordprocessing.TableGridImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        if (value is not null)
        {
          item = (value as DocumentModel.Wordprocessing.TableGridImpl)?.OpenXmlElement;
          if (item != null)
            OpenXmlElement.AddChild(item);
        }
      }
