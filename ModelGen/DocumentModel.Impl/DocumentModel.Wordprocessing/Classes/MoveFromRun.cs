...
/// </summary>
public class MoveFromRunImpl: DocumentModel.Wordprocessing.RunTrackChangeTypeImpl, MoveFromRun
{
  ...
  public MoveFromRunImpl(DocumentFormat.OpenXml.Wordprocessing.MoveFromRun openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.MoveFromRun? ChildMoveFromRun
  {
    get
    {
      if (OpenXmlElement != null)
