...
/// </summary>
public class ParagraphMarkRunPropertiesChangeImpl: ModelElement<DocumentFormat.OpenXml.Wordprocessing.ParagraphMarkRunPropertiesChange>, ParagraphMarkRunPropertiesChange
{
  /// <summary>
