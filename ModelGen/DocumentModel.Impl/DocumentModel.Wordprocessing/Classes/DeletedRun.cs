...
/// Deleted Run Content.
/// </summary>
public class DeletedRunImpl: DocumentModel.Wordprocessing.RunTrackChangeTypeImpl, DeletedRun
{
  ...
  public DeletedRunImpl(DocumentFormat.OpenXml.Wordprocessing.DeletedRun openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.DeletedRun? ChildDeletedRun
  {
    get
    {
      if (OpenXmlElement != null)
