...
/// </summary>
public class InsertedRunImpl: DocumentModel.Wordprocessing.RunTrackChangeTypeImpl, InsertedRun
{
  ...
  public InsertedRunImpl(DocumentFormat.OpenXml.Wordprocessing.InsertedRun openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Wordprocessing.InsertedRun? ChildInsertedRun
  {
    get => throw new NotImplementedException("Method not implemented");
    set => throw new NotImplementedException("Method not implemented");
  }
