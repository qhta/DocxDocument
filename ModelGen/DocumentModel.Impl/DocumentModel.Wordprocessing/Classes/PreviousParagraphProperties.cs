...
/// </summary>
public class PreviousParagraphPropertiesImpl: ModelElement<DocumentFormat.OpenXml.Wordprocessing.PreviousParagraphProperties>, PreviousParagraphProperties
{
  /// <summary>
  /// FrameProperties.
  /// </summary>
