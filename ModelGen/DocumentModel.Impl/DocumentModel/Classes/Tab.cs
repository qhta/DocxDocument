...
/// </summary>
public partial class TabImpl: ModelElementImpl, Tab
{
  public DocumentFormat.OpenXml.Office2010.CustomUI.Tab? OpenXmlElement
  {
    get => (DocumentFormat.OpenXml.Office2010.CustomUI.Tab?)_OpenXmlElement;
    set => _OpenXmlElement = value;
  }
  
  public TabImpl(): base() {}
  
  public TabImpl(DocumentFormat.OpenXml.Office2010.CustomUI.Tab openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.Group? Group
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2010.CustomUI.Group>();
        if (item != null)
          return new DocumentModel.GroupImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        {
          item = (value as DocumentModel.GroupImpl)?.OpenXmlElement;
          if (item != null)
