...
/// </summary>
public partial class TaskFormGroupTaskImpl: ModelElementImpl, TaskFormGroupTask
{
  [XmlIgnore]
  public DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupTask? OpenXmlElement
  {
    get => (DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupTask?)_OpenXmlElement;
    protected set => _OpenXmlElement = value;
  }
  
  public TaskFormGroupTaskImpl(): base() {}
  
  public TaskFormGroupTaskImpl(DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupTask openXmlElement): base(openXmlElement)
  {
  ...
  public Collection<DocumentModel.BackstageGroup>? BackstageGroups
  {
    get
    {
      if (_BackstageGroups == null)
      {
        if (OpenXmlElement != null)
        {
          var items = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageGroup>()
            .Select(item => new DocumentModel.BackstageGroupImpl(item)).ToList();
          _BackstageGroups = new ObservableCollection<DocumentModel.BackstageGroup>(items);
        }
        else
          _BackstageGroups = new ObservableCollection<DocumentModel.BackstageGroup>();
        _BackstageGroups.CollectionChanged += _BackstageGroups_CollectionChanged;
      }
      return _BackstageGroups;
    }
    set
    {
      if (value != null && value != _BackstageGroups && OpenXmlElement!=null)
      {
        OpenXmlElement.RemoveAllChildren<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageGroup>();
        foreach (var val in value)
        {
          if (val is DocumentModel.BackstageGroupImpl valImpl)
          {
      ...
      if (value is ObservableCollection<DocumentModel.BackstageGroup> observableCollection)
        _BackstageGroups = observableCollection;
      else if (value != null)
        _BackstageGroups = new ObservableCollection<DocumentModel.BackstageGroup>(value);
      else
       _BackstageGroups = null;
    }
  }
  private ObservableCollection<DocumentModel.BackstageGroup>? _BackstageGroups;
  
  private void _BackstageGroups_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs args)
  {
    if (OpenXmlElement != null)
    {
      switch (args.Action)
      {
        ...
        case NotifyCollectionChangedAction.Remove:
          ...
          foreach (var val in args.OldItems)
          {
              if (val is DocumentModel.BackstageGroupImpl valImpl)
              {
                  var oldItem = OpenXmlElement.Elements<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageGroup>()
