...
public partial class HyperlinkImpl: ModelElementImpl, Hyperlink
{
  ...
  public HyperlinkImpl(DocumentFormat.OpenXml.Office2010.CustomUI.Hyperlink openXmlElement): base(openXmlElement)
  {
  ...
  {
    get => (System.String?)OpenXmlElement?.GetTarget?.Value;
    set
    {
      if (OpenXmlElement != null)
        OpenXmlElement.GetTarget = (System.String?)value;
    }
  }
