...
/// </summary>
public partial class BackstageSubMenuImpl: ModelElementImpl, BackstageSubMenu
{
  public DocumentFormat.OpenXml.Office2010.CustomUI.BackstageSubMenu? OpenXmlElement
  {
    get => (DocumentFormat.OpenXml.Office2010.CustomUI.BackstageSubMenu?)_OpenXmlElement;
    set => _OpenXmlElement = value;
  }
  
  public BackstageSubMenuImpl(): base() {}
  
  public BackstageSubMenuImpl(DocumentFormat.OpenXml.Office2010.CustomUI.BackstageSubMenu openXmlElement): base(openXmlElement)
  {
  ...
  public DocumentModel.BackstageMenuGroup? BackstageMenuGroup
  {
    get
    {
      if (OpenXmlElement != null)
      {
        var item = OpenXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageMenuGroup>();
        if (item != null)
          return new DocumentModel.BackstageMenuGroupImpl(item);
      }
      return null;
    }
    set
    {
      if (OpenXmlElement != null)
      {
        ...
        {
          item = (value as DocumentModel.BackstageMenuGroupImpl)?.OpenXmlElement;
          if (item != null)
