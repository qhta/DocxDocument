...
/// </summary>
public partial class LayoutContainerImpl: ModelElementImpl, LayoutContainer
{
  public DocumentFormat.OpenXml.Office2010.CustomUI.LayoutContainer? OpenXmlElement
  {
    get => (DocumentFormat.OpenXml.Office2010.CustomUI.LayoutContainer?)_OpenXmlElement;
    set => _OpenXmlElement = value;
  }
  
  public LayoutContainerImpl(): base() {}
  
  public LayoutContainerImpl(DocumentFormat.OpenXml.Office2010.CustomUI.LayoutContainer openXmlElement): base(openXmlElement)
  {
  ...
  /// </summary>
  public DocumentModel.ExpandKind? Align
  {
    get => (DocumentModel.ExpandKind?)OpenXmlElement?.Align?.Value;
    set
    {
      if (OpenXmlElement != null)
        OpenXmlElement.Align = (DocumentFormat.OpenXml.Office2010.CustomUI.ExpandValues?)value;
    }
  }
  ...
  /// </summary>
  public DocumentModel.LayoutChildrenKind? LayoutChildren
  {
    get => (DocumentModel.LayoutChildrenKind?)OpenXmlElement?.LayoutChildren?.Value;
    set
    {
      if (OpenXmlElement != null)
        OpenXmlElement.LayoutChildren = (DocumentFormat.OpenXml.Office2010.CustomUI.LayoutChildrenValues?)value;
    }
  }
  ...
  public DocumentModel.LayoutContainer? ChildLayoutContainer
  {
    get
    {
      if (OpenXmlElement != null)
