...
public class HorizontalPositionImpl: ModelElementImpl, HorizontalPosition
{
  ...
  /// </summary>
  public DocumentModel.Wordprocessing.Drawings.HorizontalRelativePositionKind? RelativeFrom
  {
    get => (DocumentModel.Wordprocessing.Drawings.HorizontalRelativePositionKind?)OpenXmlElement?.RelativeFrom?.Value;
    set
    {
