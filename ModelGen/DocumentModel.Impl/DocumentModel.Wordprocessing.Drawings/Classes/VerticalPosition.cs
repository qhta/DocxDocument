...
public class VerticalPositionImpl: ModelElementImpl, VerticalPosition
{
  ...
  /// </summary>
  public DocumentModel.Wordprocessing.Drawings.VerticalRelativePositionKind? RelativeFrom
  {
    get => (DocumentModel.Wordprocessing.Drawings.VerticalRelativePositionKind?)OpenXmlElement?.RelativeFrom?.Value;
    set
    {
