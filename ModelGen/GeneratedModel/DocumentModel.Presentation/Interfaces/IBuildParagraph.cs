...
public interface IBuildParagraph // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// Shape ID
  /// </summary>
  ...
  /// Build Types
  /// </summary>
  public ParagraphBuild? Build { get ; set; }
  
  /// <summary>
  /// Build Level
  /// </summary>
  public uint? BuildLevel { get ; set; }
  ...
  /// </summary>
  public bool? AutoAnimateBackground { get ; set; }
