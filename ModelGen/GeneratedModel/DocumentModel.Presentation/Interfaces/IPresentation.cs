...
public interface IPresentation // : DocumentFormat.OpenXml.TypedOpenXmlPartRootElement
{
  /// <summary>
  /// serverZoom
  /// </summary>
  public int? ServerZoom { get ; set; }
  ...
  /// </summary>
  public bool? ShowSpecialPlaceholderOnTitleSlide { get ; set; }
  ...
  /// bookmarkIdSeed
  /// </summary>
  public uint? BookmarkIdSeed { get ; set; }
  
  /// <summary>
  /// conformance
  /// </summary>
  public ConformanceClass? Conformance { get ; set; }
