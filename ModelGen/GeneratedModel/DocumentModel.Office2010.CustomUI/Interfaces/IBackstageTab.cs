...
/// </summary>
[ChildElementInfo(typeof(DocumentModel.Office2010.CustomUI.IBackstageGroups))]
[ChildElementInfo(typeof(DocumentModel.Office2010.CustomUI.ISimpleGroups))]
public interface IBackstageTab // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  ...
  /// </summary>
  public int? FirstColumnMinWidth { get ; set; }
  
  /// <summary>
  /// firstColumnMaxWidth, this property is only available in Office 2010 and later.
  /// </summary>
  public int? FirstColumnMaxWidth { get ; set; }
  
  /// <summary>
  /// secondColumnMinWidth, this property is only available in Office 2010 and later.
  /// </summary>
  public int? SecondColumnMinWidth { get ; set; }
  
  /// <summary>
  /// secondColumnMaxWidth, this property is only available in Office 2010 and later.
  /// </summary>
  public int? SecondColumnMaxWidth { get ; set; }
  
  /// <summary>
  /// BackstageGroups.
  /// </summary>
  public IBackstageGroups? BackstageGroups { get ; set; }
  
  /// <summary>
  /// SimpleGroups.
  /// </summary>
  public ISimpleGroups? SimpleGroups { get ; set; }
