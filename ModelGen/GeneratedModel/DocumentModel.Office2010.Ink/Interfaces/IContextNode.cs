...
public interface IContextNode // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  /// id
  /// </summary>
  ...
  /// rotatedBoundingBox
  /// </summary>
  public List<string>? RotatedBoundingBox { get ; set; }
  ...
  /// hotPoints
  /// </summary>
  public List<string>? HotPoints { get ; set; }
  ...
  /// shapeGeometry
  /// </summary>
  public List<string>? ShapeGeometry { get ; set; }
