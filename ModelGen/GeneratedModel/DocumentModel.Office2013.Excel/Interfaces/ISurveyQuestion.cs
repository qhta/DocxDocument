...
public interface ISurveyQuestion // : DocumentFormat.OpenXml.TypedOpenXmlCompositeElement
{
  /// <summary>
  ...
  /// </summary>
  public IQuestionPrSurveyElementPr? QuestionPrSurveyElementPr { get ; set; }
