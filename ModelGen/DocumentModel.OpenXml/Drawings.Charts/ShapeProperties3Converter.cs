...
public static class ShapeProperties3Converter
{
  ...
  /// </summary>
  private static DMDraws.BlackWhiteMode? GetBlackWhiteMode(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpBlackWhiteMode(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.BlackWhiteMode? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetBlackWhiteMode(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.BlackWhiteMode? value)
  {
  ...
  /// </summary>
  private static DMDraws.Transform2D? GetTransform2D(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpTransform2D(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Transform2D? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetTransform2D(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Transform2D? value)
  {
  ...
  private static DMDraws.CustomGeometry? GetCustomGeometry(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpCustomGeometry(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.CustomGeometry? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetCustomGeometry(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.CustomGeometry? value)
  {
  ...
  private static DMDraws.PresetGeometry? GetPresetGeometry(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpPresetGeometry(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.PresetGeometry? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetPresetGeometry(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.PresetGeometry? value)
  {
  ...
  private static Boolean? GetNoFill(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
    return openXmlElement.GetFirstChild<DXDraw.NoFill>() != null;
  }
  
  private static bool CmpNoFill(DXO2013DrawChart.ShapeProperties openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetNoFill(DXO2013DrawChart.ShapeProperties openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  private static DMDraws.SolidFill? GetSolidFill(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpSolidFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.SolidFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSolidFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.SolidFill? value)
  {
  ...
  private static DMDraws.GradientFill? GetGradientFill(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpGradientFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.GradientFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetGradientFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.GradientFill? value)
  {
  ...
  private static DMDraws.BlipFill? GetBlipFill(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpBlipFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.BlipFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetBlipFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.BlipFill? value)
  {
  ...
  private static DMDraws.PatternFill? GetPatternFill(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpPatternFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.PatternFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetPatternFill(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.PatternFill? value)
  {
  ...
  private static Boolean? GetGroupFill(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
    return openXmlElement.GetFirstChild<DXDraw.GroupFill>() != null;
  }
  
  private static bool CmpGroupFill(DXO2013DrawChart.ShapeProperties openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetGroupFill(DXO2013DrawChart.ShapeProperties openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  private static DMDraws.Outline? GetOutline(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpOutline(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Outline? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetOutline(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Outline? value)
  {
  ...
  private static DMDraws.EffectList? GetEffectList(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpEffectList(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.EffectList? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetEffectList(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.EffectList? value)
  {
  ...
  private static DMDraws.EffectDag? GetEffectDag(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpEffectDag(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.EffectDag? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetEffectDag(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.EffectDag? value)
  {
  ...
  private static DMDraws.Scene3DType? GetScene3DType(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpScene3DType(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Scene3DType? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetScene3DType(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Scene3DType? value)
  {
  ...
  private static DMDraws.Shape3DType? GetShape3DType(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpShape3DType(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Shape3DType? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetShape3DType(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.Shape3DType? value)
  {
  ...
  private static DMDraws.ShapePropertiesExtensionList? GetShapePropertiesExtensionList(DXO2013DrawChart.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpShapePropertiesExtensionList(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.ShapePropertiesExtensionList? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetShapePropertiesExtensionList(DXO2013DrawChart.ShapeProperties openXmlElement, DMDraws.ShapePropertiesExtensionList? value)
  {
  ...
  public static DocumentModel.Drawings.Charts.ShapeProperties3? CreateModelElement(DXO2013DrawChart.ShapeProperties? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO2013DrawChart.ShapeProperties? openXmlElement, DMDrawsCharts.ShapeProperties3? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDrawsCharts.ShapeProperties3 value)
    where OpenXmlElementType: DXO2013DrawChart.ShapeProperties, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO2013DrawChart.ShapeProperties openXmlElement, DMDrawsCharts.ShapeProperties3 value)
  {
