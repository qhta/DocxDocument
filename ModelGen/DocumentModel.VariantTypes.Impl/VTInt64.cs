...
/// </summary>
public class VTInt64Impl: ModelElement<DocumentFormat.OpenXml.TypedOpenXmlLeafTextElement>, VTInt64
{
  public VTInt64Impl()
  {
  ...
  public object ToType(Type conversionType, IFormatProvider? provider)
  {
    ...
    throw new InvalidOperationException($"Can't convert Int64 Variant to {conversionType} type");
  }
