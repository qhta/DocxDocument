...
/// Decimal.
/// </summary>
public class VTDecimalImpl: VariantImpl, VTDecimal
{
  public new DocumentFormat.OpenXml.VariantTypes.VTDecimal? OpenXmlElement
  {
    get => (DocumentFormat.OpenXml.VariantTypes.VTDecimal?)_OpenXmlElement;
