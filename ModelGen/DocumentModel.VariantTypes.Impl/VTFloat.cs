...
/// 4-Byte Real Number.
/// </summary>
public class VTFloatImpl: ModelElement<DocumentFormat.OpenXml.VariantTypes.VTFloat>, VTFloat
{
  public VTFloatImpl()
  {
  ...
  public object ToType(Type conversionType, IFormatProvider? provider)
  {
    ...
    throw new InvalidOperationException($"Can't convert Single Variant to {conversionType} type");
  }
