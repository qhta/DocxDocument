...
/// </summary>
public class VTUnsignedInt32Impl: ModelElement<DocumentFormat.OpenXml.TypedOpenXmlLeafTextElement>, VTUnsignedInt32
{
  ...
  public object ToType(Type conversionType, IFormatProvider? provider)
  {
    ...
    throw new InvalidOperationException($"Can't convert UInt32 Variant to {conversionType} type");
  }
