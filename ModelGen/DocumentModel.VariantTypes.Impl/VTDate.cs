...
/// </summary>
public class VTDateImpl : ModelElement<DocumentFormat.OpenXml.VariantTypes.VTDate>, VTDate
{
  public VTDateImpl()
  {
  ...
  public object ToType(Type conversionType, IFormatProvider? provider)
  {
    ...
    throw new InvalidOperationException($"Can't convert VTDate Variant to {conversionType} type");
  }
