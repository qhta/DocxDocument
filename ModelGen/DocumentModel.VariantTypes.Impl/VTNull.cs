...
/// </summary>
public class VTNullImpl: ModelElement<DocumentFormat.OpenXml.VariantTypes.VTNull>, VTNull
{
  public VTNullImpl()
  {
  ...
  public object ToType(Type conversionType, IFormatProvider? provider)
  {
    ...
    throw new InvalidOperationException($"Can't convert Null Variant to {conversionType} type");
  }
