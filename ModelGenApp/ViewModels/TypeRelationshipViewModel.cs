...
{
  public TypeRelationshipViewModel(PhaseResultsViewModel phase, TypeInfoViewModel? owner, TypeRelationship relationship, TNS nameKindSelector) : base(relationship)
  {
    Owner = owner;
    Phase = phase;
