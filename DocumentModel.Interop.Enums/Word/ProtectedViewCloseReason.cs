...
/// </remarks>
[WordInteropEnumType(typeof(Microsoft.Office.Interop.Word.WdProtectedViewCloseReason))]
public enum ProtectedViewCloseReason
{
  /// <summary>
  /// The window was closed normally.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdProtectedViewCloseReason.wdProtectedViewCloseNormal))]
  Normal = 0,
  /// <summary>
  /// The window was closed when the user clicked the Enable Editing or Edit Anyway button while in Protected View.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdProtectedViewCloseReason.wdProtectedViewCloseEdit))]
  Edit = 1,
  /// <summary>
  /// The window was closed because the application shut it down forcefully or it stopped responding.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdProtectedViewCloseReason.wdProtectedViewCloseForced))]
  Forced = 2
}
