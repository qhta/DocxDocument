...
/// </remarks>
[WordInteropEnumType("WdCompatibilityMode")]
public enum CompatibilityMode
{
  /// <summary>
  /// Specifies the compatibility mode that Word 2010 uses when opening a document.
  /// </summary>
  [WordInteropEnumValue("wdWord2003")]
  Word2003 = 11,
  /// <summary>
  /// Specifies the compatibility mode that Word 2010 uses when opening a document.
  /// </summary>
  [WordInteropEnumValue("wdWord2007")]
  Word2007 = 12,
  /// <summary>
  /// Specifies the compatibility mode that Word 2010 uses when opening a document.
  /// </summary>
  [WordInteropEnumValue("wdWord2010")]
  Word2010 = 14,
  /// <summary>
  /// Specifies the compatibility mode that Word 2010 uses when opening a document.
  /// </summary>
  [WordInteropEnumValue("wdWord2013")]
  Word2013 = 15,
  /// <summary>
  /// Compatibility mode equivalent to the latest version of Word.
  /// </summary>
  [WordInteropEnumValue("wdCurrent")]
  Current = 65535
}
