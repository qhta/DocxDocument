...
/// </remarks>
[WordInteropEnumType(typeof(Microsoft.Office.Interop.Word.WdFieldKind))]
public enum FieldKind
{
  /// <summary>
  /// An invalid field (for example, a pair of field characters with nothing inside).
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdFieldKind.wdFieldKindNone))]
  None = 0,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdFieldKind.wdFieldKindHot))]
  Hot = 1,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdFieldKind.wdFieldKindWarm))]
  Warm = 2,
  /// <summary>
  /// A field that doesn't have a result, for example, an Index Entry (XE), Table of Contents Entry (TC), or Private
  /// field.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdFieldKind.wdFieldKindCold))]
  Cold = 3
}
