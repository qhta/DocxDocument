...
/// </remarks>
[InteropEnumType("Microsoft.Office.Interop.Word.WdRelativeHorizontalSize")]
public enum RelativeHorizontalSize
{
  /// <summary>
  /// Width is relative to the space between the left margin and the right margin.
  /// </summary>
  [InteropEnumValue("wdRelativeHorizontalSizeMargin")]
  Margin = 0,
  /// <summary>
  /// Width is relative to the width of the page.
  /// </summary>
  [InteropEnumValue("wdRelativeHorizontalSizePage")]
  Page = 1,
  /// <summary>
  /// Width is relative to the size of the left margin.
  /// </summary>
  [InteropEnumValue("wdRelativeHorizontalSizeLeftMarginArea")]
  LeftMarginArea = 2,
  /// <summary>
  /// Width is relative to the width of the right margin.
  /// </summary>
  [InteropEnumValue("wdRelativeHorizontalSizeRightMarginArea")]
  RightMarginArea = 3,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("wdRelativeHorizontalSizeInnerMarginArea")]
  InnerMarginArea = 4,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("wdRelativeHorizontalSizeOuterMarginArea")]
  OuterMarginArea = 5
}
