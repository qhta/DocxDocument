...
/// </remarks>
[WordInteropEnumType(typeof(Microsoft.Office.Interop.Word.WdLockType))]
public enum LockType
{
  /// <summary>
  /// Reserved for future use.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdLockType.wdLockNone))]
  None = 0,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdLockType.wdLockReservation))]
  Reservation = 1,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdLockType.wdLockEphemeral))]
  Ephemeral = 2,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdLockType.wdLockChanged))]
  Changed = 3
}
