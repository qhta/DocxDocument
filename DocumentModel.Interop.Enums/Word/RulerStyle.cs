...
/// </remarks>
[WordInteropEnumType("WdRulerStyle")]
public enum RulerStyle
{
  ...
  /// </summary>
  [WordInteropEnumValue("wdAdjustNone")]
  None = 0,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue("wdAdjustSameWidth")]
  SameWidth = 3
}
