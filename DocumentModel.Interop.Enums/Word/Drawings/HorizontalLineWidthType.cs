...
/// </remarks>
[InteropEnumType("Microsoft.Office.Interop.Word.WdHorizontalLineWidthType")]
public enum HorizontalLineWidthType
{
  ...
  /// value.
  /// </summary>
  [InteropEnumValue("wdHorizontalLineFixedWidth")]
  FixedWidth = -2,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("wdHorizontalLinePercentWidth")]
  PercentWidth = -1
}
