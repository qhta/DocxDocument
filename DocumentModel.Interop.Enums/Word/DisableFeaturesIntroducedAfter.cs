...
/// </remarks>
[WordInteropEnumType(typeof(Microsoft.Office.Interop.Word.WdDisableFeaturesIntroducedAfter))]
public enum DisableFeaturesIntroducedAfter
{
  /// <summary>
  /// Specifies Word for Windows 95, versions 7.0 and 7.0a.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdDisableFeaturesIntroducedAfter.wd70))]
  Wd70 = 0,
  /// <summary>
  /// Specifies Word for Windows 95, versions 7.0 and 7.0a, Asian edition.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdDisableFeaturesIntroducedAfter.wd70FE))]
  Wd70FE = 1,
  /// <summary>
  /// Specifies Word 97 for Windows. Default.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdDisableFeaturesIntroducedAfter.wd80))]
  Wd80 = 2
}
