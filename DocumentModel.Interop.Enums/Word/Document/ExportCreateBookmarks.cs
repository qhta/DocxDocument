...
/// </remarks>
[InteropEnumType("Microsoft.Office.Interop.Word.WdExportCreateBookmarks")]
public enum ExportCreateBookmarks
{
  /// <summary>
  /// Do not create bookmarks in the exported document.
  /// </summary>
  [InteropEnumValue("wdExportCreateNoBookmarks")]
  NoBookmarks = 0,
  /// <summary>
  ...
  /// comments.
  /// </summary>
  [InteropEnumValue("wdExportCreateHeadingBookmarks")]
  HeadingBookmarks = 1,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("wdExportCreateWordBookmarks")]
  WordBookmarks = 2
}
