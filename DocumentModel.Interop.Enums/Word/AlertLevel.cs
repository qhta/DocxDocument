...
/// </remarks>
[WordInteropEnumType(typeof(Microsoft.Office.Interop.Word.WdAlertLevel))]
public enum AlertLevel
{
  ...
  /// the macro continues.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdAlertLevel.wdAlertsNone))]
  None = 0,
  /// <summary>
  /// Only message boxes are displayed; errors are trapped and returned to the macro.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdAlertLevel.wdAlertsMessageBox))]
  MessageBox = -2,
  /// <summary>
  /// All message boxes and alerts are displayed; errors are returned to the macro.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.WdAlertLevel.wdAlertsAll))]
  All = -1
}
