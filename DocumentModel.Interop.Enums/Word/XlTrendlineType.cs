...
/// </remarks>
[WordInteropEnumType(typeof(Microsoft.Office.Interop.Word.XlTrendlineType))]
public enum TrendlineType
{
  ...
  /// + ex^2 + fx + g.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.XlTrendlineType.xlPolynomial))]
  Polynomial = 3,
  /// <summary>
  /// Uses an equation to calculate the least squares fit through points, for example, y = ax^b.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.XlTrendlineType.xlPower))]
  Power = 4,
  /// <summary>
  /// Uses an equation to calculate the least squares fit through points, for example, y=ab^x .
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.XlTrendlineType.xlExponential))]
  Exponential = 5,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.XlTrendlineType.xlMovingAvg))]
  MovingAvg = 6,
  /// <summary>
  /// Uses the equation y = c ln x + b to calculate the least squares fit through points.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.XlTrendlineType.xlLogarithmic))]
  Logarithmic = -4133,
  /// <summary>
  /// Uses the linear equation y = mx + b to calculate the least squares fit through points.
  /// </summary>
  [WordInteropEnumValue(nameof(Microsoft.Office.Interop.Word.XlTrendlineType.xlLinear))]
  Linear = -4132
}
