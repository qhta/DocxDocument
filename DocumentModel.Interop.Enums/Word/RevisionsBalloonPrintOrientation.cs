...
/// </remarks>
[WordInteropEnumType("WdRevisionsBalloonPrintOrientation")]
public enum RevisionsBalloonPrintOrientation
{
  ...
  /// </summary>
  [WordInteropEnumValue("wdBalloonPrintOrientationAuto")]
  Auto = 0,
  /// <summary>
  /// Word preserves the orientation of the original, uncommented document.
  /// </summary>
  [WordInteropEnumValue("wdBalloonPrintOrientationPreserve")]
  Preserve = 1,
  /// <summary>
  ...
  /// </summary>
  [WordInteropEnumValue("wdBalloonPrintOrientationForceLandscape")]
  ForceLandscape = 2
}
