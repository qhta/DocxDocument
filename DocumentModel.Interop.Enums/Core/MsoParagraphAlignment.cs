...
/// </remarks>
[InteropEnumType("Microsoft.Office.Core.MsoParagraphAlignment")]
public enum ParagraphAlignment
{
  /// <summary>
  /// Use a combination of alignment styles.
  /// </summary>
  [InteropEnumValue("msoAlignMixed")]
  Mixed = -2,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("msoAlignCenter")]
  Center = 2,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("msoAlignRight")]
  Right = 3,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("msoAlignThaiDistribute")]
  ThaiDistribute = 6,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("msoAlignJustifyLow")]
  JustifyLow = 7
}
