...
/// </remarks>
[OfficeInteropEnumType(typeof(Microsoft.Office.Core.MsoParagraphAlignment))]
public enum ParagraphAlignment
{
  /// <summary>
  /// Use a combination of alignment styles.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignMixed))]
  Mixed = -2,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignLeft))]
  Left = 1,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignCenter))]
  Center = 2,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignRight))]
  Right = 3,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignJustify))]
  Justify = 4,
  /// <summary>
  /// Specifies that the first and last characters of each line (except the last) are aligned to the left and right
  /// margins, and lines are filled by adding or subtracting the same amount from each character. The last line of
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignDistribute))]
  Distribute = 5,
  /// <summary>
  /// Specifies that the first and last characters of each line (except the last) are aligned to the left and right
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignThaiDistribute))]
  ThaiDistribute = 6,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoParagraphAlignment.msoAlignJustifyLow))]
  JustifyLow = 7
}
