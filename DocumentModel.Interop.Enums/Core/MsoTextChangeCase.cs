...
/// </remarks>
[OfficeInteropEnumType(typeof(Microsoft.Office.Core.MsoTextChangeCase))]
public enum TextChangeCase
{
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoTextChangeCase.msoCaseSentence))]
  Sentence = 1,
  /// <summary>
  /// Display the text as lowercase characters.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoTextChangeCase.msoCaseLower))]
  Lower,
  /// <summary>
  /// Display the text as uppercase characters.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoTextChangeCase.msoCaseUpper))]
  Upper,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoTextChangeCase.msoCaseTitle))]
  Title,
  /// <summary>
  /// Indicates that lowercase text should be converted to uppercase and that uppercase text should be converted to
  /// lowercase text.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoTextChangeCase.msoCaseToggle))]
  Toggle
}
