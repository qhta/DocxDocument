...
/// </remarks>
[OfficeInteropEnumType("MsoTextChangeCase")]
public enum TextChangeCase
{
  ...
  /// </summary>
  [OfficeInteropEnumValue("msoCaseSentence")]
  Sentence = 1,
  /// <summary>
  /// Display the text as lowercase characters.
  /// </summary>
  [OfficeInteropEnumValue("msoCaseLower")]
  Lower,
  /// <summary>
  /// Display the text as uppercase characters.
  /// </summary>
  [OfficeInteropEnumValue("msoCaseUpper")]
  Upper,
  /// <summary>
