...
/// </remarks>
[OfficeInteropEnumType(typeof(Microsoft.Office.Core.MsoCustomXMLValidationErrorType))]
public enum CustomXMLValidationErrorType
{
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoCustomXMLValidationErrorType.msoCustomXMLValidationErrorSchemaGenerated))]
  SchemaGenerated,
  /// <summary>
  /// Specifies that the error will clear itself whenever any change is made to the node it is bound to.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoCustomXMLValidationErrorType.msoCustomXMLValidationErrorAutomaticallyCleared))]
  AutomaticallyCleared,
  /// <summary>
  /// Specifies that the error will not be cleared until the Delete() method is called.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoCustomXMLValidationErrorType.msoCustomXMLValidationErrorManual))]
  Manual
}
