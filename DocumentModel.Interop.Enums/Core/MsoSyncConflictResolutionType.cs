...
/// </remarks>
[OfficeInteropEnumType(typeof(Microsoft.Office.Core.MsoSyncConflictResolutionType))]
public enum SyncConflictResolutionType
{
  /// <summary>
  /// Replace the server copy with the local copy.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoSyncConflictResolutionType.msoSyncConflictClientWins))]
  ClientWins,
  /// <summary>
  /// Replace the local copy with the server copy.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoSyncConflictResolutionType.msoSyncConflictServerWins))]
  ServerWins,
  /// <summary>
  ...
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.MsoSyncConflictResolutionType.msoSyncConflictMerge))]
  Merge
}
