...
/// </remarks>
[OfficeInteropEnumType(typeof(Microsoft.Office.Core.XlTrendlineType))]
public enum TrendlineType
{
  /// <summary>
  /// Uses an equation to calculate the least squares fit through points, for example, y=ab^x .
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.XlTrendlineType.xlExponential))]
  Exponential = 5,
  /// <summary>
  /// Uses the linear equation y = mx + b to calculate the least squares fit through points.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.XlTrendlineType.xlLinear))]
  Linear = -4132,
  /// <summary>
  /// Uses the equation y = c ln x + b to calculate the least squares fit through points.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.XlTrendlineType.xlLogarithmic))]
  Logarithmic = -4133,
  /// <summary>
  /// Uses a sequence of averages computed from parts of the data
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.XlTrendlineType.xlMovingAvg))]
  MovingAvg = 6,
  /// <summary>
  /// Uses an equation to calculate the least squares fit through points, for example, y = ax^6 + bx^5 + cx^4 + dx^3
  /// + ex^2 + fx + g.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.XlTrendlineType.xlPolynomial))]
  Polynomial = 3,
  /// <summary>
  /// Uses an equation to calculate the least squares fit through points, for example, y = ax^b.
  /// </summary>
  [OfficeInteropEnumValue(nameof(Microsoft.Office.Core.XlTrendlineType.xlPower))]
  Power = 4
}
