...
/// </remarks>
[OfficeInteropEnumType("MsoFontLanguageIndex")]
public enum FontLanguageIndex
{
  /// <summary>
  /// Represents the Latin font face.
  /// </summary>
  [OfficeInteropEnumValue("msoThemeLatin")]
  Latin = 1,
  /// <summary>
