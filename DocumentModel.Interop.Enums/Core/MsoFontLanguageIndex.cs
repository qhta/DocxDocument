...
/// </remarks>
[InteropEnumType("Microsoft.Office.Core.MsoFontLanguageIndex")]
public enum FontLanguageIndex
{
  /// <summary>
  /// Represents the Latin font face.
  /// </summary>
  [InteropEnumValue("msoThemeLatin")]
  Latin = 1,
  /// <summary>
