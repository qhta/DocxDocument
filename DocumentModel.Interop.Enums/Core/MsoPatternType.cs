...
public enum PatternType
{
  ...
  /// </summary>
  [OfficeInteropEnumValue("msoPatternPlaid")]
  Plaid = 42,
  /// <summary>
  /// Circles that use foreground and background colors to make them appear three-dimensional, oriented in rows
  /// across the shape.
  /// </summary>
  [OfficeInteropEnumValue("msoPatternSphere")]
  Sphere = 43,
  /// <summary>
  /// Weave pattern in the foreground color running diagonally across the shape.
  /// </summary>
  [OfficeInteropEnumValue("msoPatternWeave")]
  Weave = 44,
  /// <summary>
  /// Dotted perpendicular lines in the foreground color running horizontally and vertically to form grid lines
  /// across the shape.
  /// </summary>
  [OfficeInteropEnumValue("msoPatternDottedGrid")]
  DottedGrid = 45,
  /// <summary>
  /// Small angled shapes in the foreground color running in alternating rows down the shape.
  /// </summary>
  [OfficeInteropEnumValue("msoPatternDivot")]
  Divot = 46,
  /// <summary>
  /// Overlapping curved rectangles running diagonally across the shape.
  /// </summary>
  [OfficeInteropEnumValue("msoPatternShingle")]
  Shingle = 47,
  /// <summary>
  /// Wavy lines in the foreground color.
  /// </summary>
  [OfficeInteropEnumValue("msoPatternWave")]
  Wave = 48,
  /// <summary>
  /// Horizontal
  /// </summary>
  [OfficeInteropEnumValue("msoPatternHorizontal")]
  Horizontal = 49,
  /// <summary>
  /// Vertical
  /// </summary>
  [OfficeInteropEnumValue("msoPatternVertical")]
  Vertical = 50,
  /// <summary>
  /// Cross
  /// </summary>
  [OfficeInteropEnumValue("msoPatternCross")]
  Cross = 51,
  /// <summary>
  /// Downward Diagonal
  /// </summary>
  [OfficeInteropEnumValue("msoPatternDownwardDiagonal")]
  DownwardDiagonal = 52,
  /// <summary>
  /// Upward Diagonal
  /// </summary>
  [OfficeInteropEnumValue("msoPatternUpwardDiagonal")]
  UpwardDiagonal = 53,
  /// <summary>
  /// Diagonal Cross
  /// </summary>
  [OfficeInteropEnumValue("msoPatternDiagonalCross")]
  DiagonalCross = 54
}
