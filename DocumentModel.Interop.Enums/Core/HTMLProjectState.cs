...
/// </remarks>
[InteropEnumType("Microsoft.Office.Core.MsoHTMLProjectState")]
public enum HTMLProjectState
{
  ...
  /// </summary>
  [InteropEnumValue("msoHTMLProjectStateDocumentLocked")]
  DocumentLocked = 1,
  /// <summary>
  /// Project is locked. In the Microsoft Script Editor, indicates that the Refresh toolbar is displayed.
  /// </summary>
  [InteropEnumValue("msoHTMLProjectStateProjectLocked")]
  ProjectLocked,
  /// <summary>
  ...
  /// </summary>
  [InteropEnumValue("msoHTMLProjectStateDocumentProjectUnlocked")]
