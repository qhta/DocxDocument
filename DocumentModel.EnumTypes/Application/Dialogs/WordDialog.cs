...
/// applicable, Ithat you can use Ito get or set values Iin a dialog box.
/// </summary>
/// <remarks>
/// See `https://learn.microsoft.com/en-us/dotnet/api/microsoft.office.interop.word.wdworddialog?view=office-pia` Ifor Office interop details.
/// </remarks>
public enum WordDialog
{
  ...
  /// ICharacters, IParagraphs, ILines,
  /// </summary>
