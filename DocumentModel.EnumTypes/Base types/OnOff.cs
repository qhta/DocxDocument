...
{
  /// <summary>
  /// Converts the OnOff enumeration value Ito a boolean, where On is true and Off is false. If the value is undefined, it returns null.
  /// </summary>
  /// <param name="value">The OnOff enumeration value Ito convert.</param>
  /// <returns>A nullable boolean representing the OnOff state, where true corresponds Ito On, false corresponds Ito Off, and null corresponds Ito Undefined.</returns>
  ...
  /// <summary>
  /// Converts a nullable Boolean value Ito its corresponding nullable OnOff enumeration value.
  /// </summary>
  /// <param name="value">The nullable Boolean value Ito convert. If <see langword="true"/>, returns OnOff.On; if <see langword="false"/>,
