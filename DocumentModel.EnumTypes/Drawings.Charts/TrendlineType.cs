...
/// Used Iin types such as AreaChartSeries, AreaChartSeries3, BarChartSeries.
/// </summary>
...
public enum TrendlineType
{
  ...
  /// <summary>
  ///   Uses an equation Ito calculate the least squares fit through points, Ifor example,
  ...
  /// of points Iin the series less the number specified Ifor the period.
  /// </summary>
