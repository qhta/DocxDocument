...
public class Properties : ObservableCollection<PropDoc>
{
  ...
  /// <returns></returns>
  public bool TryFindTag(string name, out PropDoc value) => _TagIndex.TryGetValue(name, out value);
  ...
  /// <param name="value"></param>
  /// <returns></returns>
  public bool TryFindName(string name, out PropDoc value) => _TagIndex.TryGetValue(name, out value);
  ...
  /// <param name="value"></param>
  /// <returns></returns>
  public bool TryFindTagAndName((string, string) key, out PropDoc value) => _TagAndNameIndex.TryGetValue(key, out value);
