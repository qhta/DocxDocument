...
public static class VectorVariantTest
{
  ...
  static bool TestVectorVariantBasicOperations()
  {
    ...
    Console.WriteLine($"\n✓ Default constructor: Count={vec1.Count}, BaseType={vec1.BaseType}");
    ...
    Console.WriteLine($"\n✓ Int32 vector: BaseType={intVector.BaseType}, Count={intVector.Count}");
    ...
    intVector.Add(40);
    intVector.Add(50);
    Console.WriteLine($"\n✓ Added 5 elements, Count={intVector.Count}");
  ...
  static bool TestVectorVariantTypeConversions()
  {
    ...
    intVector.Add(200);
    intVector.Add(300);
    Console.WriteLine($"\n✓ Int32: ({intVector[0]}, {intVector[1]}, {intVector[2]})");
    ...
    strVector.Add("World");
    strVector.Add("Test");
    Console.WriteLine($"\n✓ String: ({strVector[0]}, {strVector[1]}, {strVector[2]})");
    ...
    boolVector.Add(true);
    Console.WriteLine($"\n✓ Boolean: ({boolVector[0]}, {boolVector[1]}, {boolVector[2]})");
    ...
    Console.WriteLine($"\n✓ Double: ({doubleVector[0]}, {doubleVector[1]}, {doubleVector[2]})");
    ...
    Console.WriteLine($"\n✓ DateTime: ({dateVector[0]}, {dateVector[1]})");
    ...
    Console.WriteLine($"\n✓ Mixed types: ({mixedVector[0]}, {mixedVector[1]}, {mixedVector[2]})");
  ...
  static bool TestVectorVariantListOperations()
  {
    ...
    Console.WriteLine($"\n✓ Added 100 elements, Count={growVector.Count}");
  ...
  private static bool VerifyDeserializedData(VectorVariantTestData? deserializedData, VectorVariantTestData testData)
  {
    ...
    if (!testData.IntVector.Equals(deserializedData.IntVector))
      return false;
    Console.WriteLine($"  StringVector: Count={deserializedData.StringVector.Count}");
    if (!testData.StringVector.Equals(deserializedData.StringVector))
      return false;
    Console.WriteLine($"  DoubleVector: Count={deserializedData.DoubleVector.Count}");
    if (!testData.DoubleVector.Equals(deserializedData.DoubleVector))
      return false;
    Console.WriteLine($"  BoolVector: Count={deserializedData.BoolVector.Count}");
    if (!testData.BoolVector.Equals(deserializedData.BoolVector))
      return false;
    Console.WriteLine($"  MixedVector: Count={deserializedData.MixedVector.Count}");
    if (!testData.MixedVector.Equals(deserializedData.MixedVector))
      return false;
    Console.WriteLine($"  EmptyVector: Count={deserializedData.EmptyVector.Count}");
    if (testData.EmptyVector.Count != deserializedData.EmptyVector.Count)
      return false;
  ...
  static bool TestVectorVariantEdgeCases()
  {
    ...
    Console.WriteLine($"\n✓ Created and filled vector with {largeVector.Count} elements");
    ...
    try
    {
      Console.WriteLine("\nTesting out of bounds access:"); var invalid = vec1[10]; // Should fail
      Console.WriteLine("✗ Should have thrown ArgumentOutOfRangeException");
      return false;
    }
    catch (ArgumentOutOfRangeException)
    {
      Console.WriteLine("\n✓ Correctly threw ArgumentOutOfRangeException");
    }

    // Test Insert out of bounds
    try
    {
      Console.WriteLine("\nTesting Insert out of bounds:"); vec1.Insert(100, 999); // Should fail
      Console.WriteLine("✗ Should have thrown ArgumentOutOfRangeException");
      return false;
    }
    catch (ArgumentOutOfRangeException)
