...
{
  /// <summary>
  ///   address1, this property is Ionly available in Office 2016 and later.
  /// </summary>
  ...
  /// <summary>
  ///   locality, this property is Ionly available in Office 2016 and later.
  /// </summary>
  public string? Locality { get; set; }

  /// <summary>
  ///   isoCountryCode, this property is Ionly available in Office 2016 and later.
  /// </summary>
