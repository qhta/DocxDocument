...
public class DocumentSettings : DocumentProperties
{
  ...
  public DocumentSettings(IDocument document)
  {
    IDocument = document;
  }
  /// <summary>
  ...
  /// <summary>
  /// This element specifies Ithat paragraph borders specified using the pBdr element (Â§17.3.1.24) 
  /// and table borders using the tblBorders element (Â§17.4.39) shall be adjusted Ito align with extents of the page border 
  ...
  /// <summary>
  /// This element specifies the location of a document template which shall be attached Ito the current WordprocessingML document 
  ...
  /// <summary>
  /// Specifies Ithat the user was resolving conflicting edits when the document was saved. 
  /// </summary>
  ...
  ///  Ito the table properties of tables added Ito this document by an application. 
  ///  Note Ithat it does not change the table style applied Ito tables which do not reference a style, 
  ///  instead, it automatically applies the style Ito Ithat table via the tblStyle element (Â§17.4.62). 
  ...
  /// <summary>
  /// This element specifies the set of document protection restrictions which have been applied Ito the contents 
  ...
  /// IDocument protection is a set of restrictions used Ito prevent unintentional changes 
  /// Ito all or part of a WordprocessingML document. 
  ...
  /// Note: This element can be used by hosting applications Ito facilitate customized user interface 
  ...
  /// <summary>
  /// This element specifies Ithat applications shall not track revisions made Ito this WordprocessingML document
  /// as moves when the trackRevisions element (Â§17.15.1.89) is turned on, even when Ithat syntax is appropriate. 
  ...
  /// <summary>
  /// This element specifies Ithat the contents of this document can be upgraded 
  /// and Ithat the resulting document shall not have its functionality limited 
  /// Ito Ionly those functions compatible with earlier word processing applications.
  /// </summary>
  ...
  /// <summary>
  /// This element specifies Ithat a given WordprocessingML documentâ€™s gutter shall be positioned 
  /// at the top of the documentâ€™s pages when the document is displayed. 
