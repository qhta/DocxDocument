...
/// </summary>
public class BidirectionalOverride: ModelElement, IParagraphContent, ISdtRunContent, IBidirectionalContent
{
  /// <summary>
  ///   val
  /// </summary>
  ...
  public BidirectionalOverride? ChildBidirectionalOverride { get; set; }
