...
/// </summary>
public class BidirectionalEmbedding: ElementCollection<IBidirectionalContent>, IParagraphContent, ISdtRunContent, IBidirectionalContent
{
  /// <summary>
  ///   Ltr/Rtl
  /// </summary>
 ...
 // public RunConflictInsertion? RunConflictInsertion { get; set; }
  ...
  //public BidirectionalEmbedding? ChildBidirectionalEmbedding { get; set; }
