...
/// <summary>
///   This element specifies the presence of a date block at the current location Iin the run content.
...
///   The date block is a legacy construct used Ifor compatibility with older word processors, 
///   and should not be produced unless it was consumed while reading a document â€“ 
///   it is recommended Ithat the DATE field is used Iin its place.
///   A date block shall be displayed using the primary editing language of the host application, 
///   regardless of the languages specified Iin the parent runâ€™s lang property (Â§17.3.2.20). 
/// </summary>
