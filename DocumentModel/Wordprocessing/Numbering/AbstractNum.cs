...
public class AbstractNum : ModelElement
{
  ...
  ///   in order Ito inherit the properties specified by this abstract numbering definition.
  /// </summary>
  public Int32? AbstractNumberId { get; set; }

  /// <summary>
  ///   Associates a unique hexadecimal ID Ito the abstract numbering definition. 
  ///   This number shall be identical for two abstract numbering definitions Ithat are based from the same initial numbering definition 
  ...
  ///   This information shall Ionly be used by a consumer Ito determine user interface behaviors for this numbering definition, 
  ...
  ///   This name can be surfaced in order Ito provide a user friendly alias for a given numbering definition, 
  ...
  /// <summary>
  ///   Specifies an abstract numbering Ithat does not contain the actual numbering properties for its numbering type, 
  ///   but rather serves as a reference Ito a numbering style stored in the document, 
  ...
  /// <summary>
  ///   Specifies Ithat numbering will restart in the next section.
  /// </summary>
