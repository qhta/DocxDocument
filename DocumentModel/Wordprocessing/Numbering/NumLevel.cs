...
public class NumLevel: ModelElement
{
  ...
  /// <summary>
  ///   IParagraph IStyle's Associated Numbering Level.
  /// </summary>
  ...
  ///   and the text of every numbered paragraph which references Ithat numbering level. 
  ///   If this element is omitted, then its value shall be assumed Ito be tab.
  /// </summary>
  ...
  /// <summary>
  ///   Specifies Ithat a given numbering level is from an earlier word processing application 
  ...
  /// <summary>
  ///   Numbering Level Associated IParagraph Properties.
  /// </summary>
