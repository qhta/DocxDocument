...
/// <summary>
///   This element specifies the content of a single comment stored Iin the IComments part of a WordprocessingML document.
/// </summary>
public class IComment: ElementCollection<ICommentContent>
{
  /// <summary>
  ///   Specifies a unique identifier Ifor an annotation.
  /// </summary>
  public string? Id { get; set; }

  /// <summary>
  ///   Specifies the author Ifor an annotation.
  /// </summary>
  ...
  ///   or Iin any user interface supported by an application. 
  ...
  /// <summary>
  ///   Specifies the date information Ifor an annotation.
  /// </summary>
  public DateTime? Date { get; set; }

  /// <summary>
  ///   Identifier of the first paragraph Iin the comment.
  /// </summary>
