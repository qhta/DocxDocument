...
/// </summary>
public abstract class BaseTableCellProperties : ModelElement
{
  /// <summary>
  ...
  ///   Similarly to paragraph shading, this shading shall be applied to the contents of the cell up to the cell borders, 
  ///   regardless of the presence of text.
  /// </summary>
  public Shading? Shading { get; set; }

  /// <summary>
  ///   Specifies how this table cell shall be laid out when the parent table is displayed in a document. 
  ///   This setting only affects the behavior of the cell when the tblLayout for this row (§17.4.52; §17.4.53) 
  ...
  ///   The vertical alignment of this text is determined by the value of the val attribute. .
  /// </summary>
