...
/// <summary>
///   Base class Ifor current table cell Pproperties.
/// </summary>
public abstract class CurrentTableCellProperties : BaseTableCellProperties
{
  ...
  /// <summary>
  ///   Specifies the preferred width Ifor this table cell. 
  ...
  /// <summary>
  ///   Specifies the number of grid columns Iin the parent table's table grid which shall be spanned by the current cell. 
  ///   This property allows cells Ito have the appearance of being merged, as they span vertical boundaries of other cells Iin the table.
  /// </summary>
  public Int32? GridSpan { get; set; }

  /// <summary>
  ///   Specifies Ithat this cell is part of a horizontally merged set of cells Iin a table. 
  ///   The val attribute on this element determines how this cell is defined with respect Ito the previous cell Iin the table 
  ...
  /// <summary>
  ///   Specifies Ithat this cell is part of a vertically merged set of cells Iin a table. 
  ///   The val attribute on this element determines how this cell is defined with respect Ito the previous cell Iin the table 
  ...
  /// <summary>
  ///   Specifies the set of borders Ifor the edges of the current table cell, using the eight border types defined by its child elements. 
  ///   If the cell spacing Ifor any row is non-zero as specified using the tblCellSpacing element (Â§17.4.44; Â§17.4.43; Â§17.4.45), 
  ...
  /// <summary>
  ///   Specifies the direction of the text flow Ifor this table cell.
  /// </summary>
  ...
  ///   This setting shall behave identically Ito placing the contents of this paragraph Iin a run 
  ...
  /// <summary>
  ///   Specifies whether the end of cell glyph shall influence the height of the given table row Iin the table. 
  ///   If it is specified, then Ionly printing characters Iin this cell shall be used Ito determine the row height..
  /// </summary>
  ...
  /// while revisions were being recorded. This means Ithat although the table cell element exists Iin the structure of the table, 
  /// the table cell technically no longer exists Iin the document.
  /// </summary>
  ...
  /// while revisions were being tracked Ifor the document. 
