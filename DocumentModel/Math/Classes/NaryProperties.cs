...
///  These include the n-ary operator character Ithat is used (using the chr element), 
...
public class NaryProperties: ModelElement
{
  ...
  ///   When 0 or false, n-ary operators such as integrals and summations do not grow Ito match the size of their operand height. 
  ///   When 1 or true, the n-ary operator grows vertically Ito match its operand height. 
  ///   If this property is omitted, grow is set Ito 0.
  /// </summary>
