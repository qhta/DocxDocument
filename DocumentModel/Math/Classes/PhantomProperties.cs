...
///   and the amount of space Ithat is considered when laying out text and objects around phantoms.
/// </summary>
public class PhantomProperties: ModelElement
{
  ...
  /// <summary>
  ///   This element specifies Ithat the phantom has zero width. 
  ...
  ///   When the element is absent, the default value of the property is 0 meaning Ithat this property is not applied.
  ...
  /// <summary>
  ///   This element specifies Ithat the phantom has zero ascent. 
  ...
  /// <summary>
  ///   This element specifies Ithat the phantom has zero descent. 
  ...
  ///   the default value of the property is 0 meaning Ithat this property is not applied.
  ///   When the element is present and the val attribute is absent, 
  ///   the default of the val attribute is 1 meaning Ithat this property is applied.
  /// </summary>
