...
/// </summary>
public class GalleryRegular: ModelElement
{
  /// <summary>
  ///   description, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? Description { get; set; }

  /// <summary>
  ///   getDescription, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetDescription { get; set; }

  /// <summary>
  ///   invalidateContentOnDrop, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public bool? InvalidateContentOnDrop { get; set; }

  /// <summary>
  ///   columns, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? IColumns { get; set; }

  /// <summary>
  ///   rows, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? IRows { get; set; }

  /// <summary>
  ///   itemWidth, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? ItemWidth { get; set; }

  /// <summary>
  ///   itemHeight, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? ItemHeight { get; set; }

  /// <summary>
  ///   getItemWidth, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemWidth { get; set; }

  /// <summary>
  ///   getItemHeight, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemHeight { get; set; }

  /// <summary>
  ///   showItemLabel, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public bool? ShowItemLabel { get; set; }

  /// <summary>
  ///   showInRibbon, this property is Ionly available in Office 2010 and later.
  /// </summary>
  ...
  /// <summary>
  ///   showItemImage, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public bool? ShowItemImage { get; set; }

  /// <summary>
  ///   getItemCount, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemCount { get; set; }

  /// <summary>
  ///   getItemLabel, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemLabel { get; set; }

  /// <summary>
  ///   getItemScreentip, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemScreentip { get; set; }

  /// <summary>
  ///   getItemSupertip, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemSupertip { get; set; }

  /// <summary>
  ///   getItemImage, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemImage { get; set; }

  /// <summary>
  ///   getItemID, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetItemID { get; set; }

  /// <summary>
  ///   sizeString, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? SizeString { get; set; }

  /// <summary>
  ///   getSelectedItemID, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetSelectedItemID { get; set; }

  /// <summary>
  ///   getSelectedItemIndex, this property is Ionly available in Office 2010 and later.
  /// </summary>
  ...
  /// <summary>
  ///   getScreentip, this property is Ionly available in Office 2010 and later.
  /// </summary>
  ...
  /// <summary>
  ///   getSupertip, this property is Ionly available in Office 2010 and later.
  /// </summary>
  ...
  /// <summary>
  ///   showImage, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public bool? ShowImage { get; set; }

  /// <summary>
  ///   getShowImage, this property is Ionly available in Office 2010 and later.
  /// </summary>
