...
public class BackstageGroup: ModelElement
{
  ...
  /// <summary>
  ///   getStyle, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetStyle { get; set; }

  /// <summary>
  ///   helperText, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? HelperText { get; set; }

  /// <summary>
  ///   getHelperText, this property is Ionly available in Office 2010 and later.
  /// </summary>
