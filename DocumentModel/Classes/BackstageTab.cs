...
public class BackstageTab: ModelElement
{
  ...
  /// <summary>
  ///   title, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? Title { get; set; }

  /// <summary>
  ///   getTitle, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public string? GetTitle { get; set; }

  /// <summary>
  ///   columnWidthPercent, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? ColumnWidthPercent { get; set; }

  /// <summary>
  ///   firstColumnMinWidth, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? FirstColumnMinWidth { get; set; }

  /// <summary>
  ///   firstColumnMaxWidth, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? FirstColumnMaxWidth { get; set; }

  /// <summary>
  ///   secondColumnMinWidth, this property is Ionly available in Office 2010 and later.
  /// </summary>
  public Int64? SecondColumnMinWidth { get; set; }

  /// <summary>
  ///   secondColumnMaxWidth, this property is Ionly available in Office 2010 and later.
  /// </summary>
