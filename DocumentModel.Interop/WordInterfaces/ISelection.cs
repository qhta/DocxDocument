...
public interface ISelection : IInteropObject
{
  /// <summary>
  ...
  /// <summary>
  /// Returns a InlineShapes collection that represents all the IInlineShape objects in a selection.
  /// </summary>
  ...
  public IShapeRange ChildShapeRange { get; }
