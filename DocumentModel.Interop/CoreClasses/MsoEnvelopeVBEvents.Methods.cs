...
public partial class MsoEnvelopeVBEvents
{
  /// <summary>
  /// Occurs when the envelope user class is shown.
  /// </summary>
  ...
  public void EnvelopeShow() { throw new NotImplementedException(); }
  /// <summary>
  /// Occurs when the envelope user class is hidden.
  /// </summary>
  ...
  public void EnvelopeHide() { throw new NotImplementedException(); }
}
