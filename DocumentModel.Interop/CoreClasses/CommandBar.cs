...
public partial class CommandBar : MsoOleAccDispObj
{
  /// <summary>
  ...
  public BarType Type => throw new NotImplementedException();
  /// <summary>
  ...
  public void ShowPopup(object x, object y) { throw new NotImplementedException(); }
