...
/// </remarks>
public partial class SharedWorkspaceTasks
{
  /// <summary>
  /// Invokes `Add`.
  /// </summary>
  ...
  public SharedWorkspaceTask Add
    (string Title, object Status, object Priority, object Assignee, object Description, object DueDate) { throw new NotImplementedException(); }
}
