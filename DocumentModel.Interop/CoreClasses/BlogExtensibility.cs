...
/// <summary>
  ...
  public void BlogProviderProperties
    (out string BlogProvider, out string FriendlyName, out BlogCategorySupport CategorySupport, out bool Padding) { throw new NotImplementedException(); }
  /// <summary>
  ...
  public void SetupBlogAccount(string Account, int ParentWindow, object Document, bool NewAccount, out bool ShowPictureUI) { throw new NotImplementedException(); }
  /// <summary>
  ...
  public void GetUserBlogs
    (string Account, int ParentWindow, object Document, out Array BlogNames, out Array BlogIDs, out Array BlogURLs) { throw new NotImplementedException(); }
  /// <summary>
  ...
  public void GetRecentPosts
    (string Account, int ParentWindow, object Document, out Array PostTitles, out Array PostDates, out Array PostIDs) { throw new NotImplementedException(); }
  /// <summary>
  ...
  (string Account, string PostID, int ParentWindow, out string xHTML, out string Title, out string DatePosted,
    out Array Categories) { throw new NotImplementedException(); }
  /// <summary>
  ...
  (string Account, int ParentWindow, object Document, string xHTML, string Title, string DateTime, Array Categories,
    bool Draft, out string PostID, out string PublishMessage) { throw new NotImplementedException(); }
  /// <summary>
  ...
  (string Account, int ParentWindow, object Document, string PostID, string xHTML, string Title, string DateTime,
    Array Categories, bool Draft, out string PublishMessage) { throw new NotImplementedException(); }
  /// <summary>
  ...
  public void GetCategories(string Account, int ParentWindow, object Document, out Array Categories) { throw new NotImplementedException(); }
