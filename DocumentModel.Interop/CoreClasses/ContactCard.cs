...
public partial class ContactCard: InteropObject
{
...
/// <summary>
  ...
  /// </summary>
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.contactcard.close?view=office-pia"/>
  ...
  /// <seealso cref="http://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.contactcard.show?view=office-pia"/>
  public void Show
  (ContactCardStyle CardStyle, int RectangleLeft, int RectangleRight, int RectangleTop, int RectangleBottom,
    int HorizontalPosition, bool ShowWithDelay) { throw new NotImplementedException(); }
