...
public interface IModelTables: IEnumerable
{
  [DispId(148)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Interface)]
  ModelTable Item([In] [MarshalAs(UnmanagedType.Struct)] object Index);

  [IndexerName("_Default")]
  [DispId(0)]
  ModelTable this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
