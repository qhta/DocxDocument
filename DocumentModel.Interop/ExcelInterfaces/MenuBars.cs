...
public interface MenuBars: IEnumerable
{
  [DispId(148)]
  ...
  [DispId(181)]
  [return: MarshalAs(UnmanagedType.Interface)]
  MenuBar Add([Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Name);
  ...
  [DispId(0)]
  MenuBar this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
