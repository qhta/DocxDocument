...
public interface IPivotField
{
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [return: MarshalAs(UnmanagedType.Struct)]
  object PivotItems([Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Index);
  ...
  void AutoSort([In] int Order, [In] [MarshalAs(UnmanagedType.BStr)] string Field);

  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void AutoShow([In] int Type, [In] int Range, [In] int Count, [In] [MarshalAs(UnmanagedType.BStr)] string Field);
  ...
  ([In] [MarshalAs(UnmanagedType.BStr)] string Item,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object ClearList);
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void DrillTo([In] [MarshalAs(UnmanagedType.BStr)] string Field);

  [DispId(2581)]
  bool UseMemberPropertyAsCaption
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    get;
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  ...
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void AutoSortEx
  ([In] int Order, [In] [MarshalAs(UnmanagedType.BStr)] string Field,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object PivotLine,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object CustomSubtotal);
