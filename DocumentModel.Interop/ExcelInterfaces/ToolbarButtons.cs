...
public interface ToolbarButtons: IEnumerable
{
  [DispId(148)]
  ...
  [return: MarshalAs(UnmanagedType.Interface)]
  ToolbarButton Add
  ([Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Button,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Before,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object OnAction,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Pushed,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Enabled,
  ...
  [DispId(0)]
  ToolbarButton this[[In] int Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [TypeLibFunc(TypeLibFuncFlags.FNonBrowsable)]
