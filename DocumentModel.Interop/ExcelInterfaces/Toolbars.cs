...
public interface Toolbars: IEnumerable
{
  [DispId(148)]
  ...
  [DispId(181)]
  [return: MarshalAs(UnmanagedType.Interface)]
  Toolbar Add([Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Name);
  ...
  [DispId(0)]
  Toolbar this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(0)]
