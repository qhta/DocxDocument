...
public interface ModelTableNameChanges: IEnumerable
{
  [DispId(148)]
  ...
  [DispId(170)]
  [return: MarshalAs(UnmanagedType.Interface)]
  ModelTableNameChange Item([In] [MarshalAs(UnmanagedType.Struct)] object Index);

  [IndexerName("_Default")]
  [DispId(0)]
  ModelTableNameChange this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall,
      MethodCodeType = MethodCodeType.Runtime)]
    [DispId(0)]
