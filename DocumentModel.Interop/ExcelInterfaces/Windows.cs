...
public interface Windows: IEnumerable
{
  ...
  ([In] XlArrangeStyle ArrangeStyle = XlArrangeStyle.xlArrangeStyleTiled,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object ActiveWorkbook,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object SyncHorizontal,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object SyncVertical);
  ...
  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  [DispId(2246)]
  bool CompareSideBySideWith([In] [MarshalAs(UnmanagedType.Struct)] object WindowName);
