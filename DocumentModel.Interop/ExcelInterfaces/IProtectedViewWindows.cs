...
public interface IProtectedViewWindows: IEnumerable
{
  [DispId(148)]
  ...
  [DispId(0)]
  ProtectedViewWindow this[[In] [MarshalAs(UnmanagedType.Struct)] object Index]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [TypeLibFunc(TypeLibFuncFlags.FNonBrowsable)]
    [return: MarshalAs(UnmanagedType.Interface)]
  ...
  ([In] [MarshalAs(UnmanagedType.BStr)] string Filename,
    ...
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object RepairMode);
}