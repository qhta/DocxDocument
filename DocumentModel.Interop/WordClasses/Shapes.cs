...
public partial class Shapes : InteropCollection<Shape>
{
...
/// <summary>
  ...
  public Shape AddCallout(Core.CalloutType Type, float Left, float Top, float Width, float Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddCurve(object SafeArrayOfPoints, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddLabel(Core.TextOrientation Orientation, float Left, float Top, float Width, float Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddLine(float BeginX, float BeginY, float EndX, float EndY, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddPicture(string FileName, object LinkToFile, object SaveWithDocument, object Left, object Top, object Width, object Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddPolyline(object SafeArrayOfPoints, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddShape(int Type, float Left, float Top, float Width, float Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddTextEffect(Core.PresetTextEffect PresetTextEffect, string Text, string FontName, float FontSize, Core.TriState FontBold, Core.TriState FontItalic, float Left, float Top, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddTextbox(Core.TextOrientation Orientation, float Left, float Top, float Width, float Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddOLEObject(object ClassType, object FileName, object LinkToFile, object DisplayAsIcon, object IconFileName, object IconIndex, object IconLabel, object Left, object Top, object Width, object Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddOLEControl(object ClassType, object Left, object Top, object Width, object Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddDiagram(Core.DiagramType Type, float Left, float Top, float Width, float Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddCanvas(float Left, float Top, float Width, float Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddChart(object Type, object Left, object Top, object Width, object Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddSmartArt(object Layout, object Left, object Top, object Width, object Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddWebVideo(string EmbedCode, object VideoWidth, object VideoHeight, object PosterFrameImage, object Url, object Left, object Top, object Width, object Height, object Anchor) { throw new NotImplementedException(); }
  ...
  public Shape AddChart2(int Style, object Type, object Left, object Top, object Width, object Height, object Anchor, object NewLayout) { throw new NotImplementedException(); }
