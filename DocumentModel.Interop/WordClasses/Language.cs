...
public class Language : InteropObject
{
  /// <summary>
  ...
  public Dictionary ActiveGrammarDictionary { get; set; }
  /// <summary>
  ...
  public Dictionary ActiveHyphenationDictionary { get; set; }
  /// <summary>
  ...
  public Dictionary ActiveSpellingDictionary { get; set; }
  /// <summary>
  ...
  public Dictionary ActiveThesaurusDictionary { get; set; }
  /// <summary>
  ...
  public object WritingStyleList { get; set; }
  /// <summary>
