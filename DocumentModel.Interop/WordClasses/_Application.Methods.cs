...
/// <summary>
/// This is a primary class in a COM coclass that is required by managed code for interoperability with the
/// corresponding COM object. Use this primary class only when the method you want to use shares the same name
/// as an event of the COM object; in this case, cast to this class to call the method, and cast to the latest
/// events class to connect to the event. Otherwise, use the .NET class that is derived from the COM
