...
public partial class InlineShape : InteropObject
{
  /// <summary>
  ...
  public InlineShapeType Type { get; set; }
  ...
  public HorizontalLineFormat HorizontalLineFormat { get; set; }
  ...
  public bool IsPictureBullet { get; set; }
