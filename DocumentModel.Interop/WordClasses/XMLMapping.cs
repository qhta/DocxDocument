...
public partial class XMLMapping : InteropObject
{
  /// <summary>
  ...
  public Core.CustomXMLPart CustomXMLPart { get; set; }
  ...
  public Core.CustomXMLNode CustomXMLNode { get; set; }
...
/// <summary>
  ...
  public bool SetMapping(string xPath, string prefixMapping, Core.CustomXMLPart source) { throw new NotImplementedException(); }
