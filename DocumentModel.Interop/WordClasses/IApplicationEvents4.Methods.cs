...
public partial class IApplicationEvents4
{
  /// <summary>
  ...
  public void XMLSelectionChange(Selection Sel, XMLNode OldXMLNode, XMLNode NewXMLNode, int Reason) { throw new NotImplementedException(); }
  ...
  public void XMLValidationError(XMLNode XMLNode) { throw new NotImplementedException(); }
  ...
  public void DocumentSync(Document Doc, Core.SyncEventType SyncEventType) { throw new NotImplementedException(); }
  ...
  public void EPostageInsertEx(Document Doc, int cpDeliveryAddrStart, int cpDeliveryAddrEnd, int cpReturnAddrStart, int cpReturnAddrEnd, int xaWidth, int yaHeight, string bstrPrinterName, string bstrPaperFeed, bool fPrint, bool fCancel) { throw new NotImplementedException(); }
  ...
  public void MailMergeDataSourceValidate2(Document Doc, bool Handled) { throw new NotImplementedException(); }
  ...
  public void ProtectedViewWindowOpen(ProtectedViewWindow PvWindow) { throw new NotImplementedException(); }
  ...
  public void ProtectedViewWindowBeforeEdit(ProtectedViewWindow PvWindow, ref bool Cancel) { throw new NotImplementedException(); }
  ...
  public void ProtectedViewWindowBeforeClose(ProtectedViewWindow PvWindow, int CloseReason, ref bool Cancel) { throw new NotImplementedException(); }
  ...
  public void ProtectedViewWindowSize(ProtectedViewWindow PvWindow) { throw new NotImplementedException(); }
  ...
  public void ProtectedViewWindowActivate(ProtectedViewWindow PvWindow) { throw new NotImplementedException(); }
  ...
  public void ProtectedViewWindowDeactivate(ProtectedViewWindow PvWindow) { throw new NotImplementedException(); }
}
