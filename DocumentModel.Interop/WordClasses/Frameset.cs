...
public partial class Frameset : InteropCollection<Frameset>
{
  /// <summary>
...
/// <summary>
  ...
  public Frameset ChildFramesetItem(int Index) { throw new NotImplementedException(); }
  /// <summary>
  ...
  public Frameset AddNewFrame(FramesetNewFrameLocation Where) { throw new NotImplementedException(); }
