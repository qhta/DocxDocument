...
public partial class Broadcast : InteropObject
{
  /// <summary>
  ...
  public Core.BroadcastState State { get; set; }
  ...
  public string? PresenterServiceUrl { get; set; }
...
/// <summary>
  ...
  public void Start(string serverUrl) { throw new NotImplementedException(); }
