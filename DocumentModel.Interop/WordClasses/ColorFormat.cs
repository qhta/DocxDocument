...
/// <summary>
  ...
  public float Ink(int index) { throw new NotImplementedException(); }
  ...
  public void SetCMYK(int cyan, int magenta, int yellow, int black) { throw new NotImplementedException(); }
