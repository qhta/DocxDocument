...
public interface MsoDebugOptions_UTs: _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  MsoDebugOptions_UT this[[In] int Index]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [DispId(0)]
  ...
  [DispId(2)]
  [return: MarshalAs(UnmanagedType.Interface)]
  MsoDebugOptions_UTs GetUnitTestsInCollection([In] [MarshalAs(UnmanagedType.BStr)] string bstrCollectionName);
  ...
  ([In] [MarshalAs(UnmanagedType.BStr)] string bstrCollectionName,
    [In] [MarshalAs(UnmanagedType.BStr)] string bstrUnitTestName);
  ...
  ([In] [MarshalAs(UnmanagedType.BStr)] string bstrCollectionName,
    [In] [MarshalAs(UnmanagedType.BStr)] string bstrUnitTestNameFilter);
}