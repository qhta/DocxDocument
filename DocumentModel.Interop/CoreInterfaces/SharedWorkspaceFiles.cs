...
public interface SharedWorkspaceFiles: _IMsoDispObj, IEnumerable
{
  ...
  [DispId(0)]
  SharedWorkspaceFile this[[In] int Index]
  {
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    [DispId(0)]
  ...
  ([In] [MarshalAs(UnmanagedType.BStr)] string FileName,
    ...
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object OverwriteIfFileAlreadyExists,
    [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object KeepInSync);
