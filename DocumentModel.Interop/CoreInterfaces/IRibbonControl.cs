...
/// <summary>
/// Represents the `IRibbonControl` interface.
/// </summary>
/// <remarks>
/// See `https://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.iribboncontrol?view=office-pia` for Office interop details.
/// </remarks>
