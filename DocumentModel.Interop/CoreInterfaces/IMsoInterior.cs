...
/// <summary>
/// Represents the `IMsoInterior` interface.
/// </summary>
/// <remarks>
/// See `https://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.imsointerior?view=office-pia` for Office interop details.
/// </remarks>
