...
/// <summary>
/// Represents the `IMsoChartFormat` interface.
/// </summary>
/// <remarks>
/// See `https://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.imsochartformat?view=office-pia` for Office interop details.
/// </remarks>
