...
/// <summary>
/// Represents the `IMsoChart` interface.
/// </summary>
/// <remarks>
/// See `https://learn.microsoft.com/en-us/dotnet/api/microsoft.office.core.imsochart?view=office-pia` for Office interop details.
/// </remarks>
