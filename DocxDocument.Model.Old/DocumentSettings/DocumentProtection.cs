...
/// </summary>
public class DocumentProtection: DocxBasedElement<WD.DocumentProtection>, IDocumentProtection
{
  public DocumentProtection() : base(new WD.DocumentProtection())
  {
  }

  public DocumentProtection(WD.DocumentProtection element) : base(element)
  {
  }
  ...
  /// </summary>
  public DM.CryptAlgorithmClass? CryptographicAlgorithmClass
  {
  ...
  /// </summary>
  public DM.DocProtection? Edit
  {
    get => (DM.DocProtection?)DocxElement.Edit?.Value;
    set => DocxElement.Edit = (value != null) ? (WD.DocumentProtectionValues)value : null;
  }
  ...
  {
    get => DocxElement.Enforcement?.Value;
    set => DocxElement.Enforcement = (value != null) ? (bool)value : null;
  }
  ...
  {
    get => DocxElement.Formatting?.Value;
    set => DocxElement.Formatting = (value != null) ? (bool)value : null;
  }
