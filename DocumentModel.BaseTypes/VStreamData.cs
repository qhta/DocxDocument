...
/// 
/// // Access properties
/// Console.WriteLine($"Version: {streamData.Version}");
...
public readonly partial struct VStreamData : IEquatable<VStreamData>
{
  ...
  /// <item><description><b>Version tracking:</b> Distinguishes between different versions of the same data format</description></item>
  ...
  /// <item><description>Custom format identifiers for proprietary data</description></item>
  /// <item><description><see cref="Guid.Empty"/> for format-agnostic binary data</description></item>
  /// </list>
  /// </para>
  /// </remarks>
  ...
  /// <item><description><b>Custom format IDs:</b> Application-specific identifiers for proprietary formats</description></item>
  /// <item><description><b>Version markers:</b> Identifiers that distinguish between format versions</description></item>
  /// </list>
  /// </para>
  /// <para>
  ...
  /// <remarks>
  /// <para>
  /// The structure and interpretation of this data depends on the <see cref="Version"/> GUID.
  ...
  /// implications of loading the entire stream into a byte array. The data is stored in
  ...
  /// <list type="bullet">
  /// <item><description>Their <see cref="Version"/> GUIDs are equal</description></item>
  ...
  /// <list type="bullet">
  /// <item><description>The hash code of the <see cref="Version"/> GUID</description></item>
  ...
  /// hash-based collections like <see cref="Dictionary{TKey,TValue}"/> and
  /// <see cref="HashSet{T}"/>.
  /// </para>
  /// <para>
  ...
  /// used frequently in hash-based collections, or use the version GUID alone for hash-based
