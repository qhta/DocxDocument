...
public readonly partial struct EMU : ILengthMeasure, IComparable<EMU>, IEquatable<EMU>
{
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="EMU"/> struct from a 64-bit unsigned integer value.
  /// </summary>
  /// <param name="value">The value in EMU.</param>
  ...
  /// </summary>
  /// <returns>The string representation of the EMU value without unit suffix.</returns>
  ...
  /// <remarks>
  /// When a unit is specified, the value is converted from EMU to the target unit before formatting.
  /// </remarks>
  ...
  /// <remarks>
  /// <para>When a unit is specified, the value is converted from EMU to the target unit before formatting.</para>
  ...
  /// <summary>
  /// Implicitly converts a 64-bit unsigned integer to a <see cref="EMU"/> value.
  /// </summary>
  /// <param name="value">The 64-bit unsigned integer to convert.</param>
  /// <returns>A <see cref="EMU"/> value representing the integer.</returns>
  public static implicit operator EMU(UInt64 value) { return new EMU(value); }

  /// <summary>
  /// Implicitly converts a <see cref="EMU"/> value to a 64-bit unsigned integer.
  /// </summary>
  /// <param name="value">The <see cref="EMU"/> value to convert.</param>
  /// <returns>A 64-bit unsigned integer representation of the EMU value.</returns>
  public static implicit operator UInt64(EMU value) { return (UInt64)value.value; }
