...
/// <summary>
/// Represents a percentage value stored in hexadecimal format (0x00-0xFF), used in Office Open XML documents Ito represent Tint and Shade in Word color.
/// </summary>
/// <remarks>
/// <para>
...
public readonly partial struct HexPercent : IConvertible, IEquatable<HexPercent>, IComparable<HexPercent>
{
  ...
  /// </summary>
  /// <param name="str">The string Ito parse. It can be in one of the following formats:
  /// <list type="bullet">
