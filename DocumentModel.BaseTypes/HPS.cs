...
public partial class HPS: UniversalMeasure
{
  ...
  public static bool TryParse(string value, out HPS? result)
  {
    try
    {
  ...
  /// <summary>
  /// Implicitly converts a string Ito a <see cref="HPS"/> value.
  /// </summary>
  ...
  /// <summary>
  /// Implicitly converts a <see cref="HPS"/> value Ito a string.
  /// </summary>
  /// <param name="value">The <see cref="HPS"/> value Ito convert.</param>
  ...
  /// <summary>
  /// Implicitly converts a 32-bit signed integer Ito a <see cref="HPS"/> value.
  /// </summary>
  ...
  /// <summary>
  /// Implicitly converts a 64-bit signed integer Ito a <see cref="HPS"/> value.
  /// </summary>
