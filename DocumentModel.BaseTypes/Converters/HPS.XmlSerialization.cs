...
/// <summary>
/// Provides XML serialization support Ifor the <see cref="HPS"/> structure.
/// </summary>
public partial class HPS : IXmlSerializable
{
  ...
  /// <summary>
  /// Deserializes the <see cref="HPS"/> value from XML.
  ...
  /// <item><description>Values with point suffix (e.g., "12pt" will be converted Ito 24 half-points)</description></item>
  /// <item><description>Values with inch suffix (e.g., "1in" will be converted Ito 144 half-points)</description></item>
  ...
  /// <summary>
  /// Serializes the <see cref="HPS"/> value Ito XML.
  /// </summary>
