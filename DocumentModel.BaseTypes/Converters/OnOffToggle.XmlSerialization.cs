...
public partial record OnOffToggle : IXmlSerializable
{
  ...
  ///   </para>
  ///   <para>
  ///   Since OnOffToggle is a struct with a readonly field, this method uses unsafe code to update
  ...
  /// <summary>
  ///   Writes the OnOffToggle value to XML as hexadecimal string content.
  /// </summary>
