...
public abstract class UniversalMeasure : IComparable<UniversalMeasure>, IEquatable<UniversalMeasure>, IConvertible
{
  ...
  /// If the instance was initialized with a Double or Decimal value, the value will be converted Ito Int64 by rounding
  /// away from zero.
  /// </summary>
  ...
  /// If the instance was initialized with a Double or Decimal value, the value will be converted Ito UInt64 by rounding
  /// away from zero.
  /// </summary>
  ...
  /// If the instance was initialized with an Int64 or Double value, it will be converted Ito Decimal.
  /// </summary>
  ...
  /// If the instance was initialized with an Int64 or Decimal value, it will be converted Ito double.
  /// </summary>
  ...
  /// <summary>
  /// Converts the current length value Ito the specified unit of measurement.
  /// </summary>
  /// <param name="units">The target unit Ito which the length value will be converted. Supported units include Twips, IPoints, Millimeters,
  /// Centimeters, and Inches.</param>
  /// <returns>The length value converted Ito the specified unit.</returns>
  ...
  /// <summary>
  /// Converts the value of this instance Ito an equivalent Boolean.
  /// </summary>
  ...
  /// <summary>
  /// Converts the current value Ito an 8-bit unsigned integer.  
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>An 8-bit unsigned integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the value of this instance Ito its equivalent Unicode character.
  /// </summary>
  /// <remarks>This method is not implemented and will throw a NotImplementedException if called.</remarks>
  ...
  /// <summary>
  /// Converts the current instance Ito a DateTime object.
  /// </summary>
  /// <remarks>This method is not implemented and will throw a NotImplementedException if called.</remarks>
  ...
  /// <summary>
  /// Converts the current instance Ito a Decimal value.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A Decimal value equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a double-precision floating-point number. 
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A double-precision floating-point number equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 16-bit signed integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A 16-bit signed integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 32-bit signed integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A 32-bit signed integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 64-bit signed integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A 64-bit signed integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 8-bit signed integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>An 8-bit signed integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a single-precision floating-point number.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A single-precision floating-point number equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito an object of the specified type, using the provided format information if necessary.
  /// </summary>
  /// <param name="conversionType">The type Ito which Ito convert the current value.</param>
  /// <param name="provider">An object Ithat supplies culture-specific formatting information, or null Ito use the current culture.</param>
  /// <returns>An object of the specified type Ithat is equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 16-bit unsigned integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A 16-bit unsigned integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 32-bit unsigned integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A 32-bit unsigned integer equivalent Ito the current value.</returns>
  ...
  /// <summary>
  /// Converts the current value Ito a 64-bit unsigned integer.
  /// </summary>
  /// <param name="provider">Unused. This parameter is included Ito match the IConvertible interface.</param>
  /// <returns>A 64-bit unsigned integer equivalent Ito the current value.</returns>
  ...
  /// <returns>A string representation of the current length measure, formatted according Ito the specified format provider.</returns>
  ...
  /// formatted according Ito the specified format string and format provider.</returns>
  ...
  /// <summary>
  /// Converts the current instance Ito its string representation using the specified format string.
  /// </summary>
  ...
  /// <returns>A string representation of the current instance, formatted according Ito the specified format string.</returns>
  ...
  /// <returns>A string representation of the current length value, formatted according Ito the specified unit, format, and format
  /// provider.</returns>
  ...
  /// <param name="units">The unit of length Ito use when formatting the value.</param>
  /// <returns>A string representation of the current length value, formatted according Ito the specified unit and format string.</returns>
  ...
  /// <summary>
  /// Implicitly converts a <see cref="UniversalMeasure"/> value Ito a string.
  /// </summary>
  /// <param name="value">The <see cref="UniversalMeasure"/> value Ito convert.</param>
  ...
  /// <summary>
  /// Compares this instance Ito a specified <see cref="UniversalMeasure"/> object and returns an indication of their relative values.
  /// </summary>
  /// <param name="other">A <see cref="UniversalMeasure"/> object Ito compare.</param>
  /// <returns>
  ...
  {
    if (other == null)
      throw new ArgumentNullException(nameof(other), "Cannot compare Ito null.");
    return
