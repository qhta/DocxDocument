...
public static class EndnotesPartConverter
{
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.AlternativeFormatImportPart> GetAlternativeFormatImportParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.ChartPart> GetChartParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  private static String? GetContentType(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.DiagramColorsPart> GetDiagramColorsParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.DiagramDataPart> GetDiagramDataParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.DiagramLayoutDefinitionPart> GetDiagramLayoutDefinitionParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.DiagramPersistLayoutPart> GetDiagramPersistLayoutParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.DiagramStylePart> GetDiagramStyleParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.EmbeddedControlPersistencePart> GetEmbeddedControlPersistenceParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.EmbeddedObjectPart> GetEmbeddedObjectParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.EmbeddedPackagePart> GetEmbeddedPackageParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static DocumentModel.Wordprocessing.Endnotes? GetEndnotes(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
    if (openXmlElement?.RootElement is DocumentFormat.OpenXml.Wordprocessing.Endnotes rootElement)
      return DocumentModel.OpenXml.Wordprocessing.EndnotesConverter.CreateModelElement(rootElement);
    return null;
  }
  
  private static void SetEndnotes(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement, DocumentModel.Wordprocessing.Endnotes? value)
  {
    if (value != null)
    {
       var rootElement = DocumentModel.OpenXml.Wordprocessing.EndnotesConverter.CreateOpenXmlElement<DocumentFormat.OpenXml.Wordprocessing.Endnotes>(value);
       if (rootElement != null)
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.ExtendedChartPart> GetExtendedChartParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.ImagePart> GetImageParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  /// </summary>
  private static System.Collections.ObjectModel.Collection<DocumentModel.Packaging.Model3DReferenceRelationshipPart> GetModel3DReferenceRelationshipParts(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
  ...
  private static String? GetRelationshipType(DocumentFormat.OpenXml.Packaging.EndnotesPart openXmlElement)
  {
