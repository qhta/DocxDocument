...
public static class FooterPartConverter
{
  ...
  private static bool CmpAlternativeFormatImportParts(DXPack.FooterPart openXmlElement, Collection<DMPack.AlternativeFormatImportPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpChartParts(DXPack.FooterPart openXmlElement, Collection<DMPack.ChartPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpContentType(DXPack.FooterPart openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDiagramColorsParts(DXPack.FooterPart openXmlElement, Collection<DMPack.DiagramColorsPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpDiagramDataParts(DXPack.FooterPart openXmlElement, Collection<DMPack.DiagramDataPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpDiagramLayoutDefinitionParts(DXPack.FooterPart openXmlElement, Collection<DMPack.DiagramLayoutDefinitionPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpDiagramPersistLayoutParts(DXPack.FooterPart openXmlElement, Collection<DMPack.DiagramPersistLayoutPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpDiagramStyleParts(DXPack.FooterPart openXmlElement, Collection<DMPack.DiagramStylePart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpEmbeddedControlPersistenceParts(DXPack.FooterPart openXmlElement, Collection<DMPack.EmbeddedControlPersistencePart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpEmbeddedObjectParts(DXPack.FooterPart openXmlElement, Collection<DMPack.EmbeddedObjectPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpEmbeddedPackageParts(DXPack.FooterPart openXmlElement, Collection<DMPack.EmbeddedPackagePart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpExtendedChartParts(DXPack.FooterPart openXmlElement, Collection<DMPack.ExtendedChartPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpFooter(DXPack.FooterPart openXmlElement, DMW.Footer? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
      return true;
  }
  ...
  private static bool CmpImageParts(DXPack.FooterPart openXmlElement, Collection<DMPack.ImagePart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpModel3DReferenceRelationshipParts(DXPack.FooterPart openXmlElement, Collection<DMPack.Model3DReferenceRelationshipPart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpRelationshipType(DXPack.FooterPart openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXPack.FooterPart? openXmlElement, DMPack.FooterPart? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static void UpdateOpenXmlElement(DXPack.FooterPart openXmlElement, DMPack.FooterPart value)
  {
