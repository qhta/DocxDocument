...
public static class QuickAccessToolbarCustomizationsPartConverter
{
  ...
  private static bool CmpContentType(DXPack.QuickAccessToolbarCustomizationsPart openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRelationshipType(DXPack.QuickAccessToolbarCustomizationsPart openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXPack.QuickAccessToolbarCustomizationsPart? openXmlElement, DMPack.QuickAccessToolbarCustomizationsPart? value, DiffList? diffs, string? objName)
  {
