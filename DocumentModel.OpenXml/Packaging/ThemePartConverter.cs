...
public static class ThemePartConverter
{
  ...
  private static bool CmpContentType(DXPack.ThemePart openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpImageParts(DXPack.ThemePart openXmlElement, Collection<DMPack.ImagePart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  private static bool CmpRelationshipType(DXPack.ThemePart openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpTheme(DXPack.ThemePart openXmlElement, DMD.Theme? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
      return true;
  }
  ...
  public static bool CompareModelElement(DXPack.ThemePart? openXmlElement, DMPack.ThemePart? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpRelationshipType(openXmlElement, value.RelationshipType, diffs, objName, propName))
        ok = false;
      if (!CmpTheme(openXmlElement, value.Theme, diffs, objName, propName))
        ok = false;
      return ok;
    }
