...
public static class DigitalSignatureOriginPartConverter
{
  ...
  private static bool CmpContentType(DXPack.DigitalSignatureOriginPart openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpRelationshipType(DXPack.DigitalSignatureOriginPart openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpXmlSignatureParts(DXPack.DigitalSignatureOriginPart openXmlElement, Collection<DMPack.XmlSignaturePart>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return true;
  }
  ...
  public static bool CompareModelElement(DXPack.DigitalSignatureOriginPart? openXmlElement, DMPack.DigitalSignatureOriginPart? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpRelationshipType(openXmlElement, value.RelationshipType, diffs, objName, propName))
        ok = false;
      if (!CmpXmlSignatureParts(openXmlElement, value.XmlSignatureParts, diffs, objName, propName))
        ok = false;
      return ok;
    }
