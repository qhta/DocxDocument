...
public static class WebExtensionReferenceListConverter
{
  ...
  private static bool CmpWebExtensionStoreReferences(DXO13WE.WebExtensionReferenceList openXmlElement, Collection<DMWE.WebExtensionStoreReference>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXWE.WebExtensionStoreReferenceConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXO13WE.WebExtensionReferenceList? openXmlElement, DMWE.WebExtensionReferenceList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpWebExtensionStoreReferences(openXmlElement, value.WebExtensionStoreReferences, diffs, objName, propName))
        ok = false;
      return ok;
    }
