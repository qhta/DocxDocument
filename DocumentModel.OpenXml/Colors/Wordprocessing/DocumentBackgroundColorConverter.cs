...
/// <summary>
/// <see cref="DM.Color"/> model class from/to OpenXml <see cref="DXW.DocumentBackground"/> class converter.
/// </summary>
public static class DocumentBackgroundColorConverter
{
  #region Color value conversion.
  private static DM.Color? GetVal(DXW.DocumentBackground openXmlElement)
  {
    return ColorValueConverter.GetValue(openXmlElement?.Color);
  }

  private static bool CmpVal(DXW.DocumentBackground openXmlElement, DM.Color? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return ColorValueConverter.CmpValue(openXmlElement?.Color, value, diffs, objName, "Value");
  }

  private static void SetVal(DXW.DocumentBackground openXmlElement, DM.Color? value)
  {
  ...
  private static DMW.ThemeColorIndex? GetThemeColorIndex(DXW.DocumentBackground openXmlElement)
  {
    return EnumValueConverter.GetValue<DXW.ThemeColorValues, DMW.ThemeColorIndex>(openXmlElement?.ThemeColor?.Value);
  }

  private static bool CmpThemeColorIndex(DXW.DocumentBackground openXmlElement, DMW.ThemeColorIndex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetThemeColorIndex(DXW.DocumentBackground openXmlElement, DMW.ThemeColorIndex? value)
  {
  ...
  private static bool CmpThemeTint(DXW.DocumentBackground openXmlElement, Percent? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpThemeShade(DXW.DocumentBackground openXmlElement, Percent? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DM.Color? CreateModelElement(DXW.DocumentBackground? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXW.DocumentBackground? openXmlElement, DM.Color? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static void UpdateOpenXmlElement(DXW.DocumentBackground openXmlElement, DM.Color? value)
  {
    if (value == null)
    {
