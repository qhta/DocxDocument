...
public static class DocumentBackgroundColorConverter
{
  ...
  private static bool CmpVal(DXW.DocumentBackground openXmlElement, DM.Color? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpThemeColorIndex(DXW.DocumentBackground openXmlElement, DMW.ThemeColorIndex? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXW.DocumentBackground? openXmlElement, DM.Color? value, DiffList? diffs, string? objName)
  {
