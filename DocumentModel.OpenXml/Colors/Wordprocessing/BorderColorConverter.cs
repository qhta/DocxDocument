...
public static class BorderColorConverter
{
  ...
  private static bool CmpVal(DXW.Border openXmlElement, DM.Color? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpThemeColorIndex(DXW.Border openXmlElement, DMW.ThemeColorIndex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpThemeTint(DXW.Border openXmlElement, Percent? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpThemeShade(DXW.Border openXmlElement, Percent? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXW.Border? openXmlElement, DM.Color? value, DiffList? diffs, string? objName)
  {
