...
/// <summary>
/// <see cref="DM.Color"/> model class from/to OpenXml <see cref="DXW.BorderType"/> class converter.
/// </summary>
public static class BorderTypeColorConverter
{
  ...
  private static DMW.ThemeColorIndex? GetThemeColorIndex(DXW.BorderType openXmlElement)
  {
  ...
  public static DM.Color? CreateModelElement(DXW.BorderType? openXmlElement)
  {
  ...
  public static void UpdateOpenXmlElement(DXW.BorderType openXmlElement, DM.Color? value)
  {
    if (value == null)
    {
