...
public static class GridlineMinorConverter
{
  ...
  public static DMDrawsChartsStyle.GridlineMinor? CreateModelElement(DXO2013DrawChartStyle.GridlineMinor? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.GridlineMinor();
