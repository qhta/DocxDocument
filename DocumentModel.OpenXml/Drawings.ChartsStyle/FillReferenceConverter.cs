...
public static class FillReferenceConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXO13DCS.FillReference openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXO13DCS.FillReference openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXO13DCS.FillReference openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXO13DCS.FillReference openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXO13DCS.FillReference openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXO13DCS.FillReference openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpStyleColor(DXO13DCS.FillReference openXmlElement, DMDCS.StyleColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.FillReference? openXmlElement, DMDCS.FillReference? value, DiffList? diffs, string? objName)
  {
