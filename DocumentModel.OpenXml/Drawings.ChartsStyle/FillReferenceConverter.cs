...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXO13DCS.FillReference openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXO13DCS.FillReference openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXO13DCS.FillReference openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXO13DCS.FillReference openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXO13DCS.FillReference openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXO13DCS.FillReference openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXO13DCS.FillReference openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXO13DCS.FillReference openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXO13DCS.FillReference openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXO13DCS.FillReference openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXO13DCS.FillReference openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXO13DCS.FillReference openXmlElement, DMD.PresetColor? value)
  {
  ...
  private static DMDCS.StyleColor? GetStyleColor(DXO13DCS.FillReference openXmlElement)
  {
  ...
  private static bool CmpStyleColor(DXO13DCS.FillReference openXmlElement, DMDCS.StyleColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetStyleColor(DXO13DCS.FillReference openXmlElement, DMDCS.StyleColor? value)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.FillReference? openXmlElement, DMDCS.FillReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCS.FillReference value)
    where OpenXmlElementType: DXO13DCS.FillReference, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO13DCS.FillReference openXmlElement, DMDCS.FillReference value)
  {
