...
using FillReference = DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.FillReference;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(FillReference? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(FillReference? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(FillReference? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(FillReference? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(FillReference? openXmlElement)
  {
  ...
  public static void SetHslColor(FillReference? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(FillReference? openXmlElement)
  {
  ...
  public static void SetSystemColor(FillReference? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(FillReference? openXmlElement)
  {
  ...
  public static void SetSchemeColor(FillReference? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(FillReference? openXmlElement)
  {
  ...
  public static void SetPresetColor(FillReference? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static StyleColor? GetStyleColor(FillReference? openXmlElement)
  {
  ...
  public static void SetStyleColor(FillReference? openXmlElement, StyleColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.StyleColor>();
  ...
  public static DocumentModel.Drawings.ChartsStyle.FillReference? CreateModelElement(FillReference? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.ChartsStyle.FillReference? value)
    where OpenXmlElementType : FillReference, new()
  {
    if (value != null)
    {
