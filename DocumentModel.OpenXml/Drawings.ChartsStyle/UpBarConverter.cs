...
/// <summary>
/// Defines the UpBar Class converter from/to OpenXml.
///</summary>
public static class UpBarConverter
{
  ...
  private static void SetLineReference(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.LineReference? value)
  {
  ...
  private static String? GetLineWidthScale(DXO2013DrawChartStyle.UpBar openXmlElement)
  {
      return openXmlElement?.GetFirstChild<DXO2013DrawChartStyle.LineWidthScale>()?.Text;
  }
  
  private static bool CmpLineWidthScale(DXO2013DrawChartStyle.UpBar openXmlElement, String? value, DiffList? diffs, string? objName)
  {
      return openXmlElement?.GetFirstChild<DXO2013DrawChartStyle.LineWidthScale>()?.Text == value;
  }
  
  private static void SetLineWidthScale(DXO2013DrawChartStyle.UpBar openXmlElement, String? value)
  {
  ...
  private static void SetFillReference(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.FillReference? value)
  {
  ...
  private static void SetEffectReference(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.EffectReference? value)
  {
  ...
  private static void SetFontReference(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.FontReference? value)
  {
  ...
  private static void SetShapeProperties(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.ShapeProperties? value)
  {
  ...
  private static void SetTextCharacterPropertiesType(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.TextCharacterPropertiesType? value)
  {
  ...
  private static void SetTextBodyProperties(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.TextBodyProperties? value)
  {
  ...
  private static void SetOfficeArtExtensionList(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.OfficeArtExtensionList? value)
  {
  ...
  public static bool CompareModelElement(DXO2013DrawChartStyle.UpBar? openXmlElement, DMDrawsChartsStyle.UpBar? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDrawsChartsStyle.UpBar value)
    where OpenXmlElementType: DXO2013DrawChartStyle.UpBar, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO2013DrawChartStyle.UpBar openXmlElement, DMDrawsChartsStyle.UpBar value)
  {
