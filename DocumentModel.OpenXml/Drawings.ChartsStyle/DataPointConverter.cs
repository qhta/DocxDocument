...
public static class DataPointConverter
{
  ...
  public static DMDrawsChartsStyle.DataPoint? CreateModelElement(DXO2013DrawChartStyle.DataPoint? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataPoint();
