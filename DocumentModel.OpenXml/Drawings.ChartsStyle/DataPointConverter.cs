...
{
  private static DMDCS.LineReference? GetLineReference(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpLineReference(DXO13DCS.DataPoint openXmlElement, DMDCS.LineReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetLineReference(DXO13DCS.DataPoint openXmlElement, DMDCS.LineReference? value)
  {
  ...
  private static String? GetLineWidthScale(DXO13DCS.DataPoint openXmlElement)
  {
      return openXmlElement?.GetFirstChild<DXO13DCS.LineWidthScale>()?.Text;
  }
  
  private static bool CmpLineWidthScale(DXO13DCS.DataPoint openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
      return openXmlElement?.GetFirstChild<DXO13DCS.LineWidthScale>()?.Text == value;
  }
  
  private static void SetLineWidthScale(DXO13DCS.DataPoint openXmlElement, String? value)
  {
  ...
  private static DMDCS.FillReference? GetFillReference(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.DataPoint openXmlElement, DMDCS.FillReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetFillReference(DXO13DCS.DataPoint openXmlElement, DMDCS.FillReference? value)
  {
  ...
  private static DMDCS.EffectReference? GetEffectReference(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.DataPoint openXmlElement, DMDCS.EffectReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetEffectReference(DXO13DCS.DataPoint openXmlElement, DMDCS.EffectReference? value)
  {
  ...
  private static DMDCS.FontReference? GetFontReference(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.DataPoint openXmlElement, DMDCS.FontReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetFontReference(DXO13DCS.DataPoint openXmlElement, DMDCS.FontReference? value)
  {
  ...
  private static DMDCS.ShapeProperties? GetShapeProperties(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.DataPoint openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetShapeProperties(DXO13DCS.DataPoint openXmlElement, DMDCS.ShapeProperties? value)
  {
  ...
  private static DMDCS.TextCharacterPropertiesType? GetTextCharacterPropertiesType(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.DataPoint openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetTextCharacterPropertiesType(DXO13DCS.DataPoint openXmlElement, DMDCS.TextCharacterPropertiesType? value)
  {
  ...
  private static DMDCS.TextBodyProperties? GetTextBodyProperties(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.DataPoint openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetTextBodyProperties(DXO13DCS.DataPoint openXmlElement, DMDCS.TextBodyProperties? value)
  {
  ...
  private static DMDCS.OfficeArtExtensionList? GetOfficeArtExtensionList(DXO13DCS.DataPoint openXmlElement)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.DataPoint openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetOfficeArtExtensionList(DXO13DCS.DataPoint openXmlElement, DMDCS.OfficeArtExtensionList? value)
  {
  ...
  public static DocumentModel.Drawings.ChartsStyle.DataPoint? CreateModelElement(DXO13DCS.DataPoint? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.DataPoint? openXmlElement, DMDCS.DataPoint? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCS.DataPoint value)
    where OpenXmlElementType: DXO13DCS.DataPoint, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO13DCS.DataPoint openXmlElement, DMDCS.DataPoint value)
  {
