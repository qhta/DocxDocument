...
public static class DataPointMarkerConverter
{
  ...
  public static DMDrawsChartsStyle.DataPointMarker? CreateModelElement(DXO2013DrawChartStyle.DataPointMarker? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataPointMarker();
