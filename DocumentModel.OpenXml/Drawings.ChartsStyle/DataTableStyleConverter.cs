...
public static class DataTableStyleConverter
{
  ...
  public static DMDrawsChartsStyle.DataTableStyle? CreateModelElement(DXO2013DrawChartStyle.DataTableStyle? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataTableStyle();
