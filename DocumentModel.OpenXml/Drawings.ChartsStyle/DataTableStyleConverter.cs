...
public static class DataTableStyleConverter
{
  ...
  private static bool CmpLineReference(DXO13DCS.DataTableStyle openXmlElement, DMDCS.LineReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineWidthScale(DXO13DCS.DataTableStyle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.DataTableStyle openXmlElement, DMDCS.FillReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.DataTableStyle openXmlElement, DMDCS.EffectReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.DataTableStyle openXmlElement, DMDCS.FontReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.DataTableStyle openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.DataTableStyle openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.DataTableStyle openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.DataTableStyle openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.DataTableStyle? openXmlElement, DMDCS.DataTableStyle? value, DiffList? diffs, string? objName)
  {
