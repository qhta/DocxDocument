...
public static class EffectReferenceConverter
{
  ...
  private static DMDraws.RgbColorModelHex? GetRgbColorModelHex(DXO2013DrawChartStyle.EffectReference openXmlElement)
  {
  ...
  private static DMDraws.HslColor? GetHslColor(DXO2013DrawChartStyle.EffectReference openXmlElement)
  {
  ...
  private static DMDraws.SystemColor? GetSystemColor(DXO2013DrawChartStyle.EffectReference openXmlElement)
  {
  ...
  private static DMDraws.SchemeColor? GetSchemeColor(DXO2013DrawChartStyle.EffectReference openXmlElement)
  {
  ...
  private static DMDraws.PresetColor? GetPresetColor(DXO2013DrawChartStyle.EffectReference openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.StyleColor? GetStyleColor(DXO2013DrawChartStyle.EffectReference openXmlElement)
  {
  ...
  public static DocumentModel.Drawings.ChartsStyle.EffectReference? CreateModelElement(DXO2013DrawChartStyle.EffectReference? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO2013DrawChartStyle.EffectReference? openXmlElement, DMDrawsChartsStyle.EffectReference? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDrawsChartsStyle.EffectReference value)
    where OpenXmlElementType: DXO2013DrawChartStyle.EffectReference, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO2013DrawChartStyle.EffectReference openXmlElement, DMDrawsChartsStyle.EffectReference value)
  {
