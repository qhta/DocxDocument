...
public static class EffectReferenceConverter
{
  ...
  public static DMDrawsChartsStyle.EffectReference? CreateModelElement(DXO2013DrawChartStyle.EffectReference? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.EffectReference();
