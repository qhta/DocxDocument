...
public static class EffectReferenceConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXO13DCS.EffectReference openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXO13DCS.EffectReference openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXO13DCS.EffectReference openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXO13DCS.EffectReference openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXO13DCS.EffectReference openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXO13DCS.EffectReference openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpStyleColor(DXO13DCS.EffectReference openXmlElement, DMDCS.StyleColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.EffectReference? openXmlElement, DMDCS.EffectReference? value, DiffList? diffs, string? objName)
  {
