...
public static class TrendlineStyleConverter
{
  ...
  public static DMDrawsChartsStyle.TrendlineStyle? CreateModelElement(DXO2013DrawChartStyle.TrendlineStyle? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.TrendlineStyle();
