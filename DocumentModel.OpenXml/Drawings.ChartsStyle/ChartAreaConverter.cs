...
public static class ChartAreaConverter
{
  ...
  public static DMDrawsChartsStyle.ChartArea? CreateModelElement(DXO2013DrawChartStyle.ChartArea? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.ChartArea();
