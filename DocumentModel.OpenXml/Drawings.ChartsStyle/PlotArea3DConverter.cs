...
public static class PlotArea3DConverter
{
  ...
  private static bool CmpLineReference(DXO13DCS.PlotArea3D openXmlElement, DMDCS.LineReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineWidthScale(DXO13DCS.PlotArea3D openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.PlotArea3D openXmlElement, DMDCS.FillReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.PlotArea3D openXmlElement, DMDCS.EffectReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.PlotArea3D openXmlElement, DMDCS.FontReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.PlotArea3D openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.PlotArea3D openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.PlotArea3D openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.PlotArea3D openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.PlotArea3D? openXmlElement, DMDCS.PlotArea3D? value, DiffList? diffs, string? objName)
  {
