...
public static class PlotArea3DConverter
{
  ...
  public static DMDrawsChartsStyle.PlotArea3D? CreateModelElement(DXO2013DrawChartStyle.PlotArea3D? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.PlotArea3D();
