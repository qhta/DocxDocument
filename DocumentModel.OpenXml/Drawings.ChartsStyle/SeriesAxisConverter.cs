...
public static class SeriesAxisConverter
{
  ...
  public static DMDrawsChartsStyle.SeriesAxis? CreateModelElement(DXO2013DrawChartStyle.SeriesAxis? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.SeriesAxis();
