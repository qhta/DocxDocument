...
{
  private static DMDCS.LineReference? GetLineReference(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static String? GetLineWidthScale(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static void SetLineWidthScale(DXO13DCS.SeriesAxis openXmlElement, String? value)
  {
  ...
  private static DMDCS.FillReference? GetFillReference(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static DMDCS.EffectReference? GetEffectReference(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static DMDCS.FontReference? GetFontReference(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static DMDCS.ShapeProperties? GetShapeProperties(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static DMDCS.TextCharacterPropertiesType? GetTextCharacterPropertiesType(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static DMDCS.TextBodyProperties? GetTextBodyProperties(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  private static DMDCS.OfficeArtExtensionList? GetOfficeArtExtensionList(DXO13DCS.SeriesAxis openXmlElement)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCS.SeriesAxis value)
    where OpenXmlElementType: DXO13DCS.SeriesAxis, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO13DCS.SeriesAxis openXmlElement, DMDCS.SeriesAxis value)
  {
