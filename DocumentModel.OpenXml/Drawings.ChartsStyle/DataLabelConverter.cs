...
public static class DataLabelConverter
{
  ...
  public static DMDrawsChartsStyle.DataLabel? CreateModelElement(DXO2013DrawChartStyle.DataLabel? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataLabel();
