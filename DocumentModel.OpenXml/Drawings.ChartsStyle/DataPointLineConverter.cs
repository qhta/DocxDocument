...
public static class DataPointLineConverter
{
  ...
  public static DMDrawsChartsStyle.DataPointLine? CreateModelElement(DXO2013DrawChartStyle.DataPointLine? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataPointLine();
