...
public static class TrendlineLabelConverter
{
  ...
  public static DMDrawsChartsStyle.TrendlineLabel? CreateModelElement(DXO2013DrawChartStyle.TrendlineLabel? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.TrendlineLabel();
