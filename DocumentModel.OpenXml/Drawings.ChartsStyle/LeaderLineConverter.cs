...
public static class LeaderLineConverter
{
  ...
  public static DMDrawsChartsStyle.LeaderLine? CreateModelElement(DXO2013DrawChartStyle.LeaderLine? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.LeaderLine();
