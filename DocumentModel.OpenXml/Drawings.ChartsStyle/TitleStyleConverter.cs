...
public static class TitleStyleConverter
{
  ...
  private static bool CmpLineReference(DXO13DCS.TitleStyle openXmlElement, DMDCS.LineReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineWidthScale(DXO13DCS.TitleStyle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.TitleStyle openXmlElement, DMDCS.FillReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.TitleStyle openXmlElement, DMDCS.EffectReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.TitleStyle openXmlElement, DMDCS.FontReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.TitleStyle openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.TitleStyle openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.TitleStyle openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.TitleStyle openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.TitleStyle? openXmlElement, DMDCS.TitleStyle? value, DiffList? diffs, string? objName)
  {
