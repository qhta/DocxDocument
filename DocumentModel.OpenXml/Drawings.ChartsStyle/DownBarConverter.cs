...
public static class DownBarConverter
{
  ...
  private static bool CmpLineReference(DXO13DCS.DownBar openXmlElement, DMDCS.LineReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineWidthScale(DXO13DCS.DownBar openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.DownBar openXmlElement, DMDCS.FillReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.DownBar openXmlElement, DMDCS.EffectReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.DownBar openXmlElement, DMDCS.FontReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.DownBar openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.DownBar openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.DownBar openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.DownBar openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.DownBar? openXmlElement, DMDCS.DownBar? value, DiffList? diffs, string? objName)
  {
