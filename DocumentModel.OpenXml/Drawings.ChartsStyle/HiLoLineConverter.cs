...
/// <summary>
/// Defines the HiLoLine Class converter from/to OpenXml.
///</summary>
public static class HiLoLineConverter
{
  private static DMDrawsChartsStyle.LineReference? GetLineReference(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static String? GetLineWidthScale(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
      return openXmlElement?.GetFirstChild<DXO2013DrawChartStyle.LineWidthScale>()?.Text;
  }
  
  private static bool CmpLineWidthScale(DXO2013DrawChartStyle.HiLoLine openXmlElement, String? value, DiffList? diffs, string? objName)
  {
      return openXmlElement?.GetFirstChild<DXO2013DrawChartStyle.LineWidthScale>()?.Text == value;
  }
  
  private static void SetLineWidthScale(DXO2013DrawChartStyle.HiLoLine openXmlElement, String? value)
  {
  ...
  private static DMDrawsChartsStyle.FillReference? GetFillReference(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.EffectReference? GetEffectReference(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.FontReference? GetFontReference(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.ShapeProperties? GetShapeProperties(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.TextCharacterPropertiesType? GetTextCharacterPropertiesType(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.TextBodyProperties? GetTextBodyProperties(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  private static DMDrawsChartsStyle.OfficeArtExtensionList? GetOfficeArtExtensionList(DXO2013DrawChartStyle.HiLoLine openXmlElement)
  {
  ...
  public static DocumentModel.Drawings.ChartsStyle.HiLoLine? CreateModelElement(DXO2013DrawChartStyle.HiLoLine? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO2013DrawChartStyle.HiLoLine? openXmlElement, DMDrawsChartsStyle.HiLoLine? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDrawsChartsStyle.HiLoLine value)
    where OpenXmlElementType: DXO2013DrawChartStyle.HiLoLine, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO2013DrawChartStyle.HiLoLine openXmlElement, DMDrawsChartsStyle.HiLoLine value)
  {
