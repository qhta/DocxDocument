...
public static class GridlineMajorConverter
{
  ...
  public static DMDrawsChartsStyle.GridlineMajor? CreateModelElement(DXO2013DrawChartStyle.GridlineMajor? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.GridlineMajor();
