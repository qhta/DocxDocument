...
public static class PlotAreaConverter
{
  ...
  private static bool CmpLineReference(DXO13DCS.PlotArea openXmlElement, DMDCS.LineReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpLineWidthScale(DXO13DCS.PlotArea openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.PlotArea openXmlElement, DMDCS.FillReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.PlotArea openXmlElement, DMDCS.EffectReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.PlotArea openXmlElement, DMDCS.FontReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.PlotArea openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.PlotArea openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.PlotArea openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.PlotArea openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMDCS.PlotArea? CreateModelElement(DXO13DCS.PlotArea? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDCS.PlotArea();
  ...
  public static bool CompareModelElement(DXO13DCS.PlotArea? openXmlElement, DMDCS.PlotArea? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
