...
public static class PlotAreaConverter
{
  ...
  private static bool CmpLineReference(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.LineReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineWidthScale(DXO2013DrawChartStyle.PlotArea openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFillReference(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.FillReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpEffectReference(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.EffectReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpFontReference(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.FontReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpShapeProperties(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.ShapeProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.TextCharacterPropertiesType? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTextBodyProperties(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.TextBodyProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.OfficeArtExtensionList? value, DiffList? diffs, string? objName)
  {
  ...
  public static DocumentModel.Drawings.ChartsStyle.PlotArea? CreateModelElement(DXO2013DrawChartStyle.PlotArea? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO2013DrawChartStyle.PlotArea? openXmlElement, DMDrawsChartsStyle.PlotArea? value, DiffList? diffs, string? objName)
  {
  ...
  public static void UpdateOpenXmlElement(DXO2013DrawChartStyle.PlotArea openXmlElement, DMDrawsChartsStyle.PlotArea value)
  {
