...
public static class SeriesLineConverter
{
  ...
  public static DMDrawsChartsStyle.SeriesLine? CreateModelElement(DXO2013DrawChartStyle.SeriesLine? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.SeriesLine();
