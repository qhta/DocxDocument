...
using ShapeProperties = DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.ShapeProperties;
...
public static class ShapePropertiesConverter
{
  ...
  public static DocumentModel.Drawings.ChartsStyle.ShapeProperties? CreateModelElement(ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
