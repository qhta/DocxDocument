...
public static class CategoryAxisConverter
{
  ...
  public static DMDrawsChartsStyle.CategoryAxis? CreateModelElement(DXO2013DrawChartStyle.CategoryAxis? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.CategoryAxis();
