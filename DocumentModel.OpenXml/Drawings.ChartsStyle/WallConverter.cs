...
{
  private static DMDCS.LineReference? GetLineReference(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpLineReference(DXO13DCS.Wall openXmlElement, DMDCS.LineReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetLineReference(DXO13DCS.Wall openXmlElement, DMDCS.LineReference? value)
  {
  ...
  private static String? GetLineWidthScale(DXO13DCS.Wall openXmlElement)
  {
      return openXmlElement?.GetFirstChild<DXO13DCS.LineWidthScale>()?.Text;
  }
  
  private static bool CmpLineWidthScale(DXO13DCS.Wall openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
      return openXmlElement?.GetFirstChild<DXO13DCS.LineWidthScale>()?.Text == value;
  }
  
  private static void SetLineWidthScale(DXO13DCS.Wall openXmlElement, String? value)
  {
  ...
  private static DMDCS.FillReference? GetFillReference(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpFillReference(DXO13DCS.Wall openXmlElement, DMDCS.FillReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetFillReference(DXO13DCS.Wall openXmlElement, DMDCS.FillReference? value)
  {
  ...
  private static DMDCS.EffectReference? GetEffectReference(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpEffectReference(DXO13DCS.Wall openXmlElement, DMDCS.EffectReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetEffectReference(DXO13DCS.Wall openXmlElement, DMDCS.EffectReference? value)
  {
  ...
  private static DMDCS.FontReference? GetFontReference(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpFontReference(DXO13DCS.Wall openXmlElement, DMDCS.FontReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetFontReference(DXO13DCS.Wall openXmlElement, DMDCS.FontReference? value)
  {
  ...
  private static DMDCS.ShapeProperties? GetShapeProperties(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpShapeProperties(DXO13DCS.Wall openXmlElement, DMDCS.ShapeProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetShapeProperties(DXO13DCS.Wall openXmlElement, DMDCS.ShapeProperties? value)
  {
  ...
  private static DMDCS.TextCharacterPropertiesType? GetTextCharacterPropertiesType(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpTextCharacterPropertiesType(DXO13DCS.Wall openXmlElement, DMDCS.TextCharacterPropertiesType? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetTextCharacterPropertiesType(DXO13DCS.Wall openXmlElement, DMDCS.TextCharacterPropertiesType? value)
  {
  ...
  private static DMDCS.TextBodyProperties? GetTextBodyProperties(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpTextBodyProperties(DXO13DCS.Wall openXmlElement, DMDCS.TextBodyProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetTextBodyProperties(DXO13DCS.Wall openXmlElement, DMDCS.TextBodyProperties? value)
  {
  ...
  private static DMDCS.OfficeArtExtensionList? GetOfficeArtExtensionList(DXO13DCS.Wall openXmlElement)
  {
  ...
  private static bool CmpOfficeArtExtensionList(DXO13DCS.Wall openXmlElement, DMDCS.OfficeArtExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetOfficeArtExtensionList(DXO13DCS.Wall openXmlElement, DMDCS.OfficeArtExtensionList? value)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.Wall? openXmlElement, DMDCS.Wall? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCS.Wall value)
    where OpenXmlElementType: DXO13DCS.Wall, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO13DCS.Wall openXmlElement, DMDCS.Wall value)
  {
