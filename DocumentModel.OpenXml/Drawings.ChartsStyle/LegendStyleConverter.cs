...
public static class LegendStyleConverter
{
  ...
  public static DMDrawsChartsStyle.LegendStyle? CreateModelElement(DXO2013DrawChartStyle.LegendStyle? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.LegendStyle();
