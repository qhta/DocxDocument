...
public static class DataPoint3DConverter
{
  ...
  public static DMDrawsChartsStyle.DataPoint3D? CreateModelElement(DXO2013DrawChartStyle.DataPoint3D? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataPoint3D();
