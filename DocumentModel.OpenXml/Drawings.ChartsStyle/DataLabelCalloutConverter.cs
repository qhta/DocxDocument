...
public static class DataLabelCalloutConverter
{
  ...
  public static DMDrawsChartsStyle.DataLabelCallout? CreateModelElement(DXO2013DrawChartStyle.DataLabelCallout? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.DataLabelCallout();
