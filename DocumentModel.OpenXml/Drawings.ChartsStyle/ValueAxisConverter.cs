...
public static class ValueAxisConverter
{
  ...
  public static DMDrawsChartsStyle.ValueAxis? CreateModelElement(DXO2013DrawChartStyle.ValueAxis? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartsStyle.ValueAxis();
