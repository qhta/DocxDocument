...
public static class LineReferenceConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXO13DCS.LineReference openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXO13DCS.LineReference openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXO13DCS.LineReference openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXO13DCS.LineReference openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXO13DCS.LineReference openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXO13DCS.LineReference openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpStyleColor(DXO13DCS.LineReference openXmlElement, DMDCS.StyleColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.LineReference? openXmlElement, DMDCS.LineReference? value, DiffList? diffs, string? objName)
  {
