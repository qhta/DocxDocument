...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXO13DCS.LineReference openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXO13DCS.LineReference openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXO13DCS.LineReference openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXO13DCS.LineReference openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXO13DCS.LineReference openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXO13DCS.LineReference openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXO13DCS.LineReference openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXO13DCS.LineReference openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXO13DCS.LineReference openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXO13DCS.LineReference openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXO13DCS.LineReference openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXO13DCS.LineReference openXmlElement, DMD.PresetColor? value)
  {
  ...
  private static DMDCS.StyleColor? GetStyleColor(DXO13DCS.LineReference openXmlElement)
  {
  ...
  private static bool CmpStyleColor(DXO13DCS.LineReference openXmlElement, DMDCS.StyleColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetStyleColor(DXO13DCS.LineReference openXmlElement, DMDCS.StyleColor? value)
  {
  ...
  public static bool CompareModelElement(DXO13DCS.LineReference? openXmlElement, DMDCS.LineReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCS.LineReference value)
    where OpenXmlElementType: DXO13DCS.LineReference, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO13DCS.LineReference openXmlElement, DMDCS.LineReference value)
  {
