...
{
  public static object? GetValue(DocumentFormat.OpenXml.OpenXmlElement openXmlElement)
  {
    ...
    if (openXmlElement is VTError vError)
      return new HexWord(vError.Text);
  ...
  public static Variant CreateModelElement(DocumentFormat.OpenXml.OpenXmlElement openXmlElement)
  {
    if (openXmlElement is VTBool vBool)
  ...
  public static DocumentFormat.OpenXml.OpenXmlElement CreateOpenXmlElement(Variant variant)
  {
    switch (variant.VariantType)
    {
      case VariantType.Bool:
        return new VTBool { Text = XmlConvert.ToString(variant.ToBoolean(null)) };
      ...
      case VariantType.SByte:
        return new VTByte { Text = XmlConvert.ToString(variant.ToSByte(null)) };
      case VariantType.Byte:
        return new VTUnsignedByte { Text = XmlConvert.ToString(variant.ToByte(null)) };
      case VariantType.Int16:
        return new VTShort { Text = XmlConvert.ToString(variant.ToInt16(null)) };
      case VariantType.UInt16:
        return new VTUnsignedShort { Text = XmlConvert.ToString(variant.ToUInt16(null)) };
      case VariantType.Int32:
        return new VTInt32 { Text = XmlConvert.ToString(variant.ToInt32(null)) };
      case VariantType.UInt32:
        return new VTUnsignedInt32 { Text = XmlConvert.ToString(variant.ToUInt32(null)) };
      case VariantType.Int64:
        return new VTInt64 { Text = XmlConvert.ToString(variant.ToInt64(null)) };
      case VariantType.UInt64:
        return new VTUnsignedInt64 { Text = XmlConvert.ToString(variant.ToUInt64(null)) };
      case VariantType.Integer:
        return new VTInt64 { Text = XmlConvert.ToString(variant.ToDecimal(null)) };
      case VariantType.UnsignedInteger:
        return new VTUnsignedInt64 { Text = XmlConvert.ToString(variant.ToDecimal(null)) };
      case VariantType.Single:
        return new VTFloat { Text = XmlConvert.ToString(variant.ToSingle(null)) };
      case VariantType.Double:
        return new VTDouble { Text = XmlConvert.ToString(variant.ToDouble(null)) };
      case VariantType.Decimal:
        return new VTDecimal { Text = XmlConvert.ToString(variant.ToDecimal(null)) };
      case VariantType.Currency:
        return new VTCurrency { Text = XmlConvert.ToString(variant.ToDecimal(null)) };
      case VariantType.Date:
        return new VTDate { Text = XmlConvert.ToString(variant.ToDateTime(null), "yyyy-MM-dd") };
      case VariantType.DateTime:
        return new VTFileTime { Text = XmlConvert.ToString(variant.ToDateTime(null), XmlDateTimeSerializationMode.Unspecified) };
      case VariantType.Null:
        return new VTNull();
      case VariantType.Empty:
        return new VTEmpty();
      case VariantType.ClassId:
        return new VTClassId { Text = XmlConvert.ToString(variant.ToGuid(null)) };
      case VariantType.Error:
        return new VTError { Text = (variant.Value is HexWord hexWord) ? hexWord.ToString() : string.Empty };
      ...
      case VariantType.Variant:
        ...
        if (variant.Value is Variant variantValue)
        {
