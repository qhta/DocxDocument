...
public static class LimitConverter
{
  ...
  private static bool CmpArgumentProperties(DXM.Limit openXmlElement, DMM.ArgumentProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpControlProperties(DXM.Limit openXmlElement, DMM.ControlProperties? value, DiffList? diffs, string? objName)
  {
  ...
  public static DMM.IMathArgumentContent? CreateLimitContent(DX.OpenXmlElement? openXmlElement, object? data = null)
  {
  ...
  public static OpenXmlElement CreateOpenXmlLimitContent(DM.IModelElement model, object? data = null)
  {
  ...
  public static bool UpdateOpenXmlLimitContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, object? data = null)
  {
    if (openXmlElement != null && model != null)
    {
      if (openXmlElement is DXM.Run run && model is DMM.Run runModel)
  ...
  public static bool CompareModelElement(DXM.Limit? openXmlElement, DMM.Limit? model, DiffList? diffs, string? objName)
  {
    if (openXmlElement != null && model != null)
    {
      var ok = true;
      ...
      if (!ElementCollectionConverter<DMM.IMathArgumentContent>.CompareOpenXmlElementCollection(
        openXmlElement.Where(item=>item is not DXM.ArgumentProperties && item is not DXM.ControlProperties), model,
        CompareLimitContent, diffs, objName))
        ok = false;
