...
/// <summary>
/// <see cref="DMM.Limit"/> class from/to OpenXml converter.
/// </summary>
public static class LimitConverter
{
  #region ArgumentProperties conversion.
  private static DMM.ArgumentProperties? GetArgumentProperties(DXM.Limit openXmlElement)
  {
  ...
  private static bool CmpArgumentProperties(DXM.Limit openXmlElement, DMM.ArgumentProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetArgumentProperties(DXM.Limit openXmlElement, DMM.ArgumentProperties? value)
  {
  ...
  private static DMM.Accent? GetAccent(DXM.Limit openXmlElement)
  {
  ...
  private static DMM.ControlProperties? GetControlProperties(DXM.Limit openXmlElement)
  {
  ...
  private static bool CmpControlProperties(DXM.Limit openXmlElement, DMM.ControlProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetControlProperties(DXM.Limit openXmlElement, DMM.ControlProperties? value)
  {
  ...
  #region Limit content conversion
  public static DMM.IMathArgumentContent? CreateLimitContent(DX.OpenXmlElement? openXmlElement)
  {
    ...
    if (openXmlElement != null)
      throw new InvalidOperationException($"Element \"{openXmlElement.GetType()}\" not recognized in LimitContentConverter.CreateModelElement method");
    return null;
  }

  public static bool CompareLimitContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, 
  ...
  public static OpenXmlElement CreateOpenXmlLimitContent(DM.IModelElement model)
  {
    ...
    throw new InvalidOperationException($"Type of type \"{model.GetType()}\" not supported in LimitContentConverter.CreateOpenXmlLimitContent method");
  }

  public static bool UpdateOpenXmlLimitContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model)
  {
    if (openXmlElement != null && model != null)
    {
      if (openXmlElement is DXM.Run run && model is DMM.Run runModel)
  ...
  #region Limit model conversion.
  public static DMM.Limit? CreateModelElement(DXM.Limit? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var model = new DMM.Limit();
  ...
  public static bool CompareModelElement(DXM.Limit? openXmlElement, DMM.Limit? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && model != null)
    {
      var ok = true;
      ...
      if (!ElementCollectionConverter<DMM.IMathArgumentContent>.CompareOpenXmlElementCollection(
        openXmlElement.Where(item=>item is not DXM.ArgumentProperties && item is not DXM.ControlProperties), model,
        CompareLimitContent, diffs, objName, propName))
        ok = false;
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMM.Limit value)
    where OpenXmlElementType: DXM.Limit, new()
  {
  ...
  public static bool UpdateOpenXmlElement(DXM.Limit openXmlElement, DMM.Limit model)
  {
    ...
    return ElementCollectionConverter<DMM.IMathArgumentContent>.UpdateOpenXmlElementCollection(openXmlElement, model,
      CompareLimitContent,
      UpdateOpenXmlLimitContent,
      CreateOpenXmlLimitContent);
  }
  #endregion
}
