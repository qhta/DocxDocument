...
public static class NumeratorConverter
{
  ...
  private static bool CmpArgumentProperties(DXM.Numerator openXmlElement, DMM.ArgumentProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpControlProperties(DXM.Numerator openXmlElement, DMM.ControlProperties? value, DiffList? diffs, string? objName)
  {
  ...
  public static DMM.IMathArgumentContent? CreateNumeratorContent(DX.OpenXmlElement? openXmlElement, object? data = null)
  {
  ...
  public static OpenXmlElement CreateOpenXmlNumeratorContent(DM.IModelElement model, object? data = null)
  {
  ...
  public static bool UpdateOpenXmlNumeratorContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, object? data = null)
  {
    if (openXmlElement != null && model != null)
    {
      if (openXmlElement is DXM.Run run && model is DMM.Run runModel)
  ...
  public static bool CompareModelElement(DXM.Numerator? openXmlElement, DMM.Numerator? model, DiffList? diffs, string? objName)
  {
    if (openXmlElement != null && model != null)
    {
      var ok = true;
      ...
      if (!ElementCollectionConverter<DMM.IMathArgumentContent>.CompareOpenXmlElementCollection(
        openXmlElement.Where(item=>item is not DXM.ArgumentProperties && item is not DXM.ControlProperties), model,
        CompareNumeratorContent, diffs, objName))
        ok = false;
