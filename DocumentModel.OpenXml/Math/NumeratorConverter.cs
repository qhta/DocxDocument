...
/// <summary>
/// <see cref="DMM.Numerator"/> class from/to OpenXml converter.
/// </summary>
public static class NumeratorConverter
{
  #region ArgumentProperties conversion.
  private static DMM.ArgumentProperties? GetArgumentProperties(DXM.Numerator openXmlElement)
  {
  ...
  private static bool CmpArgumentProperties(DXM.Numerator openXmlElement, DMM.ArgumentProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetArgumentProperties(DXM.Numerator openXmlElement, DMM.ArgumentProperties? value)
  {
  ...
  private static DMM.Accent? GetAccent(DXM.Numerator openXmlElement)
  {
  ...
  private static DMM.ControlProperties? GetControlProperties(DXM.Numerator openXmlElement)
  {
  ...
  private static bool CmpControlProperties(DXM.Numerator openXmlElement, DMM.ControlProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetControlProperties(DXM.Numerator openXmlElement, DMM.ControlProperties? value)
  {
  ...
  #region Numerator content conversion
  public static DMM.IMathArgumentContent? CreateNumeratorContent(DX.OpenXmlElement? openXmlElement)
  {
    ...
    if (openXmlElement != null)
      throw new InvalidOperationException($"Element \"{openXmlElement.GetType()}\" not recognized in NumeratorContentConverter.CreateModelElement method");
    return null;
  }

  public static bool CompareNumeratorContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, 
  ...
  public static OpenXmlElement CreateOpenXmlNumeratorContent(DM.IModelElement model)
  {
    ...
    throw new InvalidOperationException($"Type of type \"{model.GetType()}\" not supported in NumeratorContentConverter.CreateOpenXmlNumeratorContent method");
  }

  public static bool UpdateOpenXmlNumeratorContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model)
  {
    if (openXmlElement != null && model != null)
    {
      if (openXmlElement is DXM.Run run && model is DMM.Run runModel)
  ...
  #region Numerator model conversion.
  public static DMM.Numerator? CreateModelElement(DXM.Numerator? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var model = new DMM.Numerator();
      ...
      ElementCollectionConverter<DMM.IMathArgumentContent>.FillModelElementCollection(
        ...
        CreateNumeratorContent);
      return model;
    }
    return null;
  }
  
  public static bool CompareModelElement(DXM.Numerator? openXmlElement, DMM.Numerator? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && model != null)
    {
      var ok = true;
      ...
      if (!ElementCollectionConverter<DMM.IMathArgumentContent>.CompareOpenXmlElementCollection(
        openXmlElement.Where(item=>item is not DXM.ArgumentProperties && item is not DXM.ControlProperties), model,
        CompareNumeratorContent, diffs, objName, propName))
        ok = false;
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMM.Numerator value)
    where OpenXmlElementType: DXM.Numerator, new()
  {
  ...
  public static bool UpdateOpenXmlElement(DXM.Numerator openXmlElement, DMM.Numerator model)
  {
    ...
    return ElementCollectionConverter<DMM.IMathArgumentContent>.UpdateOpenXmlElementCollection(openXmlElement, model,
      CompareNumeratorContent,
      UpdateOpenXmlNumeratorContent,
      CreateOpenXmlNumeratorContent);
  }
  #endregion
}
