...
public static class ArgumentConverter
{
  ...
  public static bool CmpArgumentProperties(DX.OpenXmlCompositeElement openXmlElement, DMM.ArgumentProperties? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CmpControlProperties(DX.OpenXmlCompositeElement openXmlElement, DMM.ControlProperties? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareArgumentContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, DiffList? diffs = null, string? objName = null)
  {
  ...
  public static bool CompareModelElement(DX.OpenXmlCompositeElement? openXmlElement, DMM.Argument? model, DiffList? diffs, string? objName)
  {
    if (openXmlElement != null && model != null)
    {
      var ok = true;
      ...
      if (!ElementCollectionConverter<DMM.IMathArgumentContent>.CompareOpenXmlElementCollection(
        openXmlElement.Where(item=>item is not DXM.ArgumentProperties && item is not DXM.ControlProperties), model,
        CompareArgumentContent, diffs, objName))
        ok = false;
