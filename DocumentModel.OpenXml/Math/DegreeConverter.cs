...
/// <summary>
/// <see cref="DMM.Degree"/> class from/to OpenXml converter.
/// </summary>
public static class DegreeConverter
{
  #region ArgumentProperties conversion.
  private static DMM.ArgumentProperties? GetArgumentProperties(DXM.Degree openXmlElement)
  {
  ...
  private static bool CmpArgumentProperties(DXM.Degree openXmlElement, DMM.ArgumentProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetArgumentProperties(DXM.Degree openXmlElement, DMM.ArgumentProperties? value)
  {
  ...
  private static DMM.Accent? GetAccent(DXM.Degree openXmlElement)
  {
  ...
  private static DMM.ControlProperties? GetControlProperties(DXM.Degree openXmlElement)
  {
  ...
  private static bool CmpControlProperties(DXM.Degree openXmlElement, DMM.ControlProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetControlProperties(DXM.Degree openXmlElement, DMM.ControlProperties? value)
  {
  ...
  public static DMM.IMathArgumentContent? CreateDegreeContent(DX.OpenXmlElement? openXmlElement)
  {
    ...
    if (openXmlElement != null)
      throw new InvalidOperationException($"Element \"{openXmlElement.GetType()}\" not recognized in DegreeContentConverter.CreateModelElement method");
    return null;
  }

  public static bool CompareDegreeContent(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, DiffList? diffs = null, string? objName = null)
  {
  ...
  #region Degree model conversion.
  public static DMM.Degree? CreateModelElement(DXM.Degree? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var model = new DMM.Degree();
  ...
  public static bool CompareModelElement(DXM.Degree? openXmlElement, DMM.Degree? model, DiffList? diffs, string? objName)
  {
    if (openXmlElement != null && model != null)
    {
      var ok = true;
      ...
      if (!ElementCollectionConverter<DMM.IMathArgumentContent>.CompareOpenXmlElementCollection(
        openXmlElement.Where(item=>item is not DXM.ArgumentProperties && item is not DXM.ControlProperties), model,
        CompareDegreeContent, diffs, objName))
        ok = false;
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMM.Degree value)
    where OpenXmlElementType: DXM.Degree, new()
  {
  ...
  public static bool UpdateOpenXmlElement(DXM.Degree openXmlElement, DMM.Degree model)
  {
    ...
    return ElementCollectionConverter<DMM.IMathArgumentContent>.UpdateOpenXmlElementCollection(openXmlElement, model,
      CompareDegreeContent,
      UpdateOpenXmlDegreeContent,
      CreateOpenXmlDegreeContent);
  }
  #endregion
}
