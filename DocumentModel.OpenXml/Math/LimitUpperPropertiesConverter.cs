...
public static class LimitUpperPropertiesConverter
{
  ...
  /// ControlProperties.
  /// </summary>
  private static DocumentModel.Math.ControlProperties? GetControlProperties(DocumentFormat.OpenXml.Math.LimitUpperProperties openXmlElement)
  {
  ...
  private static void SetControlProperties(DocumentFormat.OpenXml.Math.LimitUpperProperties openXmlElement, DocumentModel.Math.ControlProperties? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Math.ControlProperties>();
    if (itemElement != null)
      itemElement.Remove();
