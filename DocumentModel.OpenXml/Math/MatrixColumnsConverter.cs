...
public static class MatrixColumnsConverter
{
  ...
  private static bool CmpItems(DXM.MatrixColumns openXmlElement, IEnumerable<DMM.MatrixColumn>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXM.MatrixColumnConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXM.MatrixColumns? openXmlElement, DMM.MatrixColumns? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
