...
public static class NaryConverter
{
  ...
  /// n-ary Properties.
  /// </summary>
  private static DocumentModel.Math.NaryProperties? GetNaryProperties(DocumentFormat.OpenXml.Math.Nary openXmlElement)
  {
  ...
  private static void SetNaryProperties(DocumentFormat.OpenXml.Math.Nary openXmlElement, DocumentModel.Math.NaryProperties? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Math.NaryProperties>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Lower limit (n-ary) .
  /// </summary>
  private static DocumentModel.Math.SubArgument? GetSubArgument(DocumentFormat.OpenXml.Math.Nary openXmlElement)
  {
  ...
  private static void SetSubArgument(DocumentFormat.OpenXml.Math.Nary openXmlElement, DocumentModel.Math.SubArgument? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Math.SubArgument>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Upper limit (n-ary).
  /// </summary>
  private static DocumentModel.Math.SuperArgument? GetSuperArgument(DocumentFormat.OpenXml.Math.Nary openXmlElement)
  {
  ...
  private static void SetSuperArgument(DocumentFormat.OpenXml.Math.Nary openXmlElement, DocumentModel.Math.SuperArgument? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Math.SuperArgument>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Base (Argument).
  /// </summary>
  private static DocumentModel.Math.Base? GetBase(DocumentFormat.OpenXml.Math.Nary openXmlElement)
  {
  ...
  private static void SetBase(DocumentFormat.OpenXml.Math.Nary openXmlElement, DocumentModel.Math.Base? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Math.Base>();
    if (itemElement != null)
      itemElement.Remove();
