...
public static class SubArgumentConverter
{
  ...
  public static bool CompareModelElement(DXM.SubArgument? openXmlElement, DMM.SubArgument? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
