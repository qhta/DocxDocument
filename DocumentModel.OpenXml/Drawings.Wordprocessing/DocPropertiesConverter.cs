...
public static class DocPropertiesConverter
{
  ...
  private static bool CmpId(DXDW.DocProperties openXmlElement, UInt32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpName(DXDW.DocProperties openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDescription(DXDW.DocProperties openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpHidden(DXDW.DocProperties openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpTitle(DXDW.DocProperties openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpHyperlinkOnClick(DXDW.DocProperties openXmlElement, DMD.HyperlinkOnClick? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpHyperlinkOnHover(DXDW.DocProperties openXmlElement, DMD.HyperlinkOnHover? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpNonVisualDrawingPropertiesExtensionList(DXDW.DocProperties openXmlElement, DMD.NonVisualDrawingPropertiesExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDW.DocProperties? openXmlElement, DMDW.DocProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
