...
/// <summary>
/// Diagram Relationship Table converter from/to OpenXml.
///</summary>
public static class RelationTableConverter
{
  ...
  public static void UpdateOpenXmlElement(DXVmlO.RelationTable openXmlElement, DMVml.RelationTable value)
  {
