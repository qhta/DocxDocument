...
public static class ArcConverter
{
  ...
  /// Encoded Package
  /// </summary>
  public static Byte[]? GetGfxdata(DocumentFormat.OpenXml.Vml.Arc? openXmlElement)
  {
  ...
  public static void SetGfxdata(DocumentFormat.OpenXml.Vml.Arc? openXmlElement, Byte[]? value)
  {
    if (openXmlElement != null)
    {
      if (value != null)
