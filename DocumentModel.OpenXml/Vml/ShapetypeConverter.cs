...
public static class ShapetypeConverter
{
  ...
  {
    return DMXVml.ComplexConverter.CompareModelElement(openXmlElement.GetFirstChild<DXVmlO.Complex>(), value, diffs, objName);
  }
  ...
  public static void UpdateOpenXmlElement(DXVml.Shapetype openXmlElement, DMVml.Shapetype value)
  {
