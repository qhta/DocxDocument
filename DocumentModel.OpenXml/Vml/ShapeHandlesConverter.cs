...
public static class ShapeHandlesConverter
{
  ...
  private static bool CmpItems(DXV.ShapeHandles openXmlElement, Collection<DMV.ShapeHandle>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXV.ShapeHandleConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXV.ShapeHandles? openXmlElement, DMV.ShapeHandles? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
