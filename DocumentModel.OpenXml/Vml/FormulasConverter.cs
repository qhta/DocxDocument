...
public static class FormulasConverter
{
  ...
  private static bool CmpItems(DXV.Formulas openXmlElement, Collection<DMV.Formula>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXV.FormulaConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXV.Formulas? openXmlElement, DMV.Formulas? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
