...
public static class OvalConverter
{
  ...
  /// Encoded Package
  /// </summary>
  public static Byte[]? GetGfxdata(DocumentFormat.OpenXml.Vml.Oval? openXmlElement)
  {
  ...
  public static void SetGfxdata(DocumentFormat.OpenXml.Vml.Oval? openXmlElement, Byte[]? value)
  {
    if (openXmlElement != null)
    {
      if (value != null)
