...
public static class LineConverter
{
  ...
  /// Encoded Package
  /// </summary>
  public static Byte[]? GetGfxdata(DocumentFormat.OpenXml.Vml.Line? openXmlElement)
  {
  ...
  public static void SetGfxdata(DocumentFormat.OpenXml.Vml.Line? openXmlElement, Byte[]? value)
  {
    if (openXmlElement != null)
    {
      if (value != null)
