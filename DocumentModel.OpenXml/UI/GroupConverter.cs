...
/// <summary>
/// Defines the Group Class converter from/to OpenXml.
///</summary>
public static class GroupConverter
{
  ...
  {
    return DMXUI.DialogBoxLauncherConverter.CompareModelElement(openXmlElement.GetFirstChild<DXOCustUI.DialogBoxLauncher>(), value, diffs, objName);
  }
