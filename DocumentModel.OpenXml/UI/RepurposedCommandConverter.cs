...
public static class RepurposedCommandConverter
{
  ...
  private static bool CmpOnAction(DXOCUI.RepurposedCommand openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpEnabled(DXOCUI.RepurposedCommand openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpGetEnabled(DXOCUI.RepurposedCommand openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpIdMso(DXOCUI.RepurposedCommand openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXOCUI.RepurposedCommand? openXmlElement, DMUI.RepurposedCommand? value, DiffList? diffs, string? objName)
  {
