...
{
  public static Collection<DocumentModel.UI.Tab>? GetItems(DocumentFormat.OpenXml.Office.CustomUI.Tabs? openXmlElement)
  {
  ...
  public static void SetItems(DocumentFormat.OpenXml.Office.CustomUI.Tabs? openXmlElement, Collection<DocumentModel.UI.Tab>? value)
  {
    if (openXmlElement != null)
    {
