...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDD.FillColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDD.FillColorList openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDD.FillColorList openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXDD.FillColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDD.FillColorList openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXDD.FillColorList openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXDD.FillColorList openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDD.FillColorList openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXDD.FillColorList openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXDD.FillColorList openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDD.FillColorList openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXDD.FillColorList openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXDD.FillColorList openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXDD.FillColorList openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXDD.FillColorList openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXDD.FillColorList openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDD.FillColorList openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXDD.FillColorList openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXDD.FillColorList? openXmlElement, DMDD.FillColorList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDD.FillColorList value)
    where OpenXmlElementType: DXDD.FillColorList, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDD.FillColorList openXmlElement, DMDD.FillColorList value)
  {
