...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDD.TextFillColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDD.TextFillColorList openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDD.TextFillColorList openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXDD.TextFillColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDD.TextFillColorList openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXDD.TextFillColorList openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXDD.TextFillColorList openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDD.TextFillColorList openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXDD.TextFillColorList openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXDD.TextFillColorList openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDD.TextFillColorList openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXDD.TextFillColorList openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXDD.TextFillColorList openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXDD.TextFillColorList openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXDD.TextFillColorList openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXDD.TextFillColorList openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDD.TextFillColorList openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXDD.TextFillColorList openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static DMDD.TextFillColorList? CreateModelElement(DXDD.TextFillColorList? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDD.TextFillColorList();
  ...
  public static bool CompareModelElement(DXDD.TextFillColorList? openXmlElement, DMDD.TextFillColorList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDD.TextFillColorList value)
    where OpenXmlElementType: DXDD.TextFillColorList, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDD.TextFillColorList openXmlElement, DMDD.TextFillColorList value)
  {
