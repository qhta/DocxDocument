...
public static class PointListConverter
{
  ...
  private static bool CmpPoints(DXDD.PointList openXmlElement, Collection<DMDD.Point>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDD.PointConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXDD.PointList? openXmlElement, DMDD.PointList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
