...
public static class PresentationLayoutVariablesConverter
{
  ...
  private static bool CmpOrganizationChart(DXDD.PresentationLayoutVariables openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpMaxNumberOfChildren(DXDD.PresentationLayoutVariables openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPreferredNumberOfChildren(DXDD.PresentationLayoutVariables openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpBulletEnabled(DXDD.PresentationLayoutVariables openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpDirection(DXDD.PresentationLayoutVariables openXmlElement, DMDD.DirectionKind? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetDirection(DXDD.PresentationLayoutVariables openXmlElement, DMDD.DirectionKind? value)
  {
    ...
    if (value != null)
      openXmlElement.AddChild(EnumValueConverter.CreateOpenXmlElement<DXDD.Direction, DocumentFormat.OpenXml.Drawing.Diagrams.DirectionValues, DMDD.DirectionKind>((DMDD.DirectionKind)value));
  }
  ...
  private static bool CmpHierarchyBranch(DXDD.PresentationLayoutVariables openXmlElement, DMDD.HierarchyBranchStyleKind? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetHierarchyBranch(DXDD.PresentationLayoutVariables openXmlElement, DMDD.HierarchyBranchStyleKind? value)
  {
    ...
    if (value != null)
      openXmlElement.AddChild(EnumValueConverter.CreateOpenXmlElement<DXDD.HierarchyBranch, DocumentFormat.OpenXml.Drawing.Diagrams.HierarchyBranchStyleValues, DMDD.HierarchyBranchStyleKind>((DMDD.HierarchyBranchStyleKind)value));
  }
  ...
  private static bool CmpAnimateOneByOne(DXDD.PresentationLayoutVariables openXmlElement, DMDD.AnimateOneByOneKind? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetAnimateOneByOne(DXDD.PresentationLayoutVariables openXmlElement, DMDD.AnimateOneByOneKind? value)
  {
    ...
    if (value != null)
      openXmlElement.AddChild(EnumValueConverter.CreateOpenXmlElement<DXDD.AnimateOneByOne, DocumentFormat.OpenXml.Drawing.Diagrams.AnimateOneByOneValues, DMDD.AnimateOneByOneKind>((DMDD.AnimateOneByOneKind)value));
  }
  ...
  private static bool CmpAnimationLevel(DXDD.PresentationLayoutVariables openXmlElement, DMDD.AnimationLevelStringKind? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetAnimationLevel(DXDD.PresentationLayoutVariables openXmlElement, DMDD.AnimationLevelStringKind? value)
  {
    ...
    if (value != null)
      openXmlElement.AddChild(EnumValueConverter.CreateOpenXmlElement<DXDD.AnimationLevel, DocumentFormat.OpenXml.Drawing.Diagrams.AnimationLevelStringValues, DMDD.AnimationLevelStringKind>((DMDD.AnimationLevelStringKind)value));
  }
  ...
  private static bool CmpResizeHandles(DXDD.PresentationLayoutVariables openXmlElement, DMDD.ResizeHandlesStringKind? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetResizeHandles(DXDD.PresentationLayoutVariables openXmlElement, DMDD.ResizeHandlesStringKind? value)
  {
    ...
    if (value != null)
      openXmlElement.AddChild(EnumValueConverter.CreateOpenXmlElement<DXDD.ResizeHandles, DocumentFormat.OpenXml.Drawing.Diagrams.ResizeHandlesStringValues, DMDD.ResizeHandlesStringKind>((DMDD.ResizeHandlesStringKind)value));
  }
  ...
  public static bool CompareModelElement(DXDD.PresentationLayoutVariables? openXmlElement, DMDD.PresentationLayoutVariables? value, DiffList? diffs, string? objName)
  {
