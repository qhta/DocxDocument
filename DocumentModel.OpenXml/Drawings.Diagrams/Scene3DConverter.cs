...
public static class Scene3DConverter
{
  ...
  /// Camera.
  /// </summary>
  private static DocumentModel.Drawings.Camera? GetCamera(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement)
  {
  ...
  private static void SetCamera(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement, DocumentModel.Drawings.Camera? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Camera>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Light Rig.
  /// </summary>
  private static DocumentModel.Drawings.LightRig? GetLightRig(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement)
  {
  ...
  private static void SetLightRig(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement, DocumentModel.Drawings.LightRig? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.LightRig>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Backdrop Plane.
  /// </summary>
  private static DocumentModel.Drawings.Backdrop? GetBackdrop(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement)
  {
  ...
  private static void SetBackdrop(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement, DocumentModel.Drawings.Backdrop? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Backdrop>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// ExtensionList.
  /// </summary>
  private static DocumentModel.Drawings.ExtensionList? GetExtensionList(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement)
  {
  ...
  private static void SetExtensionList(DocumentFormat.OpenXml.Drawing.Diagrams.Scene3D openXmlElement, DocumentModel.Drawings.ExtensionList? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.ExtensionList>();
    if (itemElement != null)
      itemElement.Remove();
