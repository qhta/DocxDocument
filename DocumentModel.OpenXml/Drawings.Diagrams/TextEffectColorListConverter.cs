...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDD.TextEffectColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDD.TextEffectColorList openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDD.TextEffectColorList openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXDD.TextEffectColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDD.TextEffectColorList openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXDD.TextEffectColorList openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXDD.TextEffectColorList openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDD.TextEffectColorList openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXDD.TextEffectColorList openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXDD.TextEffectColorList openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDD.TextEffectColorList openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXDD.TextEffectColorList openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXDD.TextEffectColorList openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXDD.TextEffectColorList openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXDD.TextEffectColorList openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXDD.TextEffectColorList openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDD.TextEffectColorList openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXDD.TextEffectColorList openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXDD.TextEffectColorList? openXmlElement, DMDD.TextEffectColorList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDD.TextEffectColorList value)
    where OpenXmlElementType: DXDD.TextEffectColorList, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDD.TextEffectColorList openXmlElement, DMDD.TextEffectColorList value)
  {
