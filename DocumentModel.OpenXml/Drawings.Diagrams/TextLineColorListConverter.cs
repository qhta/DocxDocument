...
public static class TextLineColorListConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXDD.TextLineColorList openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDD.TextLineColorList openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpHslColor(DXDD.TextLineColorList openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSystemColor(DXDD.TextLineColorList openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSchemeColor(DXDD.TextLineColorList openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpPresetColor(DXDD.TextLineColorList openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMDD.TextLineColorList? CreateModelElement(DXDD.TextLineColorList? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDD.TextLineColorList();
  ...
  public static bool CompareModelElement(DXDD.TextLineColorList? openXmlElement, DMDD.TextLineColorList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
