...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(EffectColorList? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(EffectColorList? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(EffectColorList? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(EffectColorList? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(EffectColorList? openXmlElement)
  {
  ...
  public static void SetHslColor(EffectColorList? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(EffectColorList? openXmlElement)
  {
  ...
  public static void SetSystemColor(EffectColorList? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(EffectColorList? openXmlElement)
  {
  ...
  public static void SetSchemeColor(EffectColorList? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(EffectColorList? openXmlElement)
  {
  ...
  public static void SetPresetColor(EffectColorList? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Diagrams.EffectColorList? CreateModelElement(EffectColorList? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Diagrams.EffectColorList? value)
    where OpenXmlElementType : EffectColorList, new()
  {
    if (value != null)
    {
