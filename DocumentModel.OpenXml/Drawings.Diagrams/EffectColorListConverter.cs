...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDD.EffectColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDD.EffectColorList openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDD.EffectColorList openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXDD.EffectColorList openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDD.EffectColorList openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXDD.EffectColorList openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXDD.EffectColorList openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDD.EffectColorList openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXDD.EffectColorList openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXDD.EffectColorList openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDD.EffectColorList openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXDD.EffectColorList openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXDD.EffectColorList openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXDD.EffectColorList openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXDD.EffectColorList openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXDD.EffectColorList openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDD.EffectColorList openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXDD.EffectColorList openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXDD.EffectColorList? openXmlElement, DMDD.EffectColorList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDD.EffectColorList value)
    where OpenXmlElementType: DXDD.EffectColorList, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDD.EffectColorList openXmlElement, DMDD.EffectColorList value)
  {
