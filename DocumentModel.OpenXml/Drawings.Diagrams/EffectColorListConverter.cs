...
public static class EffectColorListConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXDD.EffectColorList openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDD.EffectColorList openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXDD.EffectColorList openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXDD.EffectColorList openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXDD.EffectColorList openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXDD.EffectColorList openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXDD.EffectColorList? openXmlElement, DMDD.EffectColorList? value, DiffList? diffs, string? objName)
  {
