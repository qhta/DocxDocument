...
/// <summary>
/// Effect Color List converter from/to OpenXml.
///</summary>
public static class EffectColorListConverter
{
  ...
  public static DocumentModel.Drawings.Diagrams.EffectColorList? CreateModelElement(DXDrawDgms.EffectColorList? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXDrawDgms.EffectColorList? openXmlElement, DMDrawsDgms.EffectColorList? value, DiffList? diffs, string? objName)
  {
  ...
  public static void UpdateOpenXmlElement(DXDrawDgms.EffectColorList openXmlElement, DMDrawsDgms.EffectColorList value)
  {
