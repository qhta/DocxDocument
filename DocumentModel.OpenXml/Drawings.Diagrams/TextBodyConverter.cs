...
public static class TextBodyConverter
{
  ...
  /// Body Properties.
  /// </summary>
  private static DocumentModel.Drawings.BodyProperties? GetBodyProperties(DocumentFormat.OpenXml.Drawing.Diagrams.TextBody openXmlElement)
  {
  ...
  private static void SetBodyProperties(DocumentFormat.OpenXml.Drawing.Diagrams.TextBody openXmlElement, DocumentModel.Drawings.BodyProperties? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.BodyProperties>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Text List Styles.
  /// </summary>
  private static DocumentModel.Drawings.ListStyle? GetListStyle(DocumentFormat.OpenXml.Drawing.Diagrams.TextBody openXmlElement)
  {
  ...
  private static void SetListStyle(DocumentFormat.OpenXml.Drawing.Diagrams.TextBody openXmlElement, DocumentModel.Drawings.ListStyle? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.ListStyle>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  private static DocumentModel.Drawings.Paragraph? GetParagraph(DocumentFormat.OpenXml.Drawing.Diagrams.TextBody openXmlElement)
  {
  ...
  private static void SetParagraph(DocumentFormat.OpenXml.Drawing.Diagrams.TextBody openXmlElement, DocumentModel.Drawings.Paragraph? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Paragraph>();
    if (itemElement != null)
      itemElement.Remove();
