...
public static class ConnectionListConverter
{
  ...
  private static bool CmpConnections(DXDD.ConnectionList openXmlElement, Collection<DMDD.Connection>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDD.ConnectionConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXDD.ConnectionList? openXmlElement, DMDD.ConnectionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpConnections(openXmlElement, value.Connections, diffs, objName, propName))
        ok = false;
      return ok;
    }
