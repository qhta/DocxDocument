...
public static class FillConverter
{
  ...
  ///   NoFill.
  /// </summary>
  public static Boolean? GetNoFill(Fill? openXmlElement)
  {
  ...
  public static void SetNoFill(Fill? openXmlElement, Boolean? value)
  {
    if (openXmlElement != null)
    {
      if (value == false)
  ...
  ///   SolidFill.
  /// </summary>
  public static SolidFill? GetSolidFill(Fill? openXmlElement)
  {
  ...
  public static void SetSolidFill(Fill? openXmlElement, SolidFill? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SolidFill>();
  ...
  ///   GradientFill.
  /// </summary>
  public static GradientFill? GetGradientFill(Fill? openXmlElement)
  {
  ...
  public static void SetGradientFill(Fill? openXmlElement, GradientFill? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.GradientFill>();
  ...
  ///   BlipFill.
  /// </summary>
  public static BlipFill? GetBlipFill(Fill? openXmlElement)
  {
  ...
  public static void SetBlipFill(Fill? openXmlElement, BlipFill? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.BlipFill>();
  ...
  ///   Pattern Fill.
  /// </summary>
  public static PatternFill? GetPatternFill(Fill? openXmlElement)
  {
  ...
  public static void SetPatternFill(Fill? openXmlElement, PatternFill? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PatternFill>();
  ...
  ///   Group Fill.
  /// </summary>
  public static Boolean? GetGroupFill(Fill? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static void SetGroupFill(Fill? openXmlElement, Boolean? value)
  {
    if (openXmlElement != null)
    {
      if (value == false)
  ...
  public static DocumentModel.Drawings.Fill? CreateModelElement(Fill? openXmlElement)
  {
    if (openXmlElement != null)
    {
