...
public static class PictureAttributionSourceURLConverter
{
  ...
  private static bool CmpId(DXO19D.PictureAttributionSourceURL openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  public static DocumentModel.Drawings.PictureAttributionSourceURL? CreateModelElement(DXO19D.PictureAttributionSourceURL? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO19D.PictureAttributionSourceURL? openXmlElement, DMD.PictureAttributionSourceURL? value, DiffList? diffs, string? objName)
  {
