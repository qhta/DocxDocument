...
/// <summary>
/// Alpha Inverse Effect converter from/to OpenXml.
///</summary>
public static class AlphaInverseConverter
{
  ...
  public static bool CompareModelElement(DXDraw.AlphaInverse? openXmlElement, DMDraws.AlphaInverse? value, DiffList? diffs, string? objName)
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.AlphaInverse openXmlElement, DMDraws.AlphaInverse value)
  {
