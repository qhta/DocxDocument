...
using Light2Color = DocumentFormat.OpenXml.Drawing.Light2Color;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Light2Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Light2Color? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Light2Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Light2Color? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Light2Color? openXmlElement)
  {
  ...
  public static void SetHslColor(Light2Color? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Light2Color? openXmlElement)
  {
  ...
  public static void SetSystemColor(Light2Color? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static PresetColor? GetPresetColor(Light2Color? openXmlElement)
  {
  ...
  public static void SetPresetColor(Light2Color? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Light2Color? CreateModelElement(Light2Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Light2Color? value)
    where OpenXmlElementType : Light2Color, new()
  {
    if (value != null)
    {
