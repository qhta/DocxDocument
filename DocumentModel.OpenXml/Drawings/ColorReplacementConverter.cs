...
/// <summary>
/// Defines the ColorReplacement Class converter from/to OpenXml.
///</summary>
public static class ColorReplacementConverter
{
  /// <summary>
  /// RGB Color Model - Percentage Variant.
  /// </summary>
  private static DMDraws.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDraw.ColorReplacement openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDraw.ColorReplacement openXmlElement, DMDraws.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDraw.ColorReplacement openXmlElement, DMDraws.RgbColorModelPercentage? value)
  {
  ...
  /// </summary>
  private static DMDraws.RgbColorModelHex? GetRgbColorModelHex(DXDraw.ColorReplacement openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDraw.ColorReplacement openXmlElement, DMDraws.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelHex(DXDraw.ColorReplacement openXmlElement, DMDraws.RgbColorModelHex? value)
  {
  ...
  /// </summary>
  private static DMDraws.HslColor? GetHslColor(DXDraw.ColorReplacement openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDraw.ColorReplacement openXmlElement, DMDraws.HslColor? value, DiffList? diffs, string? objName)
  {
    return DMXDraws.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDraw.HslColor>(), value, diffs, objName);
  }
  
  private static void SetHslColor(DXDraw.ColorReplacement openXmlElement, DMDraws.HslColor? value)
  {
  ...
  /// System Color.
  /// </summary>
  private static DMDraws.SystemColor? GetSystemColor(DXDraw.ColorReplacement openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDraw.ColorReplacement openXmlElement, DMDraws.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSystemColor(DXDraw.ColorReplacement openXmlElement, DMDraws.SystemColor? value)
  {
  ...
  /// Scheme Color.
  /// </summary>
  private static DMDraws.SchemeColor? GetSchemeColor(DXDraw.ColorReplacement openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXDraw.ColorReplacement openXmlElement, DMDraws.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSchemeColor(DXDraw.ColorReplacement openXmlElement, DMDraws.SchemeColor? value)
  {
  ...
  /// Preset Color.
  /// </summary>
  private static DMDraws.PresetColor? GetPresetColor(DXDraw.ColorReplacement openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDraw.ColorReplacement openXmlElement, DMDraws.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetPresetColor(DXDraw.ColorReplacement openXmlElement, DMDraws.PresetColor? value)
  {
  ...
  public static DocumentModel.Drawings.ColorReplacement? CreateModelElement(DXDraw.ColorReplacement? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXDraw.ColorReplacement? openXmlElement, DMDraws.ColorReplacement? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDraws.ColorReplacement value)
    where OpenXmlElementType: DXDraw.ColorReplacement, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.ColorReplacement openXmlElement, DMDraws.ColorReplacement value)
  {
