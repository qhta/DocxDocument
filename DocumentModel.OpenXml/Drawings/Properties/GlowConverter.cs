...
public static class GlowConverter
{
  ...
  /// Radius
  /// </summary>
  private static Int64? GetRadius(DXD.Glow openXmlElement)
  {
    return openXmlElement?.Radius?.Value;
  }
  
  private static bool CmpRadius(DXD.Glow openXmlElement, Int64? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRadius(DXD.Glow openXmlElement, Int64? value)
  {
  ...
  /// </summary>
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.Glow openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.Glow openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.Glow openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  /// </summary>
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.Glow openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.Glow openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.Glow openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  /// </summary>
  private static DMD.HslColor? GetHslColor(DXD.Glow openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.Glow openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.Glow openXmlElement, DMD.HslColor? value)
  {
  ...
  /// System Color.
  /// </summary>
  private static DMD.SystemColor? GetSystemColor(DXD.Glow openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.Glow openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.Glow openXmlElement, DMD.SystemColor? value)
  {
  ...
  /// Scheme Color.
  /// </summary>
  private static DMD.SchemeColor? GetSchemeColor(DXD.Glow openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.Glow openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.Glow openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static bool CmpPresetColor(DXD.Glow openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.Glow openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.Glow? openXmlElement, DMD.Glow? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.Glow value)
    where OpenXmlElementType: DXD.Glow, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.Glow openXmlElement, DMD.Glow value)
  {
