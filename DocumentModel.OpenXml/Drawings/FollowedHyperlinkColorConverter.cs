...
public static class FollowedHyperlinkColorConverter
{
  ...
  private static void SetRgbColorModelPercentage(DXDraw.FollowedHyperlinkColor openXmlElement, DMDraws.RgbColorModelPercentage? value)
  {
  ...
  private static void SetRgbColorModelHex(DXDraw.FollowedHyperlinkColor openXmlElement, DMDraws.RgbColorModelHex? value)
  {
  ...
  private static void SetHslColor(DXDraw.FollowedHyperlinkColor openXmlElement, DMDraws.HslColor? value)
  {
  ...
  private static void SetSystemColor(DXDraw.FollowedHyperlinkColor openXmlElement, DMDraws.SystemColor? value)
  {
  ...
  private static void SetPresetColor(DXDraw.FollowedHyperlinkColor openXmlElement, DMDraws.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXDraw.FollowedHyperlinkColor? openXmlElement, DMDraws.FollowedHyperlinkColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDraws.FollowedHyperlinkColor value)
    where OpenXmlElementType: DXDraw.FollowedHyperlinkColor, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.FollowedHyperlinkColor openXmlElement, DMDraws.FollowedHyperlinkColor value)
  {
