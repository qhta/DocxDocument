...
{
  public static Collection<DocumentModel.Drawings.Extension>? GetExtensions(DocumentFormat.OpenXml.Drawing.ExtensionList? openXmlElement)
  {
  ...
  public static void SetExtensions(DocumentFormat.OpenXml.Drawing.ExtensionList? openXmlElement, Collection<DocumentModel.Drawings.Extension>? value)
  {
    if (openXmlElement != null)
    {
