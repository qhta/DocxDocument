...
using Accent2Color = DocumentFormat.OpenXml.Drawing.Accent2Color;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Accent2Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Accent2Color? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Accent2Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Accent2Color? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Accent2Color? openXmlElement)
  {
  ...
  public static void SetHslColor(Accent2Color? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Accent2Color? openXmlElement)
  {
  ...
  public static void SetSystemColor(Accent2Color? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static PresetColor? GetPresetColor(Accent2Color? openXmlElement)
  {
  ...
  public static void SetPresetColor(Accent2Color? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Accent2Color? CreateModelElement(Accent2Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Accent2Color? value)
    where OpenXmlElementType : Accent2Color, new()
  {
    if (value != null)
    {
