...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Highlight? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Highlight? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Highlight? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Highlight? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Highlight? openXmlElement)
  {
  ...
  public static void SetHslColor(Highlight? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Highlight? openXmlElement)
  {
  ...
  public static void SetSystemColor(Highlight? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(Highlight? openXmlElement)
  {
  ...
  public static void SetSchemeColor(Highlight? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(Highlight? openXmlElement)
  {
  ...
  public static void SetPresetColor(Highlight? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Highlight? CreateModelElement(Highlight? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Highlight? value)
    where OpenXmlElementType : Highlight, new()
  {
    if (value != null)
    {
