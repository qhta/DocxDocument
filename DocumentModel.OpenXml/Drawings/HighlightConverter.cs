...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.Highlight openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.Highlight openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.Highlight openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.Highlight openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.Highlight openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.Highlight openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXD.Highlight openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.Highlight openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.Highlight openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXD.Highlight openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.Highlight openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.Highlight openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXD.Highlight openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.Highlight openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.Highlight openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXD.Highlight openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXD.Highlight openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.Highlight openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.Highlight? openXmlElement, DMD.Highlight? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.Highlight value)
    where OpenXmlElementType: DXD.Highlight, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.Highlight openXmlElement, DMD.Highlight value)
  {
