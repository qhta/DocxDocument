...
/// <summary>
/// Defines the ColorType Class converter from/to OpenXml.
///</summary>
public static class ColorTypeConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXDraw.ColorType openXmlElement, DMDraws.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDraw.ColorType openXmlElement, DMDraws.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXDraw.ColorType openXmlElement, DMDraws.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXDraw.ColorType openXmlElement, DMDraws.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXDraw.ColorType openXmlElement, DMDraws.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXDraw.ColorType openXmlElement, DMDraws.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static DocumentModel.Drawings.ColorType? CreateModelElement(DXDraw.ColorType? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXDraw.ColorType? openXmlElement, DMDraws.ColorType? value, DiffList? diffs, string? objName)
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.ColorType openXmlElement, DMDraws.ColorType value)
  {
