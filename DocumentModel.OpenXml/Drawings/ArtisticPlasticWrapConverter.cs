...
public static class ArtisticPlasticWrapConverter
{
  ...
  private static bool CmpTransparancy(DXO10D.ArtisticPlasticWrap openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSmoothness(DXO10D.ArtisticPlasticWrap openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO10D.ArtisticPlasticWrap? openXmlElement, DMD.ArtisticPlasticWrap? value, DiffList? diffs, string? objName)
  {
