...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.ColorFrom openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.ColorFrom openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.ColorFrom openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.ColorFrom openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.ColorFrom openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.ColorFrom openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXD.ColorFrom openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.ColorFrom openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.ColorFrom openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXD.ColorFrom openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.ColorFrom openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.ColorFrom openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXD.ColorFrom openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.ColorFrom openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.ColorFrom openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXD.ColorFrom openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXD.ColorFrom openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.ColorFrom openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.ColorFrom? openXmlElement, DMD.ColorFrom? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.ColorFrom value)
    where OpenXmlElementType: DXD.ColorFrom, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.ColorFrom openXmlElement, DMD.ColorFrom value)
  {
