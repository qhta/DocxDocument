...
public static class ColorFromConverter
{
  ...
  public static DocumentModel.Drawings.ColorFrom? CreateModelElement(DXDraw.ColorFrom? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXDraw.ColorFrom? openXmlElement, DMDraws.ColorFrom? value, DiffList? diffs, string? objName)
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.ColorFrom openXmlElement, DMDraws.ColorFrom value)
  {
