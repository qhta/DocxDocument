...
public static class ColorFromConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXD.ColorFrom openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.ColorFrom openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXD.ColorFrom openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXD.ColorFrom openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXD.ColorFrom openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXD.ColorFrom openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXD.ColorFrom? openXmlElement, DMD.ColorFrom? value, DiffList? diffs, string? objName)
  {
