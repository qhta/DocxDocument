...
using Duotone = DocumentFormat.OpenXml.Drawing.Duotone;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Duotone? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Duotone? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Duotone? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Duotone? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Duotone? openXmlElement)
  {
  ...
  public static void SetHslColor(Duotone? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Duotone? openXmlElement)
  {
  ...
  public static void SetSystemColor(Duotone? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(Duotone? openXmlElement)
  {
  ...
  public static void SetSchemeColor(Duotone? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(Duotone? openXmlElement)
  {
  ...
  public static void SetPresetColor(Duotone? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Duotone? CreateModelElement(Duotone? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Duotone? value)
    where OpenXmlElementType : Duotone, new()
  {
    if (value != null)
    {
