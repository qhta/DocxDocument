...
public static class LinePropertiesExtensionListConverter
{
  ...
  private static bool CmpLinePropertiesExtensions(DXD.LinePropertiesExtensionList openXmlElement, Collection<DMD.LinePropertiesExtension>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXD.LinePropertiesExtensionConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXD.LinePropertiesExtensionList? openXmlElement, DMD.LinePropertiesExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpLinePropertiesExtensions(openXmlElement, value.LinePropertiesExtensions, diffs, objName, propName))
        ok = false;
      return ok;
    }
