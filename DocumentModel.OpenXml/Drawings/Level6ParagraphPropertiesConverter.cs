...
/// <summary>
/// List Level 6 Text Style converter from/to OpenXml.
///</summary>
public static class Level6ParagraphPropertiesConverter
{
  ...
  private static bool CmpBulletColorText(DXDraw.Level6ParagraphProperties openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpBulletSizeText(DXDraw.Level6ParagraphProperties openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpBulletFontText(DXDraw.Level6ParagraphProperties openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpNoBullet(DXDraw.Level6ParagraphProperties openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  public static DocumentModel.Drawings.Level6ParagraphProperties? CreateModelElement(DXDraw.Level6ParagraphProperties? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXDraw.Level6ParagraphProperties? openXmlElement, DMDraws.Level6ParagraphProperties? value, DiffList? diffs, string? objName)
  {
