...
public static class Level3ParagraphPropertiesConverter
{
  ...
  public static DMDraws.Level3ParagraphProperties? CreateModelElement(DXDraw.Level3ParagraphProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDraws.Level3ParagraphProperties();
