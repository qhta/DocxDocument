...
public static class ArtisticLineDrawingConverter
{
  ...
  private static bool CmpTransparancy(DXO10D.ArtisticLineDrawing openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPencilSize(DXO10D.ArtisticLineDrawing openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO10D.ArtisticLineDrawing? openXmlElement, DMD.ArtisticLineDrawing? value, DiffList? diffs, string? objName)
  {
