...
using LineReference = DocumentFormat.OpenXml.Drawing.LineReference;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(LineReference? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(LineReference? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(LineReference? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(LineReference? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(LineReference? openXmlElement)
  {
  ...
  public static void SetHslColor(LineReference? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(LineReference? openXmlElement)
  {
  ...
  public static void SetSystemColor(LineReference? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(LineReference? openXmlElement)
  {
  ...
  public static void SetSchemeColor(LineReference? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(LineReference? openXmlElement)
  {
  ...
  public static void SetPresetColor(LineReference? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.LineReference? CreateModelElement(LineReference? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.LineReference? value)
    where OpenXmlElementType : LineReference, new()
  {
    if (value != null)
    {
