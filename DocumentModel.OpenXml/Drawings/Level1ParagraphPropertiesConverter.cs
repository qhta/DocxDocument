...
public static class Level1ParagraphPropertiesConverter
{
  ...
  public static DMDraws.Level1ParagraphProperties? CreateModelElement(DXDraw.Level1ParagraphProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDraws.Level1ParagraphProperties();
