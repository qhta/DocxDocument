...
public static class GradientStopConverter
{
  ...
  /// Position
  /// </summary>
  private static Int32? GetPosition(DXD.GradientStop openXmlElement)
  {
    return openXmlElement?.Position?.Value;
  }
  
  private static bool CmpPosition(DXD.GradientStop openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPosition(DXD.GradientStop openXmlElement, Int32? value)
  {
  ...
  /// </summary>
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.GradientStop openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.GradientStop openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.GradientStop openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  /// </summary>
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.GradientStop openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.GradientStop openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.GradientStop openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  /// </summary>
  private static DMD.HslColor? GetHslColor(DXD.GradientStop openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.GradientStop openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.GradientStop openXmlElement, DMD.HslColor? value)
  {
  ...
  /// System Color.
  /// </summary>
  private static DMD.SystemColor? GetSystemColor(DXD.GradientStop openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.GradientStop openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.GradientStop openXmlElement, DMD.SystemColor? value)
  {
  ...
  /// Scheme Color.
  /// </summary>
  private static DMD.SchemeColor? GetSchemeColor(DXD.GradientStop openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.GradientStop openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.GradientStop openXmlElement, DMD.SchemeColor? value)
  {
  ...
  /// Preset Color.
  /// </summary>
  private static DMD.PresetColor? GetPresetColor(DXD.GradientStop openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXD.GradientStop openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.GradientStop openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.GradientStop? openXmlElement, DMD.GradientStop? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
