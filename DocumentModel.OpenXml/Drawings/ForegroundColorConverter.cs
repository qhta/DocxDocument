...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.ForegroundColor openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.ForegroundColor openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.ForegroundColor openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.ForegroundColor openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.ForegroundColor openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.ForegroundColor openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXD.ForegroundColor openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.ForegroundColor openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.ForegroundColor openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXD.ForegroundColor openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.ForegroundColor openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.ForegroundColor openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXD.ForegroundColor openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.ForegroundColor openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.ForegroundColor openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXD.ForegroundColor openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXD.ForegroundColor openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.ForegroundColor openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.ForegroundColor? openXmlElement, DMD.ForegroundColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.ForegroundColor value)
    where OpenXmlElementType: DXD.ForegroundColor, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.ForegroundColor openXmlElement, DMD.ForegroundColor value)
  {
