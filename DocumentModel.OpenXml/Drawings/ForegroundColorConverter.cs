...
using ForegroundColor = DocumentFormat.OpenXml.Drawing.ForegroundColor;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(ForegroundColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(ForegroundColor? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(ForegroundColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(ForegroundColor? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(ForegroundColor? openXmlElement)
  {
  ...
  public static void SetHslColor(ForegroundColor? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(ForegroundColor? openXmlElement)
  {
  ...
  public static void SetSystemColor(ForegroundColor? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(ForegroundColor? openXmlElement)
  {
  ...
  public static void SetSchemeColor(ForegroundColor? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(ForegroundColor? openXmlElement)
  {
  ...
  public static void SetPresetColor(ForegroundColor? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.ForegroundColor? CreateModelElement(ForegroundColor? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.ForegroundColor? value)
    where OpenXmlElementType : ForegroundColor, new()
  {
    if (value != null)
    {
