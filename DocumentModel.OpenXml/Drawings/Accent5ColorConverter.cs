...
using Accent5Color = DocumentFormat.OpenXml.Drawing.Accent5Color;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Accent5Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Accent5Color? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Accent5Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Accent5Color? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Accent5Color? openXmlElement)
  {
  ...
  public static void SetHslColor(Accent5Color? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Accent5Color? openXmlElement)
  {
  ...
  public static void SetSystemColor(Accent5Color? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static PresetColor? GetPresetColor(Accent5Color? openXmlElement)
  {
  ...
  public static void SetPresetColor(Accent5Color? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Accent5Color? CreateModelElement(Accent5Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Accent5Color? value)
    where OpenXmlElementType : Accent5Color, new()
  {
    if (value != null)
    {
