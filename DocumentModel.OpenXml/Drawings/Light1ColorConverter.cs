...
using Light1Color = DocumentFormat.OpenXml.Drawing.Light1Color;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Light1Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Light1Color? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Light1Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Light1Color? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Light1Color? openXmlElement)
  {
  ...
  public static void SetHslColor(Light1Color? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Light1Color? openXmlElement)
  {
  ...
  public static void SetSystemColor(Light1Color? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static PresetColor? GetPresetColor(Light1Color? openXmlElement)
  {
  ...
  public static void SetPresetColor(Light1Color? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Light1Color? CreateModelElement(Light1Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Light1Color? value)
    where OpenXmlElementType : Light1Color, new()
  {
    if (value != null)
    {
