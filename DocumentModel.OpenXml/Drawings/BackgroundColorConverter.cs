...
using BackgroundColor = DocumentFormat.OpenXml.Drawing.BackgroundColor;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(BackgroundColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(BackgroundColor? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(BackgroundColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(BackgroundColor? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(BackgroundColor? openXmlElement)
  {
  ...
  public static void SetHslColor(BackgroundColor? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(BackgroundColor? openXmlElement)
  {
  ...
  public static void SetSystemColor(BackgroundColor? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(BackgroundColor? openXmlElement)
  {
  ...
  public static void SetSchemeColor(BackgroundColor? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(BackgroundColor? openXmlElement)
  {
  ...
  public static void SetPresetColor(BackgroundColor? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.BackgroundColor? CreateModelElement(BackgroundColor? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.BackgroundColor? value)
    where OpenXmlElementType : BackgroundColor, new()
  {
    if (value != null)
    {
