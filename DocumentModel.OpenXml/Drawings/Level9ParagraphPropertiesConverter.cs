...
{
  private static DMD.LineSpacing? GetLineSpacing(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.SpaceBefore? GetSpaceBefore(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.SpaceAfter? GetSpaceAfter(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static Boolean? GetBulletColorText(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static void SetBulletColorText(DXD.Level9ParagraphProperties openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  private static DMD.BulletColor? GetBulletColor(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static Boolean? GetBulletSizeText(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static void SetBulletSizeText(DXD.Level9ParagraphProperties openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  private static Int32? GetBulletSizePercentage(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static void SetBulletSizePercentage(DXD.Level9ParagraphProperties openXmlElement, Int32? value)
  {
    SimpleValueConverter.SetValue<DXD.BulletSizePercentage,System.Int32>(openXmlElement, value);
  }
  
  private static Int32? GetBulletSizePoints(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static void SetBulletSizePoints(DXD.Level9ParagraphProperties openXmlElement, Int32? value)
  {
    SimpleValueConverter.SetValue<DXD.BulletSizePoints,System.Int32>(openXmlElement, value);
  }
  
  private static Boolean? GetBulletFontText(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static void SetBulletFontText(DXD.Level9ParagraphProperties openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  private static DMD.TextFontType? GetBulletFont(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static Boolean? GetNoBullet(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static void SetNoBullet(DXD.Level9ParagraphProperties openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  private static DMD.AutoNumberedBullet? GetAutoNumberedBullet(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.CharacterBullet? GetCharacterBullet(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.PictureBullet? GetPictureBullet(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.TabStopList? GetTabStopList(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.DefaultRunProperties? GetDefaultRunProperties(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  private static DMD.ExtensionList? GetExtensionList(DXD.Level9ParagraphProperties openXmlElement)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.Level9ParagraphProperties value)
    where OpenXmlElementType: DXD.Level9ParagraphProperties, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.Level9ParagraphProperties openXmlElement, DMD.Level9ParagraphProperties value)
  {
