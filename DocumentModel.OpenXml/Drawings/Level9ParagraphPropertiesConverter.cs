...
public static class Level9ParagraphPropertiesConverter
{
  ...
  public static DMDraws.Level9ParagraphProperties? CreateModelElement(DXDraw.Level9ParagraphProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDraws.Level9ParagraphProperties();
