...
public static class ConnectionSiteListConverter
{
  ...
  private static bool CmpConnectionSites(DXD.ConnectionSiteList openXmlElement, Collection<DMD.ConnectionSite>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXD.ConnectionSiteConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXD.ConnectionSiteList? openXmlElement, DMD.ConnectionSiteList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpConnectionSites(openXmlElement, value.ConnectionSites, diffs, objName, propName))
        ok = false;
      return ok;
    }
