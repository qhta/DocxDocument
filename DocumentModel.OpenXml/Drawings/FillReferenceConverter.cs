...
using FillReference = DocumentFormat.OpenXml.Drawing.FillReference;
...
public static class FillReferenceConverter
{
  ...
  public static DocumentModel.Drawings.FillReference? CreateModelElement(FillReference? openXmlElement)
  {
    if (openXmlElement != null)
    {
