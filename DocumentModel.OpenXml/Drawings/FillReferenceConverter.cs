...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.FillReference openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.FillReference openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.FillReference openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.FillReference openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.FillReference openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.FillReference openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXD.FillReference openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.FillReference openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.FillReference openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXD.FillReference openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.FillReference openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.FillReference openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXD.FillReference openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.FillReference openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.FillReference openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXD.FillReference openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXD.FillReference openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.FillReference openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.FillReference? openXmlElement, DMD.FillReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.FillReference value)
    where OpenXmlElementType: DXD.FillReference, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.FillReference openXmlElement, DMD.FillReference value)
  {
