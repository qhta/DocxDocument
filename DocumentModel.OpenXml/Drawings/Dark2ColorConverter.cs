...
using Dark2Color = DocumentFormat.OpenXml.Drawing.Dark2Color;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(Dark2Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(Dark2Color? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(Dark2Color? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(Dark2Color? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(Dark2Color? openXmlElement)
  {
  ...
  public static void SetHslColor(Dark2Color? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(Dark2Color? openXmlElement)
  {
  ...
  public static void SetSystemColor(Dark2Color? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static PresetColor? GetPresetColor(Dark2Color? openXmlElement)
  {
  ...
  public static void SetPresetColor(Dark2Color? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.Dark2Color? CreateModelElement(Dark2Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Dark2Color? value)
    where OpenXmlElementType : Dark2Color, new()
  {
    if (value != null)
    {
