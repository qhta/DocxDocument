...
public static class ForegroundMarkConverter
{
  ...
  private static bool CmpFirstXCoordinate(DXO10D.ForegroundMark openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFirstYCoordinate(DXO10D.ForegroundMark openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSecondXCoordinate(DXO10D.ForegroundMark openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSecondYCoordinate(DXO10D.ForegroundMark openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMD.ForegroundMark? CreateModelElement(DXO10D.ForegroundMark? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.ForegroundMark();
  ...
  public static bool CompareModelElement(DXO10D.ForegroundMark? openXmlElement, DMD.ForegroundMark? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
