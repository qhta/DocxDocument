...
public static class Level5ParagraphPropertiesConverter
{
  ...
  public static DMDraws.Level5ParagraphProperties? CreateModelElement(DXDraw.Level5ParagraphProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDraws.Level5ParagraphProperties();
