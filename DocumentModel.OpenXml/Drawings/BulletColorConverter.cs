...
using BulletColor = DocumentFormat.OpenXml.Drawing.BulletColor;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(BulletColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(BulletColor? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(BulletColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(BulletColor? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(BulletColor? openXmlElement)
  {
  ...
  public static void SetHslColor(BulletColor? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(BulletColor? openXmlElement)
  {
  ...
  public static void SetSystemColor(BulletColor? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(BulletColor? openXmlElement)
  {
  ...
  public static void SetSchemeColor(BulletColor? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(BulletColor? openXmlElement)
  {
  ...
  public static void SetPresetColor(BulletColor? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.BulletColor? CreateModelElement(BulletColor? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.BulletColor? value)
    where OpenXmlElementType : BulletColor, new()
  {
    if (value != null)
    {
