...
{
  private static DMD.RgbColorModelPercentage? GetRgbColorModelPercentage(DXD.BulletColor openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.BulletColor openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelPercentage(DXD.BulletColor openXmlElement, DMD.RgbColorModelPercentage? value)
  {
  ...
  private static DMD.RgbColorModelHex? GetRgbColorModelHex(DXD.BulletColor openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.BulletColor openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetRgbColorModelHex(DXD.BulletColor openXmlElement, DMD.RgbColorModelHex? value)
  {
  ...
  private static DMD.HslColor? GetHslColor(DXD.BulletColor openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXD.BulletColor openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.HslColor>(), value, diffs, objName, propName);
  }
  
  private static void SetHslColor(DXD.BulletColor openXmlElement, DMD.HslColor? value)
  {
  ...
  private static DMD.SystemColor? GetSystemColor(DXD.BulletColor openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXD.BulletColor openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSystemColor(DXD.BulletColor openXmlElement, DMD.SystemColor? value)
  {
  ...
  private static DMD.SchemeColor? GetSchemeColor(DXD.BulletColor openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXD.BulletColor openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSchemeColor(DXD.BulletColor openXmlElement, DMD.SchemeColor? value)
  {
  ...
  private static DMD.PresetColor? GetPresetColor(DXD.BulletColor openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXD.BulletColor openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPresetColor(DXD.BulletColor openXmlElement, DMD.PresetColor? value)
  {
  ...
  public static bool CompareModelElement(DXD.BulletColor? openXmlElement, DMD.BulletColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.BulletColor value)
    where OpenXmlElementType: DXD.BulletColor, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.BulletColor openXmlElement, DMD.BulletColor value)
  {
