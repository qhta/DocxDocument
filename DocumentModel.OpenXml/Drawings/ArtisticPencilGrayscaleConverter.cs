...
public static class ArtisticPencilGrayscaleConverter
{
  ...
  private static bool CmpTransparancy(DXO10D.ArtisticPencilGrayscale openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpBrushSize(DXO10D.ArtisticPencilGrayscale openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO10D.ArtisticPencilGrayscale? openXmlElement, DMD.ArtisticPencilGrayscale? value, DiffList? diffs, string? objName)
  {
