...
/// Accent 3.
/// </summary>
public static class Accent3ColorConverter
{
  private static DMDraws.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDraw.Accent3Color openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDraw.Accent3Color openXmlElement, DMDraws.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDraw.Accent3Color openXmlElement, DMDraws.RgbColorModelPercentage? value)
  {
  ...
  private static DMDraws.RgbColorModelHex? GetRgbColorModelHex(DXDraw.Accent3Color openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDraw.Accent3Color openXmlElement, DMDraws.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelHex(DXDraw.Accent3Color openXmlElement, DMDraws.RgbColorModelHex? value)
  {
  ...
  private static DMDraws.HslColor? GetHslColor(DXDraw.Accent3Color openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDraw.Accent3Color openXmlElement, DMDraws.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetHslColor(DXDraw.Accent3Color openXmlElement, DMDraws.HslColor? value)
  {
  ...
  private static DMDraws.SystemColor? GetSystemColor(DXDraw.Accent3Color openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDraw.Accent3Color openXmlElement, DMDraws.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSystemColor(DXDraw.Accent3Color openXmlElement, DMDraws.SystemColor? value)
  {
  ...
  private static DMDraws.PresetColor? GetPresetColor(DXDraw.Accent3Color openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDraw.Accent3Color openXmlElement, DMDraws.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetPresetColor(DXDraw.Accent3Color openXmlElement, DMDraws.PresetColor? value)
  {
  ...
  public static DocumentModel.Drawings.Accent3Color? CreateModelElement(DXDraw.Accent3Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DocumentModel.Drawings.Accent3Color();
  ...
  public static bool CompareModelElement(DXDraw.Accent3Color? openXmlElement, DMDraws.Accent3Color? value, DiffList? diffs, string? objName)
  {
