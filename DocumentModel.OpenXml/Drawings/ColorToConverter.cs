...
using ColorTo = DocumentFormat.OpenXml.Drawing.ColorTo;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(ColorTo? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(ColorTo? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(ColorTo? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(ColorTo? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(ColorTo? openXmlElement)
  {
  ...
  public static void SetHslColor(ColorTo? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(ColorTo? openXmlElement)
  {
  ...
  public static void SetSystemColor(ColorTo? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(ColorTo? openXmlElement)
  {
  ...
  public static void SetSchemeColor(ColorTo? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(ColorTo? openXmlElement)
  {
  ...
  public static void SetPresetColor(ColorTo? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.ColorTo? CreateModelElement(ColorTo? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.ColorTo? value)
    where OpenXmlElementType : ColorTo, new()
  {
    if (value != null)
    {
