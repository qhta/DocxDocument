...
public static class ColorToConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXD.ColorTo openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.ColorTo openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpHslColor(DXD.ColorTo openXmlElement, DMD.HslColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSystemColor(DXD.ColorTo openXmlElement, DMD.SystemColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSchemeColor(DXD.ColorTo openXmlElement, DMD.SchemeColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpPresetColor(DXD.ColorTo openXmlElement, DMD.PresetColor? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMD.ColorTo? CreateModelElement(DXD.ColorTo? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.ColorTo();
  ...
  public static bool CompareModelElement(DXD.ColorTo? openXmlElement, DMD.ColorTo? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
