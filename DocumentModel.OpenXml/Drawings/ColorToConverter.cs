...
/// <summary>
/// Change Color To converter from/to OpenXml.
///</summary>
public static class ColorToConverter
{
  private static DMDraws.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDraw.ColorTo openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDraw.ColorTo openXmlElement, DMDraws.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDraw.ColorTo openXmlElement, DMDraws.RgbColorModelPercentage? value)
  {
  ...
  private static DMDraws.RgbColorModelHex? GetRgbColorModelHex(DXDraw.ColorTo openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDraw.ColorTo openXmlElement, DMDraws.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelHex(DXDraw.ColorTo openXmlElement, DMDraws.RgbColorModelHex? value)
  {
  ...
  private static DMDraws.HslColor? GetHslColor(DXDraw.ColorTo openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDraw.ColorTo openXmlElement, DMDraws.HslColor? value, DiffList? diffs, string? objName)
  {
    return DMXDraws.HslColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDraw.HslColor>(), value, diffs, objName);
  }
  
  private static void SetHslColor(DXDraw.ColorTo openXmlElement, DMDraws.HslColor? value)
  {
  ...
  private static DMDraws.SystemColor? GetSystemColor(DXDraw.ColorTo openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDraw.ColorTo openXmlElement, DMDraws.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSystemColor(DXDraw.ColorTo openXmlElement, DMDraws.SystemColor? value)
  {
  ...
  private static DMDraws.SchemeColor? GetSchemeColor(DXDraw.ColorTo openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXDraw.ColorTo openXmlElement, DMDraws.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSchemeColor(DXDraw.ColorTo openXmlElement, DMDraws.SchemeColor? value)
  {
  ...
  private static DMDraws.PresetColor? GetPresetColor(DXDraw.ColorTo openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDraw.ColorTo openXmlElement, DMDraws.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetPresetColor(DXDraw.ColorTo openXmlElement, DMDraws.PresetColor? value)
  {
  ...
  public static DocumentModel.Drawings.ColorTo? CreateModelElement(DXDraw.ColorTo? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXDraw.ColorTo? openXmlElement, DMDraws.ColorTo? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDraws.ColorTo value)
    where OpenXmlElementType: DXDraw.ColorTo, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.ColorTo openXmlElement, DMDraws.ColorTo value)
  {
