...
public static class OfficeArtExtensionListConverter
{
  ...
  private static bool CmpExtensions(DXO21DL.OfficeArtExtensionList openXmlElement, Collection<DMD.Extension>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMD.OfficeArtExtensionList? CreateModelElement(DXO21DL.OfficeArtExtensionList? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.OfficeArtExtensionList();
  ...
  public static bool CompareModelElement(DXO21DL.OfficeArtExtensionList? openXmlElement, DMD.OfficeArtExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
