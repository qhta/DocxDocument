...
/// <summary>
/// Defines the GradientFill Class converter from/to OpenXml.
///</summary>
public static class GradientFillConverter
{
  ...
  {
    var element = openXmlElement?.GetFirstChild<DXDraw.GradientStopList>();
    if (element != null)
      return DMXDraws.GradientStopListConverter.CreateModelElement(element);
    return null;
  }
  ...
  {
    return DMXDraws.GradientStopListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDraw.GradientStopList>(), value, diffs, objName);
  }
  ...
  {
    var element = openXmlElement?.GetFirstChild<DXDraw.LinearGradientFill>();
    if (element != null)
      return DMXDraws.LinearGradientFillConverter.CreateModelElement(element);
    return null;
  }
  ...
  {
    return DMXDraws.LinearGradientFillConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDraw.LinearGradientFill>(), value, diffs, objName);
  }
  ...
  {
    var element = openXmlElement?.GetFirstChild<DXDraw.PathGradientFill>();
    if (element != null)
      return DMXDraws.PathGradientFillConverter.CreateModelElement(element);
    return null;
  }
  ...
  {
    return DMXDraws.PathGradientFillConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDraw.PathGradientFill>(), value, diffs, objName);
  }
  ...
  {
    var element = openXmlElement?.GetFirstChild<DXDraw.TileRectangle>();
    if (element != null)
  ...
  {
    return DMXDraws.RelativeRectangleTypeConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDraw.TileRectangle>(), value, diffs, objName);
  }
  ...
  public static DocumentModel.Drawings.GradientFill? CreateModelElement(DXDraw.GradientFill? openXmlElement)
  {
