...
public static class ArtisticBlurConverter
{
  ...
  private static bool CmpRadius(DXO10D.ArtisticBlur openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO10D.ArtisticBlur? openXmlElement, DMD.ArtisticBlur? value, DiffList? diffs, string? objName)
  {
