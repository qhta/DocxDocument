...
public static class Level2ParagraphPropertiesConverter
{
  ...
  public static DMDraws.Level2ParagraphProperties? CreateModelElement(DXDraw.Level2ParagraphProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDraws.Level2ParagraphProperties();
