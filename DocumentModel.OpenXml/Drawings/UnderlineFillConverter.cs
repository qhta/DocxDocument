...
public static class UnderlineFillConverter
{
  ...
  private static bool CmpNoFill(DXD.UnderlineFill openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSolidFill(DXD.UnderlineFill openXmlElement, DMD.SolidFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpGradientFill(DXD.UnderlineFill openXmlElement, DMD.GradientFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpBlipFill(DXD.UnderlineFill openXmlElement, DMD.BlipFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPatternFill(DXD.UnderlineFill openXmlElement, DMD.PatternFill? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpGroupFill(DXD.UnderlineFill openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXD.UnderlineFill? openXmlElement, DMD.UnderlineFill? value, DiffList? diffs, string? objName)
  {
