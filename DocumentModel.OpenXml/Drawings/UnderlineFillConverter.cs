...
public static class UnderlineFillConverter
{
  ...
  /// NoFill.
  /// </summary>
  private static Boolean? GetNoFill(DXD.UnderlineFill openXmlElement)
  {
    return openXmlElement.GetFirstChild<DXD.NoFill>() != null;
  }
  
  private static bool CmpNoFill(DXD.UnderlineFill openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetNoFill(DXD.UnderlineFill openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  /// SolidFill.
  /// </summary>
  private static DMD.SolidFill? GetSolidFill(DXD.UnderlineFill openXmlElement)
  {
  ...
  private static bool CmpSolidFill(DXD.UnderlineFill openXmlElement, DMD.SolidFill? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetSolidFill(DXD.UnderlineFill openXmlElement, DMD.SolidFill? value)
  {
  ...
  /// GradientFill.
  /// </summary>
  private static DMD.GradientFill? GetGradientFill(DXD.UnderlineFill openXmlElement)
  {
  ...
  private static bool CmpGradientFill(DXD.UnderlineFill openXmlElement, DMD.GradientFill? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetGradientFill(DXD.UnderlineFill openXmlElement, DMD.GradientFill? value)
  {
  ...
  /// BlipFill.
  /// </summary>
  private static DMD.BlipFill? GetBlipFill(DXD.UnderlineFill openXmlElement)
  {
  ...
  private static bool CmpBlipFill(DXD.UnderlineFill openXmlElement, DMD.BlipFill? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXD.BlipFillConverter.CompareModelElement(openXmlElement.GetFirstChild<DXD.BlipFill>(), value, diffs, objName, propName);
  }
  
  private static void SetBlipFill(DXD.UnderlineFill openXmlElement, DMD.BlipFill? value)
  {
  ...
  /// Pattern Fill.
  /// </summary>
  private static DMD.PatternFill? GetPatternFill(DXD.UnderlineFill openXmlElement)
  {
  ...
  private static bool CmpPatternFill(DXD.UnderlineFill openXmlElement, DMD.PatternFill? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetPatternFill(DXD.UnderlineFill openXmlElement, DMD.PatternFill? value)
  {
  ...
  /// Group Fill.
  /// </summary>
  private static Boolean? GetGroupFill(DXD.UnderlineFill openXmlElement)
  {
    return openXmlElement.GetFirstChild<DXD.GroupFill>() != null;
  }
  
  private static bool CmpGroupFill(DXD.UnderlineFill openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetGroupFill(DXD.UnderlineFill openXmlElement, Boolean? value)
  {
    if (value == false)
    {
  ...
  public static DocumentModel.Drawings.UnderlineFill? CreateModelElement(DXD.UnderlineFill? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXD.UnderlineFill? openXmlElement, DMD.UnderlineFill? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMD.UnderlineFill value)
    where OpenXmlElementType: DXD.UnderlineFill, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXD.UnderlineFill openXmlElement, DMD.UnderlineFill value)
  {
