...
public static class Level4ParagraphPropertiesConverter
{
  ...
  public static DMDraws.Level4ParagraphProperties? CreateModelElement(DXDraw.Level4ParagraphProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDraws.Level4ParagraphProperties();
