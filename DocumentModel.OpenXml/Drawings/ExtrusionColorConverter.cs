...
using ExtrusionColor = DocumentFormat.OpenXml.Drawing.ExtrusionColor;
...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(ExtrusionColor? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(ExtrusionColor? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static HslColor? GetHslColor(ExtrusionColor? openXmlElement)
  {
  ...
  public static void SetHslColor(ExtrusionColor? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(ExtrusionColor? openXmlElement)
  {
  ...
  public static void SetSystemColor(ExtrusionColor? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static PresetColor? GetPresetColor(ExtrusionColor? openXmlElement)
  {
  ...
  public static void SetPresetColor(ExtrusionColor? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.ExtrusionColor? CreateModelElement(ExtrusionColor? openXmlElement)
  {
    if (openXmlElement != null)
    {
