...
/// <summary>
/// Defines the ListStyle Class converter from/to OpenXml.
///</summary>
public static class ListStyleConverter
{
  ...
  public static DocumentModel.Drawings.ListStyle? CreateModelElement(DXDraw.ListStyle? openXmlElement)
  {
