...
public static class StyleMatrixReferenceTypeConverter
{
  ...
  private static bool CmpIndex(DXD.StyleMatrixReferenceType openXmlElement, UInt32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXD.StyleMatrixReferenceType openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXD.StyleMatrixReferenceType openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXD.StyleMatrixReferenceType openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXD.StyleMatrixReferenceType openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXD.StyleMatrixReferenceType openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXD.StyleMatrixReferenceType openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXD.StyleMatrixReferenceType? openXmlElement, DMD.StyleMatrixReferenceType? value, DiffList? diffs, string? objName)
  {
