...
/// <summary>
/// Contour Color converter from/to OpenXml.
///</summary>
public static class ContourColorConverter
{
  ...
  public static bool CompareModelElement(DXDraw.ContourColor? openXmlElement, DMDraws.ContourColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.ContourColor openXmlElement, DMDraws.ContourColor value)
  {
