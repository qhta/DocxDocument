...
/// Accent 6.
/// </summary>
public static class Accent6ColorConverter
{
  private static DMDraws.RgbColorModelPercentage? GetRgbColorModelPercentage(DXDraw.Accent6Color openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelPercentage(DXDraw.Accent6Color openXmlElement, DMDraws.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelPercentage(DXDraw.Accent6Color openXmlElement, DMDraws.RgbColorModelPercentage? value)
  {
  ...
  private static DMDraws.RgbColorModelHex? GetRgbColorModelHex(DXDraw.Accent6Color openXmlElement)
  {
  ...
  private static bool CmpRgbColorModelHex(DXDraw.Accent6Color openXmlElement, DMDraws.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetRgbColorModelHex(DXDraw.Accent6Color openXmlElement, DMDraws.RgbColorModelHex? value)
  {
  ...
  private static DMDraws.HslColor? GetHslColor(DXDraw.Accent6Color openXmlElement)
  {
  ...
  private static bool CmpHslColor(DXDraw.Accent6Color openXmlElement, DMDraws.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetHslColor(DXDraw.Accent6Color openXmlElement, DMDraws.HslColor? value)
  {
  ...
  private static DMDraws.SystemColor? GetSystemColor(DXDraw.Accent6Color openXmlElement)
  {
  ...
  private static bool CmpSystemColor(DXDraw.Accent6Color openXmlElement, DMDraws.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetSystemColor(DXDraw.Accent6Color openXmlElement, DMDraws.SystemColor? value)
  {
  ...
  private static DMDraws.PresetColor? GetPresetColor(DXDraw.Accent6Color openXmlElement)
  {
  ...
  private static bool CmpPresetColor(DXDraw.Accent6Color openXmlElement, DMDraws.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetPresetColor(DXDraw.Accent6Color openXmlElement, DMDraws.PresetColor? value)
  {
  ...
  public static DocumentModel.Drawings.Accent6Color? CreateModelElement(DXDraw.Accent6Color? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DocumentModel.Drawings.Accent6Color();
  ...
  public static bool CompareModelElement(DXDraw.Accent6Color? openXmlElement, DMDraws.Accent6Color? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDraws.Accent6Color value)
    where OpenXmlElementType: DXDraw.Accent6Color, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDraw.Accent6Color openXmlElement, DMDraws.Accent6Color value)
  {
