...
public static class Extension2Converter
{
  ...
  private static bool CmpUri(DXO16DCD.Extension2 openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO16DCD.Extension2? openXmlElement, DMDCDs.Extension2? value, DiffList? diffs, string? objName)
  {
