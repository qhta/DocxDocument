...
public static class AxisTitleConverter
{
  ...
  /// Text.
  /// </summary>
  private static DMDCDs.Text? GetText(DXO16DCD.AxisTitle openXmlElement)
  {
  ...
  /// ShapeProperties.
  /// </summary>
  private static DMDCDs.ShapeProperties? GetShapeProperties(DXO16DCD.AxisTitle openXmlElement)
  {
  ...
  /// TxPrTextBody.
  /// </summary>
  private static DMDCDs.TxPrTextBody? GetTxPrTextBody(DXO16DCD.AxisTitle openXmlElement)
  {
  ...
  /// ExtensionList.
  /// </summary>
  private static DMDCDs.ExtensionList? GetExtensionList(DXO16DCD.AxisTitle openXmlElement)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCDs.AxisTitle value)
    where OpenXmlElementType: DXO16DCD.AxisTitle, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO16DCD.AxisTitle openXmlElement, DMDCDs.AxisTitle value)
  {
