...
public static class NonVisualDrawingPropertiesConverter
{
  ...
  public static DMDrawsChartDraws.NonVisualDrawingProperties? CreateModelElement(DXO2010DrawChartDraw.NonVisualDrawingProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartDraws.NonVisualDrawingProperties();
