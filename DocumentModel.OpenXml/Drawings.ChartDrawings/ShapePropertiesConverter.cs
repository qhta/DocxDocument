...
using ShapeProperties = DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.ShapeProperties;
...
public static class ShapePropertiesConverter
{
  ...
  public static DocumentModel.Drawings.ChartDrawings.ShapeProperties? CreateModelElement(ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
