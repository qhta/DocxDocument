...
public static class ShapePropertiesConverter
{
  ...
  private static DMD.LineProperties? GetOutline(DXO16DCD.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpOutline(DXO16DCD.ShapeProperties openXmlElement, DMD.LineProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetOutline(DXO16DCD.ShapeProperties openXmlElement, DMD.LineProperties? value)
  {
  ...
  #region ShapeProperties model conversion.
  public static DMDCDs.ShapeProperties? CreateModelElement(DXO16DCD.ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var model = new DMDCDs.ShapeProperties();
  ...
  public static bool CompareModelElement(DXO16DCD.ShapeProperties? openXmlElement, DMDCDs.ShapeProperties? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCDs.ShapeProperties model)
  ...
  public static void UpdateOpenXmlElement(DXO16DCD.ShapeProperties openXmlElement, DMDCDs.ShapeProperties model)
  {
