...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(MinColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(MinColorSolidColorFillProperties? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(MinColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(MinColorSolidColorFillProperties? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(MinColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetHslColor(MinColorSolidColorFillProperties? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(MinColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetSystemColor(MinColorSolidColorFillProperties? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(MinColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetSchemeColor(MinColorSolidColorFillProperties? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(MinColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetPresetColor(MinColorSolidColorFillProperties? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.ChartDrawings.MinColorSolidColorFillProperties? CreateModelElement(MinColorSolidColorFillProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.ChartDrawings.MinColorSolidColorFillProperties? value)
    where OpenXmlElementType : MinColorSolidColorFillProperties, new()
  {
    if (value != null)
    {
