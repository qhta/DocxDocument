...
public static class MidColorSolidColorFillPropertiesConverter
{
  ...
  public static DMDrawsChartDraws.MidColorSolidColorFillProperties? CreateModelElement(DXO2016DrawChartDraw.MidColorSolidColorFillProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartDraws.MidColorSolidColorFillProperties();
