...
using ColorMappingType = DocumentFormat.OpenXml.Office2016.Drawing.ChartDrawing.ColorMappingType;
...
public static class ColorMappingTypeConverter
{
  ...
  public static DocumentModel.Drawings.ChartDrawings.ColorMappingType? CreateModelElement(ColorMappingType? openXmlElement)
  {
    if (openXmlElement != null)
    {
