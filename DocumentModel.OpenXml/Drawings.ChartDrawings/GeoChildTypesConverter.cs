...
public static class GeoChildTypesConverter
{
  ...
  private static bool CmpEntityTypes(DXO16DCD.GeoChildTypes openXmlElement, Collection<String>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXO16DCD.GeoChildTypes? openXmlElement, DMDCDs.GeoChildTypes? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpEntityTypes(openXmlElement, value.EntityTypes, diffs, objName, propName))
        ok = false;
      return ok;
    }
