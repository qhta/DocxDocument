...
public static class GeoParentEntitiesQueryResultsConverter
{
  ...
  private static bool CmpItems(DXO16DCD.GeoParentEntitiesQueryResults openXmlElement, Collection<DMDCDs.GeoParentEntitiesQueryResult>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDCDs.GeoParentEntitiesQueryResultConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static DMDCDs.GeoParentEntitiesQueryResults? CreateModelElement(DXO16DCD.GeoParentEntitiesQueryResults? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDCDs.GeoParentEntitiesQueryResults();
  ...
  public static bool CompareModelElement(DXO16DCD.GeoParentEntitiesQueryResults? openXmlElement, DMDCDs.GeoParentEntitiesQueryResults? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
