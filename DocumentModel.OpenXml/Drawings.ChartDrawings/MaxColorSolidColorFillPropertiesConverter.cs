...
{
  public static RgbColorModelPercentage? GetRgbColorModelPercentage(MaxColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetRgbColorModelPercentage(MaxColorSolidColorFillProperties? openXmlElement, RgbColorModelPercentage? value)
  {
  ...
  public static RgbColorModelHex? GetRgbColorModelHex(MaxColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetRgbColorModelHex(MaxColorSolidColorFillProperties? openXmlElement, RgbColorModelHex? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.RgbColorModelHex>();
  ...
  public static HslColor? GetHslColor(MaxColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetHslColor(MaxColorSolidColorFillProperties? openXmlElement, HslColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.HslColor>();
  ...
  public static SystemColor? GetSystemColor(MaxColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetSystemColor(MaxColorSolidColorFillProperties? openXmlElement, SystemColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SystemColor>();
  ...
  public static SchemeColor? GetSchemeColor(MaxColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetSchemeColor(MaxColorSolidColorFillProperties? openXmlElement, SchemeColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.SchemeColor>();
  ...
  public static PresetColor? GetPresetColor(MaxColorSolidColorFillProperties? openXmlElement)
  {
  ...
  public static void SetPresetColor(MaxColorSolidColorFillProperties? openXmlElement, PresetColor? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.PresetColor>();
  ...
  public static DocumentModel.Drawings.ChartDrawings.MaxColorSolidColorFillProperties? CreateModelElement(MaxColorSolidColorFillProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.ChartDrawings.MaxColorSolidColorFillProperties? value)
    where OpenXmlElementType : MaxColorSolidColorFillProperties, new()
  {
    if (value != null)
    {
