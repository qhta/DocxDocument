...
public static class MaxColorSolidColorFillPropertiesConverter
{
  ...
  private static bool CmpRgbColorModelPercentage(DXO16DCD.MaxColorSolidColorFillProperties openXmlElement, DMD.RgbColorModelPercentage? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpRgbColorModelHex(DXO16DCD.MaxColorSolidColorFillProperties openXmlElement, DMD.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHslColor(DXO16DCD.MaxColorSolidColorFillProperties openXmlElement, DMD.HslColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSystemColor(DXO16DCD.MaxColorSolidColorFillProperties openXmlElement, DMD.SystemColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSchemeColor(DXO16DCD.MaxColorSolidColorFillProperties openXmlElement, DMD.SchemeColor? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpPresetColor(DXO16DCD.MaxColorSolidColorFillProperties openXmlElement, DMD.PresetColor? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO16DCD.MaxColorSolidColorFillProperties? openXmlElement, DMDCDs.MaxColorSolidColorFillProperties? value, DiffList? diffs, string? objName)
  {
