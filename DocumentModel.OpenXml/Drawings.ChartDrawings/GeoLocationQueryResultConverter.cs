...
/// <summary>
/// Defines the GeoLocationQueryResult Class converter from/to OpenXml.
///</summary>
public static class GeoLocationQueryResultConverter
{
  ...
  {
    return DMXDrawsChartDraws.GeoLocationQueryConverter.CompareModelElement(openXmlElement.GetFirstChild<DXO2016DrawChartDraw.GeoLocationQuery>(), value, diffs, objName);
  }
  ...
  {
    return DMXDrawsChartDraws.GeoLocationsConverter.CompareModelElement(openXmlElement.GetFirstChild<DXO2016DrawChartDraw.GeoLocations>(), value, diffs, objName);
  }
