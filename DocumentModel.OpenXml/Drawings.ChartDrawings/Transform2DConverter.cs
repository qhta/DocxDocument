...
public static class Transform2DConverter
{
  ...
  private static bool CmpRotation(DXO10DCD.Transform2D openXmlElement, Int32? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHorizontalFlip(DXO10DCD.Transform2D openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpVerticalFlip(DXO10DCD.Transform2D openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpOffset(DXO10DCD.Transform2D openXmlElement, DMD.Point2DType? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpExtents(DXO10DCD.Transform2D openXmlElement, DMD.PositiveSize2DType? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO10DCD.Transform2D? openXmlElement, DMDCDs.Transform2D? value, DiffList? diffs, string? objName)
  {
