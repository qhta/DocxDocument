...
public static class Transform2DConverter
{
  ...
  /// Rotation
  /// </summary>
  private static Int32? GetRotation(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement)
  {
    return openXmlElement.Rotation?.Value;
  }
  
  private static void SetRotation(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement, Int32? value)
  {
  ...
  /// Horizontal Flip
  /// </summary>
  private static Boolean? GetHorizontalFlip(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement)
  {
    return openXmlElement?.HorizontalFlip?.Value;
  }
  
  private static void SetHorizontalFlip(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement, Boolean? value)
  {
    if (value != null)
  ...
  /// Vertical Flip
  /// </summary>
  private static Boolean? GetVerticalFlip(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement)
  {
    return openXmlElement?.VerticalFlip?.Value;
  }
  
  private static void SetVerticalFlip(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement, Boolean? value)
  {
    if (value != null)
  ...
  /// Offset.
  /// </summary>
  private static DocumentModel.Drawings.Point2DType? GetOffset(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement)
  {
  ...
  private static void SetOffset(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement, DocumentModel.Drawings.Point2DType? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Offset>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// Extents.
  /// </summary>
  private static DocumentModel.Drawings.PositiveSize2DType? GetExtents(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement)
  {
  ...
  private static void SetExtents(DocumentFormat.OpenXml.Office2010.Drawing.ChartDrawing.Transform2D openXmlElement, DocumentModel.Drawings.PositiveSize2DType? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Extents>();
    if (itemElement != null)
      itemElement.Remove();
