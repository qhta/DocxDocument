...
public static class ShapeProperties2Converter
{
  ...
  public static ShapeProperties2? CreateModelElement(ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new ShapeProperties2();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(ShapeProperties2? value)
