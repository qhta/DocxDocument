...
public static class ShapeProperties2Converter
{
  ...
  public static DMDrawsCharts.ShapeProperties2? CreateModelElement(DXO2010DrawCharts.ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsCharts.ShapeProperties2();
