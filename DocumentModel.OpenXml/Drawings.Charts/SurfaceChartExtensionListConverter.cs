...
public static class SurfaceChartExtensionListConverter
{
  ...
  private static bool CmpSurfaceChartExtensions(DXDC.SurfaceChartExtensionList openXmlElement, Collection<DMDC.SurfaceChartExtension>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDC.SurfaceChartExtensionConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static DMD.Charts.SurfaceChartExtensionList? CreateModelElement(DXDC.SurfaceChartExtensionList? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.SurfaceChartExtensionList();
  ...
  public static bool CompareModelElement(DXDC.SurfaceChartExtensionList? openXmlElement, DMDC.SurfaceChartExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpSurfaceChartExtensions(openXmlElement, value.SurfaceChartExtensions, diffs, objName, propName))
        ok = false;
      return ok;
    }
