...
public static class Line3DChartConverter
{
  ...
  private static bool CmpGrouping(DXDC.Line3DChart openXmlElement, DMDC.GroupingKind? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpVaryColors(DXDC.Line3DChart openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpLineChartSeries(DXDC.Line3DChart openXmlElement, Collection<DMDC.LineChartSeries>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDataLabels(DXDC.Line3DChart openXmlElement, DMDC.DataLabels? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDropLines(DXDC.Line3DChart openXmlElement, DMDC.DropLines? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpGapDepth(DXDC.Line3DChart openXmlElement, UInt16? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpAxisIds(DXDC.Line3DChart openXmlElement, Collection<UInt32>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpLine3DChartExtensionList(DXDC.Line3DChart openXmlElement, DMDC.Line3DChartExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXDC.Line3DChartExtensionListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDC.Line3DChartExtensionList>(), value, diffs, objName, propName);
  }
  ...
  public static DMD.Charts.Line3DChart? CreateModelElement(DXDC.Line3DChart? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.Line3DChart();
  ...
  public static bool CompareModelElement(DXDC.Line3DChart? openXmlElement, DMDC.Line3DChart? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpAxisIds(openXmlElement, value.AxisIds, diffs, objName, propName))
        ok = false;
      if (!CmpLine3DChartExtensionList(openXmlElement, value.Line3DChartExtensionList, diffs, objName, propName))
        ok = false;
      return ok;
    }
