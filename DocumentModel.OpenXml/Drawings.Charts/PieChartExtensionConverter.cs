...
public static class PieChartExtensionConverter
{
  ...
  private static bool CmpUri(DXDC.PieChartExtension openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFilteredPieSeries(DXDC.PieChartExtension openXmlElement, DMDC.FilteredPieSeries? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDC.PieChartExtension? openXmlElement, DMDC.PieChartExtension? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
