...
public static class Line3DChartExtensionListConverter
{
  ...
  private static bool CmpLine3DChartExtensions(DXDC.Line3DChartExtensionList openXmlElement, Collection<DMDC.Line3DChartExtension>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDC.Line3DChartExtensionConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static DMD.Charts.Line3DChartExtensionList? CreateModelElement(DXDC.Line3DChartExtensionList? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.Line3DChartExtensionList();
  ...
  public static bool CompareModelElement(DXDC.Line3DChartExtensionList? openXmlElement, DMDC.Line3DChartExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpLine3DChartExtensions(openXmlElement, value.Line3DChartExtensions, diffs, objName, propName))
        ok = false;
      return ok;
    }
