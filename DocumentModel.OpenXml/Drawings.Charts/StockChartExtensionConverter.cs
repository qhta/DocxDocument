...
public static class StockChartExtensionConverter
{
  ...
  private static bool CmpUri(DXDC.StockChartExtension openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFilteredLineSeriesExtension(DXDC.StockChartExtension openXmlElement, DMDC.FilteredLineSeriesExtension? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDC.StockChartExtension? openXmlElement, DMDC.StockChartExtension? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
