...
using XValues = DocumentFormat.OpenXml.Drawing.Charts.XValues;
...
{
  public static MultiLevelStringReference? GetMultiLevelStringReference(XValues? openXmlElement)
  {
  ...
  public static void SetMultiLevelStringReference(XValues? openXmlElement, MultiLevelStringReference? value)
  {
  ...
  public static NumberReference? GetNumberReference(XValues? openXmlElement)
  {
  ...
  public static void SetNumberReference(XValues? openXmlElement, NumberReference? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.NumberReference>();
  ...
  public static NumberLiteral? GetNumberLiteral(XValues? openXmlElement)
  {
  ...
  public static void SetNumberLiteral(XValues? openXmlElement, NumberLiteral? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.NumberLiteral>();
  ...
  public static StringReference? GetStringReference(XValues? openXmlElement)
  {
  ...
  public static void SetStringReference(XValues? openXmlElement, StringReference? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.StringReference>();
  ...
  public static StringLiteral? GetStringLiteral(XValues? openXmlElement)
  {
  ...
  public static void SetStringLiteral(XValues? openXmlElement, StringLiteral? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Charts.StringLiteral>();
  ...
  public static DocumentModel.Drawings.Charts.XValues? CreateModelElement(XValues? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Charts.XValues? value)
    where OpenXmlElementType : XValues, new()
  {
    if (value != null)
    {
