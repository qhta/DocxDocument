...
public static class XValuesConverter
{
  ...
  private static bool CmpMultiLevelStringReference(DXDC.XValues openXmlElement, DMDC.MultiLevelStringReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpNumberReference(DXDC.XValues openXmlElement, DMDC.NumberReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpNumberLiteral(DXDC.XValues openXmlElement, DMDC.NumberLiteral? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpStringReference(DXDC.XValues openXmlElement, DMDC.StringReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpStringLiteral(DXDC.XValues openXmlElement, DMDC.StringLiteral? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDC.XValues? openXmlElement, DMDC.XValues? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
