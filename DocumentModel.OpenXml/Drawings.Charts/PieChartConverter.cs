...
public static class PieChartConverter
{
  ...
  private static bool CmpVaryColors(DXDC.PieChart openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpPieChartSeries(DXDC.PieChart openXmlElement, Collection<DMDC.PieChartSeries>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDataLabels(DXDC.PieChart openXmlElement, DMDC.DataLabels? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFirstSliceAngle(DXDC.PieChart openXmlElement, UInt16? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpPieChartExtensionList(DXDC.PieChart openXmlElement, DMDC.PieChartExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXDC.PieChartExtensionListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDC.PieChartExtensionList>(), value, diffs, objName, propName);
  }
  ...
  public static DMD.Charts.PieChart? CreateModelElement(DXDC.PieChart? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.PieChart();
  ...
  public static bool CompareModelElement(DXDC.PieChart? openXmlElement, DMDC.PieChart? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpFirstSliceAngle(openXmlElement, value.FirstSliceAngle, diffs, objName, propName))
        ok = false;
      if (!CmpPieChartExtensionList(openXmlElement, value.PieChartExtensionList, diffs, objName, propName))
        ok = false;
      return ok;
    }
