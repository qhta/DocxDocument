...
public static class SeriesAxisConverter
{
  ...
  {
    return DMXDrawsCharts.SerAxExtensionListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDrawCharts.SerAxExtensionList>(), value, diffs, objName);
  }
