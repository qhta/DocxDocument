...
public static class ScatterChartSeries3Converter
{
  ...
  private static bool CmpIndex(DXO13DC.ScatterChartSeries openXmlElement, UInt32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpOrder(DXO13DC.ScatterChartSeries openXmlElement, UInt32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSeriesText(DXO13DC.ScatterChartSeries openXmlElement, DMDC.SeriesText? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpChartShapeProperties(DXO13DC.ScatterChartSeries openXmlElement, DMDC.ChartShapeProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpMarker(DXO13DC.ScatterChartSeries openXmlElement, DMDC.Marker? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDataPoints(DXO13DC.ScatterChartSeries openXmlElement, Collection<DMDC.DataPoint>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDataLabels(DXO13DC.ScatterChartSeries openXmlElement, DMDC.DataLabels? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpTrendlines(DXO13DC.ScatterChartSeries openXmlElement, Collection<DMDC.Trendline>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpErrorBars(DXO13DC.ScatterChartSeries openXmlElement, Collection<DMDC.ErrorBars>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpXValues(DXO13DC.ScatterChartSeries openXmlElement, DMDC.XValues? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpYValues(DXO13DC.ScatterChartSeries openXmlElement, DMDC.YValues? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSmooth(DXO13DC.ScatterChartSeries openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpScatterSerExtensionList(DXO13DC.ScatterChartSeries openXmlElement, DMDC.ScatterSerExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXDC.ScatterSerExtensionListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDC.ScatterSerExtensionList>(), value, diffs, objName, propName);
  }
  ...
  public static DMD.Charts.ScatterChartSeries3? CreateModelElement(DXO13DC.ScatterChartSeries? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.ScatterChartSeries3();
  ...
  public static bool CompareModelElement(DXO13DC.ScatterChartSeries? openXmlElement, DMDC.ScatterChartSeries3? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpSmooth(openXmlElement, value.Smooth, diffs, objName, propName))
        ok = false;
      if (!CmpScatterSerExtensionList(openXmlElement, value.ScatterSerExtensionList, diffs, objName, propName))
        ok = false;
      return ok;
    }
