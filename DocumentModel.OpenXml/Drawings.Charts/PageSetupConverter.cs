...
public static class PageSetupConverter
{
  ...
  private static bool CmpPaperSize(DXDC.PageSetup openXmlElement, UInt32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFirstPageNumber(DXDC.PageSetup openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpOrientation(DXDC.PageSetup openXmlElement, DMDC.PageSetupOrientationKind? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return EnumValueConverter.CmpValue<DocumentFormat.OpenXml.Drawing.Charts.PageSetupOrientationValues, DMDC.PageSetupOrientationKind>(openXmlElement?.Orientation?.Value, value, diffs, objName, propName);
  }
  ...
  private static bool CmpBlackAndWhite(DXDC.PageSetup openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDraft(DXDC.PageSetup openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpUseFirstPageNumber(DXDC.PageSetup openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpHorizontalDpi(DXDC.PageSetup openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpVerticalDpi(DXDC.PageSetup openXmlElement, Int32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpCopies(DXDC.PageSetup openXmlElement, UInt32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMD.Charts.PageSetup? CreateModelElement(DXDC.PageSetup? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.PageSetup();
  ...
  public static bool CompareModelElement(DXDC.PageSetup? openXmlElement, DMDC.PageSetup? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
