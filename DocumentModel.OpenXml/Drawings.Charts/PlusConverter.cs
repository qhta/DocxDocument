...
public static class PlusConverter
{
  ...
  private static bool CmpNumberReference(DXDC.Plus openXmlElement, DMDC.NumberReference? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpNumberLiteral(DXDC.Plus openXmlElement, DMDC.NumberLiteral? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXDC.Plus? openXmlElement, DMDC.Plus? value, DiffList? diffs, string? objName)
  {
