...
{
  private static DMDC.NumberReference? GetNumberReference(DXDC.Plus openXmlElement)
  {
  ...
  private static bool CmpNumberReference(DXDC.Plus openXmlElement, DMDC.NumberReference? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetNumberReference(DXDC.Plus openXmlElement, DMDC.NumberReference? value)
  {
  ...
  private static DMDC.NumberLiteral? GetNumberLiteral(DXDC.Plus openXmlElement)
  {
  ...
  private static bool CmpNumberLiteral(DXDC.Plus openXmlElement, DMDC.NumberLiteral? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetNumberLiteral(DXDC.Plus openXmlElement, DMDC.NumberLiteral? value)
  {
  ...
  public static bool CompareModelElement(DXDC.Plus? openXmlElement, DMDC.Plus? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDC.Plus value)
    where OpenXmlElementType: DXDC.Plus, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXDC.Plus openXmlElement, DMDC.Plus value)
  {
