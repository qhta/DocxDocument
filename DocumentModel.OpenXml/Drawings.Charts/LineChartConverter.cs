...
public static class LineChartConverter
{
  ...
  private static bool CmpGrouping(DXDC.LineChart openXmlElement, DMDC.GroupingKind? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetGrouping(DXDC.LineChart openXmlElement, DMDC.GroupingKind? value)
  {
    ...
    if (value != null)
      openXmlElement.AddChild(EnumValueConverter.CreateOpenXmlElement<DXDC.Grouping, DocumentFormat.OpenXml.Drawing.Charts.GroupingValues, DMDC.GroupingKind>((DMDC.GroupingKind)value));
  }
  ...
  private static bool CmpVaryColors(DXDC.LineChart openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineChartSeries(DXDC.LineChart openXmlElement, Collection<DMDC.LineChartSeries>? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpDataLabels(DXDC.LineChart openXmlElement, DMDC.DataLabels? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpDropLines(DXDC.LineChart openXmlElement, DMDC.DropLines? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpHighLowLines(DXDC.LineChart openXmlElement, DMDC.HighLowLines? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpUpDownBars(DXDC.LineChart openXmlElement, DMDC.UpDownBars? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpShowMarker(DXDC.LineChart openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpSmooth(DXDC.LineChart openXmlElement, Boolean? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpAxisIds(DXDC.LineChart openXmlElement, Collection<UInt32>? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpLineChartExtensionList(DXDC.LineChart openXmlElement, DMDC.LineChartExtensionList? value, DiffList? diffs, string? objName)
  {
    return DMXDC.LineChartExtensionListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDC.LineChartExtensionList>(), value, diffs, objName);
  }
  ...
  public static bool CompareModelElement(DXDC.LineChart? openXmlElement, DMDC.LineChart? value, DiffList? diffs, string? objName)
  {
