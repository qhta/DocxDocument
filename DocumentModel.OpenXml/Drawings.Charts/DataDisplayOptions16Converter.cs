...
public static class DataDisplayOptions16Converter
{
  ...
  /// BooleanFalse.
  /// </summary>
  private static Boolean? GetBooleanFalse(DocumentFormat.OpenXml.Drawing.Charts.DataDisplayOptions16 openXmlElement)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2019.Drawing.Chart.BooleanFalse>();
    return itemElement != null;
  }
  
  private static void SetBooleanFalse(DocumentFormat.OpenXml.Drawing.Charts.DataDisplayOptions16 openXmlElement, Boolean? value)
  {
    if (value == false)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2019.Drawing.Chart.BooleanFalse>();
