...
public static class MultiLvlStrRefExtensionConverter
{
  ...
  /// URI
  /// </summary>
  private static String? GetUri(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement)
  {
    return openXmlElement?.Uri?.Value;
  }
  
  private static void SetUri(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement, String? value)
  {
    if (value != null)
  ...
  private static DocumentModel.Drawings.Charts.FullReference? GetFullReference(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement)
  {
  ...
  private static void SetFullReference(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement, DocumentModel.Drawings.Charts.FullReference? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.FullReference>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  private static DocumentModel.Drawings.Charts.LevelReference? GetLevelReference(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement)
  {
  ...
  private static void SetLevelReference(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement, DocumentModel.Drawings.Charts.LevelReference? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.LevelReference>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  private static DocumentModel.Drawings.Charts.FormulaReference? GetFormulaReference(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement)
  {
  ...
  private static void SetFormulaReference(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension openXmlElement, DocumentModel.Drawings.Charts.FormulaReference? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.FormulaReference>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  public static DocumentModel.Drawings.Charts.MultiLvlStrRefExtension? CreateModelElement(DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension? openXmlElement)
  {
