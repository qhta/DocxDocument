...
public static class Layout3Converter
{
  ...
  public static Layout3? CreateModelElement(Layout? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new Layout3();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(Layout3? value)
