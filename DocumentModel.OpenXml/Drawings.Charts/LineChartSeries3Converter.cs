...
public static class LineChartSeries3Converter
{
  ...
  public static LineChartSeries3? CreateModelElement(LineChartSeries? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new LineChartSeries3();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(LineChartSeries3? value)
