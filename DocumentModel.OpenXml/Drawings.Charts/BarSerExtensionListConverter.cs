...
public static class BarSerExtensionListConverter
{
  ...
  private static bool CmpBarSerExtensions(DXDC.BarSerExtensionList openXmlElement, Collection<DMDC.BarSerExtension>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDC.BarSerExtensionConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXDC.BarSerExtensionList? openXmlElement, DMDC.BarSerExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpBarSerExtensions(openXmlElement, value.BarSerExtensions, diffs, objName, propName))
        ok = false;
      return ok;
    }
