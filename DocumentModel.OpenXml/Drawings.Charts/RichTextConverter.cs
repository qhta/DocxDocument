...
public static class RichTextConverter
{
  ...
  private static bool CmpBodyProperties(DXDC.RichText openXmlElement, DMD.BodyProperties? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpListStyle(DXDC.RichText openXmlElement, DMD.ListStyle? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpParagraph(DXDC.RichText openXmlElement, DMD.Paragraph? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXDC.RichText? openXmlElement, DMDC.RichText? value, DiffList? diffs, string? objName)
  {
