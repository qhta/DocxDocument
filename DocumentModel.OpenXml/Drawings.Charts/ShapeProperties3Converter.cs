...
public static class ShapeProperties3Converter
{
  ...
  public static DMDrawsCharts.ShapeProperties3? CreateModelElement(DXO2013DrawChart.ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsCharts.ShapeProperties3();
