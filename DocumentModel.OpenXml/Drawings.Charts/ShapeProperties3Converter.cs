...
public static class ShapeProperties3Converter
{
  ...
  public static ShapeProperties3? CreateModelElement(ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new ShapeProperties3();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(ShapeProperties3? value)
