...
public static class BubbleChartConverter
{
  ...
  private static bool CmpVaryColors(DXDC.BubbleChart openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpBubbleChartSeries(DXDC.BubbleChart openXmlElement, Collection<DMDC.BubbleChartSeries>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMXDC.BubbleChartSeriesConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  private static bool CmpDataLabels(DXDC.BubbleChart openXmlElement, DMDC.DataLabels? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpBubble3D(DXDC.BubbleChart openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpBubbleScale(DXDC.BubbleChart openXmlElement, UInt32? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpShowNegativeBubbles(DXDC.BubbleChart openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSizeRepresents(DXDC.BubbleChart openXmlElement, DMDC.SizeRepresentsKind? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return EnumValueConverter.CmpValue<DocumentFormat.OpenXml.Drawing.Charts.SizeRepresentsValues, DMDC.SizeRepresentsKind>(openXmlElement.GetFirstChild<DXDC.SizeRepresents>()?.Val?.Value, value, diffs, objName, propName);
  }
  ...
  private static bool CmpAxisIds(DXDC.BubbleChart openXmlElement, Collection<UInt32>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpBubbleChartExtensionList(DXDC.BubbleChart openXmlElement, DMDC.BubbleChartExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXDC.BubbleChartExtensionListConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDC.BubbleChartExtensionList>(), value, diffs, objName, propName);
  }
  ...
  public static bool CompareModelElement(DXDC.BubbleChart? openXmlElement, DMDC.BubbleChart? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpBubble3D(openXmlElement, value.Bubble3D, diffs, objName, propName))
        ok = false;
      if (!CmpBubbleScale(openXmlElement, value.BubbleScale, diffs, objName, propName))
        ok = false;
      if (!CmpShowNegativeBubbles(openXmlElement, value.ShowNegativeBubbles, diffs, objName, propName))
        ok = false;
      if (!CmpSizeRepresents(openXmlElement, value.SizeRepresents, diffs, objName, propName))
        ok = false;
      if (!CmpAxisIds(openXmlElement, value.AxisIds, diffs, objName, propName))
        ok = false;
      if (!CmpBubbleChartExtensionList(openXmlElement, value.BubbleChartExtensionList, diffs, objName, propName))
        ok = false;
      return ok;
    }
