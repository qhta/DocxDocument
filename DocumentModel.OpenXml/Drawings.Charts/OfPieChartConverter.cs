...
public static class OfPieChartConverter
{
  ...
  {
    return openXmlElement?.GetFirstChild<DXDrawCharts.SplitPosition>()?.Val?.Value == value;
  }
  ...
  {
    return openXmlElement?.GetFirstChild<DXDrawCharts.SecondPieSize>()?.Val?.Value == value;
  }
