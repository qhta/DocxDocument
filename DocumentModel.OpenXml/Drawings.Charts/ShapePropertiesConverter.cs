...
public static class ShapePropertiesConverter
{
  ...
  private static DMD.LineProperties? GetOutline(DXDC.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpOutline(DXDC.ShapeProperties openXmlElement, DMD.LineProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetOutline(DXDC.ShapeProperties openXmlElement, DMD.LineProperties? value)
  {
  ...
  public static DocumentModel.Drawings.Charts.ShapeProperties? CreateModelElement(DXDC.ShapeProperties? openXmlElement)
  {
    ...
    {
      var model = new DocumentModel.Drawings.Charts.ShapeProperties();
  ...
  public static bool CompareModelElement(DXDC.ShapeProperties? openXmlElement, DMDC.ShapeProperties? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDC.ShapeProperties model)
  ...
  public static void UpdateOpenXmlElement(DXDC.ShapeProperties openXmlElement, DMDC.ShapeProperties model)
  {
    ...
    FillConverter.CompareFillModel(openXmlElement, model.Fill);
