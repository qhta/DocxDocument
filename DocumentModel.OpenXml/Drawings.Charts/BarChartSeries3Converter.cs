...
public static class BarChartSeries3Converter
{
  ...
  public static BarChartSeries3? CreateModelElement(BarChartSeries? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new BarChartSeries3();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(BarChartSeries3? value)
