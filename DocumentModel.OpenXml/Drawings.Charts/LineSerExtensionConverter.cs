...
public static class LineSerExtensionConverter
{
  ...
  private static bool CmpUri(DXDC.LineSerExtension openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFilteredSeriesTitle(DXDC.LineSerExtension openXmlElement, DMDC.FilteredSeriesTitle? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFilteredCategoryTitle(DXDC.LineSerExtension openXmlElement, DMDC.FilteredCategoryTitle? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDataLabelsRange(DXDC.LineSerExtension openXmlElement, DMDC.DataLabelsRange? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpCategoryFilterExceptions(DXDC.LineSerExtension openXmlElement, DMDC.CategoryFilterExceptions? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDC.LineSerExtension? openXmlElement, DMDC.LineSerExtension? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
