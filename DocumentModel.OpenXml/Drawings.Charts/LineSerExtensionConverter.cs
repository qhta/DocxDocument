...
public static class LineSerExtensionConverter
{
  ...
  /// URI
  /// </summary>
  private static String? GetUri(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement)
  {
    return openXmlElement?.Uri?.Value;
  }
  
  private static void SetUri(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement, String? value)
  {
    if (value != null)
  ...
  private static DocumentModel.Drawings.Charts.FilteredSeriesTitle? GetFilteredSeriesTitle(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement)
  {
  ...
  private static void SetFilteredSeriesTitle(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement, DocumentModel.Drawings.Charts.FilteredSeriesTitle? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.FilteredSeriesTitle>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  private static DocumentModel.Drawings.Charts.FilteredCategoryTitle? GetFilteredCategoryTitle(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement)
  {
  ...
  private static void SetFilteredCategoryTitle(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement, DocumentModel.Drawings.Charts.FilteredCategoryTitle? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.FilteredCategoryTitle>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  private static DocumentModel.Drawings.Charts.DataLabelsRange? GetDataLabelsRange(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement)
  {
  ...
  private static void SetDataLabelsRange(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement, DocumentModel.Drawings.Charts.DataLabelsRange? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.DataLabelsRange>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  private static DocumentModel.Drawings.Charts.CategoryFilterExceptions? GetCategoryFilterExceptions(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement)
  {
  ...
  private static void SetCategoryFilterExceptions(DocumentFormat.OpenXml.Drawing.Charts.LineSerExtension openXmlElement, DocumentModel.Drawings.Charts.CategoryFilterExceptions? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.CategoryFilterExceptions>();
    if (itemElement != null)
      itemElement.Remove();
