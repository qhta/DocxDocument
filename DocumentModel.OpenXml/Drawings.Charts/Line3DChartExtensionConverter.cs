...
using Line3DChartExtension = DocumentFormat.OpenXml.Drawing.Charts.Line3DChartExtension;
...
public static class Line3DChartExtensionConverter
{
  ...
  ///   URI
  /// </summary>
  public static String? GetUri(Line3DChartExtension? openXmlElement)
  {
    return openXmlElement?.Uri?.Value;
  }

  public static void SetUri(Line3DChartExtension? openXmlElement, String? value)
  {
  ...
  public static FilteredLineSeriesExtension? GetFilteredLineSeriesExtension(Line3DChartExtension? openXmlElement)
  {
  ...
  public static void SetFilteredLineSeriesExtension(Line3DChartExtension? openXmlElement, FilteredLineSeriesExtension? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Drawing.Chart.FilteredLineSeriesExtension>();
  ...
  public static DocumentModel.Drawings.Charts.Line3DChartExtension? CreateModelElement(Line3DChartExtension? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(DocumentModel.Drawings.Charts.Line3DChartExtension? value)
    where OpenXmlElementType : Line3DChartExtension, new()
  {
    if (value != null)
    {
