...
public static class RadarSerExtensionConverter
{
  ...
  private static bool CmpUri(DXDC.RadarSerExtension openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFilteredSeriesTitle(DXDC.RadarSerExtension openXmlElement, DMDC.FilteredSeriesTitle? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpFilteredCategoryTitle(DXDC.RadarSerExtension openXmlElement, DMDC.FilteredCategoryTitle? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpDataLabelsRange(DXDC.RadarSerExtension openXmlElement, DMDC.DataLabelsRange? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpCategoryFilterExceptions(DXDC.RadarSerExtension openXmlElement, DMDC.CategoryFilterExceptions? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDC.RadarSerExtension? openXmlElement, DMDC.RadarSerExtension? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
