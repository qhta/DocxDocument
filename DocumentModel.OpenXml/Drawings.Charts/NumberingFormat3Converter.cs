...
public static class NumberingFormat3Converter
{
  ...
  private static bool CmpFormatCode(DXO13DC.NumberingFormat openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpSourceLinked(DXO13DC.NumberingFormat openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMD.Charts.NumberingFormat3? CreateModelElement(DXO13DC.NumberingFormat? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMD.Charts.NumberingFormat3();
  ...
  public static bool CompareModelElement(DXO13DC.NumberingFormat? openXmlElement, DMDC.NumberingFormat3? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
