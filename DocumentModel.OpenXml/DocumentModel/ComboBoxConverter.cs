...
public static class ComboBoxConverter
{
  ...
  public static Collection<Item>? GetItems(DocumentFormat.OpenXml.Office2010.CustomUI.ComboBox? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static void SetItems(DocumentFormat.OpenXml.Office2010.CustomUI.ComboBox? openXmlElement, Collection<Item>? value)
  {
    if (openXmlElement != null)
    {
  ...
  public static ComboBox? CreateModelElement(DocumentFormat.OpenXml.Office2010.CustomUI.ComboBox? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(ComboBox? value)
