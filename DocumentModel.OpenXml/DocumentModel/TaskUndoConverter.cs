...
public static class TaskUndoConverter
{
  ...
  /// </summary>
  private static String? GetId(DocumentFormat.OpenXml.Office2021.DocumentTasks.TaskUndo openXmlElement)
  {
    return openXmlElement?.Id?.Value;
  }
  
  private static void SetId(DocumentFormat.OpenXml.Office2021.DocumentTasks.TaskUndo openXmlElement, String? value)
  {
    if (value != null)
