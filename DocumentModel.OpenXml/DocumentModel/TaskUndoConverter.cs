...
public static class TaskUndoConverter
{
  ...
  public static TaskUndo? CreateModelElement(DocumentFormat.OpenXml.Office2021.DocumentTasks.TaskUndo? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new TaskUndo();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(TaskUndo? value)
