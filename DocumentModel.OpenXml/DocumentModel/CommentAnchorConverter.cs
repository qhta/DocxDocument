...
public static class CommentAnchorConverter
{
  ...
  private static bool CmpId(DXO21DT.CommentAnchor openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO21DT.CommentAnchor? openXmlElement, DM.CommentAnchor? value, DiffList? diffs, string? objName)
  {
