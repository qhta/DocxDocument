...
public static class CommentAnchorConverter
{
  ...
  public static CommentAnchor? CreateModelElement(DocumentFormat.OpenXml.Office2021.DocumentTasks.CommentAnchor? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new CommentAnchor();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(CommentAnchor? value)
