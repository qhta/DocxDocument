...
public static class TaskFormGroupTaskConverter
{
  ...
  public static Collection<BackstageGroup>? GetBackstageGroups(DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupTask? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var collection = new Collection<BackstageGroup>();
      foreach (var item in openXmlElement.Elements<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageGroup>())
      {
        var newItem = BackstageGroupConverter.CreateModelElement(item);
        if (newItem != null)
  ...
  public static void SetBackstageGroups(DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupTask? openXmlElement, Collection<BackstageGroup>? value)
  {
    if (openXmlElement != null)
    {
      ...
      if (value != null)
        ...
        {
          var newItem = BackstageGroupConverter.CreateOpenXmlElement<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageGroup>(item);
          if (newItem != null)
  ...
  public static TaskFormGroupTask? CreateModelElement(DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupTask? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new TaskFormGroupTask();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(TaskFormGroupTask? value)
