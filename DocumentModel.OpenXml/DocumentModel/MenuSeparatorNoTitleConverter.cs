...
public static class MenuSeparatorNoTitleConverter
{
  ...
  private static bool CmpId(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpQualifiedId(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpTag(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpInsertAfterMso(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpInsertBeforeMso(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpInsertAfterQulifiedId(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  private static bool CmpInsertBeforeQulifiedId(DXO10CUI.MenuSeparatorNoTitle openXmlElement, String? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXO10CUI.MenuSeparatorNoTitle? openXmlElement, DM.MenuSeparatorNoTitle? value, DiffList? diffs, string? objName)
  {
