...
public static class TaskGroupTaskConverter
{
  ...
  public static TaskGroupTask? CreateModelElement(DocumentFormat.OpenXml.Office2010.CustomUI.TaskGroupTask? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new TaskGroupTask();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(TaskGroupTask? value)
