...
public static class ContextualTabsConverter
{
  ...
  private static bool CmpTabSets(DXO10CUI.ContextualTabs openXmlElement, Collection<DM.TabSet>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    ...
    if (value != null)
    {
      ...
      foreach (var origItem in origElements)
      {
        ...
        if (!DMX.TabSetConverter.CompareModelElement(origItem, modelItem, diffs, objName, propName))
          ok = false;
      }
      return ok;
    }
  ...
  public static bool CompareModelElement(DXO10CUI.ContextualTabs? openXmlElement, DM.ContextualTabs? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      var ok = true;
      if (!CmpTabSets(openXmlElement, value.TabSets, diffs, objName, propName))
        ok = false;
      return ok;
    }
