...
/// <summary>
/// Defines the ControlCloneQat Class converter from/to OpenXml.
///</summary>
public static class ControlCloneQatConverter
{
  ...
  /// </summary>
  private static String? GetId(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetIdMso(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetDescription(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static DM.SizeKind? GetSize(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetImage(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetImage(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetScreentip(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetSupertip(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetEnabled(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetLabel(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetInsertBeforeMso(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetInsertBeforeQulifiedId(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetVisible(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetKeytip(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static String? GetGetShowLabel(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  /// </summary>
  private static Boolean? GetShowImage(DXO2010CustUI.ControlCloneQat openXmlElement)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DM.ControlCloneQat value)
    where OpenXmlElementType: DXO2010CustUI.ControlCloneQat, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO2010CustUI.ControlCloneQat openXmlElement, DM.ControlCloneQat value)
  {
