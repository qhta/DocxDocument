...
public static class GalleryRegularConverter
{
  ...
  /// </summary>
  public static GalleryShowInRibbonKind? GetShowInRibbon(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement)
  {
    return EnumValueConverter.GetValue<GalleryShowInRibbonValues, GalleryShowInRibbonKind>(openXmlElement?.ShowInRibbon?.Value);
  }

  public static void SetShowInRibbon(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement, GalleryShowInRibbonKind? value)
  {
    if (openXmlElement != null)
  ...
  public static Collection<Item>? GetItems(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static void SetItems(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement, Collection<Item>? value)
  {
    if (openXmlElement != null)
    {
  ...
  public static Collection<ButtonRegular>? GetButtonRegulars(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static void SetButtonRegulars(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement, Collection<ButtonRegular>? value)
  {
    if (openXmlElement != null)
    {
  ...
  public static GalleryRegular? CreateModelElement(DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new GalleryRegular();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(GalleryRegular? value)
