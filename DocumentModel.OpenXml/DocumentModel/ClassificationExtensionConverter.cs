...
public static class ClassificationExtensionConverter
{
  ...
  /// </summary>
  private static String? GetUri(DocumentFormat.OpenXml.Office2021.MipLabelMetaData.ClassificationExtension openXmlElement)
  {
    return openXmlElement?.Uri?.Value;
  }
  
  private static void SetUri(DocumentFormat.OpenXml.Office2021.MipLabelMetaData.ClassificationExtension openXmlElement, String? value)
  {
    if (value != null)
