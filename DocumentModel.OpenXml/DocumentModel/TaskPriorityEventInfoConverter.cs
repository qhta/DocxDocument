...
public static class TaskPriorityEventInfoConverter
{
  ...
  public static TaskPriorityEventInfo? CreateModelElement(DocumentFormat.OpenXml.Office2021.DocumentTasks.TaskPriorityEventInfo? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new TaskPriorityEventInfo();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(TaskPriorityEventInfo? value)
