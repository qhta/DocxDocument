...
public static class CheckBoxConverter
{
  ...
  public static CheckBox? CreateModelElement(DocumentFormat.OpenXml.Office2010.CustomUI.CheckBox? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(CheckBox? value)
