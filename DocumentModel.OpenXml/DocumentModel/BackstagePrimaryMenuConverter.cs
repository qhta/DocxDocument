...
public static class BackstagePrimaryMenuConverter
{
  ...
  public static DocumentModel.BackstageMenuGroup? GetBackstageMenuGroup(DocumentFormat.OpenXml.Office2010.CustomUI.BackstagePrimaryMenu? openXmlElement)
  {
  ...
  public static void SetBackstageMenuGroup(DocumentFormat.OpenXml.Office2010.CustomUI.BackstagePrimaryMenu? openXmlElement, DocumentModel.BackstageMenuGroup? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2010.CustomUI.BackstageMenuGroup>();
