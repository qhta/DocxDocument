...
public static class TabSetConverter
{
  ...
  public static Collection<Tab>? GetTabs(DocumentFormat.OpenXml.Office2010.CustomUI.TabSet? openXmlElement)
  {
    if (openXmlElement != null)
    {
  ...
  public static void SetTabs(DocumentFormat.OpenXml.Office2010.CustomUI.TabSet? openXmlElement, Collection<Tab>? value)
  {
    if (openXmlElement != null)
    {
  ...
  public static TabSet? CreateModelElement(DocumentFormat.OpenXml.Office2010.CustomUI.TabSet? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new TabSet();
  ...
  public static OpenXmlElementType? CreateOpenXmlElement<OpenXmlElementType>(TabSet? value)
