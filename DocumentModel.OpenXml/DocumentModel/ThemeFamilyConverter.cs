...
public static class ThemeFamilyConverter
{
  ...
  /// </summary>
  private static String? GetName(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement)
  {
    return openXmlElement?.Name?.Value;
  }
  
  private static void SetName(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement, String? value)
  {
    if (value != null)
  ...
  /// </summary>
  private static String? GetId(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement)
  {
    return openXmlElement?.Id?.Value;
  }
  
  private static void SetId(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement, String? value)
  {
    if (value != null)
  ...
  /// </summary>
  private static String? GetVid(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement)
  {
    return openXmlElement?.Vid?.Value;
  }
  
  private static void SetVid(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement, String? value)
  {
    if (value != null)
  ...
  /// </summary>
  private static DocumentModel.OfficeArtExtensionList? GetOfficeArtExtensionList(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement)
  {
  ...
  private static void SetOfficeArtExtensionList(DocumentFormat.OpenXml.Office2013.Theme.ThemeFamily openXmlElement, DocumentModel.OfficeArtExtensionList? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Office2013.Theme.OfficeArtExtensionList>();
    if (itemElement != null)
      itemElement.Remove();
