...
public static class TaskTitleEventInfoConverter
{
  ...
  /// </summary>
  private static String? GetTitle(DocumentFormat.OpenXml.Office2021.DocumentTasks.TaskTitleEventInfo openXmlElement)
  {
    return openXmlElement?.Title?.Value;
  }
  
  private static void SetTitle(DocumentFormat.OpenXml.Office2021.DocumentTasks.TaskTitleEventInfo openXmlElement, String? value)
  {
    if (value != null)
