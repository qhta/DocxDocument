...
public static class SolidColorFillPropertiesConverter
{
  ...
  private static bool CmpRgbColorModelHex(DXO10W.SolidColorFillProperties openXmlElement, DMW.RgbColorModelHex? value, DiffList? diffs, string? objName)
  {
  ...
  /// SchemeColor.
  /// </summary>
  private static DMW.SchemeColor? GetSchemeColor(DXO10W.SolidColorFillProperties openXmlElement)
  {
  ...
  private static bool CmpSchemeColor(DXO10W.SolidColorFillProperties openXmlElement, DMW.SchemeColor? value, DiffList? diffs, string? objName)
  {
    return DMXW.SchemeColorConverter.CompareModelElement(openXmlElement.GetFirstChild<DXO10W.SchemeColor>(), value, diffs, objName);
  }
  
  private static void SetSchemeColor(DXO10W.SolidColorFillProperties openXmlElement, DMW.SchemeColor? value)
  {
  ...
  public static DMW.SolidColorFillProperties? CreateModelElement(DXO10W.SolidColorFillProperties? openXmlElement)
  {
  ...
  public static bool CompareModelElement(DXO10W.SolidColorFillProperties? openXmlElement, DMW.SolidColorFillProperties? value, DiffList? diffs, string? objName)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMW.SolidColorFillProperties value)
    where OpenXmlElementType: DXO10W.SolidColorFillProperties, new()
  {
  ...
  public static void UpdateOpenXmlElement(DXO10W.SolidColorFillProperties openXmlElement, DMW.SolidColorFillProperties value)
  {
