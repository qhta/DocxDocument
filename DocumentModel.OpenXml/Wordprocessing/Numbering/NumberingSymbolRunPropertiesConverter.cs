...
public static class NumberingSymbolRunPropertiesConverter
{
  ...
  #region Languages.
  private static DMW.Languages? GetLanguages(DXW.NumberingSymbolRunProperties openXmlElement)
  {
  ...
  private static bool CmpLanguages(DXW.NumberingSymbolRunProperties openXmlElement, DMW.Languages? value, DiffList? diffs, string? objName)
  {
    return DMXW.LanguageTypeConverter.CompareModelElement(openXmlElement.GetFirstChild<DXW.Languages>(), value, diffs, objName);
  }

  private static void SetLanguages(DXW.NumberingSymbolRunProperties openXmlElement, DMW.Languages? value)
  {
