...
public static class CategoryConverter
{
    ...
    if (openXmlElement != null)
    {
      ...
      if (itemElement?.Val?.Value != null)
      {
        return EnumValueConverter
          .GetValue<DocumentFormat.OpenXml.Wordprocessing.DocPartGalleryValues, DocumentModel.Wordprocessing.DocPartGalleryKind>
  ...
  public static void SetGallery(DocumentFormat.OpenXml.Wordprocessing.Category? openXmlElement, DocumentModel.Wordprocessing.DocPartGalleryKind? value)
  {
    if (openXmlElement != null)
    {
      ...
      if (value != null)
      {
        itemElement = EnumValueConverter
          .CreateOpenXmlElement<DocumentFormat.OpenXml.Wordprocessing.Category, 
              DocumentFormat.OpenXml.Wordprocessing.DocPartGalleryValues, DocumentModel.Wordprocessing.DocPartGalleryKind>
            (value);
        if (itemElement != null)
