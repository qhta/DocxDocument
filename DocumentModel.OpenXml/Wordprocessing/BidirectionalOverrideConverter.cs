...
/// <summary>
/// Defines the BidirectionalOverride Class converter from/to OpenXml.
///</summary>
public static class BidirectionalOverrideConverter
{
  ...
  private static bool CmpSimpleFields(DXW.BidirectionalOverride openXmlElement, Collection<DMW.SimpleField>? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXW.BidirectionalOverride? openXmlElement, DMW.BidirectionalOverride? value, DiffList? diffs, string? objName)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpRun(openXmlElement, value.Run, diffs, objName))
        ok = false;
      if (!CmpChildBidirectionalOverride(openXmlElement, value.ChildBidirectionalOverride, diffs, objName))
        ok = false;
  ...
  public static DXW.BidirectionalOverride CreateOpenXmlElement(DMW.BidirectionalOverride value)
  {
