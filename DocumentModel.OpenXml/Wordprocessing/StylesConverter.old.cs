...
public static class StylesConverter
{
  ...
  private static bool CmpDocDefaults(DXW.Styles openXmlElement, DMW.DocDefaults? value, DiffList? diffs)
  {
    return DocDefaultsConverter.CompareModelElement(openXmlElement?.GetFirstChild<DXW.DocDefaults>(), value, diffs);
  }
  ...
  public static bool? CompareModelElement(DXW.Styles? openXmlElement, DMW.Styles? value, DiffList? diffs)
  {
