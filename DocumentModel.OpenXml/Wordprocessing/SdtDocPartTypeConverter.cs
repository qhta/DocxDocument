...
public static class SdtDocPartTypeConverter
{
  ...
  /// </summary>
  private static String? GetDocPartGallery(DocumentFormat.OpenXml.Wordprocessing.SdtDocPartType openXmlElement)
  {
  ...
  private static void SetDocPartGallery(DocumentFormat.OpenXml.Wordprocessing.SdtDocPartType openXmlElement, String? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.DocPartGallery>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// </summary>
  private static String? GetDocPartCategory(DocumentFormat.OpenXml.Wordprocessing.SdtDocPartType openXmlElement)
  {
  ...
  private static void SetDocPartCategory(DocumentFormat.OpenXml.Wordprocessing.SdtDocPartType openXmlElement, String? value)
  {
    var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.DocPartCategory>();
    if (itemElement != null)
      itemElement.Remove();
  ...
  /// </summary>
  private static Boolean? GetDocPartUnique(DocumentFormat.OpenXml.Wordprocessing.SdtDocPartType openXmlElement)
  {
  ...
  private static void SetDocPartUnique(DocumentFormat.OpenXml.Wordprocessing.SdtDocPartType openXmlElement, Boolean? value)
  {
    if (value == false)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Wordprocessing.DocPartUnique>();
