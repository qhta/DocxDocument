...
public static class PreviousTablePropertiesConverter
{
  ...
  /// TableWidth.
  /// </summary>
  private static DMW.TableWidth? GetTableWidth(DXW.PreviousTableProperties openXmlElement)
  {
  ...
  private static bool CmpTableWidth(DXW.PreviousTableProperties openXmlElement, DMW.TableWidth? value, DiffList? diffs, string? objName)
  {
    return DMXW.TableWidthTypeConverter.CompareModelElement(openXmlElement.GetFirstChild<DXW.TableWidth>(), value, diffs, objName);
  }
  
  private static void SetTableWidth(DXW.PreviousTableProperties openXmlElement, DMW.TableWidth? value)
  {
  ...
  /// TableCellSpacing.
  /// </summary>
  private static DMW.TableWidth? GetTableCellSpacing(DXW.PreviousTableProperties openXmlElement)
  {
  ...
  private static bool CmpTableCellSpacing(DXW.PreviousTableProperties openXmlElement, DMW.TableWidth? value, DiffList? diffs, string? objName)
  {
  ...
  private static void SetTableCellSpacing(DXW.PreviousTableProperties openXmlElement, DMW.TableWidth? value)
  {
