...
public static class ParagraphMarkRunPropertiesConverter
{
  ...
  private static DMW.Languages? GetLanguages(DXW.ParagraphMarkRunProperties openXmlElement)
  {
  ...
  private static bool CmpLanguages(DXW.ParagraphMarkRunProperties openXmlElement, DMW.Languages? value, DiffList? diffs, string? objName)
  {
    return DMXW.LanguageTypeConverter.CompareModelElement(openXmlElement.GetFirstChild<DXW.Languages>(), value, diffs, objName);
  }
  
  private static void SetLanguages(DXW.ParagraphMarkRunProperties openXmlElement, DMW.Languages? value)
  {
