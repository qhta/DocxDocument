...
public static class TableCellConverter
{
  ...
  {
    return DMXW.TableCellPropertiesConverter.CompareModelElement(openXmlElement.GetFirstChild<DXW.TableCellProperties>(), value, diffs, objName?.Concat2(".",openXmlElement?.GetType().Name));
  }
  ...
  public static DocumentModel.Wordprocessing.TableCell? CreateModelElement(DXW.TableCell? openXmlElement)
  {
