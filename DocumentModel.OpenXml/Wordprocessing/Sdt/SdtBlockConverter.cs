...
public static class SdtBlockConverter
{
  ...
  public static DMW.ISdtBlockContent? CreateSdtContentBlockModelElement(DX.OpenXmlElement? openXmlElement, object? data = null)
  {
  ...
  public static bool CompareSdtContentBlockElement(DX.OpenXmlElement? openXmlElement, DM.IModelElement? model, 
  ...
  public static OpenXmlElement CreateSdtContentBlockOpenXmlElement(IModelElement model, object? data = null)
  {
    ...
    throw new InvalidOperationException($"Model of type \"{model.GetType()}\" not supported in SdtBlockConverter.CreateOpenXmlParagraphContent method");
  }
  ...
  public static bool UpdateSdtContentBlockOpenXmlElement(DX.OpenXmlElement openXmlElement, IModelElement model, object? data = null)
  {
    if (openXmlElement is DXW.Paragraph paragraph && model is DMW.Paragraph paragraphModel)
  ...
  public static DMW.SdtBlock? CreateModelElement(DXW.SdtBlock? openXmlElement)
  {
    if (openXmlElement != null)
    {
      ...
      ElementCollectionConverter<DMW.ISdtBlockContent>.FillModelElementCollection(openXmlElement.SdtContentBlock, model,
        CreateSdtContentBlockModelElement);
      return model;
    }
    return null;
  }
  ...
  public static bool CompareModelElement(DXW.SdtBlock? openXmlElement, DMW.SdtBlock? model, DiffList? diffs, string? objName)
  {
    if (openXmlElement != null && model != null)
    {
      ...
      if (!ElementCollectionConverter<DMW.ISdtBlockContent>.CompareOpenXmlElementCollection(openXmlElement.SdtContentBlock, model,
        CompareSdtContentBlockElement, diffs, objName))
        ok = false;
      return ok;
    }
    if (openXmlElement == null && model == null) return true;
  ...
  public static bool UpdateOpenXmlElement(DXW.SdtBlock openXmlElement, DMW.SdtBlock model)
  {
    ...
    return ElementCollectionConverter<DMW.ISdtBlockContent>.UpdateOpenXmlElementCollection(openXmlElement, model,
      CompareSdtContentBlockElement,
      UpdateSdtContentBlockOpenXmlElement,
      CreateSdtContentBlockOpenXmlElement);
  }
