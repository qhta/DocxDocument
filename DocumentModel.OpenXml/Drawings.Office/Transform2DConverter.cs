...
using Transform2D = DocumentFormat.OpenXml.Office.Drawing.Transform2D;
...
public static class Transform2DConverter
{
  ...
  public static DocumentModel.Drawings.Office.Transform2D? CreateModelElement(Transform2D? openXmlElement)
  {
    if (openXmlElement != null)
    {
