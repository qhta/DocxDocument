...
public static class Transform2DConverter
{
  ...
  /// Rotation
  /// </summary>
  public static Int32? GetRotation(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement)
  {
    return openXmlElement?.Rotation?.Value;
  }
  
  public static void SetRotation(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement, Int32? value)
  {
  ...
  /// Horizontal Flip
  /// </summary>
  public static Boolean? GetHorizontalFlip(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement)
  {
    return openXmlElement?.HorizontalFlip?.Value;
  }
  
  public static void SetHorizontalFlip(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement, Boolean? value)
  {
    if (openXmlElement != null)
      if (value != null)
  ...
  /// Vertical Flip
  /// </summary>
  public static Boolean? GetVerticalFlip(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement)
  {
    return openXmlElement?.VerticalFlip?.Value;
  }
  
  public static void SetVerticalFlip(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement, Boolean? value)
  {
    if (openXmlElement != null)
      if (value != null)
  ...
  /// Offset.
  /// </summary>
  public static DocumentModel.Drawings.Point2DType? GetOffset(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement)
  {
  ...
  public static void SetOffset(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement, DocumentModel.Drawings.Point2DType? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Offset>();
  ...
  /// Extents.
  /// </summary>
  public static DocumentModel.Drawings.PositiveSize2DType? GetExtents(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement)
  {
  ...
  public static void SetExtents(DocumentFormat.OpenXml.Office.Drawing.Transform2D? openXmlElement, DocumentModel.Drawings.PositiveSize2DType? value)
  {
    if (openXmlElement != null)
    {
      var itemElement = openXmlElement.GetFirstChild<DocumentFormat.OpenXml.Drawing.Extents>();
