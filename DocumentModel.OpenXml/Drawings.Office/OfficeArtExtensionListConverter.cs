...
public static class OfficeArtExtensionListConverter
{
  ...
  private static bool CmpExtensions(DXOD.OfficeArtExtensionList openXmlElement, Collection<DMD.Extension>? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static DMDO.OfficeArtExtensionList? CreateModelElement(DXOD.OfficeArtExtensionList? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDO.OfficeArtExtensionList();
  ...
  public static bool CompareModelElement(DXOD.OfficeArtExtensionList? openXmlElement, DMDO.OfficeArtExtensionList? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
