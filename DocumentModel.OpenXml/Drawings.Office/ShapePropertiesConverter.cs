...
public static class ShapePropertiesConverter
{
  ...
  public static Transform2D? GetTransform2D(ShapeProperties? openXmlElement)
  {
    ...
    if (itemElement != null)
      return Drawings.Transform2DConverter.CreateModelElement(itemElement);
    return null;
  }
  ...
  public static void SetTransform2D(ShapeProperties? openXmlElement, Transform2D? value)
  {
    if (openXmlElement != null)
    {
      ...
      if (value != null)
      {
        itemElement = Drawings.Transform2DConverter.CreateOpenXmlElement<DocumentFormat.OpenXml.Drawing.Transform2D>(value);
        if (itemElement != null)
  ...
  public static DocumentModel.Drawings.Office.ShapeProperties? CreateModelElement(ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
