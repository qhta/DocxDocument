...
public static class ShapePropertiesConverter
{
  ...
  public static DMDrawsChartDraw.ShapeProperties? CreateModelElement(DXDrawChartDraw.ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var value = new DMDrawsChartDraw.ShapeProperties();
