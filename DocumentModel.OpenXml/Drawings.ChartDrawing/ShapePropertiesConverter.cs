...
public static class ShapePropertiesConverter
{
  ...
  private static DMD.LineProperties? GetOutline(DXDCD.ShapeProperties openXmlElement)
  {
  ...
  private static bool CmpOutline(DXDCD.ShapeProperties openXmlElement, DMD.LineProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static void SetOutline(DXDCD.ShapeProperties openXmlElement, DMD.LineProperties? value)
  {
  ...
  public static DMDCD.ShapeProperties? CreateModelElement(DXDCD.ShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var model = new DMDCD.ShapeProperties();
  ...
  public static bool CompareModelElement(DXDCD.ShapeProperties? openXmlElement, DMDCD.ShapeProperties? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCD.ShapeProperties model)
  ...
  public static void UpdateOpenXmlElement(DXDCD.ShapeProperties openXmlElement, DMDCD.ShapeProperties model)
  {
