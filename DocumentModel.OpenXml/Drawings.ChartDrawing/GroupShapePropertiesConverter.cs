...
public static class GroupShapePropertiesConverter
{
  ...
  #region GroupShapeProperties model conversion.
  public static DMDCD.GroupShapeProperties? CreateModelElement(DXDCD.GroupShapeProperties? openXmlElement)
  {
    if (openXmlElement != null)
    {
      var model = new DMDCD.GroupShapeProperties();
  ...
  public static bool CompareModelElement(DXDCD.GroupShapeProperties? openXmlElement, DMDCD.GroupShapeProperties? model, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static OpenXmlElementType CreateOpenXmlElement<OpenXmlElementType>(DMDCD.GroupShapeProperties model)
  ...
  public static void UpdateOpenXmlElement(DXDCD.GroupShapeProperties openXmlElement, DMDCD.GroupShapeProperties model)
  {
