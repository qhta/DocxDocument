...
public static class ConnectionShapeConverter
{
  ...
  private static bool CmpMacro(DXDCD.ConnectionShape openXmlElement, String? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpPublished(DXDCD.ConnectionShape openXmlElement, Boolean? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpNonVisualConnectorShapeDrawingProperties(DXDCD.ConnectionShape openXmlElement, DMDCD.NonVisualConnectorShapeDrawingProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    return DMXDCD.NonVisualConnectorShapeDrawingPropertiesConverter.CompareModelElement(openXmlElement.GetFirstChild<DXDCD.NonVisualConnectorShapeDrawingProperties>(), value, diffs, objName, propName);
  }
  ...
  private static bool CmpShapeProperties(DXDCD.ConnectionShape openXmlElement, DMDCD.ShapeProperties? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  private static bool CmpStyle(DXDCD.ConnectionShape openXmlElement, DMDCD.Style? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
  ...
  public static bool CompareModelElement(DXDCD.ConnectionShape? openXmlElement, DMDCD.ConnectionShape? value, DiffList? diffs = null, string? objName = null, string? propName = null)
  {
    if (openXmlElement != null && value != null)
    {
      ...
      if (!CmpPublished(openXmlElement, value.Published, diffs, objName, propName))
        ok = false;
      if (!CmpNonVisualConnectorShapeDrawingProperties(openXmlElement, value.NonVisualConnectorShapeDrawingProperties, diffs, objName, propName))
        ok = false;
