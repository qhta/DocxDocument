...
public static class OfficeArtExtensionListConverter
{
  ...
  private static bool CmpExtensions(DXODY21SL.OfficeArtExtensionList openXmlElement, Collection<DMD.Extension>? value, DiffList? diffs, string? objName)
  {
  ...
  public static bool CompareModelElement(DXODY21SL.OfficeArtExtensionList? openXmlElement, DMDOSL.OfficeArtExtensionList? value, DiffList? diffs, string? objName)
  {
