...
public class WebExtension : Extension
{
 ...
 public WebExtensionStoreReference? WebExtensionStoreReference { get => _WebExtensionStoreReference; set => UpdateField(ref _WebExtensionStoreReference, value, nameof(WebExtensionStoreReference)); }
 ...
 public WebExtensionReferenceList? WebExtensionReferenceList { get => _WebExtensionReferenceList; set => UpdateField(ref _WebExtensionReferenceList, value, nameof(WebExtensionReferenceList)); }
 ...
 public WebExtensionPropertyBag? WebExtensionPropertyBag { get => _WebExtensionPropertyBag; set => UpdateField(ref _WebExtensionPropertyBag, value, nameof(WebExtensionPropertyBag)); }
 ...
 public WebExtensionBindingList? WebExtensionBindingList { get => _WebExtensionBindingList; set => UpdateField(ref _WebExtensionBindingList, value, nameof(WebExtensionBindingList)); }
