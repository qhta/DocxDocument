...
public partial class Reflection: ModelElement<DXD.Reflection>
{
  ...
  {
    get => _StartOpacity ??= GetProperty<Int32?>(GetUpdatableElement()?.StartOpacity);
    set => UpdateField(ref _StartOpacity, value, nameof(StartOpacity));
  }
  ...
  {
    get => _EndAlpha ??= GetProperty<Int32?>(GetUpdatableElement()?.EndAlpha);
    set => UpdateField(ref _EndAlpha, value, nameof(EndAlpha));
  }
  ...
  {
    get => _HorizontalRatio ??= GetProperty<Int32?>(GetUpdatableElement()?.HorizontalRatio);
    set => UpdateField(ref _HorizontalRatio, value, nameof(HorizontalRatio));
  }
  ...
  {
    get => _VerticalRatio ??= GetProperty<Int32?>(GetUpdatableElement()?.VerticalRatio);
    set => UpdateField(ref _VerticalRatio, value, nameof(VerticalRatio));
  }
  ...
  {
    get => _HorizontalSkew ??= GetProperty<Int32?>(GetUpdatableElement()?.HorizontalSkew);
    set => UpdateField(ref _HorizontalSkew, value, nameof(HorizontalSkew));
  }
  ...
  {
    get => _VerticalSkew ??= GetProperty<Int32?>(GetUpdatableElement()?.VerticalSkew);
    set => UpdateField(ref _VerticalSkew, value, nameof(VerticalSkew));
  }
