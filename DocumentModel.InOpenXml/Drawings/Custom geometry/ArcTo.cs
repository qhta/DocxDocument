...
public partial class ArcTo: ModelElement<DXD.ArcTo>
{
  ...
  {
    get => _WidthRadius ??= GetProperty<string?>(GetUpdatableElement()?.WidthRadius);
    set => UpdateField(ref _WidthRadius, value, nameof(WidthRadius));
  }
  ...
  {
    get => _HeightRadius ??= GetProperty<string?>(GetUpdatableElement()?.HeightRadius);
    set => UpdateField(ref _HeightRadius, value, nameof(HeightRadius));
  }
  ...
  {
    get => _StartAngle ??= GetProperty<string?>(GetUpdatableElement()?.StartAngle);
  ...
  {
    get => _SwingAngle ??= GetProperty<string?>(GetUpdatableElement()?.SwingAngle);
    set => UpdateField(ref _SwingAngle, value, nameof(SwingAngle));
  }
