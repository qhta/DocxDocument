...
public partial class CustomGeometry: ModelElement<DXD.CustomGeometry>
{
  ...
  {
    get => _ShapeGuideList ??= GetProperty<ShapeGuideList?>(GetUpdatableElement()?.ShapeGuideList);
    set => UpdateField(ref _ShapeGuideList, value, nameof(ShapeGuideList));
  }
  ...
  {
    get => _AdjustHandleList ??= GetProperty<AdjustHandleList?>(GetUpdatableElement()?.AdjustHandleList);
    set => UpdateField(ref _AdjustHandleList, value, nameof(AdjustHandleList));
  }
  ...
  {
    get => _ConnectionSiteList ??= GetProperty<ConnectionSiteList?>(GetUpdatableElement()?.ConnectionSiteList);
    set => UpdateField(ref _ConnectionSiteList, value, nameof(ConnectionSiteList));
  }
  ...
  {
    get => _Rectangle ??= GetProperty<Rectangle?>(GetUpdatableElement()?.Rectangle);
    set => UpdateField(ref _Rectangle, value, nameof(Rectangle));
  }
  ...
  {
    get => _PathList ??= GetProperty<PathList?>(GetUpdatableElement()?.PathList);
    set => UpdateField(ref _PathList, value, nameof(PathList));
  }
