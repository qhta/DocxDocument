...
public partial class HyperlinkType: ModelElement<DXD.HyperlinkType>, IExtendableHyperlinkElement
{
  ...
  {
    get => _InvalidUrl ??= GetProperty<string?>(GetUpdatableElement()?.InvalidUrl);
    set => UpdateField(ref _InvalidUrl, value, nameof(InvalidUrl));
  }
  ...
  {
    get => _Action ??= GetProperty<string?>(GetUpdatableElement()?.Action);
    set => UpdateField(ref _Action, value, nameof(Action));
  }
  ...
  {
    get => _TargetFrame ??= GetProperty<string?>(GetUpdatableElement()?.TargetFrame);
    set => UpdateField(ref _TargetFrame, value, nameof(TargetFrame));
  }
  ...
  {
    get => _Tooltip ??= GetProperty<string?>(GetUpdatableElement()?.Tooltip);
    set => UpdateField(ref _Tooltip, value, nameof(Tooltip));
  }
  ...
  public bool? History
  {
    get => _History ??= GetProperty<bool?>(GetUpdatableElement()?.History);
    set => UpdateField(ref _History, value, nameof(History));
  }
  ...
  {
    get => _HighlightClick ??= GetProperty<bool?>(GetUpdatableElement()?.HighlightClick);
    set => UpdateField(ref _HighlightClick, value, nameof(HighlightClick));
  }
  ...
  {
    get => _EndSound ??= GetProperty<bool?>(GetUpdatableElement()?.EndSound);
    set => UpdateField(ref _EndSound, value, nameof(EndSound));
  }
