...
public partial class LiveFeedProperties: ModelElement<DXO21DL.LiveFeedProperties>, IOfficeArtExtendableElement
{
  ...
  {
    get => _LiveFeedBackgroundProperties ??=
      GetProperty<LiveFeedBackgroundProperties?>(GetUpdatableElement()?.LiveFeedBackgroundProperties);
    set => UpdateField(ref _LiveFeedBackgroundProperties, value, nameof(LiveFeedBackgroundProperties));
  }
