...
public partial class ConnectionShapeLocks: ModelElement<DXD.ConnectionShapeLocks>
{
  ...
  {
    get => _ConnectorLockingExtensionList ??=
      GetProperty<ConnectorLockingExtensionList?>(GetUpdatableElement()?.ConnectorLockingExtensionList);
    set => UpdateField(ref _ConnectorLockingExtensionList, value, nameof(ConnectorLockingExtensionList));
  }
