...
public partial class PatternFill: ModelElement<DXD.PatternFill>
{
  ...
  public PresetPattern? Preset
  {
    get => _Preset ??= GetProperty<PresetPattern?>(GetUpdatableElement()?.Preset);
  ...
  {
    get => _ForegroundColor ??= GetProperty<ForegroundColor?>(GetUpdatableElement()?.ForegroundColor);
  ...
  {
    get => _BackgroundColor ??= GetProperty<BackgroundColor?>(GetUpdatableElement()?.BackgroundColor);
