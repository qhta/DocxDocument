...
public partial class Blip : ModelElement<DXD.Blip>, IExtendableElement
{
  ...
  public string? Embed { get => _Embed ??= GetProperty<string?>(GetUpdatableElement()?.Embed); set => UpdateField(ref _Embed, value, nameof(Embed)); }
  ...
  public string? Link { get => _Link ??= GetProperty<string?>(GetUpdatableElement()?.Link); set => UpdateField(ref _Link, value, nameof(Link)); }
  ...
  public BlipCompression? CompressionState { get => _CompressionState ??= GetProperty<BlipCompression?>(GetUpdatableElement()?.CompressionState); set => UpdateField(ref _CompressionState, value, nameof(CompressionState)); }
