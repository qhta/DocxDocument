...
public partial class ColorScheme : ModelElement<DXD.ColorScheme>, IOfficeArtExtendableElement
{
 ...
 public ISchemeBaseColor? Dark1Color { get => _Dark1Color; set => UpdateField(ref _Dark1Color, value, nameof(Dark1Color)); }
 ...
 public ISchemeBaseColor? Light1Color { get => _Light1Color; set => UpdateField(ref _Light1Color, value, nameof(Light1Color)); }
 ...
 public ISchemeBaseColor? Dark2Color { get => _Dark2Color; set => UpdateField(ref _Dark2Color, value, nameof(Dark2Color)); }
 ...
 public ISchemeBaseColor? Light2Color { get => _Light2Color; set => UpdateField(ref _Light2Color, value, nameof(Light2Color)); }
 ...
 public ISchemeBaseColor? Accent1Color { get => _Accent1Color; set => UpdateField(ref _Accent1Color, value, nameof(Accent1Color)); }
 ...
 public ISchemeBaseColor? Accent2Color { get => _Accent2Color; set => UpdateField(ref _Accent2Color, value, nameof(Accent2Color)); }
 ...
 public ISchemeBaseColor? Accent3Color { get => _Accent3Color; set => UpdateField(ref _Accent3Color, value, nameof(Accent3Color)); }
 ...
 public ISchemeBaseColor? Accent4Color { get => _Accent4Color; set => UpdateField(ref _Accent4Color, value, nameof(Accent4Color)); }
 ...
 public ISchemeBaseColor? Accent5Color { get => _Accent5Color; set => UpdateField(ref _Accent5Color, value, nameof(Accent5Color)); }
 ...
 public ISchemeBaseColor? Accent6Color { get => _Accent6Color; set => UpdateField(ref _Accent6Color, value, nameof(Accent6Color)); }
 ...
 public ISchemeBaseColor? Hyperlink { get => _Hyperlink; set => UpdateField(ref _Hyperlink, value, nameof(Hyperlink)); }
 ...
 public ISchemeBaseColor? FollowedHyperlinkColor { get => _FollowedHyperlinkColor; set => UpdateField(ref _FollowedHyperlinkColor, value, nameof(FollowedHyperlinkColor)); }
