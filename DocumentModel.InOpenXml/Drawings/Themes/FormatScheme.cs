...
public partial class FormatScheme: ModelElement<DXD.FormatScheme>
{
  ...
  {
    get => _FillStyleList ??= GetProperty<FillStyleList?>(GetUpdatableElement()?.FillStyleList);
    set => UpdateField(ref _FillStyleList, value, nameof(FillStyleList));
  }
  ...
  {
    get => _LineStyleList ??= GetProperty<LineStyleList?>(GetUpdatableElement()?.LineStyleList);
    set => UpdateField(ref _LineStyleList, value, nameof(LineStyleList));
  }
  ...
  {
    get => _EffectStyleList ??= GetProperty<EffectStyleList?>(GetUpdatableElement()?.EffectStyleList);
    set => UpdateField(ref _EffectStyleList, value, nameof(EffectStyleList));
  }
  ...
  public FillStyleList? BackgroundFillStyleList
  {
    get => _BackgroundFillStyleList ??= GetProperty<FillStyleList?>(GetUpdatableElement()?.BackgroundFillStyleList);
    set => UpdateField(ref _BackgroundFillStyleList, value, nameof(BackgroundFillStyleList));
  }
