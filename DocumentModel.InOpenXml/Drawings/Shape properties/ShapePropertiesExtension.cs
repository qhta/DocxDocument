...
public partial class ShapePropertiesExtension: ModelElement<DXD.ShapePropertiesExtension>, IExtension
{
  ...
  /// </summary>
  public Fill? HiddenFillProperties
  {
    get => _HiddenFillProperties;
    set => UpdateField(ref _HiddenFillProperties, value, nameof(HiddenFillProperties));
  }
  ...
  {
    get => _HiddenLineProperties;
    set => UpdateField(ref _HiddenLineProperties, value, nameof(HiddenLineProperties));
  }
  ...
  {
    get => _HiddenEffectsProperties;
    set => UpdateField(ref _HiddenEffectsProperties, value, nameof(HiddenEffectsProperties));
  }
  ...
  {
    get => _HiddenScene3D;
    set => UpdateField(ref _HiddenScene3D, value, nameof(HiddenScene3D));
  }
  ...
  {
    get => _HiddenShape3D;
    set => UpdateField(ref _HiddenShape3D, value, nameof(HiddenShape3D));
  }
  ...
  {
    get => _ShadowObscured;
    set => UpdateField(ref _ShadowObscured, value, nameof(ShadowObscured));
  }
