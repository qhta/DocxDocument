...
/// </summary>
public class ColorHolderJsonConverter<T, X> : JsonConverter<T> where T : DMD.ColorHolder<X>, new() where X: DX.OpenXmlElement
{
  static ColorHolderJsonConverter()
  {
    TypeToStringConverter.RegisterAssembly(typeof(DMD.ColorHolder<X>).Assembly);
  }
  /// <summary>
