...
public partial class BrightnessContrast: ModelElement<DXO10D.BrightnessContrast>, IExtendableElement
{
  ...
  public Int32? Bright
  {
    get => _Bright ??= GetProperty<Int32?>(GetUpdatableElement()?.Bright);
    set => UpdateField(ref _Bright, value, nameof(Bright));
  }
  ...
  {
    get => _Contrast ??= GetProperty<Int32?>(GetUpdatableElement()?.Contrast);
    set => UpdateField(ref _Contrast, value, nameof(Contrast));
  }
