...
public partial class ImageEffect: ModelElement<DXO10D.ImageEffect>, IExtendableElement
{
  ...
  {
    get => _ArtisticBlur ??= GetProperty<ArtisticBlur?>(GetUpdatableElement()?.ArtisticBlur);
  ...
  {
    get => _ArtisticCement ??= GetProperty<ArtisticCement?>(GetUpdatableElement()?.ArtisticCement);
  ...
  {
    get => _ArtisticChalkSketch ??= GetProperty<ArtisticChalkSketch?>(GetUpdatableElement()?.ArtisticChalkSketch);
  ...
  public ArtisticCrisscrossEtching? ArtisticCrisscrossEtching
  {
    get => _ArtisticCrisscrossEtching ??=
      GetProperty<ArtisticCrisscrossEtching?>(GetUpdatableElement()?.ArtisticCrisscrossEtching);
  ...
  {
    get => _ArtisticCutout ??= GetProperty<ArtisticCutout?>(GetUpdatableElement()?.ArtisticCutout);
  ...
  {
    get => _ArtisticFilmGrain ??= GetProperty<ArtisticFilmGrain?>(GetUpdatableElement()?.ArtisticFilmGrain);
  ...
  {
    get => _ArtisticGlass ??= GetProperty<ArtisticGlass?>(GetUpdatableElement()?.ArtisticGlass);
  ...
  {
    get => _ArtisticGlowDiffused ??= GetProperty<ArtisticGlowDiffused?>(GetUpdatableElement()?.ArtisticGlowDiffused);
  ...
  {
    get => _ArtisticGlowEdges ??= GetProperty<ArtisticGlowEdges?>(GetUpdatableElement()?.ArtisticGlowEdges);
  ...
  {
    get => _ArtisticLightScreen ??= GetProperty<ArtisticLightScreen?>(GetUpdatableElement()?.ArtisticLightScreen);
  ...
  {
    get => _ArtisticLineDrawing ??= GetProperty<ArtisticLineDrawing?>(GetUpdatableElement()?.ArtisticLineDrawing);
  ...
  {
    get => _ArtisticMarker ??= GetProperty<ArtisticMarker?>(GetUpdatableElement()?.ArtisticMarker);
  ...
  {
    get => _ArtisticMosaicBubbles ??= GetProperty<ArtisticMosaicBubbles?>(GetUpdatableElement()?.ArtisticMosaicBubbles);
  ...
  {
    get => _ArtisticPaintStrokes ??= GetProperty<ArtisticPaintStrokes?>(GetUpdatableElement()?.ArtisticPaintStrokes);
  ...
  {
    get => _ArtisticPaintBrush ??= GetProperty<ArtisticPaintBrush?>(GetUpdatableElement()?.ArtisticPaintBrush);
  ...
  {
    get => _ArtisticPastelsSmooth ??= GetProperty<ArtisticPastelsSmooth?>(GetUpdatableElement()?.ArtisticPastelsSmooth);
  ...
  public ArtisticPencilGrayscale? ArtisticPencilGrayscale
  {
    get => _ArtisticPencilGrayscale ??=
      GetProperty<ArtisticPencilGrayscale?>(GetUpdatableElement()?.ArtisticPencilGrayscale);
  ...
  {
    get => _ArtisticPencilSketch ??= GetProperty<ArtisticPencilSketch?>(GetUpdatableElement()?.ArtisticPencilSketch);
  ...
  {
    get => _ArtisticPhotocopy ??= GetProperty<ArtisticPhotocopy?>(GetUpdatableElement()?.ArtisticPhotocopy);
  ...
  {
    get => _ArtisticPlasticWrap ??= GetProperty<ArtisticPlasticWrap?>(GetUpdatableElement()?.ArtisticPlasticWrap);
  ...
  {
    get => _ArtisticTexturizer ??= GetProperty<ArtisticTexturizer?>(GetUpdatableElement()?.ArtisticTexturizer);
  ...
  public ArtisticWatercolorSponge? ArtisticWatercolorSponge
  {
    get => _ArtisticWatercolorSponge ??=
      GetProperty<ArtisticWatercolorSponge?>(GetUpdatableElement()?.ArtisticWatercolorSponge);
  ...
  {
    get => _BackgroundRemoval ??= GetProperty<BackgroundRemoval?>(GetUpdatableElement()?.BackgroundRemoval);
  ...
  {
    get => _BrightnessContrast ??= GetProperty<BrightnessContrast?>(GetUpdatableElement()?.BrightnessContrast);
  ...
  {
    get => _ColorTemperature ??= GetProperty<ColorTemperature?>(GetUpdatableElement()?.ColorTemperature);
  ...
  {
    get => _Saturation ??= GetProperty<Percentage?>(GetUpdatableElement()?.Saturation);
  ...
  public Int32? SharpenSoften
  {
    get => _SharpenSoften ??= GetProperty<Int32?>(GetUpdatableElement()?.SharpenSoften);
