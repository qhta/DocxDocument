...
*   **Geometry:** Interop for defining `PresetGeometry` (standard shapes like rectangles, ellipses) and `CustomGeometry` (arbitrary paths).
...
### 6. Media Management
*   **Blip (Binary Large Image or Picture):** Interop for managing embedded and linked image resources.
## functional Role
