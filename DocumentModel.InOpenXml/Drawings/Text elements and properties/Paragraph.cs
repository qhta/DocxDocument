...
public partial class Paragraph: ModelElement<DXD.Paragraph>
{
  ...
  {
    get => _Run;
    set => UpdateField(ref _Run, value, nameof(Run));
  }
  ...
  {
    get => _Field;
    set => UpdateField(ref _Field, value, nameof(Field));
  }
  ...
  /// </summary>
  public bool? TextMath
  {
    get => _TextMath;
    set => UpdateField(ref _TextMath, value, nameof(TextMath));
  }
  ...
  {
    get => _EndParagraphRunProperties;
    set => UpdateField(ref _EndParagraphRunProperties, value, nameof(EndParagraphRunProperties));
  }
