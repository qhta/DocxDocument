...
public partial class TextFontType: ModelElement<DXD.TextFontType>
{
  ...
  {
    get => _typeface ??= GetProperty<string?>(GetUpdatableElement()?.Typeface);
  ...
  {
    get => _Panose ??= GetProperty<HexBinary?>(GetUpdatableElement()?.Panose);
  ...
  public HexByte? Pitch
  {
    get => _pitch ??= GetProperty<HexByte?>(GetUpdatableElement()?.PitchFamily);
  ...
  public HexByte? Charset
  {
    get => _charset ??= GetProperty<HexByte?>(GetUpdatableElement()?.CharacterSet);
