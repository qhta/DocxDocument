...
public partial class AudioCDTimeType: ModelElement<DXD.AudioCDTimeType>
{
  ...
  public Byte? Track
  {
    get => _Track ??= GetProperty<Byte?>(GetUpdatableElement()?.Track);
    set => UpdateField(ref _Track, value, nameof(Track));
  }
  ...
  public UInt32? Time
  {
    get => _Time ??= GetProperty<UInt32?>(GetUpdatableElement()?.Time);
    set => UpdateField(ref _Time, value, nameof(Time));
  }
