...
public partial class ForegroundMark: ModelElement<DXO10D.ForegroundMark>
{
  ...
  {
    get => _FirstXCoordinate ??= GetProperty<Int32?>(GetUpdatableElement()?.FirstXCoordinate);
    set => UpdateField(ref _FirstXCoordinate, value, nameof(FirstXCoordinate));
  }
  ...
  {
    get => _FirstYCoordinate ??= GetProperty<Int32?>(GetUpdatableElement()?.FirstYCoordinate);
    set => UpdateField(ref _FirstYCoordinate, value, nameof(FirstYCoordinate));
  }
  ...
  {
    get => _SecondXCoordinate ??= GetProperty<Int32?>(GetUpdatableElement()?.SecondXCoordinate);
    set => UpdateField(ref _SecondXCoordinate, value, nameof(SecondXCoordinate));
  }
  ...
  {
    get => _SecondYCoordinate ??= GetProperty<Int32?>(GetUpdatableElement()?.SecondYCoordinate);
    set => UpdateField(ref _SecondYCoordinate, value, nameof(SecondYCoordinate));
  }
