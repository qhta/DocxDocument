...
public partial class BackgroundRemoval: ModelElement<DXO10D.BackgroundRemoval>
{
  ...
  {
    get => _MarqueeTop ??= GetProperty<Int32?>(GetUpdatableElement()?.MarqueeTop);
  ...
  {
    get => _MarqueeBottom ??= GetProperty<Int32?>(GetUpdatableElement()?.MarqueeBottom);
  ...
  {
    get => _MarqueeLeft ??= GetProperty<Int32?>(GetUpdatableElement()?.MarqueeLeft);
  ...
  {
    get => _MarqueeRight ??= GetProperty<Int32?>(GetUpdatableElement()?.MarqueeRight);
  ...
  /// </summary>
  [OpenXmlElementCollection(typeof(DXO10D.ForegroundMark))]
  public ForegroundMarks? ForegroundMarks
  {
  ...
  /// </summary>
  [OpenXmlElementCollection(typeof(DXO10D.BackgroundMark))]
  public BackgroundMarks? BackgroundMarks
  {
