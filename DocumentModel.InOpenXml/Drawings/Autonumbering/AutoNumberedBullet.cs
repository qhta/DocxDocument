...
public partial class AutoNumberedBullet: ModelElement<DXD.AutoNumberedBullet>
{
  ...
  public TextAutoNumberSchemeType? Type
  {
    get => _Type ??= GetProperty<TextAutoNumberSchemeType?>(GetUpdatableElement()?.Type);
  ...
  {
    get => _StartAt ??= GetProperty<Int32?>(GetUpdatableElement()?.StartAt);
    set => UpdateField(ref _StartAt, value, nameof(StartAt));
  }
