...
public partial class Vector3DType: ModelElement<DXD.Vector3DType>
{
  ...
  public Int64? Dx
  {
    get => _Dx ??= GetProperty<Int64?>(GetUpdatableElement()?.Dx);
    set => UpdateField(ref _Dx, value, nameof(Dx));
  }
  private Int64? _Dx;
  ...
  public Int64? Dy
  {
    get => _Dy ??= GetProperty<Int64?>(GetUpdatableElement()?.Dy);
    set => UpdateField(ref _Dy, value, nameof(Dy));
  }
  private Int64? _Dy;
  ...
  public Int64? Dz
  {
    get => _Dz ??= GetProperty<Int64?>(GetUpdatableElement()?.Dz);
    set => UpdateField(ref _Dz, value, nameof(Dz));
  }
  private Int64? _Dz;
}