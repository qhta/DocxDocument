...
public partial class Camera: ModelElement<DXD.Camera>
{
  ...
  public PresetCamera? Preset
  {
    get => _Preset ??= GetProperty<PresetCamera?>(GetUpdatableElement()?.Preset);
  ...
  {
    get => _FieldOfView ??= GetProperty<Int32?>(GetUpdatableElement()?.FieldOfView);
    set => UpdateField(ref _FieldOfView, value, nameof(FieldOfView));
  }
  ...
  public Int32? Zoom
  {
    get => _Zoom ??= GetProperty<Int32?>(GetUpdatableElement()?.Zoom);
  ...
  {
    get => _Rotation ??= GetProperty<Rotation?>(GetUpdatableElement()?.Rotation);
