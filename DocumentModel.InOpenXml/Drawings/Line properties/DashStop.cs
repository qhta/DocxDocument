...
public partial class DashStop: ModelElement<DXD.DashStop>
{
  ...
  {
    get => _DashLength ??= GetProperty<Int32?>(GetUpdatableElement()?.DashLength);
    set => UpdateField(ref _DashLength, value, nameof(DashLength));
  }
  ...
  {
    get => _SpaceLength ??= GetProperty<Int32?>(GetUpdatableElement()?.SpaceLength);
    set => UpdateField(ref _SpaceLength, value, nameof(SpaceLength));
  }
