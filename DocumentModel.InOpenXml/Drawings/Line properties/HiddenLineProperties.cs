...
public partial class HiddenLineProperties: ModelElement<DXO10D.HiddenLineProperties>, ILinePropertiesExtendableElement
{
  ...
  public Int32? Width
  {
    get => _Width ??= GetProperty<Int32?>(GetUpdatableElement()?.Width);
  ...
  public LineCap? CapType
  {
    get => _CapType ??= GetProperty<LineCap?>(GetUpdatableElement()?.CapType);
    set => UpdateField(ref _CapType, value, nameof(CapType));
  }
  ...
  public CompoundLine? CompoundLineType
  {
    get => _CompoundLineType ??= GetProperty<CompoundLine?>(GetUpdatableElement()?.CompoundLineType);
    set => UpdateField(ref _CompoundLineType, value, nameof(CompoundLineType));
  }
  ...
  {
    get => _Alignment ??= GetProperty<PenAlignment?>(GetUpdatableElement()?.Alignment);
  ...
  /// </summary>
  public PresetLineDash? PresetDash
  {
    get => _PresetDash;
    set => UpdateField(ref _PresetDash, value, nameof(PresetDash));
  }
  ...
  /// </summary>
  public bool? LineJoinBevel
  {
    get => _LineJoinBevel;
    set => UpdateField(ref _LineJoinBevel, value, nameof(LineJoinBevel));
  }
  ...
  {
    get => _LinePropertiesExtensionList;
    set => UpdateField(ref _LinePropertiesExtensionList, value, nameof(LinePropertiesExtensionList));
  }
