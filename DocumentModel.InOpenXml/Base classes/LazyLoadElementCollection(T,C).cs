...
[XmlRoot("LazyLoadElementCollection", Namespace = "DocumentModel")]
public class LazyLoadElementCollection<ItemType, OpenXmlCollectionType> : ModelElementCollection<ItemType, OpenXmlCollectionType> where ItemType : ModelElement where OpenXmlCollectionType : DX.OpenXmlCompositeElement
{
 /// <summary>
 ///   Default constructor.
 /// </summary>
