...
/// <typeparam name="T">The type of elements in the collection. Must implement <see cref="DocumentModel.INamedObject"/> and <see cref="IEquatable{T}"/>.</typeparam>
public class NameIndexedElementCollectionClass<T>: Collection<T>
