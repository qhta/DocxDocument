...
public static class VariantUtils
{
  ...
  /// </summary>
  private static readonly Dictionary<DXVT.VectorBaseValues, Type> VectorBaseValueToType = new Dictionary<DXVT.VectorBaseValues, Type>()
 {
  {
   DXVT.VectorBaseValues.Variant,
   typeof(object)
  },
  {
   DXVT.VectorBaseValues.OneByteSignedInteger,
   typeof(sbyte)
  },
  {
   DXVT.VectorBaseValues.TwoBytesSignedInteger,
   typeof(Int16)
  },
  {
   DXVT.VectorBaseValues.FourBytesSignedInteger,
   typeof(Int32)
  },
  {
   DXVT.VectorBaseValues.EightBytesSignedInteger,
   typeof(Int64)
  },
  {
   DXVT.VectorBaseValues.OneByteUnsignedInteger,
   typeof(byte)
  },
  {
   DXVT.VectorBaseValues.TwoBytesUnsignedInteger,
   typeof(UInt16)
  },
  {
   DXVT.VectorBaseValues.FourBytesUnsignedInteger,
   typeof(UInt32)
  },
  {
   DXVT.VectorBaseValues.EightBytesUnsignedInteger,
   typeof(UInt64)
  },
  {
   DXVT.VectorBaseValues.FourBytesReal,
   typeof(Single)
  },
  {
   DXVT.VectorBaseValues.EightBytesReal,
   typeof(Double)
  },
  {
   DXVT.VectorBaseValues.Lpstr,
   typeof(String)
  },
  {
   DXVT.VectorBaseValues.Lpwstr,
   typeof(String)
  },
  {
   DXVT.VectorBaseValues.Bstr,
   typeof(String)
  },
  {
   DXVT.VectorBaseValues.Date,
   typeof(DateTime)
  },
  {
   DXVT.VectorBaseValues.Filetime,
   typeof(DateTime)
  },
  {
   DXVT.VectorBaseValues.Bool,
   typeof(bool)
  },
  {
   DXVT.VectorBaseValues.Currency,
   typeof(Decimal)
  },
  {
   DXVT.VectorBaseValues.Error,
   typeof(int)
  },
  {
   DXVT.VectorBaseValues.ClassId,
   typeof(Guid)
  },
 };
  /// <summary>
 ...
 {
  {
   DXVT.ArrayBaseValues.Variant,
   typeof(object)
  },
  {
   DXVT.ArrayBaseValues.OneByteSignedInteger,
   typeof(sbyte)
  },
  {
   DXVT.ArrayBaseValues.TwoBytesSignedInteger,
   typeof(Int16)
  },
  {
   DXVT.ArrayBaseValues.FourBytesSignedInteger,
   typeof(Int32)
  },
  {
   DXVT.ArrayBaseValues.Integer,
   typeof(Int64)
  },
  {
   DXVT.ArrayBaseValues.OneByteUnsignedInteger,
   typeof(byte)
  },
  {
   DXVT.ArrayBaseValues.TwoBytesUnsignedInteger,
   typeof(UInt16)
  },
  {
   DXVT.ArrayBaseValues.FourBytesUnsignedInteger,
   typeof(UInt32)
  },
  {
   DXVT.ArrayBaseValues.UnsignedInteger,
   typeof(UInt64)
  },
  {
   DXVT.ArrayBaseValues.FourBytesReal,
   typeof(Single)
  },
  {
   DXVT.ArrayBaseValues.EightBytesReal,
   typeof(Double)
  },
  {
   DXVT.ArrayBaseValues.Bstr,
   typeof(String)
  },
  {
   DXVT.ArrayBaseValues.Date,
   typeof(DateTime)
  },
  {
   DXVT.ArrayBaseValues.Bool,
   typeof(bool)
  },
  {
   DXVT.ArrayBaseValues.Currency,
   typeof(Decimal)
  },
  {
   DXVT.ArrayBaseValues.Error,
   typeof(int)
  },
 };
  /// <summary>
