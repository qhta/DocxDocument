...
public class ValueAxisScaling: ModelElement<DXO16DCD.ValueAxisScaling>
{
  /// <summary>
  /// Specifies the max.
  /// </summary>
  [OpenXmlProperty(nameof(DXO16DCD.ValueAxisScaling.Max))]
  public string? Max { get => _Max; set => UpdateField(ref _Max, value, nameof(Max)); }
  ...
  public string? Min { get => _Min; set => UpdateField(ref _Min, value, nameof(Min)); }
  ...
  public string? MajorUnit { get => _MajorUnit; set => UpdateField(ref _MajorUnit, value, nameof(MajorUnit)); }
  ...
  public string? MinorUnit { get => _MinorUnit; set => UpdateField(ref _MinorUnit, value, nameof(MinorUnit)); }
