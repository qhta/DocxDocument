...
public partial class SeriesElementVisibilities: ModelElement<DXO16DCD.SeriesElementVisibilities>
{
  ...
  {
    get => _ConnectorLines ??= GetProperty<bool?>(GetUpdatableElement()?.ConnectorLines);
  ...
  {
    get => _MeanLine ??= GetProperty<bool?>(GetUpdatableElement()?.MeanLine);
    set => UpdateField(ref _MeanLine, value, nameof(MeanLine));
  }
  ...
  {
    get => _MeanMarker ??= GetProperty<bool?>(GetUpdatableElement()?.MeanMarker);
    set => UpdateField(ref _MeanMarker, value, nameof(MeanMarker));
  }
  ...
  {
    get => _Nonoutliers ??= GetProperty<bool?>(GetUpdatableElement()?.Nonoutliers);
    set => UpdateField(ref _Nonoutliers, value, nameof(Nonoutliers));
  }
  ...
  {
    get => _Outliers ??= GetProperty<bool?>(GetUpdatableElement()?.Outliers);
    set => UpdateField(ref _Outliers, value, nameof(Outliers));
  }
