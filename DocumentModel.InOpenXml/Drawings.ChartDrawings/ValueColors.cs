...
public partial class ValueColors: ModelElement<DXO16DCD.ValueColors>
{
  ...
  public SolidColorFillProperties? MinColorSolidColorFillProperties
  {
    get => _MinColorSolidColorFillProperties ??=
      GetProperty<SolidColorFillProperties?>(GetUpdatableElement()?.MinColorSolidColorFillProperties);
  ...
  public SolidColorFillProperties? MidColorSolidColorFillProperties
  {
    get => _MidColorSolidColorFillProperties ??=
      GetProperty<SolidColorFillProperties?>(GetUpdatableElement()?.MidColorSolidColorFillProperties);
  ...
  public SolidColorFillProperties? MaxColorSolidColorFillProperties
  {
    get => _MaxColorSolidColorFillProperties ??=
      GetProperty<SolidColorFillProperties?>(GetUpdatableElement()?.MaxColorSolidColorFillProperties);
