...
public partial class Text: ModelElement<DXO16DCD.Text>
{
  ...
  {
    get => _TextData ??= GetProperty<TextData?>(GetUpdatableElement()?.TextData);
    set => UpdateField(ref _TextData, value, nameof(TextData));
  }
  ...
  {
    get => _RichTextBody ??= GetProperty<RichTextBody?>(GetUpdatableElement()?.RichTextBody);
