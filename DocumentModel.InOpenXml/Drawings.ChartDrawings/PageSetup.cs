...
public partial class PageSetup: ModelElement<DXO16DCD.PageSetup>
{
  ...
  {
    get => _FirstPageNumber ??= GetProperty<UInt32?>(GetUpdatableElement()?.FirstPageNumber);
  ...
  {
    get => _Orientation ??= GetProperty<PageOrientation?>(GetUpdatableElement()?.Orientation);
