...
public partial class Address: ModelElement<DXO16DCD.Address>
{
  ...
  {
    get => _Address1 ??= GetProperty<string?>(GetUpdatableElement()?.Address1);
    set => UpdateField(ref _Address1, value, nameof(Address1));
  }
  ...
  {
    get => _Locality ??= GetProperty<string?>(GetUpdatableElement()?.Locality);
    set => UpdateField(ref _Locality, value, nameof(Locality));
  }
  ...
  {
    get => _IsoCountryCode ??= GetProperty<string?>(GetUpdatableElement()?.IsoCountryCode);
