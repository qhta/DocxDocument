...
public partial class NonVisualDrawingProperties: ModelElement<DXO10DCD.NonVisualDrawingProperties>
{
  ...
  {
    get => _HyperlinkOnClick ??= GetProperty<HyperlinkOnClick?>(GetUpdatableElement()?.HyperlinkOnClick);
  ...
  {
    get => _HyperlinkOnHover ??= GetProperty<HyperlinkOnHover?>(GetUpdatableElement()?.HyperlinkOnHover);
  ...
  public NonVisualDrawingPropertiesExtensionList? NonVisualDrawingPropertiesExtensionList
  {
    get => _NonVisualDrawingPropertiesExtensionList ??=
      GetProperty<NonVisualDrawingPropertiesExtensionList?>(GetUpdatableElement()
