...
public partial class ColorMappingType: ModelElement<DXO16DCD.ColorMappingType>
{
  ...
  {
    get => _Background1 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Background1);
  ...
  {
    get => _Text1 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Text1);
  ...
  {
    get => _Background2 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Background2);
  ...
  {
    get => _Text2 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Text2);
  ...
  {
    get => _Accent1 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Accent1);
  ...
  {
    get => _Accent2 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Accent2);
  ...
  {
    get => _Accent3 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Accent3);
  ...
  {
    get => _Accent4 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Accent4);
  ...
  {
    get => _Accent5 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Accent5);
  ...
  {
    get => _Accent6 ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Accent6);
  ...
  {
    get => _Hyperlink ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.Hyperlink);
  ...
  {
    get => _FollowedHyperlink ??= GetProperty<ColorSchemeIndex?>(GetUpdatableElement()?.FollowedHyperlink);
