...
public partial class Binning: ModelElement<DXO16DCD.Binning>
{
  ...
  {
    get => _IntervalClosed ??= GetProperty<IntervalClosedSide?>(GetUpdatableElement()?.IntervalClosed);
    set => UpdateField(ref _IntervalClosed, value, nameof(IntervalClosed));
  }
  ...
  {
    get => _Underflow ??= GetProperty<string?>(GetUpdatableElement()?.Underflow);
    set => UpdateField(ref _Underflow, value, nameof(Underflow));
  }
  ...
  {
    get => _Overflow ??= GetProperty<string?>(GetUpdatableElement()?.Overflow);
    set => UpdateField(ref _Overflow, value, nameof(Overflow));
  }
  ...
  {
    get => _Xsddouble ??= GetProperty<string?>(GetUpdatableElement()?.Xsddouble);
    set => UpdateField(ref _Xsddouble, value, nameof(Xsddouble));
  }
  ...
  {
    get => _BinCountXsdunsignedInt ??= GetProperty<string?>(GetUpdatableElement()?.BinCountXsdunsignedInt);
    set => UpdateField(ref _BinCountXsdunsignedInt, value, nameof(BinCountXsdunsignedInt));
  }
