...
public partial class MaxValueColorEndPosition: ModelElement<DXO16DCD.MaxValueColorEndPosition>
{
  ...
  {
    get => _ExtremeValueColorPosition ??= GetProperty<bool?>(GetUpdatableElement()?.ExtremeValueColorPosition);
  ...
  {
    get => _NumberColorPosition ??= GetProperty<Double?>(GetUpdatableElement()?.NumberColorPosition);
  ...
  {
    get => _PercentageColorPosition ??= GetProperty<Double?>(GetUpdatableElement()?.PercentageColorPosition);
