...
public partial class Axis: ModelElement<DXO16DCD.Axis>
{
  ...
  public bool? Hidden
  {
    get => _Hidden ??= GetProperty<bool?>(GetUpdatableElement()?.Hidden);
  ...
  {
    get => _CategoryAxisScaling;
    set => UpdateField(ref _CategoryAxisScaling, value, nameof(CategoryAxisScaling));
  }
  ...
  {
    get => _ValueAxisScaling;
    set => UpdateField(ref _ValueAxisScaling, value, nameof(ValueAxisScaling));
  }
  ...
  {
    get => _MajorGridlinesGridlines;
    set => UpdateField(ref _MajorGridlinesGridlines, value, nameof(MajorGridlinesGridlines));
  }
  ...
  {
    get => _MinorGridlinesGridlines;
    set => UpdateField(ref _MinorGridlinesGridlines, value, nameof(MinorGridlinesGridlines));
  }
  ...
  {
    get => _MajorTickMarksTickMarks;
    set => UpdateField(ref _MajorTickMarksTickMarks, value, nameof(MajorTickMarksTickMarks));
  }
  ...
  {
    get => _MinorTickMarksTickMarks;
    set => UpdateField(ref _MinorTickMarksTickMarks, value, nameof(MinorTickMarksTickMarks));
  }
