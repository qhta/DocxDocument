...
public partial class SeriesLayoutProperties: ModelElement<DXO16DCD.SeriesLayoutProperties>
{
  ...
  {
    get => _ParentLabelLayout ??= GetProperty<ParentLabelLayout?>(GetUpdatableElement()?.ParentLabelLayout);
  ...
  {
    get => _RegionLabelLayout ??= GetProperty<RegionLabelLayoutEnum?>(GetUpdatableElement()?.RegionLabelLayout);
  ...
  public SeriesElementVisibilities? SeriesElementVisibilities
  {
    get => _SeriesElementVisibilities ??=
      GetProperty<SeriesElementVisibilities?>(GetUpdatableElement()?.SeriesElementVisibilities);
