...
public partial class SeriesLayoutProperties : ModelElement<DXO16DCD.SeriesLayoutProperties>
{
  ...
  public ParentLabelLayout? ParentLabelLayout { get => _ParentLabelLayout; set => UpdateField(ref _ParentLabelLayout, value, nameof(ParentLabelLayout)); }
  ...
  public RegionLabelLayoutEnum? RegionLabelLayout { get => _RegionLabelLayout; set => UpdateField(ref _RegionLabelLayout, value, nameof(RegionLabelLayout)); }
  ...
  public SeriesElementVisibilities? SeriesElementVisibilities { get => _SeriesElementVisibilities; set => UpdateField(ref _SeriesElementVisibilities, value, nameof(SeriesElementVisibilities)); }
