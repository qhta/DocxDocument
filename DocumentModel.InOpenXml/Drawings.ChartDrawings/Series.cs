...
public class Series : ModelElement<DXO16DCD.Series>
{
 ...
 public ValueColors? ValueColors { get => _ValueColors; set => UpdateField(ref _ValueColors, value, nameof(ValueColors)); }
 ...
 public ValueColorPositions? ValueColorPositions { get => _ValueColorPositions; set => UpdateField(ref _ValueColorPositions, value, nameof(ValueColorPositions)); }
 ...
 /// </summary>
 public SeriesLayoutProperties? SeriesLayoutProperties { get => _SeriesLayoutProperties; set => UpdateField(ref _SeriesLayoutProperties, value, nameof(SeriesLayoutProperties)); }
