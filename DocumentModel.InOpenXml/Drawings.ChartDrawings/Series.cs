...
public partial class Series: ModelElement<DXO16DCD.Series>
{
  ...
  {
    get => _LayoutId ??= GetProperty<SeriesLayout?>(GetUpdatableElement()?.LayoutId);
    set => UpdateField(ref _LayoutId, value, nameof(LayoutId));
  }
  ...
  {
    get => _OwnerIdx ??= GetProperty<UInt32?>(GetUpdatableElement()?.OwnerIdx);
    set => UpdateField(ref _OwnerIdx, value, nameof(OwnerIdx));
  }
  ...
  {
    get => _FormatIdx ??= GetProperty<UInt32?>(GetUpdatableElement()?.FormatIdx);
    set => UpdateField(ref _FormatIdx, value, nameof(FormatIdx));
  }
  ...
  public Text? Text
  {
    get => _Text ??= GetProperty<Text?>(GetUpdatableElement()?.Text);
  ...
  {
    get => _ValueColors ??= GetProperty<ValueColors?>(GetUpdatableElement()?.ValueColors);
  ...
  {
    get => _ValueColorPositions ??= GetProperty<ValueColorPositions?>(GetUpdatableElement()?.ValueColorPositions);
