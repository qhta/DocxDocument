...
public partial class ContentPart: ModelElement<DXO10DCD.ContentPart> //: OfficeArtExtendableElement
{
  ...
  public NonVisualContentPartProperties? NonVisualContentPartProperties
  {
    get => _NonVisualContentPartProperties ??=
      GetProperty<NonVisualContentPartProperties?>(GetUpdatableElement()?.NonVisualContentPartProperties);
  ...
  {
    get => _ApplicationNonVisualDrawingProperties ??=
      GetProperty<ApplicationNonVisualDrawingProperties?>(GetUpdatableElement()?.ApplicationNonVisualDrawingProperties);
