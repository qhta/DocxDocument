...
public partial class SampleDataType: ModelElement<DXDD.SampleDataType>
{
  ...
  {
    get => _UseDefault ??= GetProperty<bool?>(GetUpdatableElement()?.UseDefault);
    set => UpdateField(ref _UseDefault, value, nameof(UseDefault));
  }
  ...
  {
    get => _DataModel ??= GetProperty<DataModel?>(GetUpdatableElement()?.DataModel);
    set => UpdateField(ref _DataModel, value, nameof(DataModel));
  }
