...
public partial class Point: ModelElement<DXDD.Point>
{
  ...
  public Point? Type
  {
    get => _Type ??= GetProperty<Point?>(GetUpdatableElement()?.Type);
  ...
  {
    get => _ConnectionId ??= GetProperty<string?>(GetUpdatableElement()?.ConnectionId);
    set => UpdateField(ref _ConnectionId, value, nameof(ConnectionId));
  }
  ...
  {
    get => _PropertySet ??= GetProperty<PropertySet?>(GetUpdatableElement()?.PropertySet);
    set => UpdateField(ref _PropertySet, value, nameof(PropertySet));
  }
  ...
  {
    get => _TextBody ??= GetProperty<TextBody?>(GetUpdatableElement()?.TextBody);
  ...
  {
    get => _PtExtensionList ??= GetProperty<PtExtensionList?>(GetUpdatableElement()?.PtExtensionList);
    set => UpdateField(ref _PtExtensionList, value, nameof(PtExtensionList));
  }
