...
[DataContract]
[XmlRoot("StyleLabel", Namespace = "DocumentModel.Drawings.Diagrams")]
public partial class StyleLabel: ModelElement<DXDD.StyleLabel>
{
  ...
  {
    get => _Scene3D ??= GetProperty<Scene3D?>(GetUpdatableElement()?.Scene3D);
  ...
  {
    get => _Shape3D ??= GetProperty<Shape3D?>(GetUpdatableElement()?.Shape3D);
    set => UpdateField(ref _Shape3D, value, nameof(Shape3D));
  }
