...
public partial class ShapeProperties: ModelElement<DXDD.ShapeProperties>
{
  ...
  {
    get => _CustomGeometry ??= GetElement<CustomGeometry, DXD.CustomGeometry>(GetUpdatableElement());
  ...
  {
    get => _PresetGeometry ??= GetElement<PresetGeometry, DXD.PresetGeometry>(GetUpdatableElement());
  ...
  {
    get => _Outline ??= GetElement<LineProperties, DXD.Outline>(GetUpdatableElement());
  ...
  public ShapePropertiesExtensionList? ShapePropertiesExtensionList
  {
    get => _ShapePropertiesExtensionList ??=
      GetElement<ShapePropertiesExtensionList, DXD.ShapePropertiesExtensionList>(GetUpdatableElement());
