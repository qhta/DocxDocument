...
public class DocEvents: ModelElement<DXOW.DocEvents>
{
  ...
  {
    get => _EventDocNewXsdString ??= GetProperty<string?>(GetUpdatableElement()?.EventDocNewXsdString);
  ...
  {
    get => _EventDocOpenXsdString ??= GetProperty<string?>(GetUpdatableElement()?.EventDocOpenXsdString);
  ...
  {
    get => _EventDocCloseXsdString ??= GetProperty<string?>(GetUpdatableElement()?.EventDocCloseXsdString);
  ...
  {
    get => _EventDocSyncXsdString ??= GetProperty<string?>(GetUpdatableElement()?.EventDocSyncXsdString);
  ...
  public string? EventDocXmlAfterInsertXsdString
  {
    get => _EventDocXmlAfterInsertXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocXmlAfterInsertXsdString);
  ...
  public string? EventDocXmlBeforeDeleteXsdString
  {
    get => _EventDocXmlBeforeDeleteXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocXmlBeforeDeleteXsdString);
  ...
  {
    get => _EventDocContentControlAfterInsertXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocContentControlAfterInsertXsdString);
  ...
  {
    get => _EventDocContentControlBeforeDeleteXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocContentControlBeforeDeleteXsdString);
  ...
  {
    get => _EventDocContentControlOnExistXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocContentControlOnExistXsdString);
  ...
  {
    get => _EventDocContentControlOnEnterXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocContentControlOnEnterXsdString);
  ...
  {
    get => _EventDocStoreUpdateXsdString ??= GetProperty<string?>(GetUpdatableElement()?.EventDocStoreUpdateXsdString);
  ...
  {
    get => _EventDocContentControlUpdateXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocContentControlUpdateXsdString);
  ...
  {
    get => _EventDocBuildingBlockAfterInsertXsdString ??=
      GetProperty<string?>(GetUpdatableElement()?.EventDocBuildingBlockAfterInsertXsdString);
