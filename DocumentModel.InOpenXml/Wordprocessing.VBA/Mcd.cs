...
public class Mcd: ModelElement<DXOW.Mcd>
{
  ...
  {
    get => _MacroName ??= GetProperty<string?>(GetUpdatableElement()?.MacroName);
    set => UpdateField(ref _MacroName, value, nameof(MacroName));
  }
  ...
  {
    get => _MenuHelp ??= GetProperty<string?>(GetUpdatableElement()?.MenuHelp);
    set => UpdateField(ref _MenuHelp, value, nameof(MenuHelp));
  }
  ...
  public HexChar? BEncrypt
  {
    get => _BEncrypt ??= GetProperty<HexChar?>(GetUpdatableElement()?.BEncrypt);
    set => UpdateField(ref _BEncrypt, value, nameof(BEncrypt));
  }
  ...
  public HexChar? Cmg
  {
    get => _Cmg ??= GetProperty<HexChar?>(GetUpdatableElement()?.Cmg);
    set => UpdateField(ref _Cmg, value, nameof(Cmg));
  }
