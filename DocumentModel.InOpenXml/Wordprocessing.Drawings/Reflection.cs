...
public partial class Reflection: ModelElement<DXO10W.Reflection>, IDrawingProperty
{
  ...
  {
    get => _BlurRadius ??= GetProperty<Int64?>(GetUpdatableElement()?.BlurRadius);
    set => UpdateField(ref _BlurRadius, value, nameof(BlurRadius));
  }
  ...
  {
    get => _StartingOpacity ??= GetProperty<Int32?>(GetUpdatableElement()?.StartingOpacity);
    set => UpdateField(ref _StartingOpacity, value, nameof(StartingOpacity));
  }
  ...
  {
    get => _StartPosition ??= GetProperty<Int32?>(GetUpdatableElement()?.StartPosition);
    set => UpdateField(ref _StartPosition, value, nameof(StartPosition));
  }
  ...
  {
    get => _EndingOpacity ??= GetProperty<Int32?>(GetUpdatableElement()?.EndingOpacity);
    set => UpdateField(ref _EndingOpacity, value, nameof(EndingOpacity));
  }
  ...
  {
    get => _EndPosition ??= GetProperty<Int32?>(GetUpdatableElement()?.EndPosition);
    set => UpdateField(ref _EndPosition, value, nameof(EndPosition));
  }
  ...
  {
    get => _DistanceFromText ??= GetProperty<Int64?>(GetUpdatableElement()?.DistanceFromText);
    set => UpdateField(ref _DistanceFromText, value, nameof(DistanceFromText));
  }
  ...
  {
    get => _DirectionAngle ??= GetProperty<Int32?>(GetUpdatableElement()?.DirectionAngle);
    set => UpdateField(ref _DirectionAngle, value, nameof(DirectionAngle));
  }
  ...
  {
    get => _FadeDirection ??= GetProperty<Int32?>(GetUpdatableElement()?.FadeDirection);
    set => UpdateField(ref _FadeDirection, value, nameof(FadeDirection));
  }
  ...
  {
    get => _HorizontalScalingFactor ??= GetProperty<Int32?>(GetUpdatableElement()?.HorizontalScalingFactor);
    set => UpdateField(ref _HorizontalScalingFactor, value, nameof(HorizontalScalingFactor));
  }
  ...
  {
    get => _VerticalScalingFactor ??= GetProperty<Int32?>(GetUpdatableElement()?.VerticalScalingFactor);
    set => UpdateField(ref _VerticalScalingFactor, value, nameof(VerticalScalingFactor));
  }
  ...
  {
    get => _HorizontalSkewAngle ??= GetProperty<Int32?>(GetUpdatableElement()?.HorizontalSkewAngle);
    set => UpdateField(ref _HorizontalSkewAngle, value, nameof(HorizontalSkewAngle));
  }
  ...
  {
    get => _VerticalSkewAngle ??= GetProperty<Int32?>(GetUpdatableElement()?.VerticalSkewAngle);
    set => UpdateField(ref _VerticalSkewAngle, value, nameof(VerticalSkewAngle));
  }
  ...
  {
    get => _Alignment ??= GetProperty<RectangleAlignment?>(GetUpdatableElement()?.Alignment);
