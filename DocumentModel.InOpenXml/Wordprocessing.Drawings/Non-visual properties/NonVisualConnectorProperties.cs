...
public partial class NonVisualConnectorProperties: ModelElement<DXO10WDS.NonVisualConnectorProperties>,
  IExtendableElement
{
  /// <summary>
  ...
  {
    get => _ConnectionShapeLocks ??= GetProperty<ConnectionShapeLocks?>(GetUpdatableElement()?.ConnectionShapeLocks);
  ...
  {
    get => _StartConnection ??= GetProperty<ConnectionType?>(GetUpdatableElement()?.StartConnection);
  ...
  {
    get => _EndConnection ??= GetProperty<ConnectionType?>(GetUpdatableElement()?.EndConnection);
