...
public partial class LightRig: ModelElement<DXO10W.LightRig>
{
  ...
  public DMD.LightRigType? LightRigType
  {
    get => _LightRigType ??= GetProperty<DMD.LightRigType?>(GetUpdatableElement()?.LightRigType);
  ...
  public DMD.LightRigDirection? LightDirectionType
  {
    get => _LightDirectionType ??= GetProperty<DMD.LightRigDirection?>(GetUpdatableElement()?.LightDirectionType);
  ...
  {
    get => _SphereCoordinates ??= GetProperty<SphereCoordinates?>(GetUpdatableElement()?.SphereCoordinates);
