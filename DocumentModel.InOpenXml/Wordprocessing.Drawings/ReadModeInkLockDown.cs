...
public partial class ReadModeInkLockDown: ModelElement<DXW.ReadModeInkLockDown>
{
  ...
  {
    get => _UseActualPages ??= GetProperty<bool?>(GetUpdatableElement()?.UseActualPages);
    set => UpdateField(ref _UseActualPages, value, nameof(UseActualPages));
  }
  ...
  public PixelsMeasure? Width
  {
    get => _Width ??= GetProperty<PixelsMeasure?>(GetUpdatableElement()?.Width);
  ...
  public PixelsMeasure? Height
  {
    get => _Height ??= GetProperty<PixelsMeasure?>(GetUpdatableElement()?.Height);
  ...
  {
    get => _FontSize ??= GetProperty<Percentage?>(GetUpdatableElement()?.FontSize);
