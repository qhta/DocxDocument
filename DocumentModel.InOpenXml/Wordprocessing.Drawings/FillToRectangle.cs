...
[DataContract]
[XmlRoot("FillToRectangle", Namespace = "DocumentModel.Wordprocessing.Drawings")]
public partial class FillToRectangle: ModelElement<DXD.FillToRectangle>
{
  ...
  public Int32? Left
  {
    get => _Left ??= GetProperty<Int32?>(GetUpdatableElement()?.Left);
  ...
  public Int32? Top
  {
    get => _Top ??= GetProperty<Int32?>(GetUpdatableElement()?.Top);
  ...
  public Int32? Right
  {
    get => _Right ??= GetProperty<Int32?>(GetUpdatableElement()?.Right);
  ...
  public Int32? Bottom
  {
    get => _Bottom ??= GetProperty<Int32?>(GetUpdatableElement()?.Bottom);
