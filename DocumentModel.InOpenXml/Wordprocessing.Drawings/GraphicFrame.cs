...
public partial class GraphicFrame: ModelElement<DXD.GraphicFrame>, IOfficeArtExtendableElement
{
  ...
  public NonVisualGraphicFrameProperties? NonVisualGraphicFrameProperties
  {
    get => _NonVisualGraphicFrameProperties ??=
      GetProperty<NonVisualGraphicFrameProperties?>(GetUpdatableElement()?.NonVisualGraphicFrameProperties);
  ...
  {
    get => _Graphic ??= GetProperty<Graphic?>(GetUpdatableElement()?.Graphic);
