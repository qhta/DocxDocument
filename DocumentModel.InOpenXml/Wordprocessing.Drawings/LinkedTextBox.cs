...
public partial class LinkedTextBox: ModelElement<DXO10WDS.LinkedTextBox>, DMD.IOfficeArtExtendableElement
{
  ...
  public UInt16? Id
  {
    get => _Id ??= GetProperty<UInt16?>(GetUpdatableElement()?.Id);
  ...
  {
    get => _Sequence ??= GetProperty<UInt16?>(GetUpdatableElement()?.Sequence);
    set => UpdateField(ref _Sequence, value, nameof(Sequence));
  }
