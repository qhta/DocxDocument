...
public partial class Glow: ModelElement<DXO10W.Glow>, IDrawingProperty
{
  ...
  {
    get => _GlowRadius ??= GetProperty<Int64?>(GetUpdatableElement()?.GlowRadius);
    set => UpdateField(ref _GlowRadius, value, nameof(GlowRadius));
  }
  ...
  public RgbColorHex? RgbColorModelHex
  {
    get => _RgbColorModelHex ??= GetProperty<RgbColorHex?>(GetUpdatableElement()?.RgbColorModelHex);
  ...
  {
    get => _SchemeColor ??= GetProperty<SchemeColor?>(GetUpdatableElement()?.SchemeColor);
