...
public partial class ContentPart: ModelElement<DXO10W.ContentPart>, IOfficeArtExtendableElement
{
  ...
  {
    get => _WordNonVisualContentPartShapeProperties ??=
      GetProperty<WordNonVisualContentPartShapeProperties?>(GetUpdatableElement()
        ?.WordNonVisualContentPartShapeProperties);
    set => UpdateField(ref _WordNonVisualContentPartShapeProperties, value,
      nameof(WordNonVisualContentPartShapeProperties));
  }
