...
/// </summary>
/// <remarks>
///   This class defines a lightweight schema reference
///   that identifies an XML schema through its target namespace UriString. Unlike the <see cref="Schema"/>
///   class which includes manifest and physical file locations, SchemaReference provides a minimal
...
/// </remarks>
public class SchemaReference: CollectionItem
{
  /// <summary>
