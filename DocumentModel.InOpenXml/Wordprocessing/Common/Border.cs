...
public partial class Border: ModelElement<DXW.BorderType>
{
  ...
  public Twips? Width
  {
    get => _Width ??= GetProperty<Twips?>(GetUpdatableElement()?.Size);
  ...
  public bool? Shadow
  {
    get => _Shadow ??= GetProperty<bool?>(GetUpdatableElement()?.Shadow);
  ...
  public bool? Frame
  {
    get => _Frame ??= GetProperty<bool?>(GetUpdatableElement()?.Frame);
    set => UpdateField(ref _Frame, value, nameof(Frame));
  }
