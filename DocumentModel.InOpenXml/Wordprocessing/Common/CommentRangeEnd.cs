...
/// <summary>
/// Represents the end of the range around which a comment is anchored in the content of a WordprocessingML document.
...
/// </summary>
public interface CommentRangeEnd : MarkupRangeElement, ICommonContent
{
}