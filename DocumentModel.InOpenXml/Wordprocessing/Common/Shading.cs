...
public partial class Shading: ModelElement<DXW.Shading>
{
  ...
  {
    get => _Pattern ??= GetProperty<ShadingPattern?>(GetUpdatableElement()?.Val);
    set => UpdateField(ref _Pattern, value, nameof(Pattern));
  }
  ...
  public DMW.WordColor? ForegroundColor
  {
    get => _ForegroundColor;
    set => UpdateField(ref _ForegroundColor, value, nameof(ForegroundColor));
  }
  ...
  public DMW.WordColor? BackgroundColor
  {
    get => _BackgroundColor;
    set => UpdateField(ref _BackgroundColor, value, nameof(BackgroundColor));
  }
  ...
  public void LoadForegroundColor(DXW.Shading shading)
  {
    this.ForegroundColor =
      DMW.WordColor.FromOpenXml(shading.Color, shading.ThemeColor, shading.ThemeTint, shading.ThemeShade);
  }
  ...
  public void LoadBackgroundColor(DXW.Shading shading)
  {
    this.BackgroundColor =
      DMW.WordColor.FromOpenXml(shading.Fill, shading.ThemeFill, shading.ThemeFillTint, shading.ThemeFillShade);
  }
  ...
  public void UpdateBackgroundColor(DXW.Shading shading)
  {
    ...
    {
      (shading.Fill, shading.ThemeFill, shading.ThemeFillTint, shading.ThemeFillShade) =
        this.BackgroundColor.ToOpenXml();
    }
    else
    {
      shading.Fill = null;
