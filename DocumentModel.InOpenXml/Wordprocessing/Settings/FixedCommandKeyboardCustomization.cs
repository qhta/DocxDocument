...
public partial class FixedCommandKeyboardCustomization : ModelElement<DXOW.FixedCommandKeyboardCustomization>
{
  ...
  public string? CommandName { get => _CommandName; set => UpdateField(ref _CommandName, value, nameof(CommandName)); }
  ...
  public HexChar? CommandIndex { get => _CommandIndex; set => UpdateField(ref _CommandIndex, value, nameof(CommandIndex)); }
  ...
  public HexChar? Argument { get => _Argument; set => UpdateField(ref _Argument, value, nameof(Argument)); }
