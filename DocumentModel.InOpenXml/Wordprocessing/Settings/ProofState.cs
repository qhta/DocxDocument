...
public partial class ProofState : ModelElement<DXW.ProofState>
{
  ...
  public ProofingState? Spelling { get => _Spelling; set => UpdateField(ref _Spelling, value, nameof(Spelling)); }
  ...
  public ProofingState? Grammar { get => _Grammar; set => UpdateField(ref _Grammar, value, nameof(Grammar)); }
