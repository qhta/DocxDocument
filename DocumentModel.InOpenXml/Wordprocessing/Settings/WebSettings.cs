...
public partial class WebSettings : ModelElement<DXW.WebSettings>
{
  ...
  {
    get => _Frameset ??= GetProperty<Frameset?>(GetUpdatableElement()?.Frameset);
    set => UpdateField(ref _Frameset, value, nameof(Frameset));
  }
  ...
  public DivElements? Divs
  {
    get => _Divs ??= GetProperty<DivElements?>(GetUpdatableElement()?.Divs);
    set => UpdateField(ref _Divs, value, nameof(Divs));
  }
  ...
  {
    get => _WebPageEncoding ??= GetProperty<string?>(GetUpdatableElement()?.WebPageEncoding);
    set => UpdateField(ref _WebPageEncoding, value, nameof(WebPageEncoding));
  }
  ...
  {
    get => _OptimizeForBrowser ??= GetProperty<bool?>(GetUpdatableElement()?.OptimizeForBrowser);
    set => UpdateField(ref _OptimizeForBrowser, value, nameof(OptimizeForBrowser));
  }
  ...
  {
    get => _RelyOnVML ??= GetProperty<bool?>(GetUpdatableElement()?.RelyOnVML);
    set => UpdateField(ref _RelyOnVML, value, nameof(RelyOnVML));
  }
  ...
  {
    get => _AllowPNG ??= GetProperty<bool?>(GetUpdatableElement()?.AllowPNG);
    set => UpdateField(ref _AllowPNG, value, nameof(AllowPNG));
  }
  ...
  public bool? DoNotRelyOnCSS
  {
    get => _DoNotRelyOnCSS ??= GetProperty<bool?>(GetUpdatableElement()?.DoNotRelyOnCSS);
    set => UpdateField(ref _DoNotRelyOnCSS, value, nameof(DoNotRelyOnCSS));
  }
  ...
  public bool? DoNotSaveAsSingleFile
  {
    get => _DoNotSaveAsSingleFile ??= GetProperty<bool?>(GetUpdatableElement()?.DoNotSaveAsSingleFile);
    set => UpdateField(ref _DoNotSaveAsSingleFile, value, nameof(DoNotSaveAsSingleFile));
  }
  ...
  public bool? DoNotOrganizeInFolder
  {
    get => _DoNotOrganizeInFolder ??= GetProperty<bool?>(GetUpdatableElement()?.DoNotOrganizeInFolder);
    set => UpdateField(ref _DoNotOrganizeInFolder, value, nameof(DoNotOrganizeInFolder));
  }
  ...
  public bool? DoNotUseLongFileNames
  {
    get => _DoNotUseLongFileNames ??= GetProperty<bool?>(GetUpdatableElement()?.DoNotUseLongFileNames);
    set => UpdateField(ref _DoNotUseLongFileNames, value, nameof(DoNotUseLongFileNames));
  }
  ...
  {
    get => _PixelsPerInch ??= GetProperty<int?>(GetUpdatableElement()?.PixelsPerInch);
    set => UpdateField(ref _PixelsPerInch, value, nameof(PixelsPerInch));
  }
