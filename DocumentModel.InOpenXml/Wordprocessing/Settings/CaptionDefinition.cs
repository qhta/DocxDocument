...
public partial class CaptionDefinition: ModelElement<DXW.Caption>
{
  ...
  {
    get => _Position ??= GetProperty<CaptionPosition?>(GetUpdatableElement()?.Position);
  ...
  {
    get => _ChapterNumber ??= GetProperty<bool?>(GetUpdatableElement()?.ChapterNumber);
    set => UpdateField(ref _ChapterNumber, value, nameof(ChapterNumber));
  }
  ...
  public int? Heading
  {
    get => _Heading ??= GetProperty<int?>(GetUpdatableElement()?.Heading);
    set => UpdateField(ref _Heading, value, nameof(Heading));
  }
  ...
  public bool? NoLabel
  {
    get => _NoLabel ??= GetProperty<bool?>(GetUpdatableElement()?.NoLabel);
    set => UpdateField(ref _NoLabel, value, nameof(NoLabel));
  }
  ...
  {
    get => _NumberFormat ??= GetProperty<NumberFormat?>(GetUpdatableElement()?.NumberFormat);
  ...
  public ChapterSeparator? Separator
  {
    get => _Separator ??= GetProperty<ChapterSeparator?>(GetUpdatableElement()?.Separator);
