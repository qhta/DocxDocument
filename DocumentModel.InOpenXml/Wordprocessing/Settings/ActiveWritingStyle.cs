...
public partial class ActiveWritingStyle : ModelElement<DXW.ActiveWritingStyle>
{
  ...
  {
    get => _ApplicationName ??= GetProperty<string?>(GetUpdatableElement()?.ApplicationName);
    set => UpdateField(ref _ApplicationName, value, nameof(ApplicationName));
  }
  ...
  {
    get => _CheckStyle ??= GetProperty<bool?>(GetUpdatableElement()?.CheckStyle);
    set => UpdateField(ref _CheckStyle, value, nameof(CheckStyle));
  }
  ...
  {
    get => _DllVersion ??= GetProperty<Int32?>(GetUpdatableElement()?.DllVersion);
    set => UpdateField(ref _DllVersion, value, nameof(DllVersion));
  }
  ...
  {
    get => _VendorID ??= GetProperty<UInt16?>(GetUpdatableElement()?.VendorID);
    set => UpdateField(ref _VendorID, value, nameof(VendorID));
  }
  ...
  {
    get => _NaturalLanguageGrammarCheck ??= GetProperty<bool?>(GetUpdatableElement()?.NaturalLanguageGrammarCheck);
    set => UpdateField(ref _NaturalLanguageGrammarCheck, value, nameof(NaturalLanguageGrammarCheck));
  }
