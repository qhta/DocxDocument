...
public partial class DivElement : ModelElement<DXW.Div>
{
  ...
  public Int32? Id { get => _Id ??= GetProperty<Int32?>(GetUpdatableElement()?.Id); set => UpdateField(ref _Id, value, nameof(Id)); }
  private Int32? _Id;
  ...
  public DivBorders? DivBorder { get => _DivBorder ??= GetProperty<DivBorders?>(GetUpdatableElement()?.DivBorder); set => UpdateField(ref _DivBorder, value, nameof(DivBorder)); }
