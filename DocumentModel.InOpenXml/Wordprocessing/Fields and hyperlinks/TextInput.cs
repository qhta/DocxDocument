...
public partial class TextInput: ModelElement<DXW.TextInput>
{
  ...
  public TextBoxFormField? TextBoxFormFieldType
  {
    get => _TextBoxFormFieldType ??= GetProperty<TextBoxFormField?>(GetUpdatableElement()?.TextBoxFormFieldType);
    set => UpdateField(ref _TextBoxFormFieldType, value, nameof(TextBoxFormFieldType));
  }
  ...
  {
    get => _DefaultTextBoxFormFieldString ??=
      GetProperty<string?>(GetUpdatableElement()?.DefaultTextBoxFormFieldString);
    set => UpdateField(ref _DefaultTextBoxFormFieldString, value, nameof(DefaultTextBoxFormFieldString));
  }
  ...
  {
    get => _MaxLength ??= GetProperty<Int16?>(GetUpdatableElement()?.MaxLength);
  ...
  {
    get => _Format ??= GetProperty<string?>(GetUpdatableElement()?.Format);
    set => UpdateField(ref _Format, value, nameof(Format));
  }
