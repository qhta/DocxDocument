...
public partial class SdtContentDate: ModelElement<DXW.SdtContentDate>
{
  ...
  {
    get => _FullDate ??= GetProperty<DateTime?>(GetUpdatableElement()?.FullDate);
    set => UpdateField(ref _FullDate, value, nameof(FullDate));
  }
  ...
  {
    get => _DateFormat ??= GetProperty<string?>(GetUpdatableElement()?.DateFormat);
    set => UpdateField(ref _DateFormat, value, nameof(DateFormat));
  }
  ...
  public DateFormat? SdtDateMappingType
  {
    get => _SdtDateMappingType ??= GetProperty<DateFormat?>(GetUpdatableElement()?.SdtDateMappingType);
    set => UpdateField(ref _SdtDateMappingType, value, nameof(SdtDateMappingType));
  }
  ...
  {
    get => _Calendar ??= GetProperty<Calendar?>(GetUpdatableElement()?.Calendar);
    set => UpdateField(ref _Calendar, value, nameof(Calendar));
  }
