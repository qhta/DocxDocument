...
public partial class SdtRepeatedSection: ModelElement<DXO13W.SdtRepeatedSection>
{
  ...
  {
    get => _SectionTitle ??= GetProperty<string?>(GetUpdatableElement()?.SectionTitle);
    set => UpdateField(ref _SectionTitle, value, nameof(SectionTitle));
  }
  ...
  public bool? DoNotAllowInsertDeleteSection
  {
    get => _DoNotAllowInsertDeleteSection ??= GetProperty<bool?>(GetUpdatableElement()?.DoNotAllowInsertDeleteSection);
    set => UpdateField(ref _DoNotAllowInsertDeleteSection, value, nameof(DoNotAllowInsertDeleteSection));
  }
