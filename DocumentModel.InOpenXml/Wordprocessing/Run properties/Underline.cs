...
public partial class Underline: ModelElement<DXW.Underline>
{
  ...
  {
    get => _Type ??= GetProperty<UnderlineType?>(GetUpdatableElement()?.Val);
  ...
  {
    this.Color =
      DMW.WordColor.FromOpenXml(underline.Color, underline.ThemeColor, underline.ThemeTint, underline.ThemeShade);
  }
