...
public abstract partial class BaseRunProperties<OpenXmlElementType> : ModelElement<OpenXmlElementType> where OpenXmlElementType : DX.OpenXmlCompositeElement
{
  ...
  {
    get => _RunFonts ??= GetElement<DMW.RunFonts, DXW.RunFonts>(GetUpdatableElement()); 
  ...
  public Boolean? Bold
  {
    get => _Bold ??= GetElement<bool?, DXW.Bold>(GetUpdatableElement());
  ...
  {
    get => _BoldCS ??= GetElement<bool?, DXW.BoldComplexScript>(GetUpdatableElement());
  ...
  {
    get => _Italic ??= GetElement<bool?, DXW.Italic>(GetUpdatableElement());
  ...
  {
    get => _ItalicCS ??= GetElement<bool?, DXW.ItalicComplexScript>(GetUpdatableElement());
  ...
  [MultiCategory("Fonts and attributes")]
  public HPS? FontSize { get => _FontSize ??= GetElement<HPS?, DXW.FontSize>(GetUpdatableElement()); set => UpdateField(ref _FontSize, value, nameof(FontSize)); }
  ...
  [MultiCategory("Fonts and attributes")]
  public HPS? FontSizeCS { get => _FontSizeCS ??= GetElement<HPS?, DXW.FontSizeComplexScript>(GetUpdatableElement()); set => UpdateField(ref _FontSizeCS, value, nameof(FontSizeCS)); }
  ...
  [MultiCategory("Fonts and attributes")]
  public bool? AllCaps { get => _AllCaps ??= GetElement<bool?, DXW.Caps>(GetUpdatableElement()); set => UpdateField(ref _AllCaps, value, nameof(AllCaps)); }
  ...
  [MultiCategory("Fonts and attributes")]
  public bool? SmallCaps { get => _SmallCaps ??= GetElement<bool?, DXW.SmallCaps>(GetUpdatableElement()); set => UpdateField(ref _SmallCaps, value, nameof(SmallCaps)); }
  ...
  /// </summary>
  [MultiCategory("Fonts and attributes")]
  public Underline? Underline { get => _Underline ??= GetElement<Underline?, DXW.Underline>(GetUpdatableElement()); set => UpdateField(ref _Underline, value, nameof(Underline)); }
  ...
  [MultiCategory("Fonts and attributes")]
  public bool? Strike { get => _Strike ??= GetElement<bool?, DXW.Strike>(GetUpdatableElement()); set => UpdateField(ref _Strike, value, nameof(Strike)); }
  ...
  [MultiCategory("Fonts and attributes")]
  public bool? DoubleStrike { get => _DoubleStrike ??= GetElement<bool?, DXW.DoubleStrike>(GetUpdatableElement()); set => UpdateField(ref _DoubleStrike, value, nameof(DoubleStrike)); }
  ...
  public Twips? Spacing { get => _Spacing ??= GetElement<Twips?, DXW.Spacing>(GetUpdatableElement()); set => UpdateField(ref _Spacing, value, nameof(Spacing)); }
  ...
  public HPS? Kern { get => _Kern ??= GetElement<HPS?, DXW.Kern>(GetUpdatableElement()); set => UpdateField(ref _Kern, value, nameof(Kern)); }
  private HPS? _Kern;
  ...
  [MultiCategory("Positioning and alignment")]
  public bool? SnapToGrid { get => _SnapToGrid ??= GetElement<bool?, DXW.SnapToGrid>(GetUpdatableElement()); set => UpdateField(ref _SnapToGrid, value, nameof(SnapToGrid)); }
  ...
  [MultiCategory("Positioning and alignment")]
  public VerticalPosition? VerticalTextAlignment { get => _VerticalTextAlignment ??= GetElement<VerticalPosition?, DXW.VerticalTextAlignment>(GetUpdatableElement()); set => UpdateField(ref _VerticalTextAlignment, value, nameof(VerticalTextAlignment)); }
  ...
  [MultiCategory("Positioning and alignment")]
  public Twips? Position { get => _Position ??= GetElement<Twips?, DXW.Position>(GetUpdatableElement()); set => UpdateField(ref _Position, value, nameof(Position)); }
  ...
  public bool? Outline { get => _Outline ??= GetElement<bool?, DXW.Outline>(GetUpdatableElement()); set => UpdateField(ref _Outline, value, nameof(Outline)); }
  ...
  [MultiCategory("Effects and Border")]
  public bool? Emboss { get => _Emboss ??= GetElement<bool?, DXW.Emboss>(GetUpdatableElement()); set => UpdateField(ref _Emboss, value, nameof(Emboss)); }
  ...
  [MultiCategory("Effects and Border")]
  public bool? Imprint { get => _Imprint ??= GetElement<bool?, DXW.Imprint>(GetUpdatableElement()); set => UpdateField(ref _Imprint, value, nameof(Imprint)); }
  ...
  [MultiCategory("Effects and Border")]
  public bool? HasShadow { get => _HasShadow ??= GetElement<bool?, DXW.Shadow>(GetUpdatableElement()); set => UpdateField(ref _HasShadow, value, nameof(HasShadow)); }
  ...
  public Languages? Language { get => _Language ??= GetElement<Languages?, DXW.Languages>(GetUpdatableElement()); set => UpdateField(ref _Language, value, nameof(Language)); }
  ...
  [MultiCategory("Languages and proofing")]
  public bool? NoProof { get => _NoProof ??= GetElement<bool?, DXW.NoProof>(GetUpdatableElement()); set => UpdateField(ref _NoProof, value, nameof(NoProof)); }
  ...
  [MultiCategory("Effects and Border")]
  public Shading? Shading { get => _Shading ??= GetElement<Shading?, DXW.Shading>(GetUpdatableElement()); set => UpdateField(ref _Shading, value, nameof(Shading)); }
  ...
  [MultiCategory("Effects and Border")]
  public Border? Border { get => _Border ??= GetElement<Border?, DXW.Border>(GetUpdatableElement()); set => UpdateField(ref _Border, value, nameof(Border)); }
  ...
  [MultiCategory("Effects and Border")]
  public TextEffect? TextEffect { get => _TextEffect ??= GetElement<TextEffect?, DXW.TextEffect>(GetUpdatableElement()); set => UpdateField(ref _TextEffect, value, nameof(TextEffect)); }
  ...
  [MultiCategory("Scaling and spacing")]
  public FitText? FitText { get => _FitText ??= GetElement<FitText?, DXW.FitText>(GetUpdatableElement()); set => UpdateField(ref _FitText, value, nameof(FitText)); }
  ...
  public EmphasisMark? Emphasis { get => _Emphasis ??= GetElement<EmphasisMark?, DXW.Emphasis>(GetUpdatableElement()); set => UpdateField(ref _Emphasis, value, nameof(Emphasis)); }
  ...
  public EastAsianLayout? EastAsianLayout { get => _EastAsianLayout ??= GetElement<EastAsianLayout?, DXW.EastAsianLayout>(GetUpdatableElement()); set => UpdateField(ref _EastAsianLayout, value, nameof(EastAsianLayout)); }
  ...
  public bool? Hidden { get => _hidden ??= GetElement<bool?, DXW.Vanish>(GetUpdatableElement()); set => UpdateField(ref _hidden, value, nameof(Hidden)); }
  ...
  public bool? HiddenAlways { get => _hiddenAlways ??= GetElement<bool?, DXW.SpecVanish>(GetUpdatableElement()); set => UpdateField(ref _hiddenAlways, value, nameof(HiddenAlways)); }
  ...
  public bool? HiddenInWeb { get => _hiddenInWeb ??= GetElement<bool?, DXW.WebHidden>(GetUpdatableElement()); set => UpdateField(ref _hiddenInWeb, value, nameof(HiddenInWeb)); }
