...
public partial class EastAsianLayout: ModelElement<DXW.EastAsianLayout>
{
  ...
  public bool? Combine
  {
    get => _Combine ??= GetProperty<bool?>(GetUpdatableElement()?.Combine);
    set => UpdateField(ref _Combine, value, nameof(Combine));
  }
  ...
  public CombineBracket? CombineBrackets
  {
    get => _CombineBrackets ??= GetProperty<CombineBracket?>(GetUpdatableElement()?.CombineBrackets);
    set => UpdateField(ref _CombineBrackets, value, nameof(CombineBrackets));
  }
  ...
  {
    get => _Vertical ??= GetProperty<bool?>(GetUpdatableElement()?.Vertical);
  ...
  public bool? VerticalCompress
  {
    get => _VerticalCompress ??= GetProperty<bool?>(GetUpdatableElement()?.VerticalCompress);
    set => UpdateField(ref _VerticalCompress, value, nameof(VerticalCompress));
  }
