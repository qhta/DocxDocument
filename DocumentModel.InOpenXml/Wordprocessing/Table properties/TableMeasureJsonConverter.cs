...
{
 /// <summary>
 /// Reads and converts JSON to a <see cref = "TableMeasure"/> value.
 /// </summary>
 /// <param name = "reader">The <see cref = "Utf8JsonReader"/> to read from.</param>
 /// <param name = "typeToConvert">The type to convert.</param>
 /// <param name = "options">The <see cref = "JsonSerializerOptions"/> to use.</param>
 /// <returns>A <see cref = "TableMeasure"/> value parsed from the JSON input.</returns>
 /// <exception cref = "JsonException">
 /// Thrown when:
 /// <list type="bullet">
 /// <item><description>The JSON token is a string but contains a null value.</description></item>
 /// <item><description>The string value cannot be parsed as a valid TableMeasure measurement (must be a number optionally followed by unit suffix: mm, cm, pt, or in).</description></item>
 ...
 /// <item><description>Numeric tokens as integer values representing TableMeasure directly</description></item>
 /// </list>
 /// </remarks>
 public override DMW.TableMeasure Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
 {
  if (reader.TokenType == JsonTokenType.String)
  {
   ...
   {
    throw new JsonException($"Invalid TableMeasure string '{value}'. " + $"String must be a valid number optionally followed by unit suffix (mm, cm, pt, or in). Error: {ex.Message}", ex);
   }
  }
 ...
 /// <param name = "value">The <see cref = "TableMeasure"/> value to serialize.</param>
 /// <param name = "options">The <see cref = "JsonSerializerOptions"/> to use.</param>
 /// <remarks>
 /// Writes the TableMeasure value as a numeric string without unit suffix.
 /// For example, a value of 1440 TableMeasure is written as "1440".
 /// </remarks>
 public override void Write(Utf8JsonWriter writer, DMW.TableMeasure value, JsonSerializerOptions options)
 {
