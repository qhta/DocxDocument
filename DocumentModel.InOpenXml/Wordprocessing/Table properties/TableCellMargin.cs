...
public partial class TableCellMargin: ModelElement<DXW.TableCellMargin>
{
  ...
  public TableMeasure? TopMargin
  {
    get => _TopMargin ??= GetProperty<TableMeasure?>(GetUpdatableElement()?.TopMargin);
    set => UpdateField(ref _TopMargin, value, nameof(TopMargin));
  }
  ...
  public TableMeasure? LeftMargin
  {
    get => _LeftMargin ??= GetProperty<TableMeasure?>(GetUpdatableElement()?.LeftMargin);
  ...
  public TableMeasure? StartMargin
  {
    get => _StartMargin ??= GetProperty<TableMeasure?>(GetUpdatableElement()?.StartMargin);
    set => UpdateField(ref _StartMargin, value, nameof(StartMargin));
  }
  ...
  public TableMeasure? BottomMargin
  {
    get => _BottomMargin ??= GetProperty<TableMeasure?>(GetUpdatableElement()?.BottomMargin);
    set => UpdateField(ref _BottomMargin, value, nameof(BottomMargin));
  }
  ...
  public TableMeasure? RightMargin
  {
    get => _RightMargin ??= GetProperty<TableMeasure?>(GetUpdatableElement()?.RightMargin);
  ...
  public TableMeasure? EndMargin
  {
    get => _EndMargin ??= GetProperty<TableMeasure?>(GetUpdatableElement()?.EndMargin);
    set => UpdateField(ref _EndMargin, value, nameof(EndMargin));
  }
