...
public partial class BaseTableProperties<T>: ModelElement<T>
  where T: DX.OpenXmlElement
{
  /// <summary>
  /// Table alignment, specifying horizontal justification of the table within the document.
  /// </summary>
  public TableRowAlignment? TableJustification
  {
    get => _TableJustification;
    set => UpdateField(ref _TableJustification, value, nameof(TableJustification));
  }
  ...
  /// </summary>
  public TableMeasure? TableIndentation
  {
    get => _TableIndentation;
    set => UpdateField(ref _TableIndentation, value, nameof(TableIndentation));
  }
  ...
  /// </summary>
  public DefaultTableCellMargin? DefaultTableCellMargin
  {
    get => _DefaultTableCellMargin;
    set => UpdateField(ref _DefaultTableCellMargin, value, nameof(DefaultTableCellMargin));
  }
  ...
  /// </summary>
  public TableMeasure? TableCellSpacing
  {
    get => _TableCellSpacing;
    set => UpdateField(ref _TableCellSpacing, value, nameof(TableCellSpacing));
  }
  ...
  {
    get => _TableBorders;
    set => UpdateField(ref _TableBorders, value, nameof(TableBorders));
  }
