...
public abstract partial class BaseTableRowProperties<T> : ModelElement<T> where T : DX.OpenXmlElement
{
 ...
 public TableMeasure? CellSpacing { get => _CellSpacing; set => UpdateField(ref _CellSpacing, value, nameof(CellSpacing)); }
 ...
 public TableMeasure? WidthBefore { get => _WidthBefore; set => UpdateField(ref _WidthBefore, value, nameof(WidthBefore)); }
