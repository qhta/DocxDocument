...
public abstract partial  class BaseTableRowProperties<T> : ModelElement<T> where T : DX.OpenXmlElement
{
    ...
    /// </summary>
    public TableWidth? CellSpacing { get => _CellSpacing; set => UpdateField(ref _CellSpacing, value, nameof(CellSpacing)); }
    ...
    /// </summary>
    public TableWidth? WidthBefore { get => _WidthBefore; set => UpdateField(ref _WidthBefore, value, nameof(WidthBefore)); }
