...
public partial class TablePositionProperties: ModelElement<DXW.TablePositionProperties>
{
  ...
  {
    get => _LeftFromText ??= GetProperty<Int16?>(GetUpdatableElement()?.LeftFromText);
    set => UpdateField(ref _LeftFromText, value, nameof(LeftFromText));
  }
  ...
  {
    get => _RightFromText ??= GetProperty<Int16?>(GetUpdatableElement()?.RightFromText);
    set => UpdateField(ref _RightFromText, value, nameof(RightFromText));
  }
  ...
  {
    get => _TopFromText ??= GetProperty<Int16?>(GetUpdatableElement()?.TopFromText);
    set => UpdateField(ref _TopFromText, value, nameof(TopFromText));
  }
  ...
  {
    get => _BottomFromText ??= GetProperty<Int16?>(GetUpdatableElement()?.BottomFromText);
    set => UpdateField(ref _BottomFromText, value, nameof(BottomFromText));
  }
  ...
  {
    get => _VerticalAnchor ??= GetProperty<VerticalAnchor?>(GetUpdatableElement()?.VerticalAnchor);
    set => UpdateField(ref _VerticalAnchor, value, nameof(VerticalAnchor));
  }
  ...
  {
    get => _HorizontalAnchor ??= GetProperty<HorizontalAnchor?>(GetUpdatableElement()?.HorizontalAnchor);
    set => UpdateField(ref _HorizontalAnchor, value, nameof(HorizontalAnchor));
  }
  ...
  public HorizontalAlignment? TablePositionXAlignment
  {
    get => _TablePositionXAlignment ??=
      GetProperty<HorizontalAlignment?>(GetUpdatableElement()?.TablePositionXAlignment);
    set => UpdateField(ref _TablePositionXAlignment, value, nameof(TablePositionXAlignment));
  }
  ...
  {
    get => _TablePositionX ??= GetProperty<Int32?>(GetUpdatableElement()?.TablePositionX);
    set => UpdateField(ref _TablePositionX, value, nameof(TablePositionX));
  }
  ...
  public VerticalAlignment? TablePositionYAlignment
  {
    get => _TablePositionYAlignment ??= GetProperty<VerticalAlignment?>(GetUpdatableElement()?.TablePositionYAlignment);
    set => UpdateField(ref _TablePositionYAlignment, value, nameof(TablePositionYAlignment));
  }
  ...
  {
    get => _TablePositionY ??= GetProperty<Int32?>(GetUpdatableElement()?.TablePositionY);
    set => UpdateField(ref _TablePositionY, value, nameof(TablePositionY));
  }
