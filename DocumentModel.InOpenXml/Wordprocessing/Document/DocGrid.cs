...
public partial class DocGrid: ModelElement<DXW.DocGrid>, ISectionPropertiesContent
{
  ...
  public DocGridType? Type
  {
    get => _Type ??= GetProperty<DocGridType?>(GetUpdatableElement()?.Type);
  ...
  public Twips? LinePitch
  {
    get => _LinePitch ??= GetProperty<Twips?>(GetUpdatableElement()?.LinePitch);
    set => UpdateField(ref _LinePitch, value, nameof(LinePitch));
  }
  ...
  public Twips? CharacterSpace
  {
    get => _CharacterSpace ??= GetProperty<Twips?>(GetUpdatableElement()?.CharacterSpace);
    set => UpdateField(ref _CharacterSpace, value, nameof(CharacterSpace));
  }
