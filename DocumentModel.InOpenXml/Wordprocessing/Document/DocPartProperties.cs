...
public partial class DocPartProperties : ModelElement<DXW.DocPartProperties>
{
  ...
  public DocPartName? DocPartName { get => _DocPartName ??= GetProperty<DocPartName?>(GetUpdatableElement()?.DocPartName); set => UpdateField(ref _DocPartName, value, nameof(DocPartName)); }
  ...
  public string? StyleId { get => _StyleId ??= GetProperty<string?>(GetUpdatableElement()?.StyleId); set => UpdateField(ref _StyleId, value, nameof(StyleId)); }
  ...
  public Category? Category { get => _Category ??= GetProperty<Category?>(GetUpdatableElement()?.Category); set => UpdateField(ref _Category, value, nameof(Category)); }
  ...
  public DocPartTypes? DocPartTypes { get => _DocPartTypes ??= GetProperty<DocPartTypes?>(GetUpdatableElement()?.DocPartTypes); set => UpdateField(ref _DocPartTypes, value, nameof(DocPartTypes)); }
  ...
  public Behaviors? Behaviors { get => _Behaviors ??= GetProperty<Behaviors?>(GetUpdatableElement()?.Behaviors); set => UpdateField(ref _Behaviors, value, nameof(Behaviors)); }
  ...
  public string? DocPartId { get => _DocPartId ??= GetProperty<string?>(GetUpdatableElement()?.DocPartId); set => UpdateField(ref _DocPartId, value, nameof(DocPartId)); }
