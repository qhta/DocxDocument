...
public partial class DocumentProtection: ModelElement<DXW.DocumentProtection>
{
  ...
  public DocumentProtectionType? Edit
  {
    get => _Edit ??= GetProperty<DocumentProtectionType?>(GetUpdatableElement()?.Edit);
    set => UpdateField(ref _Edit, value, nameof(Edit));
  }
  ...
  {
    get => _Enforcement ??= GetProperty<bool?>(GetUpdatableElement()?.Enforcement);
    set => UpdateField(ref _Enforcement, value, nameof(Enforcement));
  }
