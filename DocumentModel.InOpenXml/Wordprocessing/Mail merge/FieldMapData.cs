...
public partial class FieldMapData: ModelElement<DXW.FieldMapData>
{
  ...
  public MailMergeOdsoField? MailMergeFieldType
  {
    get => _MailMergeFieldType ??= GetElement<MailMergeOdsoField, DXW.MailMergeFieldType>(GetUpdatableElement());
    set => UpdateField(ref _MailMergeFieldType, value, nameof(MailMergeFieldType));
  }
  ...
  public string? Name
  {
    get => _Name ??= GetElement<string, DXW.Name>(GetUpdatableElement());
  ...
  {
    get => _MappedName ??= GetElement<string, DXW.MappedName>(GetUpdatableElement());
    set => UpdateField(ref _MappedName, value, nameof(MappedName));
  }
  ...
  {
    get => _ColumnIndex ??= GetElement<UInt16, DXW.ColumnIndex>(GetUpdatableElement());
    set => UpdateField(ref _ColumnIndex, value, nameof(ColumnIndex));
  }
  ...
  {
    get => _LanguageId ??= GetElement<string, DXW.LanguageId>(GetUpdatableElement());
  ...
  {
    get => _DynamicAddress ??= GetElement<bool, DXW.DynamicAddress>(GetUpdatableElement());
    set => UpdateField(ref _DynamicAddress, value, nameof(DynamicAddress));
  }
