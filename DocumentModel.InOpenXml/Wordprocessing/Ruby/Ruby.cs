...
public partial class Ruby: ModelElement<DXW.Ruby>, IRunContent, IRubyContent
{
  ...
  {
    get => _RubyProperties ??= GetProperty<RubyProperties?>(GetUpdatableElement()?.RubyProperties);
    set => UpdateField(ref _RubyProperties, value, nameof(RubyProperties));
  }
  ...
  {
    get => _RubyContent ??= GetProperty<IRubyContent?>(GetUpdatableElement()?.RubyContent);
    set => UpdateField(ref _RubyContent, value, nameof(RubyContent));
  }
  ...
  {
    get => _RubyBase ??= GetProperty<RubyBase?>(GetUpdatableElement()?.RubyBase);
    set => UpdateField(ref _RubyBase, value, nameof(RubyBase));
  }
