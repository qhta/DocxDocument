...
[DataContract]
[XmlRoot("TextColumns", Namespace = "DocumentModel.Wordprocessing")]
public partial class TextColumns: ModelElement<DXW.Columns>, ISectionPropertiesContent
{
  ...
  {
    get => _EqualWidth ??= GetProperty<bool?>(GetUpdatableElement()?.EqualWidth);
    set => UpdateField(ref _EqualWidth, value, nameof(EqualWidth));
  }
  ...
  public Twips? Space
  {
    get => _Space ??= GetProperty<Twips?>(GetUpdatableElement()?.Space);
    set => UpdateField(ref _Space, value, nameof(Space));
  }
  ...
  {
    get => _ColumnCount ??= GetProperty<int?>(GetUpdatableElement()?.ColumnCount);
  ...
  {
    get => _Separator ??= GetProperty<bool?>(GetUpdatableElement()?.Separator);
