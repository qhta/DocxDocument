...
public partial class LineNumberType: ModelElement<DXW.LineNumberType>, ISectionPropertiesContent
{
  ...
  {
    get => _CountBy ??= GetProperty<Int16?>(GetUpdatableElement()?.CountBy);
    set => UpdateField(ref _CountBy, value, nameof(CountBy));
  }
  ...
  public Int16? Start
  {
    get => _Start ??= GetProperty<Int16?>(GetUpdatableElement()?.Start);
  ...
  public LineNumberRestart? Restart
  {
    get => _Restart ??= GetProperty<LineNumberRestart?>(GetUpdatableElement()?.Restart);
    set => UpdateField(ref _Restart, value, nameof(Restart));
  }
