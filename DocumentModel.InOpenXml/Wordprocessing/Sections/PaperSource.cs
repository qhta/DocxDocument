...
public partial class PaperSource: ModelElement<DXW.PaperSource>, ISectionPropertiesContent
{
  ...
  public UInt16? First
  {
    get => _First ??= GetProperty<UInt16?>(GetUpdatableElement()?.First);
    set => UpdateField(ref _First, value, nameof(First));
  }
  ...
  public UInt16? Other
  {
    get => _Other ??= GetProperty<UInt16?>(GetUpdatableElement()?.Other);
    set => UpdateField(ref _Other, value, nameof(Other));
  }
