...
public partial class PageNumberType: ModelElement<DXW.PageNumberType>, ISectionPropertiesContent
{
  ...
  {
    get => _Format ??= GetProperty<NumberFormat?>(GetUpdatableElement()?.Format);
  ...
  public Int32? Start
  {
    get => _Start ??= GetProperty<Int32?>(GetUpdatableElement()?.Start);
  ...
  {
    get => _ChapterStyle ??= GetProperty<Byte?>(GetUpdatableElement()?.ChapterStyle);
  ...
  {
    get => _ChapterSeparator ??= GetProperty<ChapterSeparator?>(GetUpdatableElement()?.ChapterSeparator);
