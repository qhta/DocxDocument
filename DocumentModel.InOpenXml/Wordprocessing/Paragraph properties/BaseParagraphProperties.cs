...
/// </summary>
[XmlRoot("BaseParagraphProperties", Namespace = "DocumentModel.Wordprocessing")]
 ...
 where T : DX.OpenXmlCompositeElement
{
 ...
 public ParagraphSpacing? SpacingBefore { get => _spacingBefore; set => UpdateField(ref _spacingBefore, value, nameof(SpacingBefore)); }
 ...
 public ParagraphSpacing? SpacingAfter { get => _spacingAfter; set => UpdateField(ref _spacingAfter, value, nameof(SpacingAfter)); }
 ...
 public Interline? SpacingInterline { get => _spacingInterline; set => UpdateField(ref _spacingInterline, value, nameof(SpacingInterline)); }
 ...
 public void LoadBefore(DX.OpenXmlElement openXmlElement)
 {
  ...
  {
   if (source.Before == null && source.BeforeLines == null && source.BeforeAutoSpacing == null)
    return;
 ...
 public void LoadAfter(DX.OpenXmlElement openXmlElement)
 {
  ...
  if (paragraphSpacing is DXW.SpacingBetweenLines source)
  {
   if (source.After == null && source.AfterLines == null && source.AfterAutoSpacing == null)
    return;
 ...
 public void LoadInterlines(DX.OpenXmlElement openXmlElement)
 {
  ...
  if (paragraphSpacing is DXW.SpacingBetweenLines source)
  {
   if (source.Line == null && source.LineRule == null)
    return;
 ...
 public void UpdateInterlines(DX.OpenXmlElement openXmlElement)
 {
  ...
  if (SpacingInterline.LineRule != null)
   target.LineRule = EnumTypeConverter.CreateOpenXmlEnumValue<DXW.LineSpacingRuleValues, LineSpacingRule>(SpacingInterline.LineRule.Value);
 }
 ...
 public bool? SpacingByContext { get => _spacingByContext; set => UpdateField(ref _spacingByContext, value, nameof(SpacingByContext)); }
 ...
 public VerticalTextAlignment? VerticalTextAlignment { get => _verticalTextAlignment; set => UpdateField(ref _verticalTextAlignment, value, nameof(VerticalTextAlignment)); }
 ...
 public OutlineLevel? OutlineLevel { get => _OutlineLevel; set => UpdateField(ref _OutlineLevel, value, nameof(OutlineLevel)); }
