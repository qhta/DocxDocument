...
{
  /// <summary>
  /// Default constructor for the <see cref = "ParagraphProperties"/> class, initializing a new instance of paragraph properties with default values.
  /// </summary>
  public ParagraphProperties() : base() { }

  /// <summary>
  /// Constructor that initializes the paragraph properties with a parent paragraph.
  /// </summary>
