...
public partial class ParagraphProperties: BaseParagraphProperties<DXW.ParagraphProperties>
{
  ...
  {
    get => _ParagraphStyleId;
    set => UpdateField(ref _ParagraphStyleId, value, nameof(ParagraphStyleId));
  }
  ...
  {
    get => _ParagraphMarkRunProperties;
    set => UpdateField(ref _ParagraphMarkRunProperties, value, nameof(ParagraphMarkRunProperties));
  }
  ...
  public SectionProperties? SectionProperties
  {
    ...
    set => UpdateField(ref _SectionProperties, value, nameof(SectionProperties));
  }
  ...
  {
    get => _ParagraphPropertiesChange;
    set => UpdateField(ref _ParagraphPropertiesChange, value, nameof(ParagraphPropertiesChange));
  }
