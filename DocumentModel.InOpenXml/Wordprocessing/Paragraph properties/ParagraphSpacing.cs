...
public partial class ParagraphSpacing : ModelElement //<DXW.SpacingBeforeOrAfter>
{
  ...
  public void FromOpenXml(DX.StringValue? sourceVal, DX.Int32Value? sourceLines, DX.OnOffValue? sourceAutoSpacing)
  {
  ...
  {
    return (Val != null ? new DX.StringValue(Val.ToString()) : null, Lines != null ? new DX.Int32Value(Lines.Value) : null, AutoSpacing != null ? new DX.OnOffValue(AutoSpacing.Value) : null);
  }
}