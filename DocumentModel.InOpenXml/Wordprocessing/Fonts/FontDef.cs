...
public partial class FontDef : ModelElement
{
  /// <summary>
  ...
  {
    get => _fontName;
    set => UpdateField(ref _fontName, value, nameof(FontName));
  }
  ...
  {
    get => _Aliases;
    set => UpdateField(ref _Aliases, value, nameof(Aliases));
  }
  ...
  public HexBinary? Panose
  {
    get => _Panose;
    set => UpdateField(ref _Panose, value, nameof(Panose));
  }
  ...
  {
    get => _charset;
    set => UpdateField(ref _charset, value, nameof(Charset));
  }
  ...
  {
    get => _FontFamily;
    set => UpdateField(ref _FontFamily, value, nameof(FontFamily));
  }
  ...
  public bool? NotTrueType
  {
    get => _NotTrueType;
    set => UpdateField(ref _NotTrueType, value, nameof(NotTrueType));
  }
  ...
  {
    get => _Pitch;
    set => UpdateField(ref _Pitch, value, nameof(Pitch));
  }
  ...
  private void LoadFontSignatureFromOpenXml(object openXmlElement)
  {
    ...
    if (openXmlFontSignature==null)
      return;
    var str =
      openXmlFontSignature.UnicodeSignature0?.ToString() +
      openXmlFontSignature.UnicodeSignature1?.ToString() +
      openXmlFontSignature.UnicodeSignature2?.ToString() +
      openXmlFontSignature.UnicodeSignature3?.ToString() +
      openXmlFontSignature.CodePageSignature0?.ToString() + 
      openXmlFontSignature.CodePageSignature1?.ToString();
