namespace DocumentModel.Wordprocessing;
  ...
  /// This interface extends <see cref="CustomXmlElement"/>, <see cref="CustomXmlBlockContentCollection"/>, <see cref="IStoryContent"/>, <see cref="ITableCellContent"/>, <see cref="ISdtBlockContent"/>, <see cref="ICustomXmlBlockContent"/>, and <see cref="ICommentContent"/>, enabling advanced integration, annotation, and schema-based processing of custom XML data within block-level document content.
  /// The attributes on this element specify the name and namespace UriString of the custom XML element.
  /// </summary>
  public class CustomXmlBlock : ElementCollection<CommonContent<ICustomXmlBlockContent>>,
