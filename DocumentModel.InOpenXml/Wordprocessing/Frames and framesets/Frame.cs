...
public partial class Frame: ModelElement<DXW.Frame>, IFramesetItem
{
  ...
  {
    get => _FrameSize ??= GetProperty<UInt32?>(GetUpdatableElement()?.FrameSize);
    set => UpdateField(ref _FrameSize, value, nameof(FrameSize));
  }
  ...
  {
    get => _FrameName ??= GetProperty<string?>(GetUpdatableElement()?.FrameName);
    set => UpdateField(ref _FrameName, value, nameof(FrameName));
  }
  ...
  public SourceReference? SourceFileReference
  {
    get => _SourceFileReference ??= GetProperty<SourceReference?>(GetUpdatableElement()?.SourceFileReference);
    set => UpdateField(ref _SourceFileReference, value, nameof(SourceFileReference));
  }
  ...
  {
    get => _MarginWidth ??= GetProperty<UInt32?>(GetUpdatableElement()?.MarginWidth);
    set => UpdateField(ref _MarginWidth, value, nameof(MarginWidth));
  }
  ...
  {
    get => _MarginHeight ??= GetProperty<UInt32?>(GetUpdatableElement()?.MarginHeight);
    set => UpdateField(ref _MarginHeight, value, nameof(MarginHeight));
  }
  ...
  public FrameScrollbarVisibility? ScrollbarVisibility
  {
    get => _ScrollbarVisibility ??= GetProperty<FrameScrollbarVisibility?>(GetUpdatableElement()?.ScrollbarVisibility);
    set => UpdateField(ref _ScrollbarVisibility, value, nameof(ScrollbarVisibility));
  }
  ...
  public bool? NoResizeAllowed
  {
    get => _NoResizeAllowed ??= GetProperty<bool?>(GetUpdatableElement()?.NoResizeAllowed);
    set => UpdateField(ref _NoResizeAllowed, value, nameof(NoResizeAllowed));
  }
  ...
  public bool? LinkedToFile
  {
    get => _LinkedToFile ??= GetProperty<bool?>(GetUpdatableElement()?.LinkedToFile);
    set => UpdateField(ref _LinkedToFile, value, nameof(LinkedToFile));
  }
