...
public partial class FrameProperties: ModelElement<DXW.FrameProperties> //, IFrameProperties
{
  ...
  {
    get => _dropCap ??= GetProperty<DropCapLocation?>(GetUpdatableElement()?.DropCap);
    set => UpdateField(ref _dropCap, value, nameof(DropCap));
  }
  ...
  public Int32? DropCapLines
  {
    get => _dropCapLines ??= GetProperty<Int32?>(GetUpdatableElement()?.Lines);
    set => UpdateField(ref _dropCapLines, value, nameof(DropCapLines));
  }
  ...
  public Twips? VerticalSpace
  {
    get => _VerticalSpace ??= GetProperty<Twips?>(GetUpdatableElement()?.VerticalSpace);
    set => UpdateField(ref _VerticalSpace, value, nameof(VerticalSpace));
  }
  ...
  public Twips? HorizontalSpace
  {
    get => _HorizontalSpace ??= GetProperty<Twips?>(GetUpdatableElement()?.HorizontalSpace);
    set => UpdateField(ref _HorizontalSpace, value, nameof(HorizontalSpace));
  }
  ...
  {
    get => _Wrap ??= GetProperty<TextWrapping?>(GetUpdatableElement()?.Wrap);
  ...
  public HorizontalAnchor? HorizontalPosition
  {
    get => _HorizontalPosition ??= GetProperty<HorizontalAnchor?>(GetUpdatableElement()?.HorizontalPosition);
    set => UpdateField(ref _HorizontalPosition, value, nameof(HorizontalPosition));
  }
  ...
  public VerticalAnchor? VerticalPosition
  {
    get => _VerticalPosition ??= GetProperty<VerticalAnchor?>(GetUpdatableElement()?.VerticalPosition);
    set => UpdateField(ref _VerticalPosition, value, nameof(VerticalPosition));
  }
  ...
  public Twips? X
  {
    get => _X ??= GetProperty<Twips?>(GetUpdatableElement()?.X);
  ...
  {
    get => _XAlign ??= GetProperty<HorizontalAlignment?>(GetUpdatableElement()?.XAlign);
    set => UpdateField(ref _XAlign, value, nameof(XAlign));
  }
  ...
  public Twips? Y
  {
    get => _Y ??= GetProperty<Twips?>(GetUpdatableElement()?.Y);
  ...
  {
    get => _YAlign ??= GetProperty<VerticalAlignment?>(GetUpdatableElement()?.YAlign);
    set => UpdateField(ref _YAlign, value, nameof(YAlign));
  }
  ...
  public bool? AnchorLock
  {
    get => _AnchorLock ??= GetProperty<bool?>(GetUpdatableElement()?.AnchorLock);
    set => UpdateField(ref _AnchorLock, value, nameof(AnchorLock));
  }
