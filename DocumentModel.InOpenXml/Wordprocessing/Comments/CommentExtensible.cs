...
public partial class CommentExtensible: ModelElement<DXO21WCE.CommentExtensible>
{
  ...
  public HexInt? DurableId
  {
    get => _DurableId ??= GetProperty<HexInt?>(GetUpdatableElement()?.DurableId);
    set => UpdateField(ref _DurableId, value, nameof(DurableId));
  }
  ...
  {
    get => _DateUtc ??= GetProperty<DateTime?>(GetUpdatableElement()?.DateUtc);
    set => UpdateField(ref _DateUtc, value, nameof(DateUtc));
  }
  ...
  public bool? IntelligentPlaceholder
  {
    get => _IntelligentPlaceholder ??= GetProperty<bool?>(GetUpdatableElement()?.IntelligentPlaceholder);
    set => UpdateField(ref _IntelligentPlaceholder, value, nameof(IntelligentPlaceholder));
  }
