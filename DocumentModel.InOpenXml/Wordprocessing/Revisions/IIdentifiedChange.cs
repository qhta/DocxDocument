...
/// This class provides properties for the change ID, author, and date, enabling identification, tracking, and review of individual revisions within the document.
/// </summary>
public interface IIdentifiedChange
{
  /// <summary>
