...
/// </summary>
public partial class RunTrackChangeType : IdentifiedChange, IElementCollection<IParagraphContent>, ICommonContent
{
  ...
  public IParagraphContent this[int index] { get => _elementCollectionImplementation[index]; set => _elementCollectionImplementation[index] = value; }
  ...
  public event NotifyCollectionChangedEventHandler? CollectionChanged { add => _elementCollectionImplementation.CollectionChanged += value; remove => _elementCollectionImplementation.CollectionChanged -= value; }
}