...
public partial class AbstractNumberings : ModelElementCollection<AbstractNumbering, DXW.Numbering, DXW.AbstractNum>
{
 ...
 public void UpdateNumberings(DX.OpenXmlElement element)
 {
  ...
  {
   var openXmlChild = OpenXmlElementConverter.ConvertTo(modelItem, typeof(DXW.AbstractNum)) as DXW.AbstractNum;
 ...
 public void LoadNumberings(DX.OpenXmlElement element)
 {
  ...
  {
   var modeItem = OpenXmlElementConverter.ConvertFrom(openXmlChild, typeof(DMW.AbstractNumbering)) as DMW.AbstractNumbering;
   this.Add(modeItem!);
  }
