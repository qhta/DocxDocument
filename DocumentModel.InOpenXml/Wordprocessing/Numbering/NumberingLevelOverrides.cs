...
public class NumberingLevelOverrides:
  ModelElementCollection<NumberingLevelOverride, DXW.NumberingInstance, DXW.LevelOverride>
{
  /// <summary>
  /// Default constructor.
  /// </summary>
  ...
  public void LoadOverrides(DX.OpenXmlElement element)
  {
    ...
    {
      var modelItem =
        OpenXmlElementConverter.ConvertFrom(openXmlChild, typeof(DMW.NumberingLevelOverride)) as
