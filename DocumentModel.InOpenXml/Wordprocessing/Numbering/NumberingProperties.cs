...
public partial class NumberingProperties: ModelElement<DXW.NumberingProperties>
{
  ...
  {
    get => _NumberingLevelReference ??= GetProperty<NumLevel?>(GetUpdatableElement()?.NumberingLevelReference);
  ...
  {
    get => _NumberingId ??= GetProperty<Int32?>(GetUpdatableElement()?.NumberingId);
    set => UpdateField(ref _NumberingId, value, nameof(NumberingId));
  }
  ...
  {
    get => _NumberingChange ??= GetProperty<NumberingChange?>(GetUpdatableElement()?.NumberingChange);
  ...
  {
    get => _Inserted ??= GetProperty<Inserted?>(GetUpdatableElement()?.Inserted);
    set => UpdateField(ref _Inserted, value, nameof(Inserted));
  }
