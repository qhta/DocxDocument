...
public partial class NumberingInstance : ModelElement<DXW.NumberingInstance>
{
  ...
  /// </summary>
  public NumberingLevelOverrides? LevelOverrides { get => _LevelOverrides; set => UpdateField(ref _LevelOverrides, value, nameof(LevelOverrides)); }

  private NumberingLevelOverrides? _LevelOverrides;
}