...
public partial class NumberingInstance: ModelElement<DXW.NumberingInstance>
{
  ...
  {
    get => _NumberID ??= GetProperty<Int32?>(GetUpdatableElement()?.NumberID);
    set => UpdateField(ref _NumberID, value, nameof(NumberID));
  }
  ...
  {
    get => _DurableId ??= GetProperty<Int32?>(GetUpdatableElement()?.DurableId);
  ...
  {
    get => _AbstractNumId ??= GetProperty<Int32?>(GetUpdatableElement()?.AbstractNumId);
