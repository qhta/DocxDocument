...
[DataContract]
[XmlRoot("NumberingLevelOverride", Namespace = "DocumentModel.Wordprocessing")]
public partial class NumberingLevelOverride: ModelElement<DXW.LevelOverride>
{
  ...
  {
    get => _StartOverrideNumberingValue ??= GetProperty<Int32?>(GetUpdatableElement()?.StartOverrideNumberingValue);
    set => UpdateField(ref _StartOverrideNumberingValue, value, nameof(StartOverrideNumberingValue));
  }
  ...
  public NumberingLevel? Level
  {
    get => _Level ??= GetProperty<NumberingLevel?>(GetUpdatableElement()?.Level);
