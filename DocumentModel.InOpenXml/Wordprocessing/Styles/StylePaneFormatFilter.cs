...
public partial class StylePaneFormatFilter: ModelElement<DXW.StylePaneFormatFilter>
{
  ...
  [Obsolete("This property is deprecated. Use the individual filter properties instead.")]
  public HexChar? Val
  {
  ...
  {
    get => _AllStyles ??= GetProperty<bool?>(GetUpdatableElement()?.AllStyles);
    set => UpdateField(ref _AllStyles, value, nameof(AllStyles));
  }
  ...
  {
    get => _CustomStyles ??= GetProperty<bool?>(GetUpdatableElement()?.CustomStyles);
    set => UpdateField(ref _CustomStyles, value, nameof(CustomStyles));
  }
  ...
  {
    get => _LatentStyles ??= GetProperty<bool?>(GetUpdatableElement()?.LatentStyles);
  ...
  {
    get => _StylesInUse ??= GetProperty<bool?>(GetUpdatableElement()?.StylesInUse);
    set => UpdateField(ref _StylesInUse, value, nameof(StylesInUse));
  }
  ...
  {
    get => _HeadingStyles ??= GetProperty<bool?>(GetUpdatableElement()?.HeadingStyles);
    set => UpdateField(ref _HeadingStyles, value, nameof(HeadingStyles));
  }
  ...
  {
    get => _NumberingStyles ??= GetProperty<bool?>(GetUpdatableElement()?.NumberingStyles);
    set => UpdateField(ref _NumberingStyles, value, nameof(NumberingStyles));
  }
  ...
  {
    get => _TableStyles ??= GetProperty<bool?>(GetUpdatableElement()?.TableStyles);
    set => UpdateField(ref _TableStyles, value, nameof(TableStyles));
  }
  ...
  {
    get => _DirectFormattingOnRuns ??= GetProperty<bool?>(GetUpdatableElement()?.DirectFormattingOnRuns);
    set => UpdateField(ref _DirectFormattingOnRuns, value, nameof(DirectFormattingOnRuns));
  }
  ...
  {
    get => _DirectFormattingOnParagraphs ??= GetProperty<bool?>(GetUpdatableElement()?.DirectFormattingOnParagraphs);
    set => UpdateField(ref _DirectFormattingOnParagraphs, value, nameof(DirectFormattingOnParagraphs));
  }
  ...
  {
    get => _DirectFormattingOnNumbering ??= GetProperty<bool?>(GetUpdatableElement()?.DirectFormattingOnNumbering);
    set => UpdateField(ref _DirectFormattingOnNumbering, value, nameof(DirectFormattingOnNumbering));
  }
  ...
  {
    get => _DirectFormattingOnTables ??= GetProperty<bool?>(GetUpdatableElement()?.DirectFormattingOnTables);
    set => UpdateField(ref _DirectFormattingOnTables, value, nameof(DirectFormattingOnTables));
  }
  ...
  {
    get => _ClearFormatting ??= GetProperty<bool?>(GetUpdatableElement()?.ClearFormatting);
    set => UpdateField(ref _ClearFormatting, value, nameof(ClearFormatting));
  }
  ...
  {
    get => _Top3HeadingStyles ??= GetProperty<bool?>(GetUpdatableElement()?.Top3HeadingStyles);
    set => UpdateField(ref _Top3HeadingStyles, value, nameof(Top3HeadingStyles));
  }
  ...
  {
    get => _VisibleStyles ??= GetProperty<bool?>(GetUpdatableElement()?.VisibleStyles);
    set => UpdateField(ref _VisibleStyles, value, nameof(VisibleStyles));
  }
  ...
  {
    get => _AlternateStyleNames ??= GetProperty<bool?>(GetUpdatableElement()?.AlternateStyleNames);
    set => UpdateField(ref _AlternateStyleNames, value, nameof(AlternateStyleNames));
  }
