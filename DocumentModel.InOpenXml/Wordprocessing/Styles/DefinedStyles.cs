...
[DirectAccess()]
public partial class DefinedStyles : ModelElementCollection<StyleDef, DXW.Styles, DXW.Style>
{
 ///// <summary>
 ///// Default constructor.
 ///// </summary>
 ...
 public DefinedStyles(Styles styles, DXW.Styles? openXmlCollection) : base(styles, openXmlCollection)
 {
 }
 ...
 //[JsonIgnore]
 //[NotMapped]
 //public Styles? Styles { get => Parent as Styles;  }
