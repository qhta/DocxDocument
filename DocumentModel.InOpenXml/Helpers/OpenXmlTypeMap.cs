...
#pragma warning disable OOXML0001
  ...
  /// <returns>The OpenXML type that is mapped to the specified model element type.</returns>
  /// <exception cref="ArgumentException">Thrown if there is no OpenXML type mapping for the specified model element type.</exception>
  public static Type GetOpenXmlTypeForModelElementType(Type modelElementType)
  {
    ...
    throw new ArgumentException($"No OpenXML type mapping found for {modelElementType.Name}");
  }
}