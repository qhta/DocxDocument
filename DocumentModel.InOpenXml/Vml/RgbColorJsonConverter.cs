...
/// <summary>
/// Provides JSON serialization and deserialization support for the <see cref="RgbColor"/> structure.
/// </summary>
/// <remarks>
...
{
  /// <summary>
  /// Reads and converts JSON to an <see cref="RgbColor"/> value.
  /// </summary>
  /// <param name="reader">The <see cref="Utf8JsonReader"/> to read from.</param>
  /// <param name="typeToConvert">The type to convert.</param>
  /// <param name="options">The <see cref="JsonSerializerOptions"/> to use.</param>
  /// <returns>An <see cref="RgbColor"/> value parsed from the JSON input.</returns>
  ...
  public override RgbColor Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    ...
    //    {
    //      return new RgbColor(intValue);
    //    }

    //    if (reader.TryGetUInt32(out uint uintValue))
    //    {
    //      return new RgbColor(uintValue);
    //    }

    //    if (reader.TryGetInt64(out long longValue))
    //    {
    //      return new RgbColor((Int32)longValue);
    //    }
  ...
  /// <summary>
  /// Writes an <see cref="RgbColor"/> value as JSON.
  /// </summary>
  /// <param name="writer">The <see cref="Utf8JsonWriter"/> to write to.</param>
  /// <param name="value">The <see cref="RgbColor"/> value to serialize.</param>
  /// <param name="options">The <see cref="JsonSerializerOptions"/> to use.</param>
  /// <remarks>
