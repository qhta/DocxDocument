...
public partial class Curve: ModelElement<DXV.Curve>, IEmbeddedObjectContent
{
  ...
  public string? From
  {
    get => _From ??= GetProperty<string?>(GetUpdatableElement()?.From);
    set => UpdateField(ref _From, value, nameof(From));
  }
  ...
  {
    get => _Control1 ??= GetProperty<string?>(GetUpdatableElement()?.Control1);
    set => UpdateField(ref _Control1, value, nameof(Control1));
  }
  ...
  {
    get => _Control2 ??= GetProperty<string?>(GetUpdatableElement()?.Control2);
    set => UpdateField(ref _Control2, value, nameof(Control2));
  }
  ...
  public string? To
  {
    get => _To ??= GetProperty<string?>(GetUpdatableElement()?.To);
    set => UpdateField(ref _To, value, nameof(To));
  }
