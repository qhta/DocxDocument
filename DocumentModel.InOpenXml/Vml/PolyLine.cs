...
{
  /// <summary>
  ///   Unique identifier for the polyline element.
  /// </summary>
  ...
  /// <summary>
  ///   CSS-style formatting properties for the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Target URL for hyperlink associated with the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   CSS class name for styling the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Descriptive title for the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Origin point of the coordinate system for the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline should be printed.
  /// </summary>
  ...
  /// <summary>
  ///   Additional optional text associated with the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Color value for the top border of the polyline.
  /// </summary>
  [OpenXmlProperty(nameof(DXV.PolyLine.BorderTopColor))]
  public string? BorderTopColor
  {
    get => _BorderTopColor ??= GetProperty<string?>(GetUpdatableElement()?.BorderTopColor);
  ...
  /// <summary>
  ///   Color value for the left border of the polyline.
  /// </summary>
  [OpenXmlProperty(nameof(DXV.PolyLine.BorderLeftColor))]
  public string? BorderLeftColor
  {
    get => _BorderLeftColor ??= GetProperty<string?>(GetUpdatableElement()?.BorderLeftColor);
  ...
  /// <summary>
  ///   Color value for the bottom border of the polyline.
  /// </summary>
  [OpenXmlProperty(nameof(DXV.PolyLine.BorderBottomColor))]
  public string? BorderBottomColor
  {
    get => _BorderBottomColor ??= GetProperty<string?>(GetUpdatableElement()?.BorderBottomColor);
  ...
  /// <summary>
  ///   Color value for the right border of the polyline.
  /// </summary>
  [OpenXmlProperty(nameof(DXV.PolyLine.BorderRightColor))]
  public string? BorderRightColor
  {
    get => _BorderRightColor ??= GetProperty<string?>(GetUpdatableElement()?.BorderRightColor);
  ...
  /// <summary>
  ///   Specifies how text margins are calculated within the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline interior is filled.
  /// </summary>
  ...
  /// <summary>
  ///   Primary color used to fill the polyline interior.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline outline is drawn.
  /// </summary>
  ...
  /// <summary>
  ///   Color used for the polyline outline stroke.
  /// </summary>
  ...
  /// <summary>
  ///   Width of the polyline outline stroke.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the border stroke is drawn inside the polyline path.
  /// </summary>
  ...
  /// <summary>
  ///   Additional optional numeric value associated with the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Type of connector line used when the polyline acts as a connector.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline contains an embedded OLE object.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline prefers relative resizing.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline is clipped to the text wrapping polygon.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether rendering of the polyline is clipped to its boundaries.
  /// </summary>
  ...
  {
    get => _Points ??= GetProperty<string?>(GetUpdatableElement()?.Points);
    set => UpdateField(ref _Points, value, nameof(Points));
  }
  ...
  /// <summary>
  ///   Lists formula definitions used by the polyline.
  /// </summary>
  ...
  /// <summary>
  ///   Indicates whether the polyline anchor is locked.
  /// </summary>
