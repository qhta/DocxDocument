...
public partial class TextBox: ModelElement<DXV.TextBox>
{
  ...
  public string? Inset
  {
    get => _Inset ??= GetProperty<string?>(GetUpdatableElement()?.Inset);
    set => UpdateField(ref _Inset, value, nameof(Inset));
  }
  ...
  {
    get => _SingleClick ??= GetProperty<bool?>(GetUpdatableElement()?.SingleClick);
    set => UpdateField(ref _SingleClick, value, nameof(SingleClick));
  }
