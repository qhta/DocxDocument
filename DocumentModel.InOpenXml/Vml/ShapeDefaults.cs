...
public partial class ShapeDefaults: ModelElement<DXVO.ShapeDefaults>
{
  ...
  {
    get => _MaxShapeId ??= GetProperty<Int64?>(_openXmlElement?.MaxShapeId);
  ...
  public string? Style
  {
    get => _Style ??= GetProperty<string?>(_openXmlElement?.Style);
  ...
  {
    get => _BeFilled ??= GetProperty<bool?>(_openXmlElement?.BeFilled);
  ...
  {
    get => _FillColor ??= GetProperty<DMV.Color?>(_openXmlElement?.FillColor);
  ...
  {
    get => _IsStroke ??= GetProperty<bool?>(_openXmlElement?.IsStroke);
  ...
  {
    get => _StrokeColor ??= GetProperty<DMV.Color?>(_openXmlElement?.StrokeColor);
  ...
  {
    get => _AllowInCell ??= GetProperty<bool?>(_openXmlElement?.AllowInCell);
  ...
  {
    get => _AllowOverlap ??= GetProperty<bool?>(_openXmlElement?.AllowOverlap);
  ...
  {
    get => _InsetMode ??= GetProperty<InsetMargin?>(_openXmlElement?.InsetMode);
  ...
  public Fill? Fill
  {
    get => _Fill ??= GetProperty<Fill?>(_openXmlElement?.Fill);
  ...
  {
    get => _ImageData ??= GetProperty<ImageData?>(_openXmlElement?.ImageData);
  ...
  {
    get => _Stroke ??= GetProperty<Stroke?>(_openXmlElement?.Stroke);
  ...
  {
    get => _TextBox ??= GetProperty<TextBox?>(_openXmlElement?.TextBox);
  ...
  {
    get => _Shadow ??= GetProperty<Shadow?>(_openXmlElement?.Shadow);
  ...
  public Skew? Skew
  {
    get => _Skew ??= GetProperty<Skew?>(_openXmlElement?.Skew);
  ...
  {
    get => _Extrusion ??= GetProperty<Extrusion?>(_openXmlElement?.Extrusion);
  ...
  {
    get => _Callout ??= GetProperty<Callout?>(_openXmlElement?.Callout);
  ...
  public Lock? Lock
  {
    get => _Lock ??= GetProperty<Lock?>(_openXmlElement?.Lock);
  ...
  {
    get => _ColorMostRecentlyUsed ??= GetProperty<ColorMostRecentlyUsed?>(_openXmlElement?.ColorMostRecentlyUsed);
  ...
  {
    get => _ColorMenu ??= GetProperty<ColorMenu?>(_openXmlElement?.ColorMenu);
  ...
  {
    get => _Extension ??= GetProperty<ExtensionHandlingBehavior?>(_openXmlElement?.Extension);
