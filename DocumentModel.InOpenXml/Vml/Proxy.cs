...
public partial class Proxy: ModelElement<DXVO.Proxy>
{
  ...
  public bool? Start
  {
    get => _Start ??= GetProperty<bool?>(GetUpdatableElement()?.Start);
  ...
  public bool? End
  {
    get => _End ??= GetProperty<bool?>(GetUpdatableElement()?.End);
  ...
  {
    get => _ConnectionLocation ??= GetProperty<Int32?>(GetUpdatableElement()?.ConnectionLocation);
    set => UpdateField(ref _ConnectionLocation, value, nameof(ConnectionLocation));
  }
