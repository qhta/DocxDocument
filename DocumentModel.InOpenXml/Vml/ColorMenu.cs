...
public partial class ColorMenu: ModelElement<DXVO.ColorMenu>
{
  ...
  public VmlColor? ShadowColor
  {
    get => _ShadowColor ??= GetProperty<VmlColor?>(GetUpdatableElement()?.ShadowColor);
    set => UpdateField(ref _ShadowColor, value, nameof(ShadowColor));
  }
  ...
  public VmlColor? ExtrusionColor
  {
    get => _ExtrusionColor ??= GetProperty<VmlColor?>(GetUpdatableElement()?.ExtrusionColor);
