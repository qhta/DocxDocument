...
public partial class CustomUI : ModelElement<DXO10CUI.CustomUI>
{
  ...
  {
    get => _OnLoad ??= GetProperty<String?>(GetUpdatableElement()?.OnLoad);
    set => UpdateField(ref _OnLoad, value, nameof(OnLoad));
  }
  ...
  {
    get => _LoadImage ??= GetProperty<String?>(GetUpdatableElement()?.LoadImage);
    set => UpdateField(ref _LoadImage, value, nameof(LoadImage));
  }
  ...
  {
    get => _Commands ??= GetProperty<Commands?>(GetUpdatableElement()?.Commands);
    set => UpdateField(ref _Commands, value, nameof(Commands));
  }
  ...
  {
    get => _Ribbon ??= GetProperty<Ribbon?>(GetUpdatableElement()?.Ribbon);
    set => UpdateField(ref _Ribbon, value, nameof(Ribbon));
  }
  ...
  {
    get => _Backstage ??= GetProperty<Backstage?>(GetUpdatableElement()?.Backstage);
    set => UpdateField(ref _Backstage, value, nameof(Backstage));
  }
  ...
  {
    get => _ContextMenus ??= GetProperty<ContextMenus?>(GetUpdatableElement()?.ContextMenus);
  ...
  public DXPP.RibbonAndBackstageCustomizationsPart? RibbonAndBackstageCustomizationsPart
  {
    get => _RibbonAndBackstageCustomizationsPart ??=
      GetProperty<DXPP.RibbonAndBackstageCustomizationsPart?>(GetUpdatableElement()
