...
/// </summary>
[OpenXmlType(typeof(DXO10CUI.DynamicMenu))]
[DataContract]
[XmlRoot("DynamicMenu", Namespace = "DocumentModel.CustomUI")]
public partial class DynamicMenu : ModelElement<DXO10CUI.DynamicMenu>
{
  /// <summary>
  /// Specifies the size mode of the control.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Size))]
  public Size? Size
  {
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetSize))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Description))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetDescription))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Id))]
  public String? Id
  {
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.QualifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Tag))]
  public String? Tag
  {
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.IdMso))]
  public String? IdMso
  {
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetContent))]
  public String? GetContent
  {
    get => _GetContent ??= GetProperty<String?>(GetUpdatableElement()?.GetContent);
    set => UpdateField(ref _GetContent, value, nameof(GetContent));
  }
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.InvalidateContentOnDrop))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Image))]
  public String? Image
  {
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.ImageMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetImage))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Screentip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetScreentip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Supertip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetSupertip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Enabled))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetEnabled))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Label))]
  public String? Label
  {
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetLabel))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.InsertAfterMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.InsertBeforeMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.InsertAfterQulifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.InsertBeforeQulifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Visible))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetVisible))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.Keytip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetKeytip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.ShowLabel))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetShowLabel))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.ShowImage))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.DynamicMenu.GetShowImage))]
