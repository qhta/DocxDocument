...
public partial class BackstageTab: ModelElement<DXO10CUI.BackstageTab>
{
  ...
  {
    get => _ColumnWidthPercent ??= GetProperty<int?>(GetUpdatableElement()?.ColumnWidthPercent);
  ...
  {
    get => _FirstColumnMinWidth ??= GetProperty<int?>(GetUpdatableElement()?.FirstColumnMinWidth);
  ...
  {
    get => _FirstColumnMaxWidth ??= GetProperty<int?>(GetUpdatableElement()?.FirstColumnMaxWidth);
  ...
  {
    get => _SecondColumnMinWidth ??= GetProperty<int?>(GetUpdatableElement()?.SecondColumnMinWidth);
  ...
  {
    get => _SecondColumnMaxWidth ??= GetProperty<int?>(GetUpdatableElement()?.SecondColumnMaxWidth);
  ...
  {
    get => _BackstageGroups ??= GetProperty<BackstageGroups?>(GetUpdatableElement()?.BackstageGroups);
  ...
  {
    get => _SimpleGroups ??= GetProperty<SimpleGroups?>(GetUpdatableElement()?.SimpleGroups);
