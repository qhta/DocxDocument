...
[DataContract]
[XmlRoot("BackstageTab", Namespace = "DocumentModel.CustomUI")]
public partial class BackstageTab : ModelElement<DXO10CUI.BackstageTab>
{
  ...
  public int? ColumnWidthPercent { get => _ColumnWidthPercent; set => UpdateField(ref _ColumnWidthPercent, value, nameof(ColumnWidthPercent)); }
  ...
  public int? FirstColumnMinWidth { get => _FirstColumnMinWidth; set => UpdateField(ref _FirstColumnMinWidth, value, nameof(FirstColumnMinWidth)); }
  ...
  public int? FirstColumnMaxWidth { get => _FirstColumnMaxWidth; set => UpdateField(ref _FirstColumnMaxWidth, value, nameof(FirstColumnMaxWidth)); }
  ...
  public int? SecondColumnMinWidth { get => _SecondColumnMinWidth; set => UpdateField(ref _SecondColumnMinWidth, value, nameof(SecondColumnMinWidth)); }
  ...
  public int? SecondColumnMaxWidth { get => _SecondColumnMaxWidth; set => UpdateField(ref _SecondColumnMaxWidth, value, nameof(SecondColumnMaxWidth)); }
  ...
  public BackstageGroups? BackstageGroups { get => _BackstageGroups; set => UpdateField(ref _BackstageGroups, value, nameof(BackstageGroups)); }
  ...
  public SimpleGroups? SimpleGroups { get => _SimpleGroups; set => UpdateField(ref _SimpleGroups, value, nameof(SimpleGroups)); }
