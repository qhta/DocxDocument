...
public class BackstageDropDown: ModelElement<DXO10CUI.BackstageDropDown>
{
  /// <summary>
  ...
  /// </summary>
  public Collection<BackstageItemType>? ItemBackstageItems
  {
    get => _ItemBackstageItems;
    set => UpdateField(ref _ItemBackstageItems, value, nameof(ItemBackstageItems));
  }
