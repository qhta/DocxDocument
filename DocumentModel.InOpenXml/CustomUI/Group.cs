...
public class Group : ModelElement<DXO10CUI.Group>
{
 /// <summary>
 ...
 public Boolean? AutoScale { get => _AutoScale; set => UpdateField(ref _AutoScale, value, nameof(AutoScale)); }
 ...
 public Boolean? CenterVertically { get => _CenterVertically; set => UpdateField(ref _CenterVertically, value, nameof(CenterVertically)); }
