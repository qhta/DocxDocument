...
public partial class ImageControl: ModelElement<DXO10CUI.ImageControl>
{
  ...
  {
    get => _AltText ??= GetProperty<String?>(GetUpdatableElement()?.AltText);
    set => UpdateField(ref _AltText, value, nameof(AltText));
  }
  ...
  {
    get => _GetAltText ??= GetProperty<String?>(GetUpdatableElement()?.GetAltText);
    set => UpdateField(ref _GetAltText, value, nameof(GetAltText));
  }
