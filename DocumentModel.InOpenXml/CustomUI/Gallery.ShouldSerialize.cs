...
public partial class Gallery
{
  ...
  public bool ShouldSerializeGetSize() => !String.IsNullOrEmpty(GetSize);
  ...
  public bool ShouldSerializeInvalidateContentOnDrop() => InvalidateContentOnDrop is not null;
  public bool ShouldSerializeColumns() => Columns is not null;
  public bool ShouldSerializeRows() => Rows is not null;
  public bool ShouldSerializeItemWidth() => ItemWidth is not null;
  public bool ShouldSerializeItemHeight() => ItemHeight is not null;
  public bool ShouldSerializeGetItemWidth() => !String.IsNullOrEmpty(GetItemWidth);
  public bool ShouldSerializeGetItemHeight() => !String.IsNullOrEmpty(GetItemHeight);
  public bool ShouldSerializeShowItemLabel() => ShowItemLabel is not null;
  public bool ShouldSerializeShowInRibbon() => ShowInRibbon is not null;
  ...
  public bool ShouldSerializeShowItemImage() => ShowItemImage is not null;
  ...
  public bool ShouldSerializeGetItemScreentip() => !String.IsNullOrEmpty(GetItemScreentip);
  public bool ShouldSerializeGetItemSupertip() => !String.IsNullOrEmpty(GetItemSupertip);
  public bool ShouldSerializeGetItemImage() => !String.IsNullOrEmpty(GetItemImage);
  ...
  public bool ShouldSerializeGetSelectedItemID() => !String.IsNullOrEmpty(GetSelectedItemID);
