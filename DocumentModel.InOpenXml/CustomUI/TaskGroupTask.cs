...
public class TaskGroupTask: ModelElement<DXO10CUI.TaskGroupTask>
{
  /// <summary>
  /// Specifies the unique identifier of the control.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Id))]
  public String? Id { get => _Id; set => UpdateField(ref _Id, value, nameof(Id)); }
  private String? _Id;
  /// <summary>
  /// Specifies the qualified identifier of the control.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.QualifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Tag))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.IdMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.InsertAfterMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.InsertBeforeMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.InsertAfterQulifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.InsertBeforeQulifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.OnAction))]
  public String? OnAction { get => _OnAction; set => UpdateField(ref _OnAction, value, nameof(OnAction)); }
  private String? _OnAction;
  /// <summary>
  /// Specifies the is definitive.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.IsDefinitive))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Image))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.ImageMso))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.GetEnabled))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Label))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.GetLabel))]
  public String? GetLabel { get => _GetLabel; set => UpdateField(ref _GetLabel, value, nameof(GetLabel)); }
  private String? _GetLabel;
  /// <summary>
  /// Specifies whether the control is visible.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Visible))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.GetVisible))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Description))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.GetDescription))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.Keytip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.TaskGroupTask.GetKeytip))]
