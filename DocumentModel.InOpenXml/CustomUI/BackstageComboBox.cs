...
/// <list type="bullet">
///   <item><description><see cref="T:DocumentFormat.OpenXml.Office2010.CustomUI.ItemBackstageItem"/> <c>&lt;mso14:item&gt;</c></description></item>
/// </list>
/// </remark>
[OpenXmlType(typeof(DXO10CUI.BackstageComboBox))]
public class BackstageComboBox: ModelElement<DXO10CUI.BackstageComboBox>
{
  /// <summary>
  /// Specifies the unique identifier of the control.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Id))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.QualifiedId))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Tag))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.AlignLabel))]
  ...
  /// <summary>
  /// Specifies the expansion position of the control in layout.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Expand))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Enabled))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetEnabled))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Label))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetLabel))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Visible))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetVisible))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.Keytip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetKeytip))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetText))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.OnChange))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.SizeString))]
  public String? SizeString { get => _SizeString; set => UpdateField(ref _SizeString, value, nameof(SizeString)); }

  private String? _SizeString;

  /// <summary>
  /// Specifies the callback that returns the number of available items.
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetItemCount))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetItemLabel))]
  ...
  /// </summary>
  [OpenXmlProperty(nameof(DXO10CUI.BackstageComboBox.GetItemID))]
