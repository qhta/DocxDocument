...
public class BackstageGroupButton: ModelElement<DXO10CUI.BackstageGroupButton>
{
  /// <summary>
  ...
  public Style2? Style { get => _Style; set => UpdateField(ref _Style, value, nameof(Style)); }
