...
public partial class Function: ModelElement<DXM.MathFunction>, ICommonMathContent
{
  ...
  {
    get => _FunctionProperties ??= GetProperty<FunctionProperties?>(GetUpdatableElement()?.FunctionProperties);
    set => UpdateField(ref _FunctionProperties, value, nameof(FunctionProperties));
  }
  ...
  {
    get => _FunctionName ??= GetProperty<FunctionName?>(GetUpdatableElement()?.FunctionName);
    set => UpdateField(ref _FunctionName, value, nameof(FunctionName));
  }
