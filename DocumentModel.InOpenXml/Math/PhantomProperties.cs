...
public partial class PhantomProperties: ModelElement<DXM.PhantomProperties>
{
  ...
  {
    get => _ShowPhantom ??= GetProperty<bool?>(GetUpdatableElement()?.ShowPhantom);
    set => UpdateField(ref _ShowPhantom, value, nameof(ShowPhantom));
  }
  ...
  {
    get => _ZeroWidth ??= GetProperty<bool?>(GetUpdatableElement()?.ZeroWidth);
    set => UpdateField(ref _ZeroWidth, value, nameof(ZeroWidth));
  }
  ...
  {
    get => _ZeroAscent ??= GetProperty<bool?>(GetUpdatableElement()?.ZeroAscent);
    set => UpdateField(ref _ZeroAscent, value, nameof(ZeroAscent));
  }
  ...
  {
    get => _ZeroDescent ??= GetProperty<bool?>(GetUpdatableElement()?.ZeroDescent);
    set => UpdateField(ref _ZeroDescent, value, nameof(ZeroDescent));
  }
  ...
  {
    get => _Transparent ??= GetProperty<bool?>(GetUpdatableElement()?.Transparent);
    set => UpdateField(ref _Transparent, value, nameof(Transparent));
  }
