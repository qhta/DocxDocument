...
public partial class PreSubSuper: ModelElement<DXM.PreSubSuper>, ICommonMathContent
{
  ...
  {
    get => _PreSubSuperProperties ??= GetProperty<PreSubSuperProperties?>(GetUpdatableElement()?.PreSubSuperProperties);
    set => UpdateField(ref _PreSubSuperProperties, value, nameof(PreSubSuperProperties));
  }
