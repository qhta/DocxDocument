...
public partial class BorderBox: ModelElement<DXM.BorderBox>, ICommonMathContent
{
  ...
  {
    get => _BorderBoxProperties ??= GetProperty<BorderBoxProperties?>(GetUpdatableElement()?.BorderBoxProperties);
    set => UpdateField(ref _BorderBoxProperties, value, nameof(BorderBoxProperties));
  }
