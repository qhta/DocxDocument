...
public partial class MatrixColumn: ModelElement<DXM.MatrixColumn>
{
  ...
  {
    get => _MatrixColumnProperties ??=
      GetProperty<MatrixColumnProperties?>(GetUpdatableElement()?.MatrixColumnProperties);
    set => UpdateField(ref _MatrixColumnProperties, value, nameof(MatrixColumnProperties));
  }
