...
public partial class GroupShape : ModelElement<DXOD.GroupShape>
{
  ...
  public GroupShapeNonVisualProperties? GroupShapeNonVisualProperties { get => _GroupShapeNonVisualProperties ??= GetProperty<GroupShapeNonVisualProperties?>(GetUpdatableElement()?.GroupShapeNonVisualProperties); set => UpdateField(ref _GroupShapeNonVisualProperties, value, nameof(GroupShapeNonVisualProperties)); }
  ...
  public GroupShapeProperties? GroupShapeProperties { get => _GroupShapeProperties ??= GetProperty<GroupShapeProperties?>(GetUpdatableElement()?.GroupShapeProperties); set => UpdateField(ref _GroupShapeProperties, value, nameof(GroupShapeProperties)); }
