...
[DataContract]
[XmlRoot("Shape", Namespace = "DocumentModel.Drawings.Office")]
public partial class Shape: ModelElement<DXOD.Shape>
{
  ...
  {
    get => _ShapeNonVisualProperties ??=
      GetProperty<ShapeNonVisualProperties?>(GetUpdatableElement()?.ShapeNonVisualProperties);
    set => UpdateField(ref _ShapeNonVisualProperties, value, nameof(ShapeNonVisualProperties));
  }
  ...
  {
    get => _Transform2D ??= GetProperty<Transform2D?>(GetUpdatableElement()?.Transform2D);
