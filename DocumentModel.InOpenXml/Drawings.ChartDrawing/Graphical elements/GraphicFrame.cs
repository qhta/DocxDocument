...
public partial class GraphicFrame: ModelElement<DXDCD.GraphicFrame>
{
  ...
  {
    get => _NonVisualGraphicFrameProperties ??=
      GetElement<NonVisualGraphicFrameProperties, DXDCD.NonVisualGraphicFrameProperties>(GetUpdatableElement());
    set => UpdateField(ref _NonVisualGraphicFrameProperties, value, nameof(NonVisualGraphicFrameProperties));
  }
  ...
  {
    get => _Transform ??= GetElement<Transform, DXDCD.Transform>(GetUpdatableElement());
    set => UpdateField(ref _Transform, value, nameof(Transform));
  }
  ...
  {
    get => _Graphic ??= GetElement<Graphic, DXD.Graphic>(GetUpdatableElement());
    set => UpdateField(ref _Graphic, value, nameof(Graphic));
  }
