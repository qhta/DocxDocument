...
[DataContract]
[XmlRoot("Shape", Namespace = "DocumentModel.Drawings.ChartDrawing")]
public partial class Shape: ModelElement<DXDCD.Shape>
{
  ...
  public string? Macro
  {
    get => _Macro ??= GetProperty<string?>(GetUpdatableElement()?.Macro);
    set => UpdateField(ref _Macro, value, nameof(Macro));
  }
  ...
  {
    get => _TextLink ??= GetProperty<string?>(GetUpdatableElement()?.TextLink);
    set => UpdateField(ref _TextLink, value, nameof(TextLink));
  }
  ...
  {
    get => _LockText ??= GetProperty<bool?>(GetUpdatableElement()?.LockText);
    set => UpdateField(ref _LockText, value, nameof(LockText));
  }
  ...
  {
    get => _Published ??= GetProperty<bool?>(GetUpdatableElement()?.Published);
    set => UpdateField(ref _Published, value, nameof(Published));
  }
  ...
  public NonVisualShapeProperties? NonVisualShapeProperties
  {
    get => _NonVisualShapeProperties ??=
      GetElement<NonVisualShapeProperties, DXDCD.NonVisualShapeProperties>(GetUpdatableElement());
  ...
  {
    get => _ShapeProperties ??= GetElement<ShapeProperties, DXDCD.ShapeProperties>(GetUpdatableElement());
  ...
  public Style? Style
  {
    get => _Style ??= GetElement<Style, DXDCD.Style>(GetUpdatableElement());
  ...
  {
    get => _TextBody ??= GetElement<TextBody, DXDCD.TextBody>(GetUpdatableElement());
    set => UpdateField(ref _TextBody, value, nameof(TextBody));
  }
