...
public class Shape : ModelElement<DXDCD.Shape>
{
 ...
 public NonVisualShapeProperties? NonVisualShapeProperties { get => _NonVisualShapeProperties; set => UpdateField(ref _NonVisualShapeProperties, value, nameof(NonVisualShapeProperties)); }
