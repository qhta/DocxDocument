...
public partial class Picture: ModelElement<DXDCD.Picture>
{
  ...
  {
    get => _NonVisualPictureProperties ??=
      GetElement<NonVisualPictureProperties, DXDCD.NonVisualPictureProperties>(GetUpdatableElement());
    set => UpdateField(ref _NonVisualPictureProperties, value, nameof(NonVisualPictureProperties));
  }
  ...
  {
    get => _BlipFill ??= GetElement<BlipFill, DXDCD.BlipFill>(GetUpdatableElement());
    set => UpdateField(ref _BlipFill, value, nameof(BlipFill));
  }
