...
public partial class
  NonVisualShapeDrawingProperties: ModelElement<DXDCD.NonVisualShapeDrawingProperties> //: ExtendableElement
{
  /// <summary>
  ...
  public bool? TextBox
  {
    get => _TextBox ??= GetProperty<bool?>(GetUpdatableElement()?.TextBox);
  ...
  {
    get => _ShapeLocks ??= GetProperty<ShapeLocks?>(GetUpdatableElement()?.ShapeLocks);
