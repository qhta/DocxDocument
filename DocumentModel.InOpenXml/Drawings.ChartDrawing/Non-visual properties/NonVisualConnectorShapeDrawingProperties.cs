...
public partial class
  NonVisualConnectorShapeDrawingProperties: ModelElement<DXDCD.NonVisualConnectorShapeDrawingProperties>
{
  /// <summary>
  ...
  public NonVisualConnectionShapeProperties? NonVisualConnectionShapeProperties
  {
    get => _NonVisualConnectionShapeProperties ??=
      GetProperty<NonVisualConnectionShapeProperties?>(GetUpdatableElement()?.NonVisualConnectionShapeProperties);
