...
public partial class NonVisualGroupShapeDrawingProperties: ModelElement<DXD.NonVisualGroupShapeDrawingProperties>
{
  /// <summary>
  ...
  {
    get => _GroupShapeLocks ??= GetProperty<GroupShapeLocks?>(GetUpdatableElement()?.GroupShapeLocks);
  ...
  {
    get => _NonVisualGroupDrawingShapePropsExtensionList ??=
      GetProperty<NonVisualGroupDrawingShapePropsExtensionList?>(GetUpdatableElement()
