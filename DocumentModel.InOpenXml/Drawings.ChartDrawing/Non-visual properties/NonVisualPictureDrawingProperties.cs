...
public partial class NonVisualPictureDrawingProperties: ModelElement<DXDCD.NonVisualPictureDrawingProperties>
{
  ...
  {
    get => _PreferRelativeResize ??= GetProperty<bool?>(GetUpdatableElement()?.PreferRelativeResize);
  ...
  {
    get => _PictureLocks ??= GetProperty<PictureLocks?>(GetUpdatableElement()?.PictureLocks);
  ...
  public NonVisualPicturePropertiesExtensionList? NonVisualPicturePropertiesExtensionList
  {
    get => _NonVisualPicturePropertiesExtensionList ??=
      GetProperty<NonVisualPicturePropertiesExtensionList?>(GetUpdatableElement()
