...
public partial class
  NonVisualGraphicFrameDrawingProperties: ModelElement<
  DXDCD.NonVisualGraphicFrameDrawingProperties> //, IExtendableElement
{
  /// <summary>
  ...
  {
    get => _GraphicFrameLocks ??= GetProperty<GraphicFrameLocks?>(GetUpdatableElement()?.GraphicFrameLocks);
