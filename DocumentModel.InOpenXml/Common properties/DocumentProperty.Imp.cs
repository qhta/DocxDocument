...
public abstract partial class DocumentProperty : Interfaces.DocumentProperty
{
  ...
  private static readonly BiDiDictionary<DocPropertyType, Type> typeMapping = new()
  {
  ...
  bool Interfaces.DocumentProperty.LinkToContent { get; set; }
  string Interfaces.DocumentProperty.LinkSource { get; set; }
}