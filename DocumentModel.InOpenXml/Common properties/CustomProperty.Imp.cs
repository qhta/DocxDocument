...
public sealed partial class CustomProperty : DMP.ICustomProperty, DMP.IDocumentProperty
{
 ...
 /// </summary>
 object? DMP.IDocumentProperty.Value { get => this.Value; set => this.Value = (value as Variant) ?? new Variant(value); }
 ...
 {
  {
   DMP.DocPropertyType.Number,
   "Integer"
  },
  {
   DMP.DocPropertyType.Boolean,
   "Boolean"
  },
  {
   DMP.DocPropertyType.Date,
   "Date"
  },
  {
   DMP.DocPropertyType.String,
   "String"
  },
  {
   DMP.DocPropertyType.Float,
   "Float"
  },
 };
 /// <summary>
