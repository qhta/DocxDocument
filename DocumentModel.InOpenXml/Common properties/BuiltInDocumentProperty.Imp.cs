...
public partial class BuiltInDocumentProperty :  DIC.DocumentProperty
{
  /// <summary>
  /// Name of the built-in document property. If not set, it defaults to an empty string.
  /// </summary>
  ...
  /// </summary>
  bool DIC.DocumentProperty.LinkToContent { get; set; } = false;
  /// <summary>
  ...
  /// </summary>
  string DIC.DocumentProperty.LinkSource { get; set; } = string.Empty;
}