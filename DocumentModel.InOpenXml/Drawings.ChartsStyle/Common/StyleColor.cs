...
public partial class StyleColor: ModelElement<DXO13DCS.StyleColor>
{
  ...
  {
    get => _AlphaModulation;
    set => UpdateField(ref _AlphaModulation, value, nameof(AlphaModulation));
  }
  ...
  {
    get => _HueModulation;
    set => UpdateField(ref _HueModulation, value, nameof(HueModulation));
  }
  ...
  {
    get => _SaturationOffset;
    set => UpdateField(ref _SaturationOffset, value, nameof(SaturationOffset));
  }
  ...
  {
    get => _SaturationModulation;
    set => UpdateField(ref _SaturationModulation, value, nameof(SaturationModulation));
  }
  ...
  {
    get => _LuminanceOffset;
    set => UpdateField(ref _LuminanceOffset, value, nameof(LuminanceOffset));
  }
  ...
  {
    get => _LuminanceModulation;
    set => UpdateField(ref _LuminanceModulation, value, nameof(LuminanceModulation));
  }
  ...
  {
    get => _RedModulation;
    set => UpdateField(ref _RedModulation, value, nameof(RedModulation));
  }
  ...
  {
    get => _GreenModulation;
    set => UpdateField(ref _GreenModulation, value, nameof(GreenModulation));
  }
  ...
  {
    get => _BlueModulation;
    set => UpdateField(ref _BlueModulation, value, nameof(BlueModulation));
  }
  ...
  {
    get => _InverseGamma;
    set => UpdateField(ref _InverseGamma, value, nameof(InverseGamma));
  }
