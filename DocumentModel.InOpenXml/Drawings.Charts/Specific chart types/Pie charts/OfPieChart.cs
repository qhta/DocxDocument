...
public partial class OfPieChart : ModelElement<DXDC.OfPieChart>, AbstractChart
{
 ...
 public Double? SplitPosition { get => _SplitPosition; set => UpdateField(ref _SplitPosition, value, nameof(SplitPosition)); }
 ...
 public CustomSplit? CustomSplit { get => _CustomSplit; set => UpdateField(ref _CustomSplit, value, nameof(CustomSplit)); }
 ...
 public UInt16? SecondPieSize { get => _SecondPieSize; set => UpdateField(ref _SecondPieSize, value, nameof(SecondPieSize)); }
