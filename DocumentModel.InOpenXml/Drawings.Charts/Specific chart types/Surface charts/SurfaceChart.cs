...
[XmlRoot("SurfaceChart", Namespace = "DocumentModel.Drawings.Charts")]
public partial class SurfaceChart : ModelElement<DXDC.SurfaceChart>, AbstractChart
{
 ...
 public SurfaceChartSeriesList? SurfaceChartSeries { get => _SurfaceChartSeries; set => UpdateField(ref _SurfaceChartSeries, value, nameof(SurfaceChartSeries)); }
 ...
 public BandFormats? BandFormats { get => _BandFormats; set => UpdateField(ref _BandFormats, value, nameof(BandFormats)); }
 ...
 public SurfaceChartExtensionList? SurfaceChartExtensionList { get => _SurfaceChartExtensionList; set => UpdateField(ref _SurfaceChartExtensionList, value, nameof(SurfaceChartExtensionList)); }
