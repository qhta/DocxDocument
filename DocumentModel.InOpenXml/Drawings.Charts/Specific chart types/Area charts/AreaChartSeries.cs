...
public partial class AreaChartSeries : ModelElement<DXDC.AreaChartSeries>
{
 ...
 public Collection<DataPoint>? DataPoints { get => _DataPoints; set => UpdateField(ref _DataPoints, value, nameof(DataPoints)); }
 ...
 public AreaSerExtensionList? AreaSerExtensionList { get => _AreaSerExtensionList; set => UpdateField(ref _AreaSerExtensionList, value, nameof(AreaSerExtensionList)); }
