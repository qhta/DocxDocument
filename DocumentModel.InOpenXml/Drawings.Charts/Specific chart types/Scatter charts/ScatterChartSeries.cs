...
public partial class ScatterChartSeries: ModelElement<DXDC.ScatterChartSeries>
{
  ...
  {
    get => _ScatterSerExtensionList ??=
      GetElement<ScatterSerExtensionList, DXDC.ScatterSerExtensionList>(GetUpdatableElement());
    set => UpdateField(ref _ScatterSerExtensionList, value, nameof(ScatterSerExtensionList));
  }
