...
public partial class ScatterChart: ModelElement<DXDC.ScatterChart>, AbstractChart
{
  ...
  {
    get => _ScatterStyle ??= GetProperty<ScatterStyle?>(GetUpdatableElement()?.ScatterStyle);
  ...
  {
    get => _ScatterChartSeries ??= GetElement<ScatterChartSeriesList, DXDC.ScatterChartSeries>(GetUpdatableElement());
  ...
  public ScatterChartExtensionList? ScatterChartExtensionList
  {
    get => _ScatterChartExtensionList ??=
      GetElement<ScatterChartExtensionList, DXDC.ScatterChartExtensionList>(GetUpdatableElement());
