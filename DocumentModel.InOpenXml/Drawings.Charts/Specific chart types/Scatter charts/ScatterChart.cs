...
public partial class ScatterChart : ModelElement<DXDC.ScatterChart>, AbstractChart
{
 ...
 public ScatterStyle? ScatterStyle { get => _ScatterStyle; set => UpdateField(ref _ScatterStyle, value, nameof(ScatterStyle)); }
 ...
 public ScatterChartSeriesList? ScatterChartSeries { get => _ScatterChartSeries; set => UpdateField(ref _ScatterChartSeries, value, nameof(ScatterChartSeries)); }
 ...
 public ScatterChartExtensionList? ScatterChartExtensionList { get => _ScatterChartExtensionList; set => UpdateField(ref _ScatterChartExtensionList, value, nameof(ScatterChartExtensionList)); }
