...
public partial class Bar3DChart: ModelElement<DXDC.Bar3DChart>
{
  ...
  {
    get => _BarDirection ??= GetProperty<BarDirection?>(GetUpdatableElement()?.BarDirection);
    set => UpdateField(ref _BarDirection, value, nameof(BarDirection));
  }
  ...
  {
    get => _BarGrouping ??= GetProperty<BarGrouping?>(GetUpdatableElement()?.BarGrouping);
    set => UpdateField(ref _BarGrouping, value, nameof(BarGrouping));
  }
  ...
  public BarChartSeriesList? BarChartSeries
  {
    get => _BarChartSeries ??= GetElement<BarChartSeriesList, DXDC.BarChartSeries>(GetUpdatableElement());
    set => UpdateField(ref _BarChartSeries, value, nameof(BarChartSeries));
  }
  ...
  {
    get => _GapDepth ??= GetElement<UInt16, DXDC.GapDepth>(GetUpdatableElement());
    set => UpdateField(ref _GapDepth, value, nameof(GapDepth));
  }
  ...
  {
    get => _Bar3DChartExtensionList ??=
      GetElement<Bar3DChartExtensionList, DXDC.Bar3DChartExtensionList>(GetUpdatableElement());
    set => UpdateField(ref _Bar3DChartExtensionList, value, nameof(Bar3DChartExtensionList));
  }
