...
public partial class BarChart: ModelElement<DXDC.BarChart>, AbstractChart
{
  ...
  {
    get => _Overlap ??= GetElement<SByte, DXDC.Overlap>(GetUpdatableElement());
    set => UpdateField(ref _Overlap, value, nameof(Overlap));
  }
  ...
  {
    get => _BarChartExtensionList ??=
      GetElement<BarChartExtensionList, DXDC.BarChartExtensionList>(GetUpdatableElement());
    set => UpdateField(ref _BarChartExtensionList, value, nameof(BarChartExtensionList));
  }
