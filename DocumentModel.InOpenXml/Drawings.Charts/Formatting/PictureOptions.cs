...
public partial class PictureOptions: ModelElement<DXDC.PictureOptions>
{
  ...
  {
    get => _ApplyToFront ??= GetProperty<bool?>(GetUpdatableElement()?.ApplyToFront);
    set => UpdateField(ref _ApplyToFront, value, nameof(ApplyToFront));
  }
  ...
  {
    get => _ApplyToSides ??= GetProperty<bool?>(GetUpdatableElement()?.ApplyToSides);
    set => UpdateField(ref _ApplyToSides, value, nameof(ApplyToSides));
  }
  ...
  {
    get => _ApplyToEnd ??= GetProperty<bool?>(GetUpdatableElement()?.ApplyToEnd);
    set => UpdateField(ref _ApplyToEnd, value, nameof(ApplyToEnd));
  }
  ...
  {
    get => _PictureFormat ??= GetProperty<PictureFormat?>(GetUpdatableElement()?.PictureFormat);
    set => UpdateField(ref _PictureFormat, value, nameof(PictureFormat));
  }
  ...
  {
    get => _PictureStackUnit ??= GetProperty<Double?>(GetUpdatableElement()?.PictureStackUnit);
    set => UpdateField(ref _PictureStackUnit, value, nameof(PictureStackUnit));
  }
