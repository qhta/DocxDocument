...
public partial class OverrideColorMapping: ModelElement<DXD.OverrideColorMapping> //: ExtendableElement
{
  ...
  public ColorType? Background1
  {
    get => _Background1 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Background1);
  ...
  public ColorType? Text1
  {
    get => _Text1 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Text1);
    set => UpdateField(ref _Text1, value, nameof(Text1));
  }
  ...
  public ColorType? Background2
  {
    get => _Background2 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Background2);
  ...
  public ColorType? Text2
  {
    get => _Text2 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Text2);
    set => UpdateField(ref _Text2, value, nameof(Text2));
  }
  ...
  public ColorType? Accent1
  {
    get => _Accent1 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Accent1);
    set => UpdateField(ref _Accent1, value, nameof(Accent1));
  }
  ...
  public ColorType? Accent2
  {
    get => _Accent2 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Accent2);
    set => UpdateField(ref _Accent2, value, nameof(Accent2));
  }
  ...
  public ColorType? Accent3
  {
    get => _Accent3 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Accent3);
    set => UpdateField(ref _Accent3, value, nameof(Accent3));
  }
  ...
  public ColorType? Accent4
  {
    get => _Accent4 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Accent4);
    set => UpdateField(ref _Accent4, value, nameof(Accent4));
  }
  ...
  public ColorType? Accent5
  {
    get => _Accent5 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Accent5);
    set => UpdateField(ref _Accent5, value, nameof(Accent5));
  }
  ...
  public ColorType? Accent6
  {
    get => _Accent6 ??= GetProperty<ColorType?>(GetUpdatableElement()?.Accent6);
    set => UpdateField(ref _Accent6, value, nameof(Accent6));
  }
  ...
  public ColorType? Hyperlink
  {
    get => _Hyperlink ??= GetProperty<ColorType?>(GetUpdatableElement()?.Hyperlink);
  ...
  public ColorType? FollowedHyperlink
  {
    get => _FollowedHyperlink ??= GetProperty<ColorType?>(GetUpdatableElement()?.FollowedHyperlink);
