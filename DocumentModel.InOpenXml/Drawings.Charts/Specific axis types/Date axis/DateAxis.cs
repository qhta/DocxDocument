...
public partial class DateAxis: AbstractAxis<DXDC.DateAxis>
{
  ...
  {
    get => _BaseTimeUnit;
    set => UpdateField(ref _BaseTimeUnit, value, nameof(BaseTimeUnit));
  }
  ...
  {
    get => _MajorTimeUnit;
    set => UpdateField(ref _MajorTimeUnit, value, nameof(MajorTimeUnit));
  }
  ...
  {
    get => _MinorTimeUnit;
    set => UpdateField(ref _MinorTimeUnit, value, nameof(MinorTimeUnit));
  }
  ...
  {
    get => _DateAxExtensionList;
    set => UpdateField(ref _DateAxExtensionList, value, nameof(DateAxExtensionList));
  }
