...
public partial class SeriesAxis: ModelElement<DXDC.SeriesAxis>
{
  ...
  {
    get => _TickLabelSkip ??= GetElement<Int32, DXDC.TickLabelSkip>(GetUpdatableElement());
  ...
  {
    get => _TickMarkSkip ??= GetElement<Int32, DXDC.TickMarkSkip>(GetUpdatableElement());
  ...
  {
    get => _SerAxExtensionList ??= GetElement<SerAxExtensionList, DXDC.SerAxExtensionList>(GetUpdatableElement());
