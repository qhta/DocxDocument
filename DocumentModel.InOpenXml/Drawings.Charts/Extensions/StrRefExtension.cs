...
[DataContract]
[XmlRoot("StrRefExtension", Namespace = "DocumentModel.Drawings.Charts")]
public partial class StrRefExtension : Extension<DXDC.StrRefExtension>
{
 ...
 public FullReference? FullReference { get => _FullReference; set => UpdateField(ref _FullReference, value, nameof(FullReference)); }
 ...
 public LevelReference? LevelReference { get => _LevelReference; set => UpdateField(ref _LevelReference, value, nameof(LevelReference)); }
 ...
 public FormulaReference? FormulaReference { get => _FormulaReference; set => UpdateField(ref _FormulaReference, value, nameof(FormulaReference)); }
