...
public partial class CategoryFilterException: ModelElement<DXO13DC.CategoryFilterException>
{
  ...
  public bool? InvertIfNegativeBoolean
  {
    get => _InvertIfNegativeBoolean ??= GetProperty<bool?>(GetUpdatableElement()?.InvertIfNegativeBoolean);
    set => UpdateField(ref _InvertIfNegativeBoolean, value, nameof(InvertIfNegativeBoolean));
  }
  ...
  {
    get => _DataLabel ??= GetProperty<DataLabel?>(GetUpdatableElement()?.DataLabel);
    set => UpdateField(ref _DataLabel, value, nameof(DataLabel));
  }
