...
public partial class Scaling : ModelElement<DXDC.Scaling>
{
 ...
 public Orientation? Orientation { get => _Orientation; set => UpdateField(ref _Orientation, value, nameof(Orientation)); }
 ...
 public Double? MaxAxisValue { get => _MaxAxisValue; set => UpdateField(ref _MaxAxisValue, value, nameof(MaxAxisValue)); }
 ...
 public Double? MinAxisValue { get => _MinAxisValue; set => UpdateField(ref _MinAxisValue, value, nameof(MinAxisValue)); }
