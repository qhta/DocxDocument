...
public partial class PivotOptions : ModelElement<DXO10DC.PivotOptions>
{
 ...
 public bool? DropZoneFilter { get => _DropZoneFilter; set => UpdateField(ref _DropZoneFilter, value, nameof(DropZoneFilter)); }
 ...
 public bool? DropZoneCategories { get => _DropZoneCategories; set => UpdateField(ref _DropZoneCategories, value, nameof(DropZoneCategories)); }
 ...
 public bool? DropZoneData { get => _DropZoneData; set => UpdateField(ref _DropZoneData, value, nameof(DropZoneData)); }
 ...
 public bool? DropZoneSeries { get => _DropZoneSeries; set => UpdateField(ref _DropZoneSeries, value, nameof(DropZoneSeries)); }
 ...
 public bool? DropZonesVisible { get => _DropZonesVisible; set => UpdateField(ref _DropZonesVisible, value, nameof(DropZonesVisible)); }
