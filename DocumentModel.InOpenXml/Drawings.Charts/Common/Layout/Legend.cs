...
public partial class Legend: ModelElement<DXDC.Legend> //: ExtendableElement
{
  ...
  {
    get => _LegendPosition ??= GetProperty<LegendPosition?>(GetUpdatableElement()?.LegendPosition);
  ...
  {
    get => _LegendEntries ??= GetElement<LegendEntries, DXDC.LegendEntry>(GetUpdatableElement());
  ...
  public bool? Overlay
  {
    get => _Overlay ??= GetElement<bool, DXDC.Overlay>(GetUpdatableElement());
