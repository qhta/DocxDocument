...
public partial class Trendline: ModelElement<DXDC.Trendline>
{
  ...
  {
    get => _TrendlineName ??= GetElement<string, DXDC.TrendlineName>(GetUpdatableElement());
  ...
  {
    get => _TrendlineType ??= GetElement<TrendlineType, DXDC.TrendlineType>(GetUpdatableElement());
  ...
  {
    get => _PolynomialOrder ??= GetElement<Byte, DXDC.PolynomialOrder>(GetUpdatableElement());
  ...
  {
    get => _Period ??= GetElement<UInt32, DXDC.Period>(GetUpdatableElement());
    set => UpdateField(ref _Period, value, nameof(Period));
  }
  ...
  {
    get => _Forward ??= GetElement<Double, DXDC.Forward>(GetUpdatableElement());
    set => UpdateField(ref _Forward, value, nameof(Forward));
  }
  ...
  {
    get => _Backward ??= GetElement<Double, DXDC.Backward>(GetUpdatableElement());
    set => UpdateField(ref _Backward, value, nameof(Backward));
  }
  ...
  {
    get => _Intercept ??= GetElement<Double, DXDC.Intercept>(GetUpdatableElement());
    set => UpdateField(ref _Intercept, value, nameof(Intercept));
  }
  ...
  {
    get => _DisplayRSquaredValue ??= GetElement<bool, DXDC.DisplayRSquaredValue>(GetUpdatableElement());
  ...
  {
    get => _DisplayEquation ??= GetElement<bool, DXDC.DisplayEquation>(GetUpdatableElement());
  ...
  {
    get => _TrendlineLabel ??= GetElement<TrendlineLabel, DXDC.TrendlineLabel>(GetUpdatableElement());
