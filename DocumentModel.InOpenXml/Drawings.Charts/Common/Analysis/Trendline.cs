...
public partial class Trendline : ModelElement<DXDC.Trendline>
{
 ...
 public string? TrendlineName { get => _TrendlineName; set => UpdateField(ref _TrendlineName, value, nameof(TrendlineName)); }
 ...
 public TrendlineType? TrendlineType { get => _TrendlineType; set => UpdateField(ref _TrendlineType, value, nameof(TrendlineType)); }
 ...
 public Byte? PolynomialOrder { get => _PolynomialOrder; set => UpdateField(ref _PolynomialOrder, value, nameof(PolynomialOrder)); }
 ...
 public bool? DisplayRSquaredValue { get => _DisplayRSquaredValue; set => UpdateField(ref _DisplayRSquaredValue, value, nameof(DisplayRSquaredValue)); }
 ...
 public bool? DisplayEquation { get => _DisplayEquation; set => UpdateField(ref _DisplayEquation, value, nameof(DisplayEquation)); }
 ...
 public TrendlineLabel? TrendlineLabel { get => _TrendlineLabel; set => UpdateField(ref _TrendlineLabel, value, nameof(TrendlineLabel)); }
