...
public partial class DataLabelFieldTableEntry: ModelElement<DXO13DC.DataLabelFieldTableEntry>
{
  ...
  {
    get => _TextFieldGuid ??= GetProperty<string?>(GetUpdatableElement()?.TextFieldGuid);
  ...
  public DataLabelFieldTableCache? DataLabelFieldTableCache
  {
    get => _DataLabelFieldTableCache ??=
      GetProperty<DataLabelFieldTableCache?>(GetUpdatableElement()?.DataLabelFieldTableCache);
