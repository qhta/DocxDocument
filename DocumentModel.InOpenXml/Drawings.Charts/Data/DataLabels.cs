...
[DataContract]
[XmlRoot("DataLabels", Namespace = "DocumentModel.Drawings.Charts")]
public partial class DataLabels : ModelElementCollection<DataLabel, DXDC.DataLabels, DXDC.DataLabel>
{
  ...
  public LeaderLines? LeaderLines { get => _LeaderLines; set => UpdateField(ref _LeaderLines, value, nameof(LeaderLines)); }
  ...
  public DLblsExtensionList? DLblsExtensionList { get => _DLblsExtensionList; set => UpdateField(ref _DLblsExtensionList, value, nameof(DLblsExtensionList)); }
