...
public partial class MultiLevelStringReference: ModelElement<DXDC.MultiLevelStringReference>
{
  ...
  {
    get => _MultiLevelStringCache ??= GetProperty<MultiLevelStringCache?>(GetUpdatableElement()?.MultiLevelStringCache);
  ...
  public MultiLvlStrRefExtensionList? MultiLvlStrRefExtensionList
  {
    get => _MultiLvlStrRefExtensionList ??=
      GetProperty<MultiLvlStrRefExtensionList?>(GetUpdatableElement()?.MultiLvlStrRefExtensionList);
