...
public partial class Chart: ModelElement<DXDC.Chart>
{
  ...
  public Title? Title
  {
    get => _Title ??= GetProperty<Title?>(GetUpdatableElement()?.Title);
  ...
  {
    get => _AutoTitleDeleted ??= GetProperty<bool?>(GetUpdatableElement()?.AutoTitleDeleted);
    set => UpdateField(ref _AutoTitleDeleted, value, nameof(AutoTitleDeleted));
  }
  ...
  {
    get => _PivotFormats ??= GetProperty<PivotFormats?>(GetUpdatableElement()?.PivotFormats);
    set => UpdateField(ref _PivotFormats, value, nameof(PivotFormats));
  }
  ...
  {
    get => _View3D ??= GetProperty<View3D?>(GetUpdatableElement()?.View3D);
    set => UpdateField(ref _View3D, value, nameof(View3D));
  }
  ...
  public Floor? Floor
  {
    get => _Floor ??= GetProperty<Floor?>(GetUpdatableElement()?.Floor);
    set => UpdateField(ref _Floor, value, nameof(Floor));
  }
  ...
  {
    get => _SideWall ??= GetProperty<SideWall?>(GetUpdatableElement()?.SideWall);
    set => UpdateField(ref _SideWall, value, nameof(SideWall));
  }
  ...
  {
    get => _BackWall ??= GetProperty<BackWall?>(GetUpdatableElement()?.BackWall);
    set => UpdateField(ref _BackWall, value, nameof(BackWall));
  }
  ...
  {
    get => _PlotVisibleOnly ??= GetProperty<bool?>(GetUpdatableElement()?.PlotVisibleOnly);
    set => UpdateField(ref _PlotVisibleOnly, value, nameof(PlotVisibleOnly));
  }
  ...
  {
    get => _DisplayBlanksAs ??= GetProperty<DisplayBlanksAs?>(GetUpdatableElement()?.DisplayBlanksAs);
    set => UpdateField(ref _DisplayBlanksAs, value, nameof(DisplayBlanksAs));
  }
  ...
  {
    get => _ShowDataLabelsOverMaximum ??= GetProperty<bool?>(GetUpdatableElement()?.ShowDataLabelsOverMaximum);
    set => UpdateField(ref _ShowDataLabelsOverMaximum, value, nameof(ShowDataLabelsOverMaximum));
  }
