...
public partial class ChartSpaceExtension : Extension<DXDC.ChartSpaceExtension>
{
 ...
 public PivotOptions? PivotOptions { get => _PivotOptions; set => UpdateField(ref _PivotOptions, value, nameof(PivotOptions)); }
 ...
 public SketchOptions? SketchOptions { get => _SketchOptions; set => UpdateField(ref _SketchOptions, value, nameof(SketchOptions)); }
