...
public class NamespaceViewModel : ViewModel<Namespace>
{
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Name),
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.All),
    MinWidth = minColWith,
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Classes),
    MinWidth = minColWith,
    DataTemplateResourceKey = "CountColumnTemplate",
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Enums),
    MinWidth = minColWith,
    DataTemplateResourceKey = "CountColumnTemplate",
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Interfaces),
    MinWidth = minColWith,
    DataTemplateResourceKey = "CountColumnTemplate",
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Structs),
    MinWidth = minColWith,
    DataTemplateResourceKey = "CountColumnTemplate",
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Others),
    MinWidth = minColWith,
    DataTemplateResourceKey = "CountColumnTemplate",
