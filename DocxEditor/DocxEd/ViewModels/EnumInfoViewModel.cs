...
public class EnumInfoViewModel : ViewModel<EnumInfo>, IAcceptable
{
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings."+nameof(CommonStrings.EnumValName),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings."+nameof(CommonStrings.EnumValNameTooltip)
  )]
  public string Name
  {
    get
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings."+nameof(CommonStrings.EnumValue),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings."+nameof(CommonStrings.EnumValueTooltip)
  )]
