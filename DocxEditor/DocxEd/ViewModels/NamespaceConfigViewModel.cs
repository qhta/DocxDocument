...
public class NamespaceConfigViewModel : VisibleViewModel
{
  ...
  [DataGridColumn(
    IsReadOnly = true,
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.OriginalName),
  ...
  [DataGridColumn(
    ...
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.IncludedNamespaceTooltip)
    )]
  ...
  [DataGridColumn(
    ...
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ExcludedNamespaceTooltip)
    )]
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Shortcut),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ShortcutTooltip)
    )]
  ...
  [DataGridColumn(
    Header = "",
    HiddenHeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ShortcutError),
  ...
  [DataGridColumn(
    Header = "",
    HiddenHeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.TargetNamespaceError),
    DataTemplateResourceKey = "ErrorMarkTemplate"
    )]
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ExcludedTargetNamespace),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ExcludedTargetNamespaceTooltip)
    )]
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.TargetShortcut),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.TargetShortcutTooltip)
    )]
  ...
  [DataGridColumn(
    Header = "",
    HiddenHeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.TargetShortcutError),
    DataTemplateResourceKey = "ErrorMarkTemplate"
    )]
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Types)
    )]
