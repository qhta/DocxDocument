...
public class PropInfoViewModel : ViewModel<PropInfo>, IAcceptable
{
  ...
  public ClassInfoViewModel? Owner { [DebuggerStepThrough] get; private set; }
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.PropertyName),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.PropertyNameTooltip)
    )]
  public string Name
  {
    get
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ValueType),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.ValueTypeTooltip),
    DataTemplateResourceKey = "TypeInfoLinkTemplate",
