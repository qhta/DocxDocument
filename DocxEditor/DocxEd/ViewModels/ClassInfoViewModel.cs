...
public class ClassInfoViewModel : TypeInfoViewModel
{
  ...
  [DataGridColumn(
    HeaderResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.Properties),
    HeaderTooltipResourceKey = "DocxEd.CommonStrings." + nameof(CommonStrings.PropertiesTooltip),
