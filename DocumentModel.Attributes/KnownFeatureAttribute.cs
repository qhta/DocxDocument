...
// Type: DocumentModel.Attributes.KnownFeatureAttribute
...
namespace DocumentModel.Attributes
{
  ...
  public sealed class KnownFeatureAttribute : Attribute
  {
    public KnownFeatureAttribute(Type contract, Type? service = null)
    {
    }
